...
| 500ETF | `long` | 29 | 5.3% | 62.1% | +2.62 | +983 | -582 | +33.9 | +33.6 | n<60 |
...
| 159915ETF | `short` | 43 | 7.9% | 58.1% | +1.64 | +799 | -931 | +18.6 | +21.2 | n<60 |
...
| **500ETF** | 421 | 168 | 5.3% | 25.6% | 30.9% | 55.1% | +1.49 | +6433 | +0.69 | +1006 | -1169 |
| **588000ETF** | 96 | 61 | 5.3% | 5.9% | 11.2% | 62.5% | +4.87 | +7728 | +4.08 | +4634 | -1188 |
| **159915ETF** | 165 | 69 | 4.8% | 7.9% | 12.7% | 62.4% | +5.73 | +11621 | +3.88 | +4052 | -1147 |
...
| 159915ETF | `short` | 43 | +21.2 | 58.1% | n<60 |
...
**Total deployed OOS Sharpe**: +37.47 (vs single-only +28.60, Δ = +8.86)
...
|-----|------|-----------|------------|-----------------------|-------------|---------------|----------|----------------|
| 50ETF | `long` | fixed-% | 3.00% | +4.34 | +935 | -314 | 58.6% | 0 |
...
| 500ETF | `long` | fixed-% | 5.00% | +2.62 | +983 | -582 | 62.1% | 1 |
| 500ETF | `short` | ATR-14 | 3.5× | +0.02 | +23 | -1322 | 54.7% | 0 |
| 588000ETF | `long` | fixed-% | 5.00% | +4.41 | +2969 | -660 | 48.3% | 1 |
| 588000ETF | `short` | ATR-14 | 3.5× | +3.87 | +1665 | -961 | 62.5% | 0 |
| 159915ETF | `long` | fixed-% | 5.00% | +6.44 | +3253 | -693 | 57.7% | 0 |
| 159915ETF | `short` | fixed-% | 3.00% | +1.64 | +799 | -931 | 58.1% | 5 |
