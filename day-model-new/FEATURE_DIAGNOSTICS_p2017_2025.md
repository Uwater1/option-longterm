...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.0996 | +0.0463 | +0.0463 | -0.5117 | 0.77 | 1/8 | 1.12 | 1.27 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0009 | -0.2278 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1035 | +0.0229 | +0.0229 | -0.5791 | 0.83 | 1/8 | 1.06 | 0.90 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0002 | -0.0846 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1012 | +0.0544 | +0.0544 | -0.0805 | 0.80 | 1/8 | 1.14 | 1.31 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0013 | -0.0846 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1003 | -0.0055 | -0.0055 | -0.8914 | 0.88 | 1/8 | 1.16 | 1.24 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0002 | -0.0846 |
...
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0996 | +0.0244 | +0.0244 | -0.2554 | 0.89 | 1/8 | 1.26 | 1.41 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0006 | -0.0846 |
| `combo_mean__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0864 | -0.0365 | -0.0365 | -1.6583 | 0.85 | 1/8 | 1.81 | 1.78 | `max_up_ret` (0.94) | -0.0008 | +0.0613 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0936 | -0.0022 | -0.0022 | -1.3090 | 0.89 | 1/8 | 1.36 | 0.75 | `volume_weighted_price_position` (1.24) | +0.0001 | -0.0176 |
| `combo_tri_mean__star50_limit_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0969 | +0.0559 | +0.0559 | +0.3783 | 0.69 | 0/8 | 0.92 | 0.63 | `star50_limit_proximity_early` (1.49) | +0.0006 | +0.0000 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.0971 | +0.0259 | +0.0259 | -0.2846 | 0.85 | 1/8 | 1.00 | 0.98 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0001 | -0.0846 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0926 | -0.0061 | -0.0061 | -1.6781 | 0.97 | 1/8 | 1.37 | 0.79 | `volume_weighted_price_position` (1.24) | -0.0001 | -0.0176 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0843 | +0.0158 | +0.0158 | -0.4533 | 0.78 | 1/8 | 1.00 | 1.31 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0004 | -0.0846 |
| `combo_min__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0875 | +0.0300 | +0.0300 | -0.0790 | 0.85 | 1/8 | 1.16 | 0.97 | `volume_surge_direction` (1.10) | +0.0008 | +0.0613 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0901 | -0.0261 | -0.0261 | -0.8875 | 0.90 | 0/8 | 2.24 | 1.24 | `volume_weighted_price_position` (1.24) | -0.0004 | -0.0176 |
| `combo_tri_max__max_up_ret__bar_ret_0__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0914 | -0.0344 | -0.0344 | -1.3884 | 0.80 | 0/8 | 2.24 | 1.26 | `volume_weighted_price_position` (1.24) | +0.0004 | +0.1536 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0906 | -0.0223 | -0.0223 | -1.1680 | 0.69 | 0/8 | 1.62 | 1.14 | `max_up_ret` (0.94) | +0.0001 | -0.0176 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0852 | +0.0808 | +0.0808 | +0.3659 | 0.86 | 1/8 | 1.04 | 1.45 | `rbreaker_buy_setup_proximity_early` (2.51) | +0.0018 | -0.0846 |
| `combo_mean__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0923 | +0.0113 | +0.0113 | -0.6406 | 0.90 | 1/8 | 1.18 | 1.21 | `volume_surge_direction` (1.10) | -0.0002 | +0.0613 |
| `combo_max__first_bar_return__volume_surge_direction` | Gap / Overnight Reversal | +1 | +0.0790 | +0.0104 | +0.0104 | -0.1272 | 0.99 | 2/8 | 0.80 | 1.03 | `volume_surge_direction` (1.10) | -0.0000 | -0.0176 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0858 | +0.0164 | +0.0164 | -0.3387 | 0.93 | 1/8 | 1.41 | 1.28 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0007 | +0.0613 |
| `combo_rank_max__first_bar_return__volume_surge_direction` | Gap / Overnight Reversal | +1 | +0.0762 | +0.0136 | +0.0136 | -0.1774 | 0.98 | 1/8 | 0.78 | 0.93 | `volume_surge_direction` (1.10) | +0.0001 | -0.0176 |
| `combo_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0925 | -0.0315 | -0.0315 | -1.8589 | 0.78 | 0/8 | 1.36 | 0.99 | `first_bar_sentiment` (1.06) | -0.0000 | -0.0176 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0934 | +0.0037 | +0.0037 | -1.3784 | 0.83 | 1/8 | 1.38 | 0.70 | `volume_weighted_price_position` (1.24) | +0.0002 | -0.0637 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1028 | +0.0326 | +0.0326 | +0.1677 | 0.80 | 1/8 | 1.10 | 0.75 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0007 | +0.0000 |
| `combo_mean__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0851 | -0.0027 | -0.0027 | -0.4291 | 0.78 | 1/8 | 1.52 | 1.29 | `volume_surge_direction` (1.10) | -0.0003 | +0.0613 |
| `combo_tri_min__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0903 | +0.0073 | +0.0073 | -0.4890 | 0.90 | 2/8 | 1.31 | 0.92 | `volume_weighted_price_position` (1.24) | +0.0001 | -0.0176 |
| `combo_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0732 | -0.0158 | -0.0158 | -0.6017 | 1.00 | 2/8 | 1.63 | 1.61 | `volume_surge_direction` (1.10) | +0.0004 | +0.0613 |
| `combo_tri_mean__bar_ret_0__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0953 | +0.0168 | +0.0168 | -0.5135 | 0.81 | 1/8 | 1.27 | 0.77 | `volume_weighted_price_position` (1.24) | +0.0003 | -0.0637 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0956 | -0.0082 | -0.0082 | -0.8893 | 0.90 | 1/8 | 1.46 | 1.59 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0001 | +0.0613 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0959 | -0.0157 | -0.0157 | -1.4403 | 0.74 | 0/8 | 1.48 | 1.09 | `max_up_ret` (0.94) | -0.0003 | -0.0176 |
...
| `combo_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0892 | -0.0225 | -0.0225 | -1.2669 | 0.71 | 0/8 | 1.55 | 1.00 | `max_up_ret` (0.94) | -0.0006 | -0.0176 |
| `combo_rank_max__bar_ret_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0907 | -0.0214 | -0.0214 | -0.7372 | 0.86 | 1/8 | 1.55 | 0.78 | `volume_weighted_price_position` (1.24) | +0.0001 | -0.0637 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.0905 | +0.0053 | +0.0053 | -0.2216 | 0.72 | 0/8 | 1.01 | 0.67 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0003 | -0.0637 |
| `combo_tri_mean__first_bar_return__volume_weighted_price_position__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.0979 | -0.0009 | -0.0009 | -1.0800 | 0.84 | 0/8 | 1.36 | 0.87 | `volume_weighted_price_position` (1.24) | +0.0003 | -0.0637 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0804 | -0.0091 | -0.0091 | -1.2289 | 0.89 | 1/8 | 1.72 | 1.87 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0001 | +0.0613 |
...
| `max_up_ret` | Intraday Range Momentum | +1 | +0.0742 | -0.0463 | -0.0463 | -1.8589 | 0.94 | 1/8 | 2.29 | 2.13 | — | -0.0003 | +0.0613 |
...
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.0963 | +0.0592 | +0.0592 | +0.5373 | 0.72 | 0/8 | 1.01 | 0.58 | `rbreaker_sell_setup_proximity_early` (1.21) | +0.0007 | +0.0000 |
| `combo_tri_max__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0834 | -0.0217 | -0.0217 | -1.1078 | 0.95 | 1/8 | 2.87 | 2.38 | `volume_weighted_price_position` (1.24) | -0.0006 | +0.0000 |
| `combo_sig_product__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.0927 | +0.0216 | +0.0216 | -0.8416 | 0.76 | 1/8 | 1.20 | 0.81 | `bar_body_rng_0` (0.77) | +0.0009 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1039 | +0.0133 | +0.0133 | -0.4840 | 0.78 | 1/8 | 1.10 | 1.15 | `star50_limit_proximity_early` (1.49) | +0.0008 | +0.0000 |
| `combo_tri_min__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0924 | -0.0176 | -0.0176 | -1.2814 | 0.81 | 1/8 | 1.16 | 1.15 | `max_up_ret` (0.94) | -0.0003 | +0.0000 |
...
| `combo_tri_median__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0847 | -0.0151 | -0.0151 | -0.9549 | 0.94 | 1/8 | 1.42 | 0.79 | `volume_weighted_price_position` (1.24) | -0.0003 | -0.0637 |
...
| `combo_rank_max__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0846 | -0.0043 | -0.0043 | -0.2113 | 0.97 | 1/8 | 1.33 | 1.46 | `volume_surge_direction` (1.10) | -0.0004 | +0.0000 |
...
| `combo_sig_product__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0768 | +0.0753 | +0.0753 | -0.1501 | 0.98 | 2/8 | 1.48 | 0.96 | `star50_limit_proximity_early` (1.49) | +0.0011 | -0.0846 |
| `combo_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0854 | +0.0685 | +0.0685 | -0.2790 | 0.93 | 1/8 | 1.11 | 1.40 | `rbreaker_buy_setup_proximity_early` (2.51) | +0.0014 | -0.0846 |
...
| `first_bar_return` | Gap / Overnight Reversal | +1 | +0.0874 | +0.0007 | +0.0007 | -0.8124 | 0.67 | 0/8 | 0.93 | 0.68 | — | +0.0001 | -0.0637 |
...
| `combo_min__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0840 | +0.0303 | +0.0303 | -0.4943 | 0.99 | 1/8 | 1.07 | 0.93 | `volume_surge_direction` (1.10) | -0.0003 | +0.0613 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0732 | +0.0205 | +0.0205 | -0.8741 | 0.75 | 1/8 | 1.79 | 0.65 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0001 | -0.0176 |
| `combo_min__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0854 | +0.0128 | +0.0128 | -0.5403 | 0.79 | 1/8 | 1.32 | 1.09 | `volume_surge_direction` (1.10) | -0.0000 | +0.0613 |
| `combo_tri_median__smooth_momentum_structure__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0712 | -0.0410 | -0.0410 | -2.2126 | 0.88 | 1/8 | 2.77 | 2.89 | `max_up_ret` (0.94) | -0.0009 | +0.0613 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0827 | +0.0463 | +0.0463 | -0.4058 | 1.00 | 1/8 | 1.24 | 1.88 | `rbreaker_buy_setup_proximity_early` (2.51) | +0.0005 | -0.0846 |
| `combo_min__first_bar_return__volume_surge_direction` | Gap / Overnight Reversal | +1 | +0.0812 | +0.0184 | +0.0184 | -0.4276 | 0.74 | 1/8 | 0.98 | 0.57 | `volume_surge_direction` (1.10) | +0.0007 | +0.0000 |
| `volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0791 | +0.0000 | +0.0000 | -0.4047 | 1.24 | 2/8 | 2.38 | 0.88 | — | +0.0010 | -0.0637 |
| `combo_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0858 | -0.0154 | -0.0154 | -1.0675 | 0.75 | 1/8 | 1.65 | 1.25 | `first_bar_sentiment` (1.06) | -0.0003 | +0.0613 |
...
| `combo_mean__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0904 | -0.0056 | -0.0056 | -0.8552 | 0.96 | 1/8 | 1.38 | 1.09 | `first_bar_sentiment` (1.06) | +0.0000 | +0.0000 |
| `combo_sig_product__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0812 | -0.0077 | -0.0077 | -0.7220 | 0.96 | 2/8 | 1.11 | 0.58 | `volume_weighted_price_position` (1.24) | +0.0006 | -0.0637 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0589 | +0.0244 | +0.0244 | -0.8744 | 0.87 | 1/8 | 2.02 | 1.52 | `rbreaker_sell_setup_proximity_early` (1.21) | -0.0003 | -0.0846 |
...
| `combo_tri_median__smooth_momentum_structure__bar_ret_0__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0743 | -0.0270 | -0.0270 | -0.8830 | 0.93 | 1/8 | 4.13 | 1.47 | `volume_weighted_price_position` (1.24) | +0.0001 | -0.0637 |
| `combo_mean__volume_weighted_price_position__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0918 | +0.0258 | +0.0258 | -0.9326 | 0.96 | 2/8 | 1.24 | 0.86 | `volume_weighted_price_position` (1.24) | +0.0012 | -0.0176 |
...
| `combo_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0964 | -0.0284 | -0.0284 | -0.8306 | 0.67 | 0/8 | 1.60 | 1.23 | `max_up_ret` (0.94) | -0.0005 | +0.0613 |
| `combo_rel_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0889 | -0.0338 | -0.0338 | -1.4374 | 0.78 | 0/8 | 1.70 | 1.41 | `max_up_ret` (0.94) | -0.0004 | +0.0613 |
...
| `combo_min__volume_weighted_price_position__double_bottom_bull_flag_early` | Volatility & Oscillators | +1 | +0.0528 | -0.0133 | -0.0133 | -1.5530 | 0.65 | 0/8 | 0.75 | 0.49 | `double_bottom_bull_flag_early` (1.91) | +0.0005 | +0.0147 |
| `combo_max__first_bar_sentiment__volume_surge_direction` | Gap / Overnight Reversal | +1 | +0.0750 | +0.0321 | +0.0321 | -0.4244 | 0.78 | 0/8 | 0.80 | 0.74 | `volume_surge_direction` (1.10) | -0.0000 | -0.0176 |

### 500ETF — `single` (Full Model Lockbox IC: +0.0759, Sharpe: +0.1894)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_diff__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1462 | +0.0573 | +0.0573 | -0.2479 | 0.33 | 0/8 | 0.67 | 0.59 | `volume_weighted_momentum_acceleration` (0.47) | -0.0003 | -0.0125 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1315 | +0.0849 | +0.0849 | -0.1619 | 0.25 | 0/8 | 0.83 | 0.71 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0002 | +0.0938 |
| `combo_clamp_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1545 | +0.0289 | +0.0289 | -0.4555 | 0.40 | 0/8 | 0.65 | 0.59 | `volume_weighted_momentum_acceleration` (0.47) | -0.0003 | +0.0000 |
| `combo_max__volatility_expansion_trend_vector__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1141 | +0.0503 | +0.0503 | -1.5796 | 0.30 | 0/8 | 0.95 | 0.52 | `first_bar_sentiment` (0.43) | -0.0003 | -0.1070 |
| `combo_clamp_diff__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1415 | +0.0589 | +0.0589 | -0.5615 | 0.34 | 0/8 | 0.57 | 0.55 | `body_size_progression` (0.46) | +0.0000 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1474 | +0.0406 | +0.0406 | -1.4083 | 0.29 | 0/8 | 0.79 | 0.61 | `opening_drive_thrust_ratio` (0.32) | -0.0005 | -0.0125 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1361 | +0.0867 | +0.0867 | +0.2984 | 0.35 | 0/8 | 0.74 | 0.63 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0002 | -0.1563 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1453 | +0.0883 | +0.0883 | -0.5698 | 0.42 | 0/8 | 0.62 | 0.67 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0000 | -0.1563 |
| `combo_max__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1359 | +0.0534 | +0.0534 | -1.3411 | 0.39 | 0/8 | 0.74 | 0.54 | `volatility_expansion_trend_vector` (0.36) | -0.0004 | +0.0000 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1496 | +0.0719 | +0.0719 | -0.4456 | 0.27 | 0/8 | 0.71 | 0.61 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0002 | -0.0125 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1205 | +0.0959 | +0.0959 | +0.4192 | 0.31 | 0/8 | 0.84 | 0.66 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0007 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1133 | +0.0560 | +0.0560 | -1.0726 | 0.20 | 0/8 | 1.00 | 0.83 | `volume_weighted_momentum_acceleration` (0.47) | +0.0002 | -0.0125 |
| `combo_sig_product__opening_drive_thrust_ratio__trend_day_regime_conviction` | Other Technical | +1 | +0.1277 | +0.0287 | +0.0287 | -0.6970 | 0.35 | 0/8 | 0.65 | 0.55 | `trend_day_regime_conviction` (0.39) | -0.0008 | -0.1070 |
| `combo_mean__close_vs_open_range__bar_ret_0` | Other Technical | +1 | +0.1292 | +0.0469 | +0.0469 | -1.2311 | 0.36 | 0/8 | 0.79 | 0.56 | `bar_ret_0` (0.46) | -0.0002 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1315 | +0.0419 | +0.0419 | -1.0138 | 0.26 | 0/8 | 0.90 | 0.75 | `trend_day_regime_conviction` (0.39) | -0.0003 | -0.0751 |
| `combo_clamp_diff__max_up_ret__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1335 | +0.0447 | +0.0447 | -0.9029 | 0.34 | 0/8 | 0.69 | 0.55 | `late_bar_momentum` (0.53) | -0.0001 | +0.0194 |
| `combo_rank_max__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.1128 | +0.0538 | +0.0538 | -1.1112 | 0.29 | 0/8 | 1.00 | 0.68 | `close_vs_open_range` (0.39) | -0.0005 | +0.0000 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1364 | +0.0337 | +0.0337 | -1.4167 | 0.28 | 0/8 | 0.73 | 0.62 | `trend_bar_close_consistency` (0.54) | -0.0006 | -0.0751 |
| `combo_min__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1151 | +0.0647 | +0.0647 | -0.2556 | 0.33 | 0/8 | 0.76 | 0.59 | `first_bar_return` (0.46) | +0.0004 | -0.1070 |
| `combo_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.1032 | +0.0525 | +0.0525 | -0.4214 | 0.33 | 0/8 | 0.89 | 0.70 | `close_vs_open_range` (0.39) | -0.0004 | +0.0938 |
| `combo_mean__trend_bar_close_consistency__bar_ret_0` | Other Technical | +1 | +0.1128 | +0.0378 | +0.0378 | -0.8881 | 0.35 | 0/8 | 0.75 | 0.55 | `trend_bar_close_consistency` (0.54) | -0.0006 | -0.1070 |
| `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1476 | +0.0426 | +0.0426 | -0.2324 | 0.38 | 0/8 | 0.66 | 0.57 | `volume_weighted_momentum_acceleration` (0.47) | -0.0005 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1404 | +0.0942 | +0.0942 | -0.2127 | 0.33 | 0/8 | 0.63 | 0.45 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0001 | -0.1070 |
| `combo_tri_mean__star50_limit_proximity_early__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1050 | +0.0817 | +0.0817 | +0.3027 | 0.40 | 0/8 | 0.65 | 0.51 | `trend_bar_close_consistency` (0.54) | -0.0000 | +0.0000 |
| `combo_mean__net_volume_flow__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1186 | +0.0519 | +0.0519 | -0.8017 | 0.27 | 0/8 | 0.83 | 0.60 | `first_bar_sentiment` (0.43) | -0.0004 | -0.1070 |
| `combo_min__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1131 | +0.1060 | +0.1060 | +0.3487 | 0.39 | 0/8 | 0.78 | 0.66 | `star50_limit_proximity_early` (0.50) | +0.0007 | +0.0938 |
| `combo_mean__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1144 | +0.0933 | +0.0933 | -0.2396 | 0.32 | 0/8 | 0.68 | 0.52 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0001 | +0.0000 |
| `combo_rank_min__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1137 | +0.0706 | +0.0706 | -0.6439 | 0.36 | 0/8 | 0.71 | 0.54 | `first_bar_return` (0.46) | +0.0001 | -0.1070 |
...
| `combo_sig_product__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1263 | +0.0480 | +0.0480 | -0.2807 | 0.41 | 0/8 | 0.67 | 0.47 | `opening_drive_thrust_ratio` (0.32) | -0.0005 | -0.0125 |
| `combo_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1540 | +0.0316 | +0.0316 | -0.2324 | 0.40 | 0/8 | 0.66 | 0.60 | `volume_weighted_momentum_acceleration` (0.47) | +0.0001 | -0.0751 |
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1223 | +0.0126 | +0.0126 | -2.1701 | 0.35 | 0/8 | 0.74 | 0.54 | `bar_ret_0` (0.46) | -0.0007 | -0.1070 |
| `combo_mean__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1055 | +0.1051 | +0.1051 | -0.1201 | 0.40 | 0/8 | 0.69 | 0.56 | `star50_limit_proximity_early` (0.50) | +0.0006 | +0.0000 |
| `combo_rank_max__close_vs_open_range__bar_ret_0` | Other Technical | +1 | +0.1373 | +0.0231 | +0.0231 | -2.4234 | 0.30 | 0/8 | 0.82 | 0.53 | `bar_ret_0` (0.46) | -0.0007 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1523 | +0.0478 | +0.0478 | -0.8584 | 0.37 | 0/8 | 0.63 | 0.49 | `first_bar_return` (0.46) | -0.0000 | +0.0000 |
| `combo_tri_mean__max_up_ret__trend_bar_close_consistency__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1151 | +0.0336 | +0.0336 | -1.0604 | 0.33 | 0/8 | 0.89 | 0.63 | `trend_bar_close_consistency` (0.54) | -0.0007 | -0.1070 |
| `combo_mean__opening_drive_thrust_ratio__trend_bar_close_consistency` | Other Technical | +1 | +0.1248 | +0.0390 | +0.0390 | -0.6507 | 0.35 | 0/8 | 0.81 | 0.64 | `trend_bar_close_consistency` (0.54) | -0.0009 | +0.0000 |
| `combo_rank_max__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1288 | +0.0469 | +0.0469 | -1.4510 | 0.34 | 0/8 | 0.83 | 0.59 | `max_up_ret` (0.28) | +0.0001 | +0.0938 |
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0995 | -0.0041 | -0.0041 | -1.9661 | 0.29 | 0/8 | 1.40 | 0.96 | — | -0.0004 | -0.1070 |
| `combo_clamp_diff__star50_limit_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1330 | +0.1065 | +0.1065 | +0.7497 | 0.40 | 0/8 | 0.50 | 0.53 | `star50_limit_proximity_early` (0.50) | +0.0007 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1207 | +0.0921 | +0.0921 | +0.3192 | 0.46 | 0/8 | 0.40 | 0.39 | `first_bar_return` (0.46) | +0.0003 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1188 | +0.1095 | +0.1095 | +0.7916 | 0.40 | 0/8 | 0.71 | 0.58 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0003 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1271 | +0.0550 | +0.0550 | -0.9817 | 0.32 | 0/8 | 0.82 | 0.69 | `close_vs_open_range` (0.39) | -0.0001 | +0.0000 |
| `combo_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1359 | +0.0235 | +0.0235 | -2.7519 | 0.31 | 0/8 | 0.80 | 0.51 | `first_bar_return` (0.46) | -0.0003 | -0.0828 |
| `combo_min__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1347 | +0.0639 | +0.0639 | -0.6077 | 0.46 | 0/8 | 0.49 | 0.41 | `first_bar_return` (0.46) | +0.0002 | -0.1070 |
| `combo_rank_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1353 | +0.0288 | +0.0288 | -1.9401 | 0.31 | 0/8 | 0.92 | 0.66 | `bar_ret_0` (0.46) | -0.0007 | +0.0194 |
| `combo_min__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1447 | +0.0453 | +0.0453 | -0.8924 | 0.31 | 0/8 | 0.76 | 0.65 | `opening_drive_thrust_ratio` (0.32) | -0.0007 | -0.0751 |
...
| `combo_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1404 | +0.0418 | +0.0418 | +0.2392 | 0.32 | 0/8 | 0.63 | 0.55 | `body_size_progression` (0.46) | +0.0001 | +0.0194 |
| `combo_rank_max__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1529 | +0.0388 | +0.0388 | -1.1420 | 0.30 | 0/8 | 0.81 | 0.55 | `bar_ret_0` (0.46) | -0.0004 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1276 | +0.0593 | +0.0593 | -0.7951 | 0.49 | 0/8 | 0.46 | 0.38 | `bar_ret_0` (0.46) | +0.0001 | -0.1070 |
| `combo_sig_product__opening_drive_thrust_ratio__trend_bar_close_consistency` | Other Technical | +1 | +0.1239 | +0.0383 | +0.0383 | -0.5921 | 0.40 | 0/8 | 0.69 | 0.52 | `trend_bar_close_consistency` (0.54) | -0.0005 | -0.1070 |
| `combo_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1180 | +0.0186 | +0.0186 | -2.2632 | 0.37 | 0/8 | 0.74 | 0.49 | `bar_ret_0` (0.46) | -0.0004 | +0.0251 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1228 | +0.0958 | +0.0958 | +0.5075 | 0.45 | 0/8 | 0.41 | 0.41 | `bar_ret_0` (0.46) | +0.0006 | +0.0000 |
| `combo_min__trend_bar_close_consistency__bar_ret_0` | Other Technical | +1 | +0.0936 | +0.0619 | +0.0619 | -0.1417 | 0.43 | 0/8 | 0.76 | 0.63 | `trend_bar_close_consistency` (0.54) | -0.0002 | -0.1070 |
| `combo_min__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1142 | +0.1001 | +0.1001 | -0.0297 | 0.34 | 0/8 | 0.82 | 0.62 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0007 | +0.0000 |
| `combo_rank_min__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1172 | +0.1093 | +0.1093 | +0.3039 | 0.41 | 0/8 | 0.77 | 0.72 | `star50_limit_proximity_early` (0.50) | +0.0002 | +0.0938 |
| `combo_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1206 | +0.0254 | +0.0254 | -1.5318 | 0.38 | 0/8 | 0.80 | 0.59 | `early_body_momentum` (0.34) | +0.0000 | -0.1070 |
...
| `combo_mean__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1375 | +0.0281 | +0.0281 | -0.9455 | 0.32 | 0/8 | 0.76 | 0.55 | `first_bar_return` (0.46) | -0.0002 | -0.0503 |
...
| `combo_diff__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1452 | +0.0498 | +0.0498 | -0.3399 | 0.33 | 0/8 | 0.68 | 0.66 | `smooth_momentum_structure` (0.46) | +0.0001 | +0.0938 |
| `combo_clamp_diff__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.1154 | +0.1143 | +0.1143 | +1.3960 | 0.45 | 0/8 | 0.44 | 0.46 | `star50_limit_proximity_early` (0.50) | +0.0011 | +0.0938 |
| `combo_rel_diff__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1399 | +0.0458 | +0.0458 | -0.3399 | 0.35 | 0/8 | 0.66 | 0.66 | `smooth_momentum_structure` (0.46) | +0.0001 | +0.0000 |
| `combo_mean__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1160 | +0.0404 | +0.0404 | -0.4576 | 0.46 | 0/8 | 0.55 | 0.43 | `bar_ret_0` (0.46) | -0.0001 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1421 | +0.0525 | +0.0525 | -0.9776 | 0.28 | 0/8 | 0.95 | 0.60 | `body_size_progression` (0.46) | -0.0003 | +0.0194 |
| `combo_rank_max__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1395 | +0.0550 | +0.0550 | +0.1707 | 0.44 | 0/8 | 0.61 | 0.50 | `max_down_ret` (0.55) | -0.0004 | +0.0000 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1444 | +0.0393 | +0.0393 | -1.9156 | 0.33 | 0/8 | 0.74 | 0.53 | `opening_drive_thrust_ratio` (0.32) | -0.0001 | -0.1070 |
| `combo_rank_min__high_low_sequence_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1103 | +0.0812 | +0.0812 | -0.0721 | 0.50 | 0/8 | 0.69 | 0.50 | `max_down_ret` (0.55) | +0.0002 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1064 | +0.0528 | +0.0528 | -0.4408 | 0.33 | 0/8 | 0.79 | 0.60 | `trend_bar_close_consistency` (0.54) | -0.0004 | -0.1070 |
| `combo_sig_product__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1011 | +0.0944 | +0.0944 | -0.6509 | 0.54 | 0/8 | 1.10 | 1.03 | `star50_limit_proximity_early` (0.50) | +0.0007 | -0.0178 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1526 | +0.0524 | +0.0524 | -0.6914 | 0.28 | 0/8 | 0.82 | 0.65 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0004 | +0.0194 |
| `combo_sig_product__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1125 | +0.0290 | +0.0290 | -0.5714 | 0.31 | 0/8 | 0.92 | 0.80 | `early_body_momentum` (0.34) | -0.0007 | -0.1070 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1512 | +0.0376 | +0.0376 | -1.6484 | 0.30 | 0/8 | 0.81 | 0.53 | `opening_drive_thrust_ratio` (0.32) | -0.0003 | +0.0938 |
| `combo_rel_diff__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.1203 | +0.1107 | +0.1107 | +1.2537 | 0.40 | 0/8 | 0.50 | 0.50 | `star50_limit_proximity_early` (0.50) | +0.0007 | +0.0000 |
...
| `combo_min__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1028 | +0.0291 | +0.0291 | -0.6661 | 0.31 | 0/8 | 1.20 | 0.80 | `trend_bar_close_consistency` (0.54) | -0.0011 | -0.0751 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.0822 | +0.1006 | +0.1006 | +0.1239 | 0.60 | 0/8 | 0.58 | 0.44 | `smooth_momentum_structure` (0.46) | +0.0002 | +0.0000 |
| `combo_rank_max__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1075 | +0.0609 | +0.0609 | -0.4353 | 0.44 | 0/8 | 0.67 | 0.51 | `max_down_ret` (0.55) | -0.0004 | +0.0000 |
| `always_in_trend_persistence` | Volatility & Oscillators | +1 | +0.0826 | -0.0147 | -0.0147 | -1.5236 | 0.38 | 0/8 | 1.91 | 1.18 | — | -0.0002 | -0.1070 |
...
| `combo_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1301 | +0.0518 | +0.0518 | -0.2853 | 0.51 | 0/8 | 0.55 | 0.33 | `max_down_ret` (0.55) | +0.0002 | +0.0251 |
| `combo_diff__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.1153 | +0.1117 | +0.1117 | +1.3824 | 0.46 | 0/8 | 0.43 | 0.45 | `star50_limit_proximity_early` (0.50) | +0.0011 | +0.0938 |
| `combo_sig_product__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1260 | +0.0219 | +0.0219 | -1.0362 | 0.36 | 0/8 | 0.70 | 0.60 | `close_vs_open_range` (0.39) | -0.0006 | +0.0000 |
| `combo_min__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1111 | +0.0883 | +0.0883 | -0.0326 | 0.40 | 0/8 | 0.73 | 0.56 | `max_down_ret` (0.55) | +0.0001 | +0.0000 |
| `combo_rank_max__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1088 | +0.0938 | +0.0938 | -0.4554 | 0.46 | 0/8 | 0.73 | 0.54 | `star50_limit_proximity_early` (0.50) | +0.0003 | +0.0000 |
| `combo_min__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1038 | +0.0798 | +0.0798 | -0.2027 | 0.45 | 0/8 | 0.70 | 0.61 | `first_bar_return` (0.46) | +0.0002 | -0.1070 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1323 | +0.0308 | +0.0308 | -1.6524 | 0.28 | 0/8 | 0.90 | 0.61 | — | -0.0002 | -0.0751 |
| `combo_mean__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1355 | +0.0297 | +0.0297 | -1.4140 | 0.31 | 0/8 | 0.82 | 0.56 | `first_bar_sentiment` (0.43) | -0.0000 | -0.0751 |
| `combo_max__close_vs_open_range__early_body_momentum` | Intraday Range Momentum | +1 | +0.0958 | +0.0413 | +0.0413 | -0.2764 | 0.37 | 0/8 | 1.11 | 0.76 | `close_vs_open_range` (0.39) | -0.0005 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1208 | +0.0471 | +0.0471 | -0.3148 | 0.28 | 0/8 | 0.71 | 0.63 | `smooth_momentum_structure` (0.46) | -0.0002 | +0.0194 |
| `combo_rank_min__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1223 | +0.0429 | +0.0429 | -0.2027 | 0.46 | 0/8 | 0.52 | 0.39 | `first_bar_return` (0.46) | -0.0001 | -0.0751 |
| `combo_rank_min__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1129 | +0.0531 | +0.0531 | +0.0725 | 0.44 | 0/8 | 0.54 | 0.42 | `bar_ret_0` (0.46) | -0.0003 | -0.1070 |
| `combo_sig_product__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1150 | +0.0410 | +0.0410 | -0.4576 | 0.46 | 0/8 | 0.54 | 0.43 | `first_bar_return` (0.46) | +0.0000 | -0.1070 |
| `combo_tri_median__opening_drive_thrust_ratio__trend_bar_close_consistency__body_size_progression` | Other Technical | +1 | +0.0811 | +0.0189 | +0.0189 | -0.2323 | 0.38 | 0/8 | 1.30 | 1.07 | `trend_bar_close_consistency` (0.54) | -0.0006 | +0.0000 |
| `combo_max__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.1114 | +0.0486 | +0.0486 | -0.2505 | 0.44 | 0/8 | 0.68 | 0.51 | `max_down_ret` (0.55) | -0.0001 | -0.1070 |
| `combo_rel_diff__opening_drive_thrust_ratio__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1250 | +0.0700 | +0.0700 | +0.3994 | 0.36 | 0/8 | 0.61 | 0.53 | `late_bar_momentum` (0.53) | +0.0001 | +0.0000 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1205 | +0.1502 | +0.1502 | +1.1714 | 0.35 | 0/8 | 0.72 | 0.86 | `max_down_ret` (0.55) | +0.0007 | +0.0000 |
| `combo_rank_max__net_volume_flow__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1023 | +0.0313 | +0.0313 | -1.0053 | 0.32 | 0/8 | 1.07 | 0.69 | `first_bar_sentiment` (0.43) | -0.0004 | +0.0000 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__trend_bar_close_consistency` | Other Technical | +1 | +0.1066 | +0.0663 | +0.0663 | -0.4907 | 0.41 | 0/8 | 0.76 | 0.62 | `trend_bar_close_consistency` (0.54) | -0.0004 | +0.0000 |
| `combo_min__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1127 | +0.0594 | +0.0594 | -0.8629 | 0.27 | 0/8 | 1.20 | 0.85 | `close_vs_open_range` (0.39) | -0.0004 | -0.0751 |
| `combo_max__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1039 | +0.0557 | +0.0557 | -0.2026 | 0.44 | 0/8 | 0.71 | 0.52 | `max_down_ret` (0.55) | -0.0003 | -0.1075 |
| `combo_mean__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1368 | +0.0707 | +0.0707 | +0.2615 | 0.36 | 0/8 | 0.67 | 0.50 | `max_down_ret` (0.55) | +0.0002 | +0.0000 |
| `combo_sig_product__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1090 | +0.0661 | +0.0661 | +1.4473 | 0.48 | 1/8 | 0.80 | 0.38 | `volume_weighted_momentum_acceleration` (0.47) | -0.0004 | +0.0000 |
| `combo_mean__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0954 | +0.0970 | +0.0970 | +0.1808 | 0.55 | 0/8 | 0.56 | 0.45 | `max_down_ret` (0.55) | +0.0003 | +0.0000 |
| `combo_min__first_bar_return__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1016 | +0.0728 | +0.0728 | +0.2061 | 0.43 | 0/8 | 0.54 | 0.47 | `max_down_ret` (0.55) | +0.0001 | -0.1070 |
...
| `combo_sig_product__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1186 | +0.1138 | +0.1138 | +0.2628 | 0.41 | 0/8 | 0.83 | 0.74 | `star50_limit_proximity_early` (0.50) | +0.0005 | +0.0000 |
| `combo_rank_min__first_bar_return__max_down_ret` | Gap / Overnight Reversal | +1 | +0.0994 | +0.0630 | +0.0630 | +0.1498 | 0.50 | 0/8 | 0.52 | 0.44 | `max_down_ret` (0.55) | +0.0002 | -0.1070 |
| `combo_sig_product__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0903 | +0.0246 | +0.0246 | -0.5104 | 0.55 | 0/8 | 0.41 | 0.34 | `first_bar_return` (0.46) | -0.0004 | -0.1070 |
| `combo_sig_product__star50_limit_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1004 | +0.0838 | +0.0838 | -0.6184 | 0.53 | 0/8 | 1.04 | 0.90 | `star50_limit_proximity_early` (0.50) | -0.0001 | +0.0000 |
| `combo_rank_min__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1086 | +0.0610 | +0.0610 | -0.3371 | 0.31 | 0/8 | 1.13 | 0.80 | `close_vs_open_range` (0.39) | -0.0006 | +0.0194 |
| `combo_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.0998 | +0.0636 | +0.0636 | -0.1214 | 0.40 | 0/8 | 0.79 | 0.65 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0003 | -0.1070 |
| `combo_rank_max__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1087 | +0.1327 | +0.1327 | +0.9157 | 0.54 | 0/8 | 0.62 | 0.54 | `max_down_ret` (0.55) | +0.0006 | +0.0000 |
| `combo_sig_product__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1031 | +0.0291 | +0.0291 | +0.0988 | 0.29 | 0/8 | 0.81 | 0.73 | `first_bar_sentiment` (0.43) | -0.0003 | -0.1070 |
| `combo_clamp_diff__opening_drive_thrust_ratio__trend_bar_close_consistency` | Other Technical | +1 | +0.0634 | +0.0335 | +0.0335 | +0.3145 | 0.77 | 1/8 | 0.59 | 0.61 | `trend_bar_close_consistency` (0.54) | +0.0006 | +0.0938 |
| `combo_tri_mean__net_volume_flow__star50_limit_proximity_early__body_size_progression` | Volatility & Oscillators | +1 | +0.0487 | +0.0730 | +0.0730 | +0.4368 | 0.71 | 1/8 | 0.67 | 0.42 | `star50_limit_proximity_early` (0.50) | -0.0001 | +0.0000 |
| `combo_max__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1074 | +0.0923 | +0.0923 | -0.6750 | 0.46 | 0/8 | 0.65 | 0.48 | `star50_limit_proximity_early` (0.50) | +0.0000 | +0.0000 |
| `combo_sig_product__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1154 | +0.0205 | +0.0205 | -0.7130 | 0.57 | 0/8 | 0.65 | 0.35 | `bar_ret_0` (0.46) | -0.0004 | -0.1070 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1250 | +0.0435 | +0.0435 | +0.0483 | 0.42 | 0/8 | 0.55 | 0.37 | `first_bar_sentiment` (0.43) | -0.0001 | -0.0751 |
| `combo_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0993 | +0.0982 | +0.0982 | +0.3922 | 0.47 | 0/8 | 0.68 | 0.47 | `max_down_ret` (0.55) | +0.0004 | +0.0000 |
| `combo_sig_product__star50_limit_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1036 | +0.1371 | +0.1371 | +0.1462 | 0.50 | 0/8 | 0.81 | 0.93 | `star50_limit_proximity_early` (0.50) | +0.0006 | +0.0000 |
| `combo_tri_max__star50_limit_proximity_early__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0978 | +0.0756 | +0.0756 | -0.7698 | 0.47 | 0/8 | 0.65 | 0.52 | `trend_bar_close_consistency` (0.54) | -0.0002 | -0.1070 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1035 | +0.0695 | +0.0695 | -0.6436 | 0.34 | 0/8 | 0.94 | 0.63 | `body_size_progression` (0.46) | -0.0001 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1201 | +0.0805 | +0.0805 | +0.0712 | 0.39 | 0/8 | 0.66 | 0.49 | `max_down_ret` (0.55) | +0.0003 | +0.0000 |
| `combo_rank_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1064 | +0.0290 | +0.0290 | -0.9127 | 0.34 | 0/8 | 1.05 | 0.75 | `first_bar_sentiment` (0.43) | -0.0001 | +0.0000 |
...
| `open_to_current_return` | Intraday Range Momentum | +1 | +0.1077 | +0.0435 | +0.0435 | -0.2385 | 0.34 | 0/8 | 0.97 | 0.64 | — | -0.0003 | -0.0751 |
| `combo_sig_product__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.1061 | +0.1335 | +0.1335 | +0.1748 | 0.61 | 1/8 | 1.41 | 1.86 | `star50_limit_proximity_early` (0.50) | +0.0002 | +0.0938 |
| `combo_tri_max__opening_drive_thrust_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1237 | +0.0937 | +0.0937 | -0.1678 | 0.49 | 0/8 | 0.59 | 0.40 | `star50_limit_proximity_early` (0.50) | +0.0003 | +0.0000 |
...
| `combo_sig_product__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1139 | +0.0630 | +0.0630 | +0.0335 | 0.38 | 0/8 | 0.75 | 0.67 | `body_size_progression` (0.46) | -0.0003 | +0.0194 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__net_volume_flow` | Volatility & Oscillators | +1 | +0.1219 | +0.0857 | +0.0857 | -0.3128 | 0.33 | 0/8 | 0.77 | 0.57 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0002 | +0.0000 |
| `combo_sig_product__high_low_sequence_momentum__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1024 | +0.0279 | +0.0279 | -0.5752 | 0.41 | 0/8 | 0.95 | 0.56 | `first_bar_return` (0.46) | -0.0004 | -0.1070 |
| `combo_tri_median__max_up_ret__smooth_momentum_structure__net_volume_flow` | Intraday Range Momentum | +1 | +0.0946 | +0.0379 | +0.0379 | -0.6625 | 0.22 | 0/8 | 1.32 | 0.92 | `smooth_momentum_structure` (0.46) | -0.0003 | -0.0751 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1092 | +0.0212 | +0.0212 | -1.5281 | 0.47 | 0/8 | 1.03 | 0.68 | `volume_weighted_momentum_acceleration` (0.47) | -0.0006 | -0.0751 |
| `combo_sig_product__max_up_ret__high_low_sequence_momentum` | Intraday Range Momentum | +1 | +0.1076 | +0.0281 | +0.0281 | -0.8940 | 0.30 | 0/8 | 1.03 | 1.05 | `high_low_sequence_momentum` (0.43) | -0.0007 | +0.0000 |
| `combo_rank_min__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1004 | +0.0600 | +0.0600 | -0.0062 | 0.39 | 0/8 | 0.66 | 0.46 | `first_bar_sentiment` (0.43) | +0.0002 | +0.0000 |
| `morning_volume_weighted_momentum` | Intraday Range Momentum | +1 | +0.1068 | +0.0484 | +0.0484 | -0.3058 | 0.32 | 0/8 | 0.97 | 0.64 | — | -0.0004 | -0.0751 |
| `combo_sig_product__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1155 | +0.0705 | +0.0705 | -0.3494 | 0.30 | 0/8 | 0.81 | 0.65 | `max_down_ret` (0.55) | -0.0002 | +0.0000 |
...
| `combo_max__high_low_sequence_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1006 | +0.0504 | +0.0504 | -0.7776 | 0.49 | 0/8 | 0.69 | 0.48 | `max_down_ret` (0.55) | -0.0004 | +0.0000 |
| `vwap_close_divergence_trend` | Other Technical | +1 | +0.0926 | +0.0323 | +0.0323 | -0.2960 | 0.38 | 0/8 | 1.19 | 0.83 | — | -0.0004 | -0.0751 |
| `combo_sig_product__max_up_ret__early_late_momentum_divergence` | Intraday Range Momentum | +1 | +0.1111 | +0.0553 | +0.0553 | +0.1769 | 0.24 | 0/8 | 1.01 | 0.74 | `early_late_momentum_divergence` (0.53) | -0.0002 | +0.0194 |
| `max_down_ret` | Intraday Range Momentum | +1 | +0.1028 | +0.0790 | +0.0790 | +0.1275 | 0.55 | 0/8 | 0.55 | 0.39 | — | +0.0002 | +0.0000 |
| `combo_sig_product__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1015 | +0.0505 | +0.0505 | +1.1989 | 0.33 | 0/8 | 0.86 | 0.71 | `body_size_progression` (0.46) | -0.0001 | +0.0194 |
| `combo_ratio__max_down_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1022 | +0.1034 | +0.1034 | +1.0177 | 0.50 | 0/8 | 0.50 | 0.34 | `max_down_ret` (0.55) | +0.0007 | +0.0000 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1190 | +0.0824 | +0.0824 | -0.6419 | 0.49 | 0/8 | 0.58 | 0.34 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0004 | +0.0000 |
| `bar_body_rng_0` | Other Technical | +1 | +0.1136 | +0.0572 | +0.0572 | -0.7848 | 0.37 | 0/8 | 0.62 | 0.48 | — | -0.0003 | +0.0000 |
| `vwap_trend_channel_slope` | Other Technical | +1 | +0.0953 | +0.0398 | +0.0398 | -0.3845 | 0.38 | 0/8 | 1.12 | 0.88 | — | +0.0002 | -0.0751 |
| `combo_sig_product__opening_drive_thrust_ratio__early_late_momentum_divergence` | Intraday Range Momentum | +1 | +0.1085 | +0.0533 | +0.0533 | +0.0477 | 0.33 | 0/8 | 0.83 | 0.71 | `early_late_momentum_divergence` (0.53) | -0.0004 | +0.0194 |
| `combo_clamp_diff__opening_drive_thrust_ratio__trend_day_regime_conviction` | Other Technical | +1 | +0.0532 | +0.0163 | +0.0163 | -1.2828 | 0.95 | 1/8 | 0.53 | 0.28 | `trend_day_regime_conviction` (0.39) | +0.0003 | +0.0938 |
| `combo_rank_max__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1292 | +0.1068 | +0.1068 | +0.6164 | 0.41 | 0/8 | 0.65 | 0.49 | `star50_limit_proximity_early` (0.50) | +0.0004 | +0.0000 |
| `num_up_bars` | Other Technical | +1 | +0.0907 | +0.0459 | +0.0459 | -1.1323 | 0.40 | 0/8 | 1.47 | 1.31 | — | +0.0001 | -0.0125 |
| `combo_sig_product__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.0967 | +0.0521 | +0.0521 | -0.6353 | 0.49 | 0/8 | 0.48 | 0.50 | `max_down_ret` (0.55) | -0.0002 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1195 | +0.0813 | +0.0813 | -0.8506 | 0.47 | 0/8 | 0.57 | 0.58 | `max_down_ret` (0.55) | -0.0000 | +0.0000 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1417, Sharpe: +1.0401)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1386 | +0.1275 | +0.1275 | +0.8333 | 0.55 | 1/8 | 1.05 | 2.29 | `bar_body_rng_0` (0.63) | -0.0002 | +0.0180 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1375 | +0.1275 | +0.1275 | +0.6725 | 0.51 | 0/8 | 0.93 | 1.63 | `bar_body_rng_0` (0.63) | +0.0003 | +0.0180 |
| `combo_min__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1264 | +0.1434 | +0.1434 | +1.1190 | 0.66 | 1/8 | 0.91 | 2.99 | `bar_body_rng_0` (0.63) | +0.0005 | +0.1266 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1413 | +0.1277 | +0.1277 | +1.1407 | 0.50 | 1/8 | 1.07 | 1.68 | `opening_drive_thrust_ratio` (0.46) | -0.0006 | +0.0180 |
| `combo_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1407 | +0.1285 | +0.1285 | +1.1054 | 0.46 | 0/8 | 1.10 | 1.84 | `opening_drive_thrust_ratio` (0.46) | -0.0005 | +0.0180 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1361 | +0.1152 | +0.1152 | +0.8863 | 0.61 | 1/8 | 0.81 | 1.65 | `first_bar_sentiment` (0.86) | -0.0003 | +0.0180 |
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1324 | +0.1250 | +0.1250 | +0.7559 | 0.52 | 1/8 | 1.10 | 2.31 | `star50_limit_proximity_early` (0.52) | +0.0000 | +0.0180 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1365 | +0.0985 | +0.0985 | +1.0115 | 0.52 | 1/8 | 0.88 | 1.39 | `first_bar_sentiment` (0.86) | -0.0007 | +0.0180 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1256 | +0.1258 | +0.1258 | +1.0333 | 0.60 | 0/8 | 1.25 | 2.06 | `volume_weighted_price_position` (0.77) | -0.0002 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1340 | +0.1346 | +0.1346 | +1.4890 | 0.48 | 0/8 | 1.03 | 1.62 | `bar_body_rng_0` (0.63) | -0.0004 | +0.0180 |
...
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1268 | +0.1243 | +0.1243 | +2.0348 | 0.57 | 1/8 | 1.32 | 2.19 | `volume_weighted_price_position` (0.77) | -0.0004 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1335 | +0.1419 | +0.1419 | +0.8351 | 0.57 | 1/8 | 0.94 | 1.74 | `bar_body_rng_0` (0.63) | +0.0005 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1332 | +0.1135 | +0.1135 | +0.7682 | 0.34 | 0/8 | 1.26 | 1.74 | `star50_limit_proximity_early` (0.52) | -0.0002 | +0.0180 |
...
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.1057 | +0.1527 | +0.1527 | +1.5226 | 0.63 | 1/8 | 1.16 | 3.62 | `rbreaker_buy_setup_proximity_early` (0.71) | +0.0005 | +0.0932 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1369 | +0.1344 | +0.1344 | +0.8852 | 0.45 | 0/8 | 1.00 | 1.08 | `bar_ret_0` (0.48) | +0.0002 | +0.1266 |
| `combo_rank_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1165 | +0.1356 | +0.1356 | +0.6928 | 0.63 | 1/8 | 0.98 | 2.98 | `star50_limit_proximity_early` (0.52) | +0.0005 | +0.0180 |
| `combo_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1193 | +0.1361 | +0.1361 | +0.5812 | 0.65 | 1/8 | 0.91 | 2.83 | `star50_limit_proximity_early` (0.52) | +0.0005 | +0.1266 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1133 | +0.1497 | +0.1497 | +0.8445 | 0.51 | 1/8 | 1.80 | 3.12 | `volatility_expansion_trend_vector` (0.61) | -0.0000 | +0.0000 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1235 | +0.0997 | +0.0997 | +0.3365 | 0.62 | 1/8 | 0.79 | 1.43 | `first_bar_sentiment` (0.86) | +0.0002 | +0.0180 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1286 | +0.1232 | +0.1232 | +0.6752 | 0.46 | 0/8 | 0.94 | 1.40 | `first_bar_return` (0.48) | +0.0003 | +0.0180 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1329 | +0.1289 | +0.1289 | +0.8597 | 0.47 | 0/8 | 1.06 | 1.26 | `bar_body_rng_0` (0.63) | -0.0004 | +0.0000 |
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1289 | +0.1310 | +0.1310 | +1.0164 | 0.51 | 1/8 | 0.95 | 1.34 | `bar_body_rng_0` (0.63) | -0.0001 | +0.0180 |
| `combo_diff__bar_ret_0__demark_setup_reversal_early` | Other Technical | +1 | +0.1225 | +0.1293 | +0.1293 | +0.4551 | 0.45 | 0/8 | 1.27 | 1.55 | `demark_setup_reversal_early` (0.51) | +0.0005 | +0.0804 |
| `combo_min__limit_down_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0981 | +0.1345 | +0.1345 | +1.4216 | 0.84 | 1/8 | 1.47 | 3.76 | `volume_weighted_price_position` (0.77) | +0.0007 | +0.0000 |
| `combo_rel_diff__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.1274 | +0.1198 | +0.1198 | +0.3623 | 0.42 | 0/8 | 1.19 | 1.57 | `demark_setup_reversal_early` (0.51) | -0.0006 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1165 | +0.1533 | +0.1533 | +0.8711 | 0.50 | 1/8 | 1.77 | 2.85 | `volatility_expansion_trend_vector` (0.61) | -0.0001 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.1146 | +0.1426 | +0.1426 | +1.1691 | 0.57 | 1/8 | 1.16 | 2.90 | `limit_down_proximity_early` (0.71) | +0.0001 | +0.0509 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1126 | +0.1316 | +0.1316 | +1.5377 | 0.38 | 0/8 | 2.02 | 1.82 | `impulse_bar_dominance` (0.77) | +0.0004 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1282 | +0.1015 | +0.1015 | +0.0872 | 0.41 | 0/8 | 1.39 | 2.89 | `opening_drive_thrust_ratio` (0.46) | -0.0005 | +0.0804 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1375 | +0.1325 | +0.1325 | +0.7977 | 0.44 | 0/8 | 1.13 | 1.98 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0005 | +0.0000 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1210 | +0.0874 | +0.0874 | -0.5508 | 0.47 | 0/8 | 1.33 | 1.99 | `bar_body_rng_0` (0.63) | -0.0007 | +0.0804 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1132 | +0.0770 | +0.0770 | +0.1170 | 0.49 | 0/8 | 1.03 | 1.65 | `first_bar_sentiment` (0.86) | -0.0009 | +0.0804 |
| `combo_rank_min__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1133 | +0.0767 | +0.0767 | -0.2421 | 0.40 | 0/8 | 1.40 | 2.06 | `opening_drive_thrust_ratio` (0.46) | -0.0003 | +0.0804 |
| `combo_mean__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1322 | +0.1248 | +0.1248 | +0.7342 | 0.40 | 0/8 | 1.17 | 1.85 | `star50_limit_proximity_early` (0.52) | -0.0001 | +0.0180 |
| `combo_rank_min__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1186 | +0.0930 | +0.0930 | +0.0368 | 0.42 | 0/8 | 1.13 | 1.61 | `first_bar_return` (0.48) | -0.0002 | +0.0180 |
| `combo_tri_mean__max_up_ret__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1149 | +0.0802 | +0.0802 | -0.9988 | 0.53 | 0/8 | 1.12 | 1.71 | `first_bar_sentiment` (0.86) | -0.0008 | +0.0804 |
| `combo_rank_min__limit_down_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0954 | +0.1471 | +0.1471 | +1.7038 | 0.83 | 1/8 | 1.48 | 4.47 | `volume_weighted_price_position` (0.77) | +0.0006 | +0.0752 |
...
| `combo_rank_min__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1064 | +0.0673 | +0.0673 | +0.1332 | 0.57 | 0/8 | 1.59 | 2.30 | `volume_weighted_price_position` (0.77) | -0.0009 | +0.0804 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0996 | +0.1617 | +0.1617 | +1.1078 | 0.79 | 1/8 | 1.08 | 6.24 | `rbreaker_buy_setup_proximity_early` (0.71) | +0.0008 | +0.0752 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1128 | +0.1213 | +0.1213 | +0.2173 | 0.48 | 0/8 | 0.92 | 1.31 | `first_bar_sentiment` (0.86) | -0.0001 | +0.0180 |
| `combo_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0918 | +0.1286 | +0.1286 | +0.5529 | 0.75 | 1/8 | 1.22 | 5.34 | `yesterday_first_30min_return` (0.99) | +0.0013 | +0.1085 |
| `combo_min__rbreaker_buy_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0877 | +0.1386 | +0.1386 | +0.6223 | 0.60 | 0/8 | 1.91 | 4.91 | `rbreaker_buy_setup_proximity_early` (0.71) | -0.0003 | +0.0000 |
...
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1101 | +0.0882 | +0.0882 | -1.0149 | 0.50 | 0/8 | 1.47 | 2.43 | `bar_body_rng_0` (0.63) | -0.0008 | -0.0561 |
| `combo_rel_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1219 | +0.1058 | +0.1058 | +0.4149 | 0.45 | 0/8 | 1.37 | 2.62 | `demark_setup_reversal_early` (0.51) | -0.0005 | +0.0000 |
| `combo_mean__bar_ret_0__limit_down_proximity_early` | Other Technical | +1 | +0.1184 | +0.1382 | +0.1382 | +1.3500 | 0.51 | 1/8 | 0.90 | 1.28 | `limit_down_proximity_early` (0.71) | -0.0002 | +0.0180 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1172 | +0.1491 | +0.1491 | +1.4472 | 0.53 | 0/8 | 1.08 | 2.08 | `bar_body_rng_0` (0.63) | +0.0000 | +0.0804 |
| `combo_mean__bar_body_rng_0__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1022 | +0.1065 | +0.1065 | -0.2278 | 0.53 | 0/8 | 1.68 | 3.09 | `bar_body_rng_0` (0.63) | -0.0002 | +0.0804 |
| `combo_mean__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1233 | +0.1160 | +0.1160 | +1.3698 | 0.62 | 1/8 | 0.78 | 1.40 | `first_bar_sentiment` (0.86) | -0.0004 | +0.0000 |
| `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1215 | +0.1133 | +0.1133 | +0.4549 | 0.45 | 0/8 | 1.38 | 2.40 | `demark_setup_reversal_early` (0.51) | -0.0004 | +0.0804 |
| `combo_mean__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0988 | +0.1394 | +0.1394 | +0.9587 | 0.79 | 1/8 | 1.44 | 6.15 | `yesterday_first_30min_return` (0.99) | +0.0006 | +0.1085 |
| `combo_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1158 | +0.0732 | +0.0732 | -0.9166 | 0.53 | 0/8 | 1.87 | 1.92 | `volume_weighted_price_position` (0.77) | -0.0008 | +0.0804 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1230 | +0.1269 | +0.1269 | +0.7270 | 0.43 | 0/8 | 1.19 | 1.59 | `bar_body_rng_0` (0.63) | -0.0004 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1115 | +0.0864 | +0.0864 | -0.0202 | 0.55 | 0/8 | 1.23 | 2.19 | `bar_body_rng_0` (0.63) | -0.0007 | +0.0804 |
| `combo_rank_min__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0917 | +0.0888 | +0.0888 | -0.2203 | 0.60 | 0/8 | 3.58 | 7.87 | `volatility_expansion_trend_vector` (0.61) | -0.0002 | +0.0804 |
| `combo_tri_min__star50_limit_proximity_early__yesterday_early_momentum__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0941 | +0.1197 | +0.1197 | +0.9323 | 0.78 | 1/8 | 1.01 | 3.02 | `yesterday_early_momentum` (1.24) | +0.0013 | +0.0752 |
| `combo_rank_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0926 | +0.1271 | +0.1271 | +0.5469 | 0.76 | 1/8 | 1.32 | 8.02 | `yesterday_first_30min_return` (0.99) | +0.0017 | +0.0752 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1185 | +0.1056 | +0.1056 | +0.3256 | 0.46 | 0/8 | 1.55 | 2.15 | `demark_setup_reversal_early` (0.51) | -0.0003 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1132 | +0.0827 | +0.0827 | -0.0240 | 0.49 | 0/8 | 1.00 | 1.42 | `first_bar_sentiment` (0.86) | -0.0008 | +0.0180 |
...
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.1150 | +0.0792 | +0.0792 | +0.2360 | 0.46 | 0/8 | 1.44 | 2.54 | — | -0.0005 | +0.0804 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1152 | +0.1259 | +0.1259 | +0.1557 | 0.34 | 0/8 | 1.64 | 1.97 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0002 | +0.0573 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1182 | +0.0824 | +0.0824 | -0.6121 | 0.46 | 0/8 | 1.75 | 2.75 | `opening_drive_thrust_ratio` (0.46) | -0.0006 | +0.0804 |
| `combo_max__opening_drive_thrust_ratio__impulse_bar_dominance` | Other Technical | +1 | +0.1032 | +0.0968 | +0.0968 | +0.5705 | 0.45 | 0/8 | 1.86 | 2.83 | `impulse_bar_dominance` (0.77) | -0.0002 | -0.0561 |
...
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1239 | +0.1308 | +0.1308 | +0.6052 | 0.40 | 0/8 | 1.05 | 1.54 | `first_bar_return` (0.48) | -0.0003 | +0.0180 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1175 | +0.0772 | +0.0772 | -0.5386 | 0.50 | 0/8 | 1.77 | 1.84 | `volume_weighted_price_position` (0.77) | -0.0008 | +0.0804 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1208 | +0.0717 | +0.0717 | -1.1315 | 0.46 | 0/8 | 1.52 | 2.13 | `first_bar_return` (0.48) | -0.0008 | +0.0804 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1104 | +0.1100 | +0.1100 | +0.5568 | 0.67 | 1/8 | 0.87 | 1.54 | `yesterday_early_vwap_dev` (1.29) | +0.0008 | +0.0752 |
| `combo_tri_min__opening_drive_thrust_ratio__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1145 | +0.0725 | +0.0725 | +0.4339 | 0.45 | 0/8 | 1.18 | 1.53 | `first_bar_sentiment` (0.86) | -0.0007 | +0.0180 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1176 | +0.0761 | +0.0761 | -0.7836 | 0.51 | 0/8 | 1.39 | 2.51 | `first_bar_sentiment` (0.86) | -0.0011 | +0.0804 |
| `combo_min__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0915 | +0.1028 | +0.1028 | +0.3412 | 0.60 | 0/8 | 2.47 | 4.05 | `volatility_expansion_trend_vector` (0.61) | -0.0001 | +0.0804 |
| `combo_clamp_diff__bar_body_rng_0__demark_setup_reversal_early` | Other Technical | +1 | +0.1201 | +0.1338 | +0.1338 | -0.1673 | 0.53 | 1/8 | 1.22 | 1.90 | `bar_body_rng_0` (0.63) | +0.0003 | +0.0804 |
| `combo_min__opening_drive_thrust_ratio__impulse_bar_dominance` | Other Technical | +1 | +0.1030 | +0.0441 | +0.0441 | +1.1853 | 0.45 | 0/8 | 2.23 | 2.72 | `impulse_bar_dominance` (0.77) | -0.0001 | +0.0804 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1124 | +0.0939 | +0.0939 | -0.4022 | 0.49 | 0/8 | 1.14 | 1.69 | `bar_body_rng_0` (0.63) | -0.0003 | +0.0804 |
| `combo_max__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1112 | +0.0738 | +0.0738 | -0.4608 | 0.45 | 0/8 | 1.80 | 3.40 | `volatility_expansion_trend_vector` (0.61) | -0.0005 | +0.0804 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1050 | +0.0936 | +0.0936 | +0.2427 | 0.75 | 1/8 | 1.07 | 2.90 | `yesterday_early_vwap_dev` (1.29) | +0.0007 | +0.0752 |
| `combo_tri_median__opening_drive_thrust_ratio__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1149 | +0.0906 | +0.0906 | +0.8830 | 0.51 | 0/8 | 1.01 | 1.49 | `bar_body_rng_0` (0.63) | -0.0003 | +0.0804 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1249 | +0.1193 | +0.1193 | -0.2201 | 0.33 | 0/8 | 1.28 | 1.32 | `first_bar_return` (0.48) | -0.0004 | +0.0000 |
| `combo_tri_max__max_up_ret__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1226 | +0.0636 | +0.0636 | -1.2636 | 0.44 | 0/8 | 1.22 | 1.73 | `first_bar_sentiment` (0.86) | -0.0008 | +0.0804 |
| `combo_mean__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1141 | +0.0838 | +0.0838 | +0.1021 | 0.41 | 0/8 | 1.36 | 1.58 | `bar_ret_0` (0.48) | -0.0005 | +0.0804 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1114 | +0.0682 | +0.0682 | -0.6312 | 0.39 | 0/8 | 1.68 | 2.15 | — | -0.0005 | +0.0804 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1171 | +0.0811 | +0.0811 | -0.6874 | 0.39 | 0/8 | 1.58 | 1.46 | `star50_limit_proximity_early` (0.52) | -0.0007 | +0.0000 |
| `combo_rank_max__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1127 | +0.1066 | +0.1066 | +0.4207 | 0.39 | 0/8 | 1.67 | 2.71 | `star50_limit_proximity_early` (0.52) | -0.0001 | +0.0000 |
...
| `combo_sig_product__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.0893 | +0.0887 | +0.0887 | -0.3901 | 0.56 | 0/8 | 0.95 | 2.28 | `demark_setup_reversal_early` (0.51) | -0.0001 | +0.0000 |
...
| `combo_rank_max__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1159 | +0.0919 | +0.0919 | -0.8343 | 0.42 | 0/8 | 1.85 | 1.86 | `star50_limit_proximity_early` (0.52) | -0.0004 | +0.0000 |
| `combo_max__max_up_ret__impulse_bar_dominance` | Intraday Range Momentum | +1 | +0.1001 | +0.0516 | +0.0516 | -0.9575 | 0.39 | 0/8 | 2.11 | 1.96 | `impulse_bar_dominance` (0.77) | -0.0007 | -0.0561 |
| `combo_sig_product__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0864 | +0.1079 | +0.1079 | -0.2788 | 0.88 | 1/8 | 2.54 | -8.81 | `yesterday_first_30min_return` (0.99) | +0.0002 | +0.0573 |
| `combo_rank_min__bar_body_rng_0__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0921 | +0.1108 | +0.1108 | +0.6963 | 0.58 | 0/8 | 2.06 | 3.49 | `bar_body_rng_0` (0.63) | +0.0003 | +0.0804 |
...
| `combo_z_sum__volume_weighted_price_position__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0941 | +0.0893 | +0.0893 | +0.0953 | 0.68 | 0/8 | 2.47 | 3.92 | `volume_weighted_price_position` (0.77) | +0.0001 | +0.0804 |
| `combo_rank_max__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0983 | +0.1124 | +0.1124 | +0.3952 | 0.61 | 1/8 | 1.60 | 4.45 | `yesterday_first_30min_return` (0.99) | +0.0005 | +0.0000 |
...
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1159 | +0.0366 | +0.0366 | -0.6946 | 0.34 | 0/8 | 1.47 | 1.54 | `opening_drive_thrust_ratio` (0.46) | -0.0008 | +0.0804 |
| `combo_sig_product__volume_weighted_price_position__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0883 | +0.0813 | +0.0813 | -0.1094 | 0.61 | 0/8 | 2.36 | 4.52 | `volume_weighted_price_position` (0.77) | -0.0003 | +0.0804 |
| `combo_max__bar_ret_0__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1093 | +0.0894 | +0.0894 | -0.0643 | 0.40 | 0/8 | 1.56 | 1.78 | `volatility_expansion_trend_vector` (0.61) | -0.0003 | +0.0804 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1088 | +0.0764 | +0.0764 | -0.0635 | 0.55 | 0/8 | 1.10 | 2.59 | `first_bar_sentiment` (0.86) | -0.0005 | +0.0804 |
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0906 | +0.1031 | +0.1031 | -0.6008 | 0.63 | 1/8 | 2.21 | 53.82 | `volatility_expansion_trend_vector` (0.61) | +0.0001 | +0.0804 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1235 | +0.1428 | +0.1428 | +0.6972 | 0.46 | 1/8 | 1.20 | 2.09 | `demark_setup_reversal_early` (0.51) | +0.0001 | +0.0000 |
| `combo_sig_product__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1175 | +0.0906 | +0.0906 | +0.5068 | 0.45 | 0/8 | 1.19 | 1.73 | `bar_body_rng_0` (0.63) | -0.0002 | +0.0804 |
| `combo_rank_min__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1028 | +0.0656 | +0.0656 | +0.3295 | 0.57 | 0/8 | 1.51 | 2.43 | `volume_weighted_price_position` (0.77) | -0.0006 | +0.0804 |
...
| `combo_sig_product__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1189 | +0.0784 | +0.0784 | +0.2167 | 0.40 | 0/8 | 1.24 | 1.61 | `bar_ret_0` (0.48) | -0.0001 | +0.0180 |
| `net_volume_flow` | Volatility & Oscillators | +1 | +0.0815 | +0.0979 | +0.0979 | -0.7750 | 0.72 | 1/8 | 2.98 | 14.17 | — | +0.0000 | +0.0804 |
| `combo_tri_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1175 | +0.0841 | +0.0841 | +0.0197 | 0.38 | 0/8 | 1.72 | 2.07 | `opening_drive_thrust_ratio` (0.46) | -0.0005 | +0.0000 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1429 | +0.1073 | +0.1073 | +0.1834 | 0.33 | 0/8 | 1.11 | 1.94 | `first_bar_return` (0.48) | +0.0001 | +0.0573 |
| `combo_rank_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0893 | +0.0450 | +0.0450 | -0.2526 | 0.70 | 1/8 | 1.02 | 2.97 | `first_bar_sentiment` (0.86) | -0.0005 | +0.0804 |
| `combo_mean__limit_down_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.0975 | +0.1145 | +0.1145 | +0.1225 | 0.45 | 0/8 | 1.80 | 2.24 | `impulse_bar_dominance` (0.77) | +0.0000 | +0.0000 |
| `combo_z_sum__impulse_bar_dominance__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0854 | +0.0796 | +0.0796 | -0.0979 | 0.58 | 0/8 | 3.92 | 5.61 | `impulse_bar_dominance` (0.77) | +0.0006 | +0.0804 |
| `combo_max__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1110 | +0.0976 | +0.0976 | +0.4955 | 0.57 | 1/8 | 1.05 | 1.42 | `first_bar_sentiment` (0.86) | -0.0004 | +0.0000 |
| `combo_ratio__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1120 | +0.1308 | +0.1308 | +0.7043 | 0.52 | 1/8 | 1.38 | 3.68 | `volume_weighted_price_position` (0.77) | -0.0006 | +0.0000 |
| `volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0820 | +0.0926 | +0.0926 | +0.3605 | 0.61 | 0/8 | 3.52 | 6.66 | — | +0.0000 | +0.0804 |
| `combo_tri_max__opening_drive_thrust_ratio__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1102 | +0.0824 | +0.0824 | -0.3109 | 0.52 | 0/8 | 1.14 | 1.95 | `first_bar_sentiment` (0.86) | -0.0003 | +0.0804 |
| `combo_diff__max_up_ret__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1100 | +0.0739 | +0.0739 | +0.1559 | 0.48 | 0/8 | 1.20 | 2.31 | `late_bar_momentum` (0.77) | -0.0005 | +0.0180 |
| `combo_mean__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.1080 | +0.0739 | +0.0739 | +0.7136 | 0.55 | 0/8 | 1.22 | 1.51 | `volume_weighted_price_position` (0.77) | -0.0002 | +0.0804 |
...
| `combo_abs_diff__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0557 | -0.0153 | -0.0153 | -0.1443 | 0.97 | 1/8 | 0.26 | 0.12 | `volatility_expansion_trend_vector` (0.61) | -0.0005 | +0.0752 |
...
| `combo_max__bar_body_rng_0__impulse_bar_dominance` | Other Technical | +1 | +0.0888 | +0.1036 | +0.1036 | +0.2192 | 0.61 | 1/8 | 1.65 | 1.80 | `impulse_bar_dominance` (0.77) | -0.0003 | -0.0561 |
| `combo_mean__bar_body_rng_0__impulse_bar_dominance` | Other Technical | +1 | +0.1001 | +0.0960 | +0.0960 | +0.3067 | 0.44 | 0/8 | 1.65 | 2.21 | `impulse_bar_dominance` (0.77) | +0.0001 | +0.0804 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1139 | +0.0785 | +0.0785 | +0.0183 | 0.47 | 1/8 | 1.31 | 1.59 | `first_bar_sentiment` (0.86) | -0.0003 | +0.0000 |
| `combo_max__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1078 | +0.0775 | +0.0775 | +0.6742 | 0.52 | 0/8 | 0.85 | 1.28 | `first_bar_sentiment` (0.86) | +0.0000 | +0.0180 |
| `combo_ratio__bar_ret_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1064 | +0.0659 | +0.0659 | +0.7397 | 0.53 | 0/8 | 0.94 | 1.48 | `volume_weighted_price_position` (0.77) | -0.0000 | +0.0804 |
| `combo_min__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.0981 | +0.0617 | +0.0617 | +0.6479 | 0.54 | 1/8 | 1.07 | 1.61 | `first_bar_sentiment` (0.86) | -0.0005 | +0.0000 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1015 | +0.0743 | +0.0743 | +0.0905 | 0.50 | 0/8 | 0.88 | 1.37 | `first_bar_sentiment` (0.86) | -0.0005 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.0947 | +0.0934 | +0.0934 | +0.2719 | 0.57 | 0/8 | 3.10 | 2.47 | `impulse_bar_dominance` (0.77) | -0.0001 | +0.0000 |
...
| `combo_sig_product__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1079 | +0.0733 | +0.0733 | +0.7040 | 0.48 | 0/8 | 0.93 | 1.29 | `first_bar_sentiment` (0.86) | +0.0000 | +0.0180 |
| `combo_max__first_bar_return__impulse_bar_dominance` | Gap / Overnight Reversal | +1 | +0.0908 | +0.0681 | +0.0681 | +0.8101 | 0.49 | 0/8 | 1.87 | 2.06 | `impulse_bar_dominance` (0.77) | +0.0000 | -0.0561 |
| `combo_sig_product__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1166 | +0.0366 | +0.0366 | -0.2937 | 0.39 | 0/8 | 1.15 | 1.38 | `bar_body_rng_0` (0.63) | -0.0005 | +0.0804 |
| `combo_rank_min__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0962 | +0.0759 | +0.0759 | +1.4912 | 0.53 | 1/8 | 0.91 | 1.45 | `first_bar_sentiment` (0.86) | -0.0002 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0858 | +0.0936 | +0.0936 | -0.3130 | 0.95 | 1/8 | 1.25 | 6.95 | `yesterday_early_vwap_dev` (1.29) | +0.0004 | +0.0752 |
| `combo_sig_product__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1104 | +0.0278 | +0.0278 | -0.5804 | 0.37 | 0/8 | 1.09 | 1.24 | `first_bar_return` (0.48) | -0.0002 | +0.0180 |
...
_Null Baseline (un-gated candidate pool): 56.0% lock IC > 0, 15.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.7334_
...
| B4 Correlation Gate | 169 | 30 | 63.3% | 33.3% | +0.0188 | -0.5208 |

**Admitted Pool Summary**: 103 features, False Positive Rate = 92.2% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0054, Mean Lock Sharpe = -0.7600
...
_Null Baseline (un-gated candidate pool): 74.0% lock IC > 0, 23.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.5393_
...
**Admitted Pool Summary**: 205 features, False Positive Rate = 72.2% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0601, Mean Lock Sharpe = -0.4074
...
_Null Baseline (un-gated candidate pool): 82.0% lock IC > 0, 51.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.0315_
...
| B4 Correlation Gate | 278 | 30 | 100.0% | 100.0% | +0.1310 | +0.9549 |

**Admitted Pool Summary**: 179 features, False Positive Rate = 27.9% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1047, Mean Lock Sharpe = +0.3629
...
1. **300ETF `single` — 7-Year Jackknife Sign Stability too strict**: 50.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 15.0%, mean lock Sharpe=-0.1641). Consider relaxing this gate.
2. **300ETF `single` — B2 Rolling Guard too strict**: 26.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 15.0%, mean lock Sharpe=-0.4187). Consider relaxing this gate.
3. **300ETF `single` — B4 Correlation Gate too strict**: 33.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 15.0%, mean lock Sharpe=-0.5208). Consider relaxing this gate.
...
12. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 56.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 23.0%, mean lock Sharpe=-0.1073). Consider relaxing this gate.
