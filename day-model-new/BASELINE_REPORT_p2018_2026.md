...
| 159915ETF | single | 1,887 | 808 | 629 | 578 | 577 | 509 | 444 | 444 | 146 | 146 | 44 | `[12, 11, 8, 8, 7, 7, 6, 6, 5, 4, 4, 4, ... (44 clusters)]` |
...
| 159915ETF | single | 146 | 44 | `[12, 11, 8, 8, 7, 7, 6, 6, 5, 4, 4, 4, ... (44 clusters)]` | +0.1555 | [+0.1157, +0.2032] | +0.3208 | [+0.2318, +0.3996] | +0.7818 | 9.29% | 1.8854 | 7.73% | 1.5911 | 3.8831 | 2.24% |
...
| 159915ETF | single | 146 | 44 | `[12, 11, 8, 8, 7, 7, 6, 6, 5, 4, 4, 4, ... (44 clusters)]` | +0.0413* | [-0.2491, +0.2788] | -0.1209* | [-0.7113, +0.2515] | +0.2970 | -2.33% | -0.4327 | -3.76% | -0.6976 | -0.9072 | 5.22% |
...
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Cluster 10 | +1 | +0.1485 | +0.3411 | +0.3414 | 0.0000 | +1.2042 | +0.8646 | 0.950 |
...
| `combo_rank_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Cluster 14 | +1 | +0.1487 | +0.3339 | +0.3340 | 0.0000 | +1.1165 | +0.8527 | 0.838 |
| `combo_tri_min__star50_limit_proximity_early__first_bar_sentiment__bar_body_rng_0` | Cluster 10 | +1 | +0.1411 | +0.3337 | +0.3345 | 0.0000 | +1.0372 | +0.8502 | 0.940 |
| `combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Cluster 14 | +1 | +0.1520 | +0.3325 | +0.3324 | 0.0000 | +1.1207 | +0.8666 | 0.916 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Cluster 25 | +1 | +0.1422 | +0.3231 | +0.3239 | 0.0000 | +1.0138 | +0.8347 | 0.753 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_sentiment__bar_body_rng_0` | Cluster 0 | +1 | +0.1502 | +0.3108 | +0.3111 | 0.0000 | +1.0229 | +0.8548 | 0.917 |
| `combo_min__star50_limit_proximity_early__volume_weighted_price_position` | Cluster 25 | +1 | +0.1291 | +0.3107 | +0.3113 | 0.0000 | +1.0199 | +0.8239 | 0.867 |
| `combo_mean__star50_limit_proximity_early__bar_body_rng_0` | Cluster 0 | +1 | +0.1436 | +0.3076 | +0.3077 | 0.0000 | +0.8715 | +0.7884 | 0.941 |
| `combo_rel_diff__bar_body_rng_0__demark_setup_reversal_early` | Cluster 0 | +1 | +0.1445 | +0.3020 | +0.3020 | 0.0000 | +0.9304 | +0.8193 | 0.886 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Cluster 10 | +1 | +0.1296 | +0.3014 | +0.3022 | 0.0000 | +0.8297 | +0.7894 | 0.947 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Cluster 43 | +1 | +0.1423 | +0.2982 | +0.2982 | 0.0000 | +0.9595 | +0.8491 | 0.880 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment` | Cluster 10 | +1 | +0.1449 | +0.2979 | +0.2987 | 0.0000 | +0.8025 | +0.7745 | 0.923 |
...
| `combo_rank_min__opening_drive_thrust_ratio__volume_weighted_price_position` | Cluster 32 | +1 | +0.1213 | +0.2879 | +0.2881 | 0.0000 | +0.8411 | +0.7750 | 0.822 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | Cluster 19 | +1 | +0.1387 | +0.2873 | +0.2878 | 0.0000 | +0.8460 | +0.7719 | 0.923 |
| `combo_rank_min__bar_body_rng_0__limit_down_proximity_early` | Cluster 10 | +1 | +0.1243 | +0.2872 | +0.2881 | 0.0000 | +0.8954 | +0.8352 | 0.880 |
| `combo_diff__bar_ret_0__demark_setup_reversal_early` | Cluster 0 | +1 | +0.1422 | +0.2870 | +0.2871 | 0.0000 | +0.8614 | +0.8311 | 0.873 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Cluster 43 | +1 | +0.1373 | +0.2851 | +0.2849 | 0.0000 | +0.8684 | +0.8275 | 0.943 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Cluster
min__limit_down_proximity_early__volatility_expansion_trend_vector` | Cluster 42 | +1 | +0.1038 | +0.2335 | +0.2340 | 0.0000 | +0.7030 | +0.7611 | 0.882 |
| `combo_max__max_up_ret__volatility_expansion_trend_vector` | Cluster 9 | +1 | +0.1215 | +0.2332 | +0.2339 | 0.0000 | +0.7936 | +0.7667 | 0.894 |
| `combo_sig_product__bar_body_rng_0__volatility_expansion_trend_vector` | Cluster 4 | +1 | +0.1076 | +0.2328 | +0.2335 | 0.0000 | +0.6450 | +0.7446 | 0.838 |
| `combo_tri_min__opening_drive_thrust_ratio__first_bar_sentiment__first_bar_return` | Cluster 3 | +1 | +0.1239 | +0.2323 | +0.2327 | 0.0000 | +0.7324 | +0.7724 | 0.946 |
| `max_up_ret` | Cluster 9 | +1 | +0.1267 | +0.2319 | +0.2324 | 0.0000 | +0.8184 | +0.7858 | 0.937 |
| `combo_tri_median__star50_limit_proximity_early__first_bar_sentiment__first_bar_return` | Cluster 13 | +1 | +0.1244 | +0.2301 | +0.2305 | 0.0000 | +0.7367 | +0.7513 | 0.929 |
| `combo_mean__first_bar_sentiment__limit_down_proximity_early` | Cluster 10 | +1 | +0.1161 | +0.2284 | +0.2282 | 0.0000 | +0.5817 | +0.6648 | 0.930 |
| `bar_body_rng_0` | Cluster 13 | +1 | +0.1231 | +0.2273 | +0.2279 | 0.0000 | +0.5838 | +0.7152 | 0.893 |
| `combo_max__first_bar_return__volatility_expansion_trend_vector` | Cluster 21 | +1 | +0.1276 | +0.2264 | +0.2270 | 0.0000 | +0.6875 | +0.7559 | 0.910 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Cluster 33 | +1 | +0.1294 | +0.2261 | +0.2260 | 0.0000 | +0.6052 | +0.6982 | 0.852 |
| `combo_rank_max__max_up_ret__volatility_expansion_trend_vector` | Cluster 9 | +1 | +0.1223 | +0.2254 | +0.2264 | 0.0000 | +0.8243 | +0.7915 | 0.931 |
| `combo_mean__volume_weighted_price_position__volatility_expansion_trend_vector` | Cluster 34 | +1 | +0.1118 | +0.2248 | +0.2248 | 0.0000 | +0.6371 | +0.7338 | 0.917 |
| `combo_min__first_bar_sentiment__volatility_expansion_trend_vector` | Cluster 5 | +1 | +0.1002 | +0.2245 | +0.2249 | 0.0000 | +0.5222 | +0.7168 | 0.912 |
| `combo_tri_mean__max_up_ret__bar_body_rng_0__first_bar_return` | Cluster 13 | +1 | +0.1288 | +0.2224 | +0.2232 | 0.0002 | +0.7171 | +0.7817 | 0.950 |
| `combo_mean__bar_body_rng_0__impulse_bar_dominance` | Cluster 15 | +1 | +0.1183 | +0.2224 | +0.2227 | 0.0002 | +0.6113 | +0.7523 | 0.931 |
| `combo_max__bar_body_rng_0__impulse_bar_dominance` | Cluster 15 | +1 | +0.1097 | +0.2211 | +0.2215 | 0.0002 | +0.6304 | +0.7281 | 0.850 |
| `combo_mean__max_up_ret__impulse_bar_dominance` | Cluster 9 | +1 | +0.1212 | +0.2192 | +0.2194 | 0.0002 | +0.8123 | +0.7801 | 0.907 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Cluster 2 | +1 | +0.1173 | +0.2178 | +0.2171 | 0.0002 | +0.5604 | +0.7338 | 0.914 |
| `combo_ratio__volatility_expansion_trend_vector__volume_weighted_price_position` | Cluster 38 | +1 | +0.1025 | +0.2173 | +0.2174 | 0.0002 | +0.6754 | +0.7580 | 0.908 |
| `combo_max__opening_drive_thrust_ratio__impulse_bar_dominance` | Cluster 39 | +1 | +0.1181 | +0.2168 | +0.2172 | 0.0002 | +0.7038 | +0.7570 | 0.900 |
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Cluster 37 | +1 | +0.1158 | +0.2159 | +0.2157 | 0.0002 | +0.7032 | +0.7796 | 0.888 |
| `combo_rank_min__volume_weighted_price_position__volatility_expansion_trend_vector` | Cluster 34 | +1 | +0.0939 | +0.2141 | +0.2141 | 0.0002 | +0.7117 | +0.7528 | 0.943 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Cluster 37 | +1 | +0.1217 | +0.2139 | +0.2137 | 0.0002 | +0.6901 | +0.7750 | 0.898 |
| `combo_mean__max_up_ret__first_bar_sentiment` | Cluster 22 | +1 | +0.1276 | +0.2137 | +0.2143 | 0.0002 | +0.7401 | +0.7698 | 0.939 |
| `combo_sig_product__impulse_bar_dominance__volatility_expansion_trend_vector` | Cluster 38 | +1 | +0.1026 | +0.2136 | +0.2140 | 0.0002 | +0.7090 | +0.7817 | 0.943 |
| `combo_sig_product__volume_weighted_price_position__volatility_expansion_trend_vector` | Cluster 24 | +1 | +0.1155 | +0.2112 | +0.2115 | 0.0002 | +0.6773 | +0.7261 | 0.774 |
| `combo_sig_product__star50_limit_proximity_early__bar_body_rng_0` | Cluster 12 | +1 | +0.1091 | +0.2111 | +0.2116 | 0.0002 | +0.3936 | +0.6761 | 0.696 |
| `combo_sig_product__opening_drive_thrust_ratio__bar_body_rng_0` | Cluster 36 | +1 | +0.1238 | +0.2108 | +0.2101 | 0.0002 | +0.4595 | +0.7214 | 0.843 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Cluster 6 | +1 | +0.1184 | +0.2099 | +0.2097 | 0.0002 | +0.6855 | +0.7678 | 0.898 |
| `combo_rank_max__star50_limit_proximity_early__bar_body_rng_0` | Cluster 11 | +1 | +0.1255 | +0.2098 | +0.2088 | 0.0002 | +0.4964 | +0.6648 | 0.856 |
| `net_volume_flow` | Cluster 8 | +1 | +0.1081 | +0.2076 | +0.2077 | 0.0002 | +0.6497 | +0.7430 | 0.917 |
| `combo_rank_min__first_bar_return__volatility_expansion_trend_vector` | Cluster 5 | +1 | +0.1037 | +0.2066 | +0.2073 | 0.0002 | +0.5337 | +0.7441 | 0.940 |
| `combo_min__bar_body_rng_0__volume_weighted_price_position` | Cluster 35 | +1 | +0.1155 | +0.2055 | +0.2056 | 0.0002 | +0.5435 | +0.7183 | 0.878 |
| `rbreaker_sell_setup_proximity_early` | Cluster 12 | +1 | +0.1455 | +0.2042 | +0.2037 | 0.0002 | +0.4789 | +0.6586 | 0.805 |
| `combo_max__first_bar_sentiment__volatility_expansion_trend_vector` | Cluster 4 | +1 | +0.1171 | +0.2041 | +0.2044 | 0.0002 | +0.5813 | +0.7183 | 0.903 |
| `combo_max__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Cluster 11 | +1 | +0.1298 | +0.2041 | +0.2031 | 0.0002 | +0.4910 | +0.6586 | 0.856 |
| `combo_mean__limit_down_proximity_early__volatility_expansion_trend_vector` | Cluster 41 | +1 | +0.1206 | +0.2039 | +0.2039 | 0.0002 | +0.7588 | +0.7827 | 0.935 |
| `combo_min__max_up_ret__volume_weighted_price_position` | Cluster 32 | +1 | +0.1148 | +0.2037 | +0.2043 | 0.0002 | +0.5025 | +0.6880 | 0.930 |
| `combo_mean__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Cluster 1 | +1 | +0.1352 | +0.2000 | +0.1994 | 0.0002 | +0.5543 | +0.7132 | 0.866 |
| `combo_rank_max__bar_body_rng_0__volume_weighted_price_position` | Cluster 35 | +1 | +0.1206 | +0.1989 | +0.1995 | 0.0002 | +0.4585 | +0.7029 | 0.914 |
| `combo_max__opening_drive_thrust_ratio__bar_ret_0` | Cluster 18 | +1 | +0.1238 | +0.1980 | +0.1983 | 0.0002 | +0.5723 | +0.6787 | 0.942 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | Cluster 11 | +1 | +0.1286 | +0.1980 | +0.1967 | 0.0002 | +0.6311 | +0.7173 | 0.913 |
| `trend_bar_close_consistency` | Cluster 23 | +1 | +0.0897 | +0.1956 | +0.1955 | 0.0002 | +0.6074 | +0.7533 | 0.882 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Cluster 27 | +1 | +0.1295 | +0.1943 | +0.1942 | 0.0002 | +0.7027 | +0.7261 | 0.902 |
| `combo_min__rbreaker_buy_setup_proximity_early__impulse_bar_dominance` | Cluster 1 | +1 | +0.1043 | +0.1928 | +0.1928 | 0.0002 | +0.6000 | +0.7425 | 0.901 |
...
| `combo_rank_max__max_up_ret__star50_limit_proximity_early` | Cluster 29 | +1 | +0.1295 | +0.1855 | +0.1848 | 0.0004 | +0.6302 | +0.6962 | 0.875 |
| `combo_max__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Cluster 11 | +1 | +0.1054 | +0.1835 | +0.1829 | 0.0004 | +0.4415 | +0.6802 | 0.934 |
| `combo_rank_max__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Cluster 30 | +1 | +0.1117 | +0.1832 | +0.1827 | 0.0004 | +0.5927 | +0.7137 | 0.886 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early` | Cluster 29 | +1 | +0.1227 | +0.1827 | +0.1822 | 0.0004 | +0.5474 | +0.6746 | 0.934 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Cluster 40 | +1 | +0.0639 | +0.1824 | +0.1822 | 0.0004 | +0.5156 | +0.6612 | 0.460 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Cluster 12 | +1 | +0.1370 | +0.1815 | +0.1809 | 0.0004 | +0.4673 | +0.6751 | 0.792 |
| `combo_max__bar_ret_0__impulse_bar_dominance` | Cluster 15 | +1 | +0.0989 | +0.1797 | +0.1798 | 0.0004 | +0.6248 | +0.7415 | 0.931 |
| `combo_tri_min__max_up_ret__first_bar_sentiment__first_bar_return` | Cluster 13 | +1 | +0.1155 | +0.1789 | +0.1799 | 0.0006 | +0.5557 | +0.7441 | 0.937 |
| `combo_sig_product__star50_limit_proximity_early__volatility_expansion_trend_vector` | Cluster 12 | +1 | +0.0907 | +0.1785 | +0.1782 | 0.0006 | +0.5078 | +0.6792 | 0.796 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Cluster 1 | +1 | +0.1130 | +0.1784 | +0.1782 | 0.0006 | +0.4839 | +0.6864 | 0.912 |
| `combo_tri_max__star50_limit_proximity_early__first_bar_sentiment__first_bar_return` | Cluster 11 | +1 | +0.1213 | +0.1780 | +0.1771 | 0.0006 | +0.5256 | +0.6890 | 0.935 |
| `combo_min__max_up_ret__first_bar_return` | Cluster 13 | +1 | +0.1164 | +0.1766 | +0.1781 | 0.0006 | +0.6298 | +0.7734 | 0.945 |
| `combo_sig_product__max_up_ret__bar_ret_0` | Cluster 36 | +1 | +0.1236 | +0.1753 | +0.1755 | 0.0006 | +0.5580 | +0.6900 | 0.892 |
| `combo_diff__limit_down_proximity_early__demark_setup_reversal_early` | Cluster 12 | +1 | +0.1178 | +0.1750 | +0.1746 | 0.0006 | +0.4694 | +0.6586 | 0.891 |
| `combo_rel_diff__rbreaker_buy_setup_proximity_early__demark_setup_reversal_early` | Cluster 12 | +1 | +0.1158 | +0.1744 | +0.1740 | 0.0006 | +0.4724 | +0.6529 | 0.854 |
| `combo_mean__limit_down_proximity_early__impulse_bar_dominance` | Cluster 1 | +1 | +0.1071 | +0.1661 | +0.1658 | 0.0012 | +0.5660 | +0.6910 | 0.932 |
| `combo_max__bar_ret_0__limit_down_proximity_early` | Cluster 11 | +1 | +0.1089 | +0.1650 | +0.1643 | 0.0014 | +0.5434 | +0.7122 | 0.871 |
| `first_bar_return` | Cluster 13 | +1 | +0.1140 | +0.1648 | +0.1657 | 0.0014 | +0.6037 | +0.7297 | 0.945 |
| `combo_mean__first_bar_sentiment__first_bar_return` | Cluster 13 | +1 | +0.1140 | +0.1648 | +0.1657 | 0.0014 | +0.6037 | +0.7297 | 0.947 |
| `combo_sig_product__star50_limit_proximity_early__bar_ret_0` | Cluster 12 | +1 | +0.1077 | +0.1643 | +0.1655 | 0.0016 | +0.3960 | +0.6529 | 0.888 |
| `combo_ratio__bar_ret_0__volume_weighted_price_position` | Cluster 13 | +1 | +0.1121 | +0.1642 | +0.1650 | 0.0016 | +0.5547 | +0.7338 | 0.912 |
| `combo_sig_product__limit_down_proximity_early__volatility_expansion_trend_vector` | Cluster 12 | +1 | +0.0656 | +0.1624 | +0.1627 | 0.0022 | +0.4080 | +0.6632 | 0.822 |
| `combo_max__star50_limit_proximity_early__first_bar_sentiment` | Cluster 11 | +1 | +0.1118 | +0.1602 | +0.1592 | 0.0028 | +0.4237 | +0.6519 | 0.943 |
| `shaved_bar_trend_conviction` | Cluster 23 | +1 | +0.0847 | +0.1554 | +0.1556 | 0.0032 | +0.5697 | +0.6859 | 0.820 |
| `combo_sig_product__opening_drive_thrust_ratio__first_bar_return` | Cluster 36 | +1 | +0.1124 | +0.1335 | +0.1328 | 0.0072 | +0.3977 | +0.6668 | 0.888 |
| `combo_max__limit_down_proximity_early__volatility_expansion_trend_vector` | Cluster 28 | +1 | +0.1122 | +0.1317 | +0.1313 | 0.0084 | +0.4453 | +0.6658 | 0.895 |
| `combo_sig_product__yesterday_first_30min_return__yesterday_early_trend` | Cluster 2 | +1 | +0.0697 | +0.1262 | +0.1256 | 0.0116 | +0.5067 | +0.6689 | 0.805 |
| `combo_rank_min__limit_down_proximity_early__impulse_bar_dominance` | Cluster 1 | +1 | +0.0877 | +0.1184 | +0.1184 | 0.0182 | +0.4224 | +0.6735 | 0.910 |
| `combo_rank_max__max_up_ret__first_bar_sentiment` | Cluster 13 | +1 | +0.1010 | +0.1130 | +0.1133 | 0.0242 | +0.3613 | +0.6504 | 0.924 |
...
| 159915ETF | single | 146 | 44 | 0.2617 | `[12, 11, 8, 8, 7, 7, 6, 6, 5, 4, 4, 4, ... (44 clusters)]` |
...
| 159915ETF | single | Cluster 0 | 8 | 0.2617 | `combo_tri_mean__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_sentiment__bar_body_rng_0`, `combo_mean__star50_limit_proximity_early__bar_body_rng_0`, `combo_tri_mean__max_up_ret__star50_limit_proximity_early__first_bar_sentiment`, `combo_diff__bar_ret_0__demark_setup_reversal_early`, `combo_rel_diff__bar_body_rng_0__demark_setup_reversal_early`, `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__first_bar_return`, `combo_mean__first_bar_return__rbreaker_buy_setup_proximity_early` |
| 159915ETF | single | Cluster 1 | 6 | 0.2617 | `combo_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | `combo_mean__rbreaker_sell_setup_proximity_early__impulse_bar_dominance`, `combo_min__rbreaker_buy_setup_proximity_early__impulse_bar_dominance`, `combo_mean__limit_down_proximity_early__impulse_bar_dominance`, `combo_rank_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance`, `combo_rank_min__limit_down_proximity_early__impulse_bar_dominance` |
| 159915ETF | single | Cluster 2 | 6 | 0.2617 | `combo_tri_min__star50_limit_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | `combo_min__star50_limit_proximity_early__yesterday_first_30min_return`, `combo_mean__star50_limit_proximity_early__yesterday_first_30min_return`, `combo_tri_mean__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return`, `combo_rank_min__star50_limit_proximity_early__yesterday_first_30min_return`, `combo_sig_product__yesterday_first_30min_return__yesterday_early_trend` |
| 159915ETF | single | Cluster 3 | 4 | 0.2617 | `combo_min__opening_drive_thrust_ratio__bar_body_rng_0` | `combo_min__opening_drive_thrust_ratio__first_bar_sentiment`, `combo_tri_min__opening_drive_thrust_ratio__first_bar_sentiment__first_bar_return`, `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` |
| 159915ETF | single | Cluster 4 | 2 | 0.2617 | `combo_max__first_bar_sentiment__volatility_expansion_trend_vector` | `combo_sig_product__bar_body_rng_0__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 5 | 2 | 0.2617 | `combo_min__first_bar_sentiment__volatility_expansion_trend_vector` | `combo_rank_min__first_bar_return__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 6 | 3 | 0.2617 | `combo_min__opening_drive_thrust_ratio__max_up_ret` | `opening_drive_thrust_ratio`, `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` |
| 159915ETF | single | Cluster 7 | 2 | 0.2617 | `combo_rank_max__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | `combo_min__opening_drive_thrust_ratio__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 8 | 1 | 0.2617 | `net_volume_flow` | _(none)_ |
| 159915ETF | single | Cluster 9 | 7 | 0.2617 | `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | `combo_rank_max__opening_drive_thrust_ratio__max_up_ret`, `combo_rank_min__max_up_ret__volatility_expansion_trend_vector`, `combo_max__max_up_ret__volatility_expansion_trend_vector`, `max_up_ret`, `combo_rank_max__max_up_ret__volatility_expansion_trend_vector`, `combo_mean__max_up_ret__impulse_bar_dominance` |
| 159915ETF | single | Cluster 10 | 12 | 0.2617 | `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0`, `combo_tri_min__star50_limit_proximity_early__first_bar_sentiment__bar_body_rng_0`, `combo_tri_min__star50_limit_proximity_early__bar_body_rng_0__first_bar_return`, `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0`, `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment`, `combo_min__bar_body_rng_0__limit_down_proximity_early`, `combo_min__rbreaker_sell_setup_proximity_early__bar_ret_0`, `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment`, `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return`, `combo_rank_min__bar_body_rng_0__limit_down_proximity_early`, `combo_mean__first_bar_sentiment__limit_down_proximity_early` |
| 159915ETF | single | Cluster 11 | 7 | 0.2617 | `combo_max__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | `combo_tri_max__max_up_ret__star50_limit_proximity_early__bar_body_rng_0`, `combo_rank_max__star50_limit_proximity_early__bar_body_rng_0`, `combo_max__bar_ret_0__limit_down_proximity_early`, `combo_tri_max__star50_limit_proximity_early__first_bar_sentiment__first_bar_return`, `combo_max__star50_limit_proximity_early__first_bar_sentiment`, `combo_max__bar_body_rng_0__rbreaker_buy_setup_proximity_early` |
| 159915ETF | single | Cluster 12 | 8 | 0.2617 | `combo_sig_product__star50_limit_proximity_early__bar_body_rng_0` | `rbreaker_sell_setup_proximity_early`, `combo_rank_max__rbreaker_sell_setup_proximity_early__limit_down_proximity_early`, `combo_sig_product__star50_limit_proximity_early__bar_ret_0`, `combo_diff__limit_down_proximity_early__demark_setup_reversal_early`, `combo_rel_diff__rbreaker_buy_setup_proximity_early__demark_setup_reversal_early`, `combo_sig_product__star50_limit_proximity_early__volatility_expansion_trend_vector`, `combo_sig_product__limit_down_proximity_early__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 13 | 11 | 0.2617 | `combo_min__max_up_ret__bar_body_rng_0` | `bar_body_rng_0`, `combo_tri_mean__max_up_ret__bar_body_rng_0__first_bar_return`, `combo_min__max_up_ret__first_bar_sentiment`, `combo_tri_median__star50_limit_proximity_early__first_bar_sentiment__first_bar_return`, `first_bar_return`, `combo_min__max_up_ret__first_bar_return`, `combo_mean__first_bar_sentiment__first_bar_return`, `combo_tri_min__max_up_ret__first_bar_sentiment__first_bar_return`, `combo_ratio__bar_ret_0__volume_weighted_price_position`, `combo_rank_max__max_up_ret__first_bar_sentiment` |
| 159915ETF | single | Cluster 14 | 4 | 0.2617 | `combo_rank_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | `combo_rank_min__max_up_ret__star50_limit_proximity_early`, `combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early`, `combo_mean__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` |
| 159915ETF | single | Cluster 15 | 4 | 0.2617 | `combo_min__bar_body_rng_0__impulse_bar_dominance` | `combo_max__bar_body_rng_0__impulse_bar_dominance`, `combo_mean__bar_body_rng_0__impulse_bar_dominance`, `combo_max__bar_ret_0__impulse_bar_dominance` |
| 159915ETF | single | Cluster 16 | 2 | 0.2617 | `combo_rank_max__max_up_ret__bar_body_rng_0` | `combo_max__max_up_ret__bar_body_rng_0` |
| 159915ETF | single | Cluster 17 | 2 | 0.2617 | `combo_tri_mean__opening_drive_thrust_ratio__first_bar_sentiment__bar_body_rng_0` | `combo_rank_max__opening_drive_thrust_ratio__bar_body_rng_0` |
| 159915ETF | single | Cluster 18 | 3 | 0.2617 | `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_return`, `combo_max__opening_drive_thrust_ratio__bar_ret_0` |
| 159915ETF | single | Cluster 19 | 2 | 0.2617 | `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment` |
| 159915ETF | single | Cluster 20 | 2 | 0.2617 | `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` |
| 159915ETF | single | Cluster 21 | 2 | 0.2617 | `combo_mean__bar_body_rng_0__volatility_expansion_trend_vector` | `combo_max__first_bar_return__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 22 | 2 | 0.2617 | `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_sentiment` | `combo_mean__max_up_ret__first_bar_sentiment` |
| 159915ETF | single | Cluster 23 | 2 | 0.2617 | `trend_bar_close_consistency` | `shaved_bar_trend_conviction` |
| 159915ETF | single | Cluster 24 | 1 | 0.2617 | `combo_sig_product__volume_weighted_price_position__volatility_expansion_trend_vector` | _(none)_ |
| 159915ETF | single | Cluster 25 | 5 | 0.2617 | `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | `combo_min__star50_limit_proximity_early__volume_weighted_price_position`, `combo_rank_min__limit_down_proximity_early__volume_weighted_price_position`, `combo_mean__rbreaker_sell_setup_proximity_early__volume_weighted_price_position`, `combo_mean__limit_down_proximity_early__volume_weighted_price_position` |
| 159915ETF | single | Cluster 26 | 2 | 0.2617 | `combo_diff__max_up_ret__demark_setup_reversal_early` | `combo_rel_diff__max_up_ret__demark_setup_reversal_early` |
| 159915ETF | single | Cluster 27 | 2 | 0.2617 | `combo_mean__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | `combo_rank_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 28 | 1 | 0.2617 | `combo_max__limit_down_proximity_early__volatility_expansion_trend_vector` | _(none)_ |
| 159915ETF | single | Cluster 29 | 2 | 0.2617 | `combo_rank_max__max_up_ret__star50_limit_proximity_early` | `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early` |
| 159915ETF | single | Cluster 30 | 1 | 0.2617 | `combo_rank_max__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | _(none)_ |
| 159915ETF | single | Cluster 31 | 2 | 0.2617 | `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | `combo_rel_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` |
| 159915ETF | single | Cluster 32 | 2 | 0.2617 | `combo_rank_min__opening_drive_thrust_ratio__volume_weighted_price_position` | `combo_min__max_up_ret__volume_weighted_price_position` |
| 159915ETF | single | Cluster 33 | 2 | 0.2617 | `combo_rank_max__max_up_ret__volume_weighted_price_position` | `combo_mean__max_up_ret__volume_weighted_price_position` |
| 159915ETF | single | Cluster 34 | 2 | 0.2617 | `combo_mean__volume_weighted_price_position__volatility_expansion_trend_vector` | `combo_rank_min__volume_weighted_price_position__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 35 | 3 | 0.2617 | `combo_min__bar_body_rng_0__volume_weighted_price_position` | `combo_mean__first_bar_return__volume_weighted_price_position`, `combo_rank_max__bar_body_rng_0__volume_weighted_price_position` |
| 159915ETF | single | Cluster 36 | 4 | 0.2617 | `combo_sig_product__max_up_ret__bar_body_rng_0` | `combo_sig_product__opening_drive_thrust_ratio__bar_body_rng_0`, `combo_sig_product__max_up_ret__bar_ret_0`, `combo_sig_product__opening_drive_thrust_ratio__first_bar_return` |
| 159915ETF | single | Cluster 37 | 2 | 0.2617 | `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 38 | 3 | 0.2617 | `combo_max__impulse_bar_dominance__volatility_expansion_trend_vector` | `combo_ratio__volatility_expansion_trend_vector__volume_weighted_price_position`, `combo_sig_product__impulse_bar_dominance__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 39 | 2 | 0.2617 | `combo_min__opening_drive_thrust_ratio__impulse_bar_dominance` | `combo_max__opening_drive_thrust_ratio__impulse_bar_dominance` |
| 159915ETF | single | Cluster 40 | 1 | 0.2617 | `combo_rel_diff__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | _(none)_ |
| 159915ETF | single | Cluster 41 | 1 | 0.2617 | `combo_mean__limit_down_proximity_early__volatility_expansion_trend_vector` | _(none)_ |
| 159915ETF | single | Cluster 42 | 2 | 0.2617 | `combo_min__limit_down_proximity_early__volatility_expansion_trend_vector` | `combo_rank_min__limit_down_proximity_early__volatility_expansion_trend_vector` |
| 159915ETF | single | Cluster 43 | 2 | 0.2617 | `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` |
