...
### 300ETF — `single` (Full Model Lockbox IC: +0.0761, Sharpe: +0.5794)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1225 | +0.0632 | +0.0632 | +0.3639 | 0.84 | 1/8 | 0.61 | 0.56 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0004 | +0.0179 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1187 | +0.0756 | +0.0756 | +0.5654 | 0.70 | 0/8 | 0.53 | 0.48 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0003 | +0.0530 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1188 | +0.0703 | +0.0703 | +0.3240 | 0.90 | 1/8 | 0.73 | 0.73 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1156 | +0.0706 | +0.0706 | +0.8555 | 0.84 | 1/8 | 0.59 | 0.47 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0007 | +0.0210 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1193 | +0.0723 | +0.0723 | +0.4930 | 0.81 | 1/8 | 0.63 | 0.72 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0003 | +0.0328 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1119 | +0.0543 | +0.0543 | +0.3473 | 0.77 | 1/8 | 0.75 | 0.80 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0004 | +0.0613 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1132 | +0.0876 | +0.0876 | +0.7186 | 0.79 | 1/8 | 0.71 | 0.71 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0002 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.1197 | +0.0682 | +0.0682 | +0.3507 | 0.57 | 0/8 | 0.59 | 0.70 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0002 | -0.0359 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0941 | +0.0566 | +0.0566 | +0.3084 | 0.79 | 1/8 | 0.51 | 1.10 | `volume_weighted_price_position` (1.18) | -0.0009 | +0.0329 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1232 | +0.0678 | +0.0678 | +0.5240 | 0.69 | 1/8 | 0.64 | 0.70 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0001 | -0.0306 |
| `combo_tri_min__max_up_ret__bar_body_rng_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0967 | +0.0573 | +0.0573 | +0.1800 | 0.78 | 0/8 | 0.68 | 1.16 | `max_up_ret` (0.90) | -0.0005 | +0.0436 |
| `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1165 | +0.0622 | +0.0622 | +0.2186 | 0.80 | 1/8 | 0.69 | 0.76 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0003 | -0.0306 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0927 | +0.0529 | +0.0529 | +0.2969 | 0.90 | 1/8 | 0.65 | 1.25 | `volume_weighted_price_position` (1.18) | -0.0005 | -0.0021 |
| `combo_min__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1111 | +0.0742 | +0.0742 | +0.1837 | 1.00 | 1/8 | 0.68 | 0.63 | `star50_limit_proximity_early` (1.09) | +0.0006 | +0.0000 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0872 | +0.0567 | +0.0567 | +0.4294 | 0.84 | 1/8 | 0.72 | 1.37 | `volume_weighted_price_position` (1.18) | -0.0002 | +0.0090 |
| `rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.0965 | +0.0662 | +0.0662 | +0.0044 | 1.02 | 1/8 | 0.66 | 0.75 | — | -0.0005 | -0.0096 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1235 | +0.0694 | +0.0694 | +0.4182 | 0.60 | 0/8 | 0.61 | 0.70 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0003 | +0.0425 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1222 | +0.0660 | +0.0660 | +0.4096 | 0.63 | 1/8 | 0.62 | 0.77 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0001 | -0.0306 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0995 | +0.0761 | +0.0761 | +0.8091 | 0.82 | 1/8 | 0.76 | 1.03 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0002 | +0.0187 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0912 | +0.0592 | +0.0592 | +0.4308 | 0.68 | 1/8 | 0.57 | 0.87 | `max_up_ret` (0.90) | -0.0004 | +0.0187 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0811 | +0.0540 | +0.0540 | +0.0387 | 0.80 | 0/8 | 0.87 | 1.95 | `volume_weighted_price_position` (1.18) | +0.0001 | -0.0053 |
| `combo_min__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1074 | +0.0839 | +0.0839 | +0.6572 | 0.81 | 1/8 | 0.70 | 0.60 | `star50_limit_proximity_early` (1.09) | +0.0008 | +0.0000 |
| `combo_tri_mean__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0980 | +0.0637 | +0.0637 | +0.1613 | 0.73 | 1/8 | 0.64 | 1.11 | `volume_weighted_price_position` (1.18) | -0.0001 | -0.0053 |
...
| `combo_min__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0898 | +0.0448 | +0.0448 | -0.2936 | 0.91 | 2/8 | 0.70 | 0.95 | `max_up_ret` (0.90) | -0.0004 | +0.0436 |
| `combo_tri_max__max_up_ret__bar_ret_0__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0935 | +0.0596 | +0.0596 | +0.0022 | 0.71 | 0/8 | 0.69 | 1.02 | `max_up_ret` (0.90) | +0.0003 | -0.0053 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0890 | +0.0592 | +0.0592 | +0.5268 | 0.64 | 0/8 | 0.70 | 1.01 | `max_up_ret` (0.90) | +0.0003 | -0.0053 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1131 | +0.0588 | +0.0588 | +0.3446 | 0.77 | 1/8 | 0.69 | 0.81 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0003 | -0.0306 |
| `combo_tri_min__max_up_ret__bar_ret_0__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0893 | +0.0587 | +0.0587 | +0.5249 | 0.66 | 0/8 | 0.57 | 0.82 | `max_up_ret` (0.90) | +0.0003 | +0.1212 |
| `combo_tri_mean__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0947 | +0.0629 | +0.0629 | +0.5008 | 0.72 | 1/8 | 0.60 | 1.05 | `volume_weighted_price_position` (1.18) | +0.0000 | -0.0053 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.0963 | +0.0520 | +0.0520 | +0.6190 | 0.62 | 0/8 | 0.54 | 0.81 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0002 | -0.0053 |
| `combo_tri_max__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0914 | +0.0620 | +0.0620 | +0.1555 | 0.73 | 1/8 | 0.93 | 1.22 | `max_up_ret` (0.90) | +0.0002 | +0.0000 |
| `combo_tri_max__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0795 | +0.0604 | +0.0604 | +0.1889 | 0.85 | 1/8 | 1.04 | 1.51 | `volume_weighted_price_position` (1.18) | +0.0001 | -0.0053 |
| `combo_min__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0908 | +0.0601 | +0.0601 | +0.2270 | 0.84 | 1/8 | 0.71 | 1.17 | `opening_drive_thrust_ratio` (0.87) | -0.0002 | -0.0072 |
| `combo_rank_max__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0848 | +0.0579 | +0.0579 | +0.3725 | 0.77 | 1/8 | 0.63 | 1.36 | `volume_weighted_price_position` (1.18) | +0.0000 | -0.0053 |
| `combo_tri_min__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0897 | +0.0678 | +0.0678 | +0.6776 | 0.83 | 1/8 | 0.54 | 1.12 | `volume_weighted_price_position` (1.18) | -0.0001 | +0.0970 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0754 | +0.0521 | +0.0521 | +0.3504 | 0.88 | 0/8 | 0.86 | 1.55 | `volume_weighted_price_position` (1.18) | -0.0000 | -0.0053 |
| `combo_max__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0944 | +0.0572 | +0.0572 | -0.0542 | 0.62 | 0/8 | 0.61 | 0.88 | `bar_body_rng_0` (0.69) | +0.0001 | -0.0053 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0742 | +0.0529 | +0.0529 | +0.5709 | 0.72 | 1/8 | 0.59 | 0.89 | `bar_vol_0` (1.91) | -0.0000 | -0.0359 |
| `combo_rel_diff__limit_down_proximity_early__volume_concentration` | Volatility & Oscillators | +1 | +0.0664 | +0.0521 | +0.0521 | -0.1443 | 0.74 | 2/8 | 1.82 | 2.08 | `limit_down_proximity_early` (1.45) | +0.0004 | +0.0585 |
| `combo_rank_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.1000 | +0.0650 | +0.0650 | +0.1830 | 0.97 | 1/8 | 0.82 | 0.64 | `limit_down_proximity_early` (1.45) | +0.0003 | +0.0400 |
| `combo_ratio__limit_down_proximity_early__volume_concentration` | Volatility & Oscillators | +1 | +0.0660 | +0.0417 | +0.0417 | -0.0329 | 0.79 | 1/8 | 1.45 | 1.93 | `limit_down_proximity_early` (1.45) | +0.0003 | +0.0425 |
| `combo_min__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0828 | +0.0591 | +0.0591 | +0.1677 | 0.97 | 1/8 | 0.73 | 1.78 | `volume_weighted_price_position` (1.18) | -0.0005 | -0.0053 |
| `combo_min__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0872 | +0.0382 | +0.0382 | -0.0020 | 0.82 | 1/8 | 0.75 | 0.85 | `opening_drive_thrust_ratio` (0.87) | -0.0003 | +0.0000 |
| `combo_tri_max__bar_ret_0__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0902 | +0.0538 | +0.0538 | -0.2305 | 0.72 | 1/8 | 0.63 | 1.35 | `volume_weighted_price_position` (1.18) | +0.0000 | -0.0053 |
| `combo_ratio__bar_body_rng_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0917 | +0.0524 | +0.0524 | +0.2193 | 0.65 | 1/8 | 0.63 | 0.92 | `volume_weighted_price_position` (1.18) | +0.0003 | +0.0000 |
| `combo_ratio__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0833 | +0.0444 | +0.0444 | -0.2618 | 0.82 | 1/8 | 0.99 | 1.14 | `volume_weighted_price_position` (1.18) | -0.0002 | +0.0000 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0910 | +0.0843 | +0.0843 | +0.7153 | 0.82 | 1/8 | 0.86 | 0.71 | `rbreaker_buy_setup_proximity_early` (1.45) | +0.0005 | +0.0400 |
| `combo_min__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0866 | +0.0602 | +0.0602 | +0.3527 | 0.89 | 1/8 | 0.85 | 1.06 | `volume_surge_direction` (0.97) | +0.0003 | +0.0000 |
| `combo_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0754 | +0.0499 | +0.0499 | +0.3619 | 1.00 | 1/8 | 0.73 | 0.95 | `volume_surge_direction` (0.97) | +0.0004 | +0.0559 |
| `combo_rank_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0745 | +0.0492 | +0.0492 | +0.3661 | 0.94 | 2/8 | 0.69 | 0.82 | `volume_surge_direction` (0.97) | +0.0001 | +0.0559 |
| `combo_rank_min__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0754 | +0.0683 | +0.0683 | +0.8126 | 0.93 | 0/8 | 1.03 | 2.54 | `volume_surge_direction` (0.97) | +0.0003 | +0.0000 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0893 | +0.0684 | +0.0684 | +0.5896 | 0.87 | 1/8 | 0.67 | 0.76 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0001 | +0.0000 |
| `combo_clamp_diff__rbreaker_buy_setup_proximity_early__volume_concentration` | Volatility & Oscillators | +1 | +0.0619 | +0.0418 | +0.0418 | -0.0096 | 0.78 | 1/8 | 1.67 | 2.29 | `rbreaker_buy_setup_proximity_early` (1.45) | +0.0002 | -0.0552 |
| `star50_limit_proximity_early` | Other Technical | +1 | +0.0915 | +0.0606 | +0.0606 | +0.0343 | 1.09 | 1/8 | 0.76 | 0.81 | — | +0.0001 | +0.0425 |
| `combo_mean__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0868 | +0.0590 | +0.0590 | +0.6028 | 0.77 | 1/8 | 0.79 | 0.98 | `volume_surge_direction` (0.97) | +0.0004 | +0.0559 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1062 | +0.0736 | +0.0736 | +0.2598 | 0.75 | 1/8 | 0.72 | 0.82 | `rbreaker_sell_setup_proximity_early` (1.02) | +0.0000 | +0.0000 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.0767 | +0.0460 | +0.0460 | +0.4672 | 0.90 | 1/8 | 0.78 | 1.02 | — | -0.0001 | +0.0187 |
| `combo_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0979 | +0.0506 | +0.0506 | +0.4972 | 0.65 | 0/8 | 0.89 | 1.16 | `max_up_ret` (0.90) | -0.0001 | +0.0000 |
| `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0803 | +0.0503 | +0.0503 | +0.2937 | 0.90 | 2/8 | 0.94 | 1.54 | `volume_weighted_price_position` (1.18) | -0.0003 | +0.0000 |
| `combo_sig_product__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0777 | +0.0553 | +0.0553 | -0.2908 | 0.95 | 1/8 | 1.41 | 2.02 | `volume_weighted_price_position` (1.18) | -0.0002 | +0.0000 |
...
| `combo_mean__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.1032 | +0.0585 | +0.0585 | +0.3447 | 0.84 | 1/8 | 0.79 | 0.80 | `limit_down_proximity_early` (1.45) | +0.0000 | -0.0306 |
| `combo_rank_max__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0852 | +0.0550 | +0.0550 | +0.6519 | 0.73 | 1/8 | 0.51 | 0.54 | `volume_surge_direction` (0.97) | +0.0003 | +0.0000 |
| `combo_ratio__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0929 | +0.0438 | +0.0438 | +0.2841 | 0.57 | 0/8 | 0.58 | 0.83 | `volume_weighted_price_position` (1.18) | +0.0004 | +0.0970 |
| `combo_z_sum__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0921 | +0.0483 | +0.0483 | +0.4173 | 0.57 | 0/8 | 0.58 | 0.82 | `first_bar_sentiment` (0.70) | +0.0002 | -0.0053 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Other Technical | +1 | +0.0830 | +0.0525 | +0.0525 | +0.1561 | 1.15 | 1/8 | 0.88 | 0.83 | `limit_down_proximity_early` (1.45) | +0.0000 | +0.0097 |
| `combo_mean__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.1095 | +0.0642 | +0.0642 | +0.2161 | 0.64 | 0/8 | 0.68 | 0.69 | `limit_down_proximity_early` (1.45) | +0.0002 | -0.0306 |
| `combo_rank_min__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0878 | +0.0617 | +0.0617 | +0.6752 | 0.84 | 1/8 | 0.51 | 0.92 | `volume_weighted_price_position` (1.18) | -0.0004 | -0.0053 |
| `combo_rank_max__volume_weighted_price_position__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0901 | +0.0303 | +0.0303 | -0.6851 | 0.77 | 1/8 | 0.79 | 1.27 | `volume_weighted_price_position` (1.18) | -0.0003 | +0.0000 |
| `combo_clamp_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0894 | +0.0701 | +0.0701 | +0.3915 | 0.73 | 0/8 | 0.63 | 1.10 | `early_vwap_acceleration` (1.17) | +0.0002 | +0.0416 |
| `combo_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0767 | +0.0495 | +0.0495 | -0.0583 | 1.06 | 1/8 | 0.95 | 1.44 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0006 | -0.0306 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0757 | +0.0480 | +0.0480 | -0.0932 | 0.93 | 1/8 | 0.93 | 1.42 | `rbreaker_sell_setup_proximity_early` (1.02) | -0.0001 | -0.0483 |
...
| `combo_rel_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0768 | +0.0622 | +0.0622 | -0.1070 | 0.85 | 0/8 | 0.61 | 1.30 | `early_vwap_acceleration` (1.17) | +0.0002 | +0.0000 |
...
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0909 | +0.0407 | +0.0407 | -0.1788 | 0.62 | 1/8 | 0.72 | 0.90 | `max_up_ret` (0.90) | -0.0001 | +0.0000 |
| `combo_min__volume_weighted_price_position__double_bottom_bull_flag_early` | Volatility & Oscillators | +1 | +0.0354 | -0.0017 | -0.0017 | -0.6567 | 1.27 | 1/8 | 2.11 | -4.04 | `volume_weighted_price_position` (1.18) | -0.0002 | -0.0177 |

### 500ETF — `single` (Full Model Lockbox IC: +0.1118, Sharpe: +0.8067)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1763 | +0.1217 | +0.1217 | +0.8196 | 0.44 | 0/8 | 0.60 | 0.39 | `opening_drive_thrust_ratio` (0.42) | +0.0001 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1603 | +0.1205 | +0.1205 | +0.6397 | 0.52 | 0/8 | 0.63 | 0.48 | `star50_limit_proximity_early` (0.61) | +0.0002 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1776 | +0.1177 | +0.1177 | +0.6330 | 0.45 | 0/8 | 0.61 | 0.46 | `opening_drive_thrust_ratio` (0.42) | +0.0001 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1511 | +0.0995 | +0.0995 | +0.4399 | 0.39 | 0/8 | 0.66 | 0.68 | `opening_drive_thrust_ratio` (0.42) | -0.0000 | -0.0590 |
| `combo_rank_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1544 | +0.1215 | +0.1215 | +0.9205 | 0.53 | 0/8 | 0.69 | 0.52 | `star50_limit_proximity_early` (0.61) | +0.0004 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1634 | +0.0936 | +0.0936 | +0.4546 | 0.38 | 0/8 | 0.53 | 0.56 | `trend_bar_close_consistency` (0.66) | -0.0002 | -0.0002 |
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__trend_bar_close_consistency` | Other Technical | +1 | +0.1240 | +0.1061 | +0.1061 | +0.5479 | 0.51 | 0/8 | 0.60 | 0.50 | `trend_bar_close_consistency` (0.66) | +0.0001 | +0.0000 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1531 | +0.1166 | +0.1166 | +0.9210 | 0.39 | 0/8 | 0.62 | 0.68 | `opening_drive_thrust_ratio` (0.42) | +0.0002 | +0.0000 |
...
| `combo_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1702 | +0.0726 | +0.0726 | -0.3811 | 0.35 | 0/8 | 0.55 | 0.48 | `first_bar_sentiment` (0.45) | -0.0002 | -0.0230 |
| `combo_min__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1310 | +0.1134 | +0.1134 | +1.1317 | 0.47 | 0/8 | 0.66 | 0.61 | `star50_limit_proximity_early` (0.61) | +0.0004 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.2012 | +0.1108 | +0.1108 | +0.6987 | 0.36 | 0/8 | 0.56 | 0.53 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | -0.0002 |
...
| `combo_clamp_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1754 | +0.0911 | +0.0911 | +0.5122 | 0.43 | 0/8 | 0.58 | 0.48 | `body_size_progression` (0.64) | -0.0001 | -0.0230 |
...
| `combo_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | Other Technical | +1 | +0.1440 | +0.0862 | +0.0862 | -0.3387 | 0.48 | 0/8 | 0.82 | 0.59 | `double_bottom_bull_flag_early` (1.21) | -0.0001 | -0.0081 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1711 | +0.0913 | +0.0913 | +0.8496 | 0.50 | 0/8 | 0.52 | 0.34 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0002 | -0.0006 |
| `combo_diff__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1629 | +0.0993 | +0.0993 | +0.6878 | 0.41 | 0/8 | 0.73 | 0.74 | `volume_weighted_momentum_acceleration` (0.57) | -0.0001 | -0.0590 |
| `combo_min__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1672 | +0.1050 | +0.1050 | +0.3978 | 0.39 | 0/8 | 0.60 | 0.51 | `opening_drive_thrust_ratio` (0.42) | -0.0000 | -0.0230 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__trend_day_regime_conviction` | Other Technical | +1 | +0.1582 | +0.1105 | +0.1105 | +0.4458 | 0.42 | 0/8 | 0.65 | 0.59 | `star50_limit_proximity_early` (0.61) | -0.0000 | -0.0002 |
| `combo_rank_min__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1317 | +0.1205 | +0.1205 | +1.2069 | 0.47 | 0/8 | 0.72 | 0.60 | `star50_limit_proximity_early` (0.61) | +0.0003 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1697 | +0.0902 | +0.0902 | +0.9262 | 0.52 | 0/8 | 0.50 | 0.33 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0003 | -0.0081 |
...
| `combo_rank_max__opening_drive_thrust_ratio__early_body_momentum` | Intraday Range Momentum | +1 | +0.1514 | +0.0879 | +0.0879 | +0.4325 | 0.42 | 0/8 | 0.57 | 0.62 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | +0.0000 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1688 | +0.1000 | +0.1000 | +0.5378 | 0.37 | 0/8 | 0.62 | 0.68 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | -0.0590 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1677 | +0.0970 | +0.0970 | +0.4242 | 0.38 | 0/8 | 0.54 | 0.55 | `trend_bar_close_consistency` (0.66) | -0.0001 | -0.0002 |
| `combo_min__rbreaker_sell_setup_proximity_early__trend_bar_close_consistency` | Other Technical | +1 | +0.1136 | +0.1046 | +0.1046 | +0.7844 | 0.46 | 0/8 | 0.52 | 0.55 | `trend_bar_close_consistency` (0.66) | +0.0001 | +0.0000 |
...
| `combo_rank_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1585 | +0.0823 | +0.0823 | +0.1403 | 0.49 | 0/8 | 0.51 | 0.40 | `opening_drive_thrust_ratio` (0.42) | -0.0003 | -0.0197 |
| `combo_rank_min__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1207 | +0.1199 | +0.1199 | +1.1425 | 0.56 | 0/8 | 0.55 | 0.43 | `star50_limit_proximity_early` (0.61) | +0.0003 | +0.0000 |
| `combo_rank_min__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1447 | +0.0976 | +0.0976 | +0.9250 | 0.54 | 0/8 | 0.56 | 0.35 | `star50_limit_proximity_early` (0.61) | -0.0000 | -0.0006 |
...
| `combo_sig_product__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1484 | +0.1175 | +0.1175 | +0.4851 | 0.42 | 0/8 | 0.58 | 0.52 | `close_vs_open_range` (0.47) | +0.0002 | -0.0224 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1602 | +0.0884 | +0.0884 | +0.4616 | 0.41 | 0/8 | 0.54 | 0.61 | `smooth_momentum_structure` (0.60) | -0.0001 | -0.0230 |
| `combo_mean__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1624 | +0.0992 | +0.0992 | +0.5697 | 0.47 | 0/8 | 0.51 | 0.39 | `star50_limit_proximity_early` (0.61) | +0.0001 | -0.0081 |
| `combo_tri_min__opening_drive_thrust_ratio__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1140 | +0.0928 | +0.0928 | +0.4995 | 0.42 | 0/8 | 0.68 | 0.94 | `trend_bar_close_consistency` (0.66) | -0.0002 | -0.0590 |
| `combo_tri_mean__star50_limit_proximity_early__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1283 | +0.0902 | +0.0902 | +0.6835 | 0.44 | 0/8 | 0.54 | 0.50 | `trend_bar_close_consistency` (0.66) | -0.0000 | -0.0590 |
| `combo_mean__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1477 | +0.1002 | +0.1002 | +0.6774 | 0.36 | 0/8 | 0.62 | 0.55 | `star50_limit_proximity_early` (0.61) | +0.0001 | +0.0000 |
...
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1490 | +0.0982 | +0.0982 | +0.2007 | 0.30 | 0/8 | 0.74 | 0.85 | `opening_drive_thrust_ratio` (0.42) | -0.0000 | -0.0230 |
...
| `combo_rank_min__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1437 | +0.0950 | +0.0950 | +0.3896 | 0.35 | 0/8 | 0.74 | 0.85 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | -0.0590 |
| `combo_rank_min__close_vs_open_range__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1391 | +0.0775 | +0.0775 | -0.4555 | 0.45 | 0/8 | 0.47 | 0.34 | `close_vs_open_range` (0.47) | -0.0000 | -0.0590 |
| `combo_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1750 | +0.0893 | +0.0893 | +0.5003 | 0.42 | 0/8 | 0.58 | 0.50 | `body_size_progression` (0.64) | -0.0002 | -0.0236 |
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.1682 | +0.0993 | +0.0993 | +0.3094 | 0.42 | 0/8 | 0.66 | 0.63 | — | -0.0002 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1535 | +0.1004 | +0.1004 | +0.6046 | 0.41 | 0/8 | 0.66 | 0.62 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
| `combo_mean__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1691 | +0.0921 | +0.0921 | +0.3575 | 0.39 | 0/8 | 0.61 | 0.60 | `first_bar_sentiment` (0.45) | -0.0002 | +0.0000 |
...
| `combo_mean__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1405 | +0.1069 | +0.1069 | +0.5237 | 0.52 | 0/8 | 0.50 | 0.38 | `star50_limit_proximity_early` (0.61) | +0.0000 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1782 | +0.1136 | +0.1136 | +0.4793 | 0.44 | 0/8 | 0.59 | 0.48 | `star50_limit_proximity_early` (0.61) | +0.0000 | +0.0000 |
| `combo_min__trend_day_regime_conviction__close_vs_open_range` | Other Technical | +1 | +0.1116 | +0.0833 | +0.0833 | +0.2334 | 0.46 | 0/8 | 0.57 | 0.60 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
| `combo_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1440 | +0.0768 | +0.0768 | +0.5059 | 0.41 | 0/8 | 0.52 | 0.54 | `early_body_momentum` (0.37) | -0.0002 | -0.0590 |
| `combo_sig_product__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1418 | +0.0889 | +0.0889 | +0.4280 | 0.42 | 0/8 | 0.72 | 0.81 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | -0.0590 |
| `combo_sig_product__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1546 | +0.1052 | +0.1052 | +0.4585 | 0.33 | 0/8 | 0.57 | 0.51 | `early_body_momentum` (0.37) | +0.0003 | -0.0132 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1446 | +0.1108 | +0.1108 | +0.1086 | 0.50 | 0/8 | 0.45 | 0.51 | `body_size_progression` (0.64) | +0.0001 | +0.0000 |
| `combo_mean__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1285 | +0.0792 | +0.0792 | +0.0912 | 0.31 | 0/8 | 0.64 | 0.72 | `first_bar_sentiment` (0.45) | -0.0001 | -0.0590 |
| `combo_rank_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.1097 | +0.0918 | +0.0918 | +0.6021 | 0.39 | 0/8 | 0.58 | 0.60 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
...
| `combo_clamp_diff__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1580 | +0.0933 | +0.0933 | -0.0259 | 0.45 | 0/8 | 0.82 | 0.64 | `smooth_momentum_structure` (0.60) | -0.0001 | -0.0002 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1799 | +0.0913 | +0.0913 | +0.4100 | 0.36 | 0/8 | 0.61 | 0.77 | `opening_drive_thrust_ratio` (0.42) | -0.0001 | +0.0000 |
...
| `combo_min__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1619 | +0.0920 | +0.0920 | +0.4928 | 0.44 | 0/8 | 0.56 | 0.47 | `opening_drive_thrust_ratio` (0.42) | -0.0000 | +0.0000 |
| `net_volume_flow` | Volatility & Oscillators | +1 | +0.1188 | +0.0892 | +0.0892 | +0.4280 | 0.31 | 0/8 | 0.71 | 0.89 | — | -0.0001 | -0.0590 |
| `combo_rank_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1501 | +0.0813 | +0.0813 | +0.4751 | 0.42 | 0/8 | 0.53 | 0.56 | `early_body_momentum` (0.37) | -0.0002 | +0.0000 |
| `combo_rel_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | Other Technical | +1 | +0.1417 | +0.0880 | +0.0880 | -0.3254 | 0.50 | 0/8 | 0.75 | 0.52 | `double_bottom_bull_flag_early` (1.21) | -0.0001 | +0.0000 |
| `combo_rank_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1258 | +0.0906 | +0.0906 | +0.2518 | 0.59 | 0/8 | 0.59 | 0.41 | `star50_limit_proximity_early` (0.61) | +0.0002 | -0.0006 |
| `combo_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1269 | +0.0958 | +0.0958 | +0.2125 | 0.61 | 0/8 | 0.58 | 0.47 | `star50_limit_proximity_early` (0.61) | +0.0004 | -0.1249 |
| `combo_max__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1820 | +0.1064 | +0.1064 | +0.4742 | 0.37 | 0/8 | 0.56 | 0.49 | `opening_drive_thrust_ratio` (0.42) | -0.0002 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1796 | +0.0910 | +0.0910 | +0.4739 | 0.36 | 0/8 | 0.63 | 0.72 | `opening_drive_thrust_ratio` (0.42) | -0.0002 | -0.0002 |
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1511 | +0.1141 | +0.1141 | +0.8262 | 0.34 | 0/8 | 0.71 | 0.72 | `volatility_expansion_trend_vector` (0.41) | +0.0002 | -0.0590 |
...
| `combo_rank_min__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1185 | +0.0969 | +0.0969 | +0.6560 | 0.52 | 0/8 | 0.44 | 0.35 | `close_vs_open_range` (0.47) | -0.0002 | -0.0596 |
| `combo_mean__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.1170 | +0.0911 | +0.0911 | +0.3935 | 0.36 | 0/8 | 0.66 | 0.76 | `close_vs_open_range` (0.47) | +0.0001 | -0.0590 |
| `combo_min__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1351 | +0.1018 | +0.1018 | +0.4421 | 0.41 | 0/8 | 0.67 | 0.63 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
...
| `combo_mean__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1453 | +0.0886 | +0.0886 | +0.2558 | 0.33 | 0/8 | 0.60 | 0.71 | `first_bar_return` (0.41) | -0.0002 | +0.0000 |
...
| `combo_mean__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1503 | +0.0939 | +0.0939 | +0.7756 | 0.37 | 0/8 | 0.58 | 0.65 | `close_vs_open_range` (0.47) | -0.0000 | -0.0590 |
| `combo_rank_min__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1468 | +0.0742 | +0.0742 | -0.1280 | 0.35 | 0/8 | 0.52 | 0.47 | `first_bar_sentiment` (0.45) | -0.0002 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__trend_bar_close_consistency` | Other Technical | +1 | +0.1373 | +0.0857 | +0.0857 | +0.4571 | 0.49 | 0/8 | 0.66 | 0.76 | `trend_bar_close_consistency` (0.66) | -0.0001 | -0.0590 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.0825 | +0.0453 | +0.0453 | +0.2299 | 1.02 | 1/8 | 0.17 | 0.14 | `smooth_momentum_structure` (0.60) | -0.0003 | +0.0000 |
| `combo_min__max_up_ret__high_low_sequence_momentum` | Intraday Range Momentum | +1 | +0.1291 | +0.0971 | +0.0971 | +0.6507 | 0.31 | 0/8 | 0.67 | 0.95 | `high_low_sequence_momentum` (0.47) | +0.0000 | -0.0230 |
| `combo_max__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1595 | +0.0936 | +0.0936 | +0.0056 | 0.47 | 0/8 | 0.61 | 0.50 | `max_down_ret` (0.60) | -0.0001 | -0.1252 |
...
| `combo_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1626 | +0.0765 | +0.0765 | +0.4322 | 0.42 | 0/8 | 0.60 | 0.78 | `first_bar_sentiment` (0.45) | -0.0002 | -0.0002 |
| `combo_mean__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1781 | +0.0944 | +0.0944 | +0.4366 | 0.38 | 0/8 | 0.60 | 0.64 | `opening_drive_thrust_ratio` (0.42) | -0.0000 | +0.0000 |
| `combo_max__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1616 | +0.0860 | +0.0860 | +0.4491 | 0.40 | 0/8 | 0.56 | 0.56 | `close_vs_open_range` (0.47) | -0.0001 | -0.0002 |
...
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1619 | +0.0920 | +0.0920 | +0.4322 | 0.33 | 0/8 | 0.57 | 0.66 | — | -0.0002 | -0.0230 |
| `combo_tri_median__opening_drive_thrust_ratio__smooth_momentum_structure__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1117 | +0.0934 | +0.0934 | +0.4880 | 0.40 | 0/8 | 0.61 | 0.71 | `smooth_momentum_structure` (0.60) | +0.0000 | +0.0000 |
| `combo_rank_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1639 | +0.0928 | +0.0928 | +0.0552 | 0.32 | 0/8 | 0.55 | 0.68 | `bar_ret_0` (0.41) | -0.0001 | -0.0236 |
...
| `combo_rank_max__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1764 | +0.0954 | +0.0954 | +0.3172 | 0.35 | 0/8 | 0.64 | 0.74 | `opening_drive_thrust_ratio` (0.42) | -0.0002 | -0.0006 |
| `combo_max__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1304 | +0.0580 | +0.0580 | -0.1978 | 0.35 | 0/8 | 0.61 | 0.84 | `first_bar_sentiment` (0.45) | -0.0002 | -0.0590 |
| `combo_rank_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1606 | +0.0831 | +0.0831 | +0.2070 | 0.42 | 0/8 | 0.58 | 0.54 | `max_down_ret` (0.60) | -0.0001 | -0.0236 |
| `combo_mean__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1709 | +0.0854 | +0.0854 | +0.4811 | 0.35 | 0/8 | 0.54 | 0.66 | `bar_ret_0` (0.41) | -0.0002 | +0.0251 |
| `combo_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1639 | +0.0830 | +0.0830 | +0.2163 | 0.36 | 0/8 | 0.52 | 0.65 | `bar_ret_0` (0.41) | -0.0004 | +0.0251 |
| `combo_rank_max__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1611 | +0.0854 | +0.0854 | +0.4781 | 0.39 | 0/8 | 0.57 | 0.58 | `close_vs_open_range` (0.47) | -0.0001 | +0.0000 |
| `combo_min__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1185 | +0.0979 | +0.0979 | +0.4302 | 0.51 | 0/8 | 0.45 | 0.36 | `close_vs_open_range` (0.47) | +0.0001 | -0.0671 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1441 | +0.0905 | +0.0905 | +0.7330 | 0.45 | 0/8 | 0.49 | 0.51 | `rbreaker_sell_setup_proximity_early` (0.41) | +0.0001 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1183 | +0.0951 | +0.0951 | +0.2989 | 0.62 | 1/8 | 0.37 | 0.29 | `volume_weighted_momentum_acceleration` (0.57) | -0.0001 | +0.0000 |
| `combo_max__close_vs_open_range__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1362 | +0.0768 | +0.0768 | +0.3491 | 0.36 | 0/8 | 0.69 | 0.68 | `close_vs_open_range` (0.47) | -0.0001 | +0.0000 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1589 | +0.0746 | +0.0746 | +0.3150 | 0.44 | 0/8 | 0.57 | 0.67 | `trend_bar_close_consistency` (0.66) | -0.0002 | -0.0590 |
| `combo_max__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1760 | +0.1040 | +0.1040 | -0.0012 | 0.45 | 0/8 | 0.56 | 0.47 | `star50_limit_proximity_early` (0.61) | -0.0003 | -0.1249 |
| `combo_mean__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.1285 | +0.0937 | +0.0937 | +0.2553 | 0.41 | 0/8 | 0.64 | 0.56 | `max_down_ret` (0.60) | +0.0000 | -0.0590 |
...
| `trend_bar_close_consistency` | Other Technical | +1 | +0.0765 | +0.0642 | +0.0642 | +0.4479 | 0.66 | 0/8 | 0.56 | 1.12 | — | -0.0001 | -0.0590 |
| `combo_sig_product__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.1076 | +0.0881 | +0.0881 | +0.1341 | 0.51 | 0/8 | 0.54 | 0.55 | `close_vs_open_range` (0.47) | +0.0001 | -0.0224 |
| `combo_mean__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1425 | +0.0916 | +0.0916 | +0.6450 | 0.41 | 0/8 | 0.56 | 0.48 | `max_down_ret` (0.60) | +0.0001 | -0.0081 |
| `combo_rank_max__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1705 | +0.1101 | +0.1101 | +0.4988 | 0.48 | 0/8 | 0.53 | 0.46 | `star50_limit_proximity_early` (0.61) | -0.0000 | -0.0006 |
| `combo_rank_max__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1590 | +0.0922 | +0.0922 | +0.9091 | 0.50 | 0/8 | 0.62 | 0.44 | `max_down_ret` (0.60) | -0.0002 | -0.0006 |
...
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1480 | +0.0664 | +0.0664 | +0.1589 | 0.32 | 0/8 | 0.58 | 0.68 | `bar_ret_0` (0.41) | -0.0003 | +0.0000 |
| `combo_mean__max_up_ret__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1464 | +0.0902 | +0.0902 | +0.6237 | 0.37 | 0/8 | 0.57 | 0.67 | `trend_day_regime_conviction` (0.44) | -0.0000 | -0.0002 |
| `combo_rank_min__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1278 | +0.0988 | +0.0988 | +0.2415 | 0.58 | 0/8 | 0.56 | 0.33 | `max_down_ret` (0.60) | +0.0000 | -0.0590 |
| `combo_mean__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1305 | +0.0933 | +0.0933 | +0.4158 | 0.71 | 0/8 | 0.46 | 0.31 | `star50_limit_proximity_early` (0.61) | +0.0002 | -0.1249 |
| `combo_rank_min__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1134 | +0.0908 | +0.0908 | +0.4995 | 0.41 | 0/8 | 0.57 | 0.68 | `bar_ret_0` (0.41) | -0.0000 | -0.0596 |
| `combo_max__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1562 | +0.0990 | +0.0990 | +0.1521 | 0.37 | 0/8 | 0.51 | 0.53 | `star50_limit_proximity_early` (0.61) | -0.0002 | +0.0488 |
...
| `combo_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1634 | +0.0794 | +0.0794 | +0.2412 | 0.32 | 0/8 | 0.62 | 0.73 | `close_vs_open_range` (0.47) | -0.0003 | +0.0000 |
| `combo_rank_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1631 | +0.0796 | +0.0796 | +0.2969 | 0.31 | 0/8 | 0.63 | 0.73 | `close_vs_open_range` (0.47) | -0.0002 | +0.0000 |
| `combo_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1328 | +0.0840 | +0.0840 | +0.6202 | 0.46 | 0/8 | 0.48 | 0.46 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0004 | -0.0590 |
| `combo_sig_product__close_vs_open_range__early_body_momentum` | Intraday Range Momentum | +1 | +0.1012 | +0.0650 | +0.0650 | -0.2871 | 0.40 | 0/8 | 0.59 | 0.79 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1795 | +0.0904 | +0.0904 | +0.0934 | 0.36 | 0/8 | 0.53 | 0.59 | `opening_drive_thrust_ratio` (0.42) | -0.0003 | -0.0002 |
| `combo_sig_product__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1323 | +0.0654 | +0.0654 | +0.3641 | 0.38 | 0/8 | 0.68 | 0.49 | `first_bar_sentiment` (0.45) | +0.0001 | -0.0590 |
| `combo_tri_mean__opening_drive_thrust_ratio__smooth_momentum_structure__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1057 | +0.0820 | +0.0820 | +0.6587 | 0.66 | 0/8 | 0.39 | 0.31 | `star50_limit_proximity_early` (0.61) | -0.0002 | -0.1249 |
| `combo_rank_min__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1453 | +0.0954 | +0.0954 | +0.5791 | 0.51 | 0/8 | 0.66 | 0.54 | `max_down_ret` (0.60) | +0.0000 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.1280 | +0.1211 | +0.1211 | -0.1320 | 0.57 | 0/8 | 0.51 | 0.56 | `body_size_progression` (0.64) | -0.0000 | -0.1249 |
| `combo_max__first_bar_return__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1553 | +0.0789 | +0.0789 | +0.3856 | 0.43 | 0/8 | 0.55 | 0.51 | `max_down_ret` (0.60) | -0.0001 | +0.0482 |
| `combo_rank_min__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1276 | +0.0797 | +0.0797 | +0.2390 | 0.55 | 0/8 | 0.48 | 0.27 | `max_down_ret` (0.60) | -0.0001 | -0.0006 |
| `combo_rank_max__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1405 | +0.1178 | +0.1178 | +0.8307 | 0.62 | 0/8 | 0.53 | 0.36 | `star50_limit_proximity_early` (0.61) | +0.0002 | -0.0006 |
| `combo_rank_min__early_body_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1179 | +0.0876 | +0.0876 | +0.1773 | 0.51 | 0/8 | 0.67 | 0.46 | `max_down_ret` (0.60) | -0.0001 | -0.0590 |
| `combo_min__close_vs_open_range__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1361 | +0.0715 | +0.0715 | -0.6886 | 0.47 | 0/8 | 0.45 | 0.36 | `close_vs_open_range` (0.47) | +0.0000 | -0.0590 |
| `combo_min__early_body_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1145 | +0.0940 | +0.0940 | +0.3762 | 0.46 | 0/8 | 0.74 | 0.61 | `max_down_ret` (0.60) | +0.0003 | -0.0590 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1248 | +0.0789 | +0.0789 | +0.2580 | 0.51 | 0/8 | 0.51 | 0.62 | `volume_weighted_momentum_acceleration` (0.57) | -0.0001 | -0.0590 |
| `combo_max__early_body_momentum__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1413 | +0.0622 | +0.0622 | -0.0153 | 0.33 | 0/8 | 0.61 | 0.75 | `first_bar_return` (0.41) | -0.0004 | +0.0000 |
...
| `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1609 | +0.0938 | +0.0938 | +0.0240 | 0.40 | 0/8 | 0.48 | 0.59 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0001 | -0.0002 |
| `combo_max__close_vs_open_range__early_body_momentum` | Intraday Range Momentum | +1 | +0.1020 | +0.0793 | +0.0793 | +0.1117 | 0.43 | 0/8 | 0.57 | 0.74 | `close_vs_open_range` (0.47) | +0.0001 | -0.0590 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1578 | +0.1017 | +0.1017 | +0.4703 | 0.28 | 0/8 | 0.51 | 0.55 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0000 | +0.0000 |
| `combo_min__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1641 | +0.0798 | +0.0798 | +0.5993 | 0.39 | 0/8 | 0.53 | 0.54 | `bar_ret_0` (0.41) | -0.0000 | +0.0000 |
...
| `combo_min__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1254 | +0.0988 | +0.0988 | +0.0640 | 0.56 | 0/8 | 0.56 | 0.39 | `max_down_ret` (0.60) | +0.0003 | +0.0000 |
| `combo_rank_max__early_body_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1203 | +0.0776 | +0.0776 | +0.4425 | 0.46 | 0/8 | 0.57 | 0.62 | `max_down_ret` (0.60) | -0.0000 | +0.0000 |
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0858 | +0.0541 | +0.0541 | -0.2763 | 0.67 | 1/8 | 1.56 | 5.22 | — | -0.0004 | -0.0224 |
| `combo_min__first_bar_return__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1327 | +0.0836 | +0.0836 | +0.2902 | 0.50 | 0/8 | 0.52 | 0.35 | `max_down_ret` (0.60) | +0.0002 | -0.0006 |
| `combo_sig_product__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1369 | +0.1223 | +0.1223 | +0.4818 | 0.39 | 0/8 | 0.73 | 0.83 | `star50_limit_proximity_early` (0.61) | -0.0001 | -0.0195 |
| `combo_rank_max__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1432 | +0.0990 | +0.0990 | +0.5523 | 0.47 | 0/8 | 0.52 | 0.51 | `star50_limit_proximity_early` (0.61) | -0.0001 | -0.0006 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1322 | +0.1300 | +0.1300 | +0.6068 | 0.44 | 0/8 | 0.66 | 0.67 | `star50_limit_proximity_early` (0.61) | +0.0000 | -0.1364 |
| `combo_rank_max__close_vs_open_range__early_body_momentum` | Intraday Range Momentum | +1 | +0.1067 | +0.0820 | +0.0820 | +0.6056 | 0.40 | 0/8 | 0.59 | 0.71 | `close_vs_open_range` (0.47) | -0.0000 | -0.0590 |
| `combo_max__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1788 | +0.0900 | +0.0900 | -0.0106 | 0.35 | 0/8 | 0.66 | 0.78 | `opening_drive_thrust_ratio` (0.42) | -0.0002 | -0.0006 |
| `combo_max__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1567 | +0.0720 | +0.0720 | -0.3014 | 0.35 | 0/8 | 0.60 | 0.74 | `volatility_expansion_trend_vector` (0.41) | -0.0003 | -0.0006 |
| `combo_tri_max__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1649 | +0.0963 | +0.0963 | +0.3050 | 0.46 | 0/8 | 0.52 | 0.47 | `star50_limit_proximity_early` (0.61) | -0.0002 | -0.0590 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1530 | +0.0729 | +0.0729 | +0.0143 | 0.43 | 0/8 | 0.86 | 1.32 | `opening_drive_thrust_ratio` (0.42) | -0.0002 | -0.0002 |
| `combo_rank_min__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1672 | +0.0777 | +0.0777 | -0.4806 | 0.37 | 0/8 | 0.56 | 0.51 | `first_bar_sentiment` (0.45) | -0.0001 | +0.0000 |
| `combo_rel_diff__opening_drive_thrust_ratio__early_late_momentum_divergence` | Intraday Range Momentum | +1 | +0.1485 | +0.0871 | +0.0871 | +0.9219 | 0.55 | 0/8 | 0.67 | 0.52 | `early_late_momentum_divergence` (0.70) | -0.0003 | +0.0000 |
| `combo_abs_diff__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.0947 | -0.0211 | -0.0211 | -0.4893 | 0.85 | 1/8 | 0.50 | 0.17 | `close_vs_open_range` (0.47) | -0.0002 | +0.0000 |
...
| `first_bar_return` | Gap / Overnight Reversal | +1 | +0.1457 | +0.0699 | +0.0699 | +0.4640 | 0.41 | 0/8 | 0.52 | 0.50 | — | -0.0002 | -0.0006 |
| `combo_mean__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1278 | +0.0920 | +0.0920 | +0.5487 | 0.52 | 0/8 | 0.58 | 0.42 | `max_down_ret` (0.60) | +0.0002 | +0.0000 |
| `combo_sig_product__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1454 | +0.1031 | +0.1031 | +0.6726 | 0.41 | 0/8 | 0.57 | 0.41 | `body_size_progression` (0.64) | +0.0000 | -0.0008 |
| `combo_max__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.1223 | +0.0851 | +0.0851 | -0.0023 | 0.42 | 0/8 | 0.56 | 0.49 | `max_down_ret` (0.60) | -0.0001 | -0.1843 |
| `combo_max__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1398 | +0.0978 | +0.0978 | +0.2106 | 0.43 | 0/8 | 0.54 | 0.52 | `star50_limit_proximity_early` (0.61) | -0.0003 | -0.0590 |
| `combo_rank_max__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1262 | +0.0836 | +0.0836 | -0.0702 | 0.43 | 0/8 | 0.70 | 0.64 | `star50_limit_proximity_early` (0.61) | +0.0000 | -0.0006 |
| `combo_max__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1469 | +0.1001 | +0.1001 | +0.2217 | 0.50 | 0/8 | 0.50 | 0.42 | `star50_limit_proximity_early` (0.61) | -0.0002 | -0.0590 |
| `combo_rank_max__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1247 | +0.0837 | +0.0837 | +0.5254 | 0.51 | 0/8 | 0.60 | 0.53 | `max_down_ret` (0.60) | -0.0000 | -0.0006 |
...
| `combo_rank_min__first_bar_sentiment__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1447 | +0.0745 | +0.0745 | +0.7136 | 0.47 | 0/8 | 0.50 | 0.36 | `max_down_ret` (0.60) | +0.0000 | +0.0000 |
...
| `combo_rank_max__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1407 | +0.1051 | +0.1051 | +0.4203 | 0.57 | 0/8 | 0.52 | 0.44 | `star50_limit_proximity_early` (0.61) | +0.0001 | -0.0006 |
| `combo_max__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.1253 | +0.0831 | +0.0831 | +0.3714 | 0.52 | 0/8 | 0.61 | 0.47 | `max_down_ret` (0.60) | +0.0001 | -0.0006 |
...
| `max_down_ret` | Intraday Range Momentum | +1 | +0.1248 | +0.0828 | +0.0828 | +0.1693 | 0.60 | 0/8 | 0.61 | 0.36 | — | +0.0001 | -0.1249 |
| `combo_min__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | Other Technical | +1 | +0.0671 | +0.0716 | +0.0716 | +0.0053 | 0.84 | 1/8 | 1.18 | 0.87 | `double_bottom_bull_flag_early` (1.21) | -0.0001 | +0.0000 |
| `combo_sig_product__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1603 | +0.0792 | +0.0792 | +0.3953 | 0.43 | 0/8 | 0.52 | 0.66 | `bar_ret_0` (0.41) | -0.0001 | -0.0006 |
| `combo_tri_median__opening_drive_thrust_ratio__smooth_momentum_structure__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1208 | +0.1053 | +0.1053 | -0.3095 | 0.74 | 0/8 | 0.40 | 0.50 | `star50_limit_proximity_early` (0.61) | -0.0001 | -0.1249 |
...
| `open_to_current_return` | Intraday Range Momentum | +1 | +0.1142 | +0.0851 | +0.0851 | +0.2899 | 0.40 | 0/8 | 0.64 | 0.90 | — | +0.0001 | -0.0590 |
| `vwap_trend_channel_slope` | Other Technical | +1 | +0.0991 | +0.0839 | +0.0839 | +0.1758 | 0.52 | 0/8 | 0.73 | 0.93 | — | -0.0000 | -0.0590 |
...
| `combo_sig_product__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1424 | +0.0999 | +0.0999 | +0.3072 | 0.28 | 0/8 | 0.68 | 0.80 | `rbreaker_sell_setup_proximity_early` (0.41) | -0.0002 | -0.0114 |
| `combo_sig_product__high_low_sequence_momentum__max_down_ret` | Intraday Range Momentum | +1 | +0.1200 | +0.0788 | +0.0788 | +0.1181 | 0.49 | 0/8 | 0.77 | 0.66 | `max_down_ret` (0.60) | +0.0001 | -0.0006 |
| `or_fill_ratio` | Other Technical | +1 | +0.0805 | +0.0777 | +0.0777 | +0.0150 | 0.55 | 0/8 | 0.66 | 0.63 | — | +0.0001 | +0.0000 |
| `bar_body_rng_0` | Other Technical | +1 | +0.1360 | +0.0806 | +0.0806 | +0.1142 | 0.36 | 0/8 | 0.60 | 0.57 | — | -0.0002 | +0.0000 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1433, Sharpe: +1.7662)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1376 | +0.1458 | +0.1458 | +1.3138 | 0.56 | 0/8 | 1.26 | 1.00 | `star50_limit_proximity_early` (0.69) | +0.0003 | +0.0890 |
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1461 | +0.1423 | +0.1423 | +1.5753 | 0.57 | 1/8 | 1.24 | 0.87 | `star50_limit_proximity_early` (0.69) | +0.0003 | -0.0050 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1569 | +0.1269 | +0.1269 | +1.6324 | 0.53 | 0/8 | 0.99 | 0.60 | `first_bar_sentiment` (0.75) | -0.0001 | -0.0148 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1535 | +0.1236 | +0.1236 | +0.8616 | 0.53 | 0/8 | 1.08 | 0.76 | `first_bar_sentiment` (0.75) | +0.0002 | +0.0262 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1650 | +0.1008 | +0.1008 | +1.2076 | 0.54 | 1/8 | 0.80 | 0.42 | `first_bar_sentiment` (0.75) | -0.0004 | +0.0113 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1585 | +0.1129 | +0.1129 | +1.5874 | 0.50 | 1/8 | 0.97 | 0.67 | `first_bar_sentiment` (0.75) | -0.0004 | -0.0198 |
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1404 | +0.1368 | +0.1368 | +1.3236 | 0.56 | 1/8 | 1.18 | 0.88 | `star50_limit_proximity_early` (0.69) | +0.0001 | -0.0050 |
| `combo_tri_min__star50_limit_proximity_early__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1504 | +0.1246 | +0.1246 | +1.6742 | 0.68 | 1/8 | 1.15 | 0.55 | `first_bar_sentiment` (0.75) | -0.0001 | +0.0066 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1670 | +0.1328 | +0.1328 | +1.4080 | 0.57 | 1/8 | 1.00 | 0.59 | `bar_body_rng_0` (0.54) | +0.0003 | +0.0066 |
| `combo_tri_min__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1437 | +0.1292 | +0.1292 | +0.9902 | 0.57 | 0/8 | 0.89 | 0.56 | `star50_limit_proximity_early` (0.69) | +0.0002 | +0.0262 |
| `combo_rank_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1362 | +0.1357 | +0.1357 | +1.1873 | 0.61 | 1/8 | 1.31 | 1.00 | `star50_limit_proximity_early` (0.69) | +0.0004 | +0.0085 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1458 | +0.1354 | +0.1354 | +1.5192 | 0.43 | 0/8 | 1.00 | 0.79 | `opening_drive_thrust_ratio` (0.51) | -0.0000 | -0.0413 |
| `combo_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1072 | +0.1075 | +0.1075 | +0.3554 | 0.82 | 1/8 | 1.22 | 0.96 | `yesterday_first_30min_return` (0.92) | -0.0002 | +0.0607 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1459 | +0.1218 | +0.1218 | +0.9113 | 0.56 | 1/8 | 0.91 | 0.52 | `first_bar_sentiment` (0.75) | -0.0003 | -0.0148 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1647 | +0.1300 | +0.1300 | +1.4067 | 0.38 | 0/8 | 1.02 | 0.78 | `rbreaker_sell_setup_proximity_early` (0.44) | +0.0002 | +0.0113 |
| `combo_rank_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1078 | +0.1077 | +0.1077 | +0.3400 | 0.82 | 1/8 | 1.31 | 1.07 | `yesterday_first_30min_return` (0.92) | +0.0004 | +0.0554 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1676 | +0.1171 | +0.1171 | +1.5562 | 0.45 | 0/8 | 0.93 | 0.68 | `first_bar_sentiment` (0.75) | -0.0003 | +0.0113 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1519 | +0.1295 | +0.1295 | +1.2978 | 0.48 | 1/8 | 1.16 | 0.98 | `opening_drive_thrust_ratio` (0.51) | +0.0002 | +0.0604 |
| `combo_tri_mean__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1620 | +0.1312 | +0.1312 | +1.2050 | 0.42 | 0/8 | 0.92 | 0.87 | `star50_limit_proximity_early` (0.69) | -0.0001 | +0.0113 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1299 | +0.0937 | +0.0937 | +0.6050 | 0.61 | 1/8 | 1.14 | 0.91 | `yesterday_early_vwap_dev` (1.10) | -0.0000 | +0.0458 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1647 | +0.0967 | +0.0967 | +1.0067 | 0.59 | 1/8 | 0.86 | 0.53 | `first_bar_sentiment` (0.75) | -0.0001 | +0.0262 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1617 | +0.1187 | +0.1187 | +0.9375 | 0.54 | 1/8 | 0.93 | 0.65 | `rbreaker_sell_setup_proximity_early` (0.44) | -0.0000 | +0.0112 |
| `combo_mean__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1188 | +0.1298 | +0.1298 | +0.8732 | 0.79 | 1/8 | 0.97 | 0.79 | `yesterday_first_30min_return` (0.92) | -0.0003 | +0.1442 |
| `combo_clamp_diff__bar_ret_0__demark_setup_reversal_early` | Other Technical | +1 | +0.1383 | +0.1176 | +0.1176 | +1.3628 | 0.53 | 0/8 | 1.12 | 1.05 | `demark_setup_reversal_early` (0.76) | -0.0002 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1687 | +0.1232 | +0.1232 | +1.1886 | 0.47 | 1/8 | 1.07 | 0.73 | `bar_body_rng_0` (0.54) | -0.0005 | -0.0083 |
| `combo_rank_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1388 | +0.1268 | +0.1268 | +1.0353 | 0.70 | 1/8 | 1.05 | 0.61 | `star50_limit_proximity_early` (0.69) | +0.0002 | +0.0112 |
...
| `combo_rank_min__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1415 | +0.1345 | +0.1345 | +1.2143 | 0.58 | 0/8 | 1.23 | 0.81 | `star50_limit_proximity_early` (0.69) | +0.0005 | +0.0813 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1515 | +0.1091 | +0.1091 | +0.6773 | 0.49 | 0/8 | 0.78 | 0.51 | `first_bar_sentiment` (0.75) | -0.0003 | +0.0113 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1315 | +0.1354 | +0.1354 | +1.4221 | 0.61 | 0/8 | 1.05 | 0.81 | `volume_weighted_price_position` (0.83) | +0.0003 | +0.1002 |
| `combo_min__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1153 | +0.1333 | +0.1333 | +1.3096 | 0.66 | 1/8 | 1.32 | 1.17 | `star50_limit_proximity_early` (0.69) | +0.0000 | +0.0963 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1532 | +0.1260 | +0.1260 | +1.0555 | 0.36 | 0/8 | 1.19 | 1.11 | `rbreaker_sell_setup_proximity_early` (0.44) | -0.0003 | +0.0674 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1670 | +0.1101 | +0.1101 | +1.1180 | 0.43 | 0/8 | 1.01 | 0.74 | `first_bar_sentiment` (0.75) | -0.0005 | +0.0113 |
| `combo_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.1272 | +0.1326 | +0.1326 | +1.4134 | 0.78 | 1/8 | 1.29 | 0.55 | `rbreaker_buy_setup_proximity_early` (1.06) | +0.0001 | +0.0066 |
| `combo_mean__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.1385 | +0.1161 | +0.1161 | +1.6835 | 0.59 | 1/8 | 1.13 | 0.70 | `limit_down_proximity_early` (1.06) | -0.0001 | +0.0330 |
| `combo_min__first_bar_return__limit_down_proximity_early` | Gap / Overnight Reversal | +1 | +0.1236 | +0.1216 | +0.1216 | +1.1418 | 0.76 | 1/8 | 1.10 | 0.52 | `limit_down_proximity_early` (1.06) | +0.0001 | +0.0262 |
| `combo_z_sum__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1346 | +0.1002 | +0.1002 | +0.9526 | 0.53 | 0/8 | 1.05 | 0.61 | `first_bar_sentiment` (0.75) | -0.0002 | -0.0050 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1297 | +0.0986 | +0.0986 | +1.1068 | 0.60 | 0/8 | 1.09 | 0.56 | `first_bar_sentiment` (0.75) | -0.0001 | +0.0000 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1308 | +0.1138 | +0.1138 | +0.6098 | 0.56 | 0/8 | 1.33 | 1.49 | `demark_setup_reversal_early` (0.76) | -0.0001 | +0.0834 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1402 | +0.1030 | +0.1030 | +0.3991 | 0.43 | 0/8 | 1.05 | 0.95 | `opening_drive_thrust_ratio` (0.51) | +0.0001 | +0.0511 |
| `combo_mean__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1562 | +0.1219 | +0.1219 | +1.3598 | 0.48 | 0/8 | 0.95 | 0.87 | `star50_limit_proximity_early` (0.69) | -0.0002 | +0.0113 |
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.1143 | +0.1176 | +0.1176 | +1.1307 | 0.51 | 0/8 | 1.21 | 0.99 | — | -0.0002 | -0.0050 |
| `combo_rel_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1302 | +0.1206 | +0.1206 | +0.7735 | 0.55 | 0/8 | 1.24 | 1.34 | `demark_setup_reversal_early` (0.76) | +0.0001 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1487 | +0.1323 | +0.1323 | +1.4436 | 0.42 | 0/8 | 1.06 | 1.04 | `star50_limit_proximity_early` (0.69) | -0.0001 | -0.0148 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1402 | +0.1106 | +0.1106 | +0.5865 | 0.44 | 0/8 | 0.93 | 0.87 | `opening_drive_thrust_ratio` (0.51) | +0.0000 | +0.0016 |
| `combo_rank_min__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1155 | +0.1385 | +0.1385 | +1.2999 | 0.66 | 1/8 | 1.37 | 1.20 | `star50_limit_proximity_early` (0.69) | +0.0001 | +0.0113 |
| `combo_tri_mean__max_up_ret__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1495 | +0.0976 | +0.0976 | +0.5013 | 0.49 | 1/8 | 0.89 | 0.58 | `first_bar_sentiment` (0.75) | -0.0003 | +0.0036 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1315 | +0.1402 | +0.1402 | +1.1873 | 0.50 | 1/8 | 1.21 | 1.23 | `volatility_expansion_trend_vector` (0.69) | +0.0001 | +0.0815 |
| `combo_tri_mean__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1563 | +0.1361 | +0.1361 | +1.5551 | 0.44 | 0/8 | 0.96 | 0.87 | `star50_limit_proximity_early` (0.69) | -0.0001 | +0.0113 |
| `combo_rank_max__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1350 | +0.1046 | +0.1046 | +0.6295 | 0.49 | 0/8 | 0.91 | 0.68 | `opening_drive_thrust_ratio` (0.51) | -0.0000 | -0.0050 |
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1346 | +0.0998 | +0.0998 | +0.6165 | 0.45 | 1/8 | 1.18 | 0.81 | `bar_body_rng_0` (0.54) | -0.0000 | +0.0066 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1418 | +0.1273 | +0.1273 | +1.2414 | 0.47 | 0/8 | 1.20 | 0.99 | `opening_drive_thrust_ratio` (0.51) | +0.0000 | +0.0411 |
| `combo_max__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Other Technical | +1 | +0.1348 | +0.1226 | +0.1226 | +0.5885 | 0.61 | 1/8 | 1.32 | 1.38 | `limit_down_proximity_early` (1.06) | -0.0004 | +0.0398 |
| `combo_rank_min__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1202 | +0.1418 | +0.1418 | +1.6907 | 0.77 | 1/8 | 1.13 | 0.77 | `volume_weighted_price_position` (0.83) | +0.0003 | +0.1002 |
| `combo_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1416 | +0.0960 | +0.0960 | +0.2321 | 0.35 | 0/8 | 1.04 | 0.89 | `bar_ret_0` (0.44) | -0.0001 | +0.0547 |
| `combo_tri_max__max_up_ret__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1489 | +0.0853 | +0.0853 | +0.2321 | 0.46 | 0/8 | 1.00 | 0.81 | `first_bar_sentiment` (0.75) | -0.0003 | +0.0547 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1413 | +0.0935 | +0.0935 | +1.0080 | 0.52 | 0/8 | 1.18 | 0.92 | `first_bar_sentiment` (0.75) | +0.0000 | +0.0561 |
| `combo_max__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1530 | +0.1051 | +0.1051 | +0.8632 | 0.52 | 1/8 | 0.97 | 0.66 | `first_bar_sentiment` (0.75) | -0.0006 | +0.0192 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1299 | +0.1126 | +0.1126 | +0.8926 | 0.49 | 0/8 | 1.22 | 1.17 | `opening_drive_thrust_ratio` (0.51) | +0.0001 | -0.0050 |
| `combo_z_sum__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1544 | +0.1009 | +0.1009 | +1.3306 | 0.59 | 1/8 | 1.12 | 0.68 | `first_bar_sentiment` (0.75) | -0.0005 | +0.0113 |
| `combo_min__star50_limit_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1086 | +0.1236 | +0.1236 | +1.2361 | 0.54 | 0/8 | 1.29 | 1.45 | `impulse_bar_dominance` (1.03) | +0.0003 | +0.0807 |
| `combo_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1381 | +0.0924 | +0.0924 | +0.8838 | 0.47 | 1/8 | 1.19 | 0.84 | `bar_body_rng_0` (0.54) | -0.0001 | +0.0598 |
| `combo_tri_min__max_up_ret__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1453 | +0.1066 | +0.1066 | +0.7844 | 0.52 | 0/8 | 0.79 | 0.54 | `first_bar_sentiment` (0.75) | -0.0004 | +0.0066 |
| `combo_rank_max__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1127 | +0.1302 | +0.1302 | +0.6763 | 0.66 | 1/8 | 0.77 | 0.68 | `yesterday_first_30min_return` (0.92) | +0.0001 | +0.0793 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1282 | +0.1014 | +0.1014 | +0.5632 | 0.39 | 0/8 | 1.13 | 1.08 | — | -0.0001 | +0.0598 |
| `combo_z_sum__opening_drive_thrust_ratio__impulse_bar_dominance` | Other Technical | +1 | +0.1053 | +0.1136 | +0.1136 | +1.0592 | 0.52 | 0/8 | 1.41 | 1.41 | `impulse_bar_dominance` (1.03) | +0.0000 | +0.0651 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1243 | +0.1277 | +0.1277 | +1.0889 | 0.38 | 0/8 | 1.18 | 1.34 | `rbreaker_sell_setup_proximity_early` (0.44) | -0.0003 | +0.0627 |
| `combo_max__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1152 | +0.1055 | +0.1055 | +0.6298 | 0.47 | 0/8 | 1.13 | 1.19 | `volatility_expansion_trend_vector` (0.69) | +0.0000 | +0.0651 |
| `combo_max__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1113 | +0.1279 | +0.1279 | +0.6215 | 0.62 | 1/8 | 0.77 | 0.70 | `yesterday_first_30min_return` (0.92) | -0.0002 | +0.0611 |
| `combo_rel_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1176 | +0.1248 | +0.1248 | +1.0719 | 0.61 | 0/8 | 1.49 | 1.46 | `demark_setup_reversal_early` (0.76) | -0.0000 | +0.0000 |
| `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1206 | +0.1256 | +0.1256 | +1.0969 | 0.60 | 0/8 | 1.48 | 1.45 | `demark_setup_reversal_early` (0.76) | -0.0001 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1288 | +0.1129 | +0.1129 | +0.7706 | 0.54 | 0/8 | 0.99 | 0.67 | `bar_body_rng_0` (0.54) | -0.0000 | +0.0066 |
| `combo_tri_min__first_bar_sentiment__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1374 | +0.0958 | +0.0958 | +0.8819 | 0.53 | 1/8 | 0.83 | 0.52 | `first_bar_sentiment` (0.75) | -0.0002 | +0.0066 |
| `combo_clamp_diff__star50_limit_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1186 | +0.1250 | +0.1250 | +0.3681 | 0.69 | 2/8 | 1.49 | 1.71 | `demark_setup_reversal_early` (0.76) | +0.0000 | +0.0963 |
...
| `combo_mean__max_up_ret__impulse_bar_dominance` | Intraday Range Momentum | +1 | +0.1130 | +0.0994 | +0.0994 | +0.6676 | 0.48 | 0/8 | 1.34 | 1.61 | `impulse_bar_dominance` (1.03) | +0.0001 | +0.0718 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.1370 | +0.1229 | +0.1229 | +0.4385 | 0.56 | 1/8 | 1.33 | 1.44 | `rbreaker_buy_setup_proximity_early` (1.06) | -0.0000 | +0.0396 |
| `combo_diff__max_up_ret__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1218 | +0.1060 | +0.1060 | +0.9522 | 0.51 | 0/8 | 1.07 | 0.67 | `late_bar_momentum` (0.82) | +0.0001 | +0.0822 |
| `combo_z_sum__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1023 | +0.1228 | +0.1228 | +0.9670 | 0.56 | 0/8 | 1.29 | 1.23 | `volatility_expansion_trend_vector` (0.69) | +0.0000 | +0.0651 |
| `combo_z_sum__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1297 | +0.1202 | +0.1202 | +1.1147 | 0.44 | 0/8 | 1.29 | 1.48 | `impulse_bar_dominance` (1.03) | -0.0001 | +0.0617 |
| `combo_rel_diff__max_up_ret__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1211 | +0.1169 | +0.1169 | +0.6771 | 0.48 | 0/8 | 1.04 | 0.68 | `late_bar_momentum` (0.82) | +0.0002 | +0.0000 |
| `combo_rank_max__first_bar_return__volatility_expansion_trend_vector` | Gap / Overnight Reversal | +1 | +0.1314 | +0.1051 | +0.1051 | +0.5856 | 0.39 | 0/8 | 1.05 | 0.95 | `volatility_expansion_trend_vector` (0.69) | -0.0001 | +0.0936 |
| `combo_z_sum__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1505 | +0.1259 | +0.1259 | +1.1928 | 0.42 | 0/8 | 1.05 | 0.99 | `volume_weighted_price_position` (0.83) | +0.0000 | +0.0716 |
| `combo_rank_max__yesterday_first_30min_return__rbreaker_buy_setup_proximity_early` | Intraday Range Momentum | +1 | +0.0991 | +0.1030 | +0.1030 | +0.3399 | 0.75 | 1/8 | 0.77 | 0.75 | `rbreaker_buy_setup_proximity_early` (1.06) | -0.0000 | +0.0793 |
| `combo_max__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1193 | +0.1040 | +0.1040 | +0.6497 | 0.60 | 0/8 | 1.03 | 1.08 | `impulse_bar_dominance` (1.03) | -0.0002 | +0.0444 |
| `combo_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1261 | +0.1021 | +0.1021 | +0.7660 | 0.54 | 0/8 | 1.12 | 1.20 | `volume_weighted_price_position` (0.83) | -0.0001 | +0.0511 |
| `combo_rank_min__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1358 | +0.0805 | +0.0805 | +1.2407 | 0.51 | 1/8 | 0.80 | 0.46 | `first_bar_sentiment` (0.75) | -0.0003 | +0.0000 |
| `combo_max__first_bar_sentiment__rbreaker_buy_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1311 | +0.0635 | +0.0635 | +0.5211 | 0.65 | 1/8 | 0.86 | 0.60 | `rbreaker_buy_setup_proximity_early` (1.06) | -0.0006 | +0.0113 |
| `combo_rank_max__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1182 | +0.1083 | +0.1083 | +0.5114 | 0.42 | 0/8 | 1.14 | 1.07 | `volatility_expansion_trend_vector` (0.69) | +0.0001 | +0.0651 |
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0958 | +0.1097 | +0.1097 | +0.5964 | 0.52 | 0/8 | 1.25 | 1.18 | `volatility_expansion_trend_vector` (0.69) | +0.0000 | +0.0936 |
| `combo_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1095 | +0.1090 | +0.1090 | +0.3724 | 0.66 | 0/8 | 1.03 | 1.15 | `star50_limit_proximity_early` (0.69) | -0.0001 | +0.0262 |
| `combo_sig_product__impulse_bar_dominance__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0833 | +0.0956 | +0.0956 | +0.7826 | 0.69 | 0/8 | 1.49 | 1.74 | `impulse_bar_dominance` (1.03) | +0.0000 | +0.0651 |
| `volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0795 | +0.1157 | +0.1157 | +1.0095 | 0.69 | 0/8 | 1.44 | 1.58 | — | +0.0001 | +0.0651 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0962 | +0.1074 | +0.1074 | +0.9088 | 0.54 | 0/8 | 1.32 | 1.14 | `volatility_expansion_trend_vector` (0.69) | -0.0000 | +0.0651 |
| `combo_abs_diff__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0591 | -0.0132 | -0.0132 | -0.5256 | 0.84 | 2/8 | 0.53 | 0.98 | `volatility_expansion_trend_vector` (0.69) | +0.0002 | +0.0651 |
| `combo_mean__rbreaker_buy_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1010 | +0.1043 | +0.1043 | +0.6683 | 0.77 | 1/8 | 1.42 | 2.01 | `rbreaker_buy_setup_proximity_early` (1.06) | -0.0000 | +0.0617 |
...
_Null Baseline (un-gated candidate pool): 81.0% lock IC > 0, 39.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.1837_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 1062 | 30 | 100.0% | 83.3% | +0.0595 | +0.2560 |
| B2 Rolling Guard | 181 | 30 | 96.7% | 90.0% | +0.0553 | +0.2447 |
| BH-FDR Gate | 5 | 5 | 100.0% | 0.0% | +0.0298 | -0.4561 |
| B3 Composite Floor | 53 | 30 | 100.0% | 76.7% | +0.0600 | +0.2736 |
| B4 Correlation Gate | 107 | 30 | 100.0% | 86.7% | +0.0663 | +0.3769 |

**Admitted Pool Summary**: 93 features, False Positive Rate = 22.6% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0577, Mean Lock Sharpe = +0.2748
...
_Null Baseline (un-gated candidate pool): 76.0% lock IC > 0, 47.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.0093_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 1718 | 30 | 100.0% | 100.0% | +0.0901 | +0.5869 |
| B2 Rolling Guard | 218 | 30 | 100.0% | 70.0% | +0.0757 | +0.2262 |
| BH-FDR Gate | 7 | 7 | 85.7% | 0.0% | +0.0145 | -0.6172 |
| B3 Composite Floor | 144 | 30 | 100.0% | 100.0% | +0.0955 | +0.5158 |
| B4 Correlation Gate | 543 | 30 | 100.0% | 100.0% | +0.1068 | +0.7359 |

**Admitted Pool Summary**: 260 features, False Positive Rate = 9.2% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0919, Mean Lock Sharpe = +0.4007
...
_Null Baseline (un-gated candidate pool): 85.0% lock IC > 0, 66.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.3244_
...
| B3 Composite Floor | 145 | 30 | 100.0% | 100.0% | +0.1127 | +0.9691 |
| B4 Correlation Gate | 122 | 30 | 100.0% | 100.0% | +0.1277 | +1.2946 |

**Admitted Pool Summary**: 119 features, False Positive Rate = 0.8% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1153, Mean Lock Sharpe = +0.9810
...
| `combo_tri_min__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | +0.1064 | +0.0000 | +0.0678 | 0.64x | 2015-02-06 |
...
| `combo_min__volume_weighted_price_position__opening_drive_thrust_ratio` | +0.1090 | +0.0000 | +0.0591 | 0.54x | 2017-07-10 |
...
| `combo_rank_min__bar_body_rng_0__volume_surge_direction` | +0.0782 | +0.0000 | +0.0692 | 0.89x | 2010-12-14 |
...
| `combo_rank_min__first_bar_return__volume_weighted_price_position` | +0.0990 | +0.0000 | +0.0623 | 0.63x | 2015-01-08 |
...
| `combo_sig_product__high_low_sequence_momentum__max_down_ret` | +0.1400 | +0.0000 | +0.0788 | 0.56x | 2016-09-26 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | +0.1480 | +0.0000 | +0.1354 | 0.91x | 2017-01-20 |
...
| `combo_rel_diff__max_up_ret__demark_setup_reversal_early` | +0.1565 | +0.0000 | +0.1206 | 0.77x | 2016-10-24 |
...
| `combo_rank_min__star50_limit_proximity_early__volume_weighted_price_position` | +0.1386 | +0.0000 | +0.1415 | 1.02x | 2016-10-24 |
...
| `combo_max__max_up_ret__volatility_expansion_trend_vector` | +0.1499 | +0.0000 | +0.1055 | 0.70x | 2016-10-24 |
| `combo_max__star50_limit_proximity_early__yesterday_first_30min_return` | +0.1157 | +0.0000 | +0.1279 | 1.11x | 2017-02-27 |
| `combo_rel_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | +0.1453 | +0.0000 | +0.1248 | 0.86x | 2016-09-14 |
| `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | +0.1472 | +0.0000 | +0.1256 | 0.85x | 2016-09-14 |
...
| `combo_z_sum__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | +0.1406 | +0.0000 | +0.1202 | 0.86x | 2017-01-20 |
...
| `combo_z_sum__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | +0.1668 | +0.0000 | +0.1259 | 0.76x | 2017-01-20 |
...
| `combo_sig_product__impulse_bar_dominance__volatility_expansion_trend_vector` | +0.1218 | +0.0000 | +0.0956 | 0.79x | 2014-05-27 |
| `volatility_expansion_trend_vector` | +0.1263 | +0.0000 | +0.1157 | 0.92x | 2016-10-24 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | +0.1337 | +0.0000 | +0.1074 | 0.80x | 2016-10-24 |
| `combo_abs_diff__max_up_ret__volatility_expansion_trend_vector` | +0.0622 | +0.0000 | -0.0132 | -0.21x | 2012-02-22 |
| `combo_mean__rbreaker_buy_setup_proximity_early__impulse_bar_dominance` | +0.1172 | +0.0000 | +0.1043 | 0.89x | 2011-10-18 |

---

## Actionable Recommendations for Filter Tuning

1. **300ETF `single` — 7-Year Jackknife Sign Stability too strict**: 83.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 39.0%, mean lock Sharpe=+0.2560). Consider relaxing this gate.
2. **300ETF `single` — B2 Rolling Guard too strict**: 90.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 39.0%, mean lock Sharpe=+0.2447). Consider relaxing this gate.
3. **300ETF `single` — B3 Composite Floor too strict**: 76.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 39.0%, mean lock Sharpe=+0.2736). Consider relaxing this gate.
4. **300ETF `single` — B4 Correlation Gate too strict**: 86.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 39.0%, mean lock Sharpe=+0.3769). Consider relaxing this gate.
...
11. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 47.0%, mean lock Sharpe=+0.5869). Consider relaxing this gate.
...
16. **159915ETF `single` — B3 Composite Floor too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 66.0%, mean lock Sharpe=+0.9691). Consider relaxing this gate.
17. **159915ETF `single` — B4 Correlation Gate too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 66.0%, mean lock Sharpe=+1.2946). Consider relaxing this gate.
...
19. **159915ETF `short` — 7-Year Jackknife Sign Stability too strict**: 50.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 19.0%, mean lock Sharpe=-0.1320). Consider relaxing this gate.
