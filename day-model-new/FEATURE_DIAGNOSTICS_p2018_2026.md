...
### 300ETF — `single` (Full Model Lockbox IC: -0.1039, Sharpe: +0.0000)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_rank_min__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1074 | +0.0272 | +0.0272 | +0.6075 | 0.50 | 0/8 | 0.74 | 0.45 | `bar_body_rng_0` (0.73) | +0.0026 | +0.0000 |
| `combo_max__bar_ret_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0860 | -0.0832 | -0.0832 | -1.1822 | 0.78 | 1/8 | 0.81 | 0.30 | `volume_surge_direction` (0.70) | +0.0015 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.1032 | -0.1221 | -0.1221 | -1.2067 | 0.59 | 0/8 | 0.76 | 0.40 | `volume_surge_direction` (0.70) | -0.0002 | +0.0000 |
| `combo_tri_mean__star50_limit_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.1034 | +0.0005 | +0.0005 | -0.7605 | 0.57 | 0/8 | 0.64 | 0.34 | `bar_body_rng_0` (0.73) | +0.0049 | +0.0000 |
| `combo_min__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0945 | -0.0625 | -0.0625 | -0.7902 | 0.67 | 0/8 | 0.66 | 0.35 | `bar_body_rng_0` (0.73) | +0.0000 | +0.0000 |
| `combo_rank_max__first_bar_return__volume_surge_direction` | Gap / Overnight Reversal | +1 | +0.0809 | -0.0811 | -0.0811 | -1.1822 | 0.83 | 1/8 | 0.88 | 0.35 | `volume_surge_direction` (0.70) | +0.0013 | +0.0000 |
| `combo_tri_median__smooth_momentum_structure__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0771 | -0.1298 | -0.1298 | -1.8873 | 0.96 | 1/8 | 1.87 | 0.75 | `volume_weighted_price_position` (1.03) | -0.0022 | -0.4261 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0965 | -0.1853 | -0.1853 | -1.0717 | 0.72 | 0/8 | 0.97 | 0.63 | `volume_weighted_price_position` (1.03) | -0.0030 | -0.4261 |
| `combo_mean__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0962 | -0.1215 | -0.1215 | -2.1883 | 0.85 | 1/8 | 0.92 | 0.39 | `volume_weighted_price_position` (1.03) | -0.0004 | -0.4261 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1018 | +0.0449 | +0.0449 | -0.4434 | 0.57 | 0/8 | 0.59 | 0.26 | `bar_body_rng_0` (0.73) | +0.0043 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0918 | -0.0293 | -0.0293 | +0.7925 | 0.44 | 0/8 | 0.70 | 0.44 | `max_up_ret` (0.69) | +0.0021 | +0.0000 |
| `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0941 | -0.2002 | -0.2002 | -3.3600 | 0.76 | 1/8 | 1.09 | 0.46 | `volume_weighted_price_position` (1.03) | -0.0015 | -0.4261 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.1039 | -0.0294 | -0.0294 | -0.6275 | 0.52 | 0/8 | 0.73 | 0.42 | `bar_body_rng_0` (0.73) | +0.0022 | +0.0000 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0942 | -0.1502 | -0.1502 | -2.3921 | 0.80 | 1/8 | 0.85 | 0.42 | `volume_weighted_price_position` (1.03) | -0.0022 | -0.4261 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.0985 | -0.1994 | -0.1994 | -2.8678 | 0.71 | 0/8 | 0.87 | 0.46 | `volume_weighted_price_position` (1.03) | -0.0014 | -0.4261 |
| `combo_mean__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0938 | -0.1168 | -0.1168 | -1.6684 | 0.57 | 0/8 | 0.81 | 0.46 | `volume_surge_direction` (0.70) | +0.0006 | +0.0000 |
| `combo_tri_mean__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.1040 | -0.1573 | -0.1573 | -1.9849 | 0.68 | 0/8 | 0.83 | 0.43 | `volume_weighted_price_position` (1.03) | -0.0008 | -0.4261 |
| `combo_rank_max__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0936 | -0.0889 | -0.0889 | -2.3913 | 0.70 | 1/8 | 0.72 | 0.39 | `bar_body_rng_0` (0.73) | +0.0005 | +0.0000 |
| `combo_rank_max__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0911 | -0.1762 | -0.1762 | -2.3921 | 0.82 | 2/8 | 0.84 | 0.34 | `volume_weighted_price_position` (1.03) | -0.0027 | -0.4261 |
| `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1048 | -0.0297 | -0.0297 | -0.2989 | 0.54 | 0/8 | 0.62 | 0.29 | `opening_drive_thrust_ratio` (0.64) | +0.0020 | +0.3263 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0882 | -0.1964 | -0.1964 | -2.1840 | 0.77 | 0/8 | 1.03 | 0.66 | `volume_weighted_price_position` (1.03) | -0.0017 | -0.4261 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.0963 | +0.0147 | +0.0147 | +0.3204 | 0.59 | 0/8 | 0.76 | 0.44 | `limit_down_proximity_early` (0.90) | +0.0026 | +0.0000 |
| `combo_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0844 | -0.1457 | -0.1457 | -0.8783 | 0.66 | 1/8 | 0.86 | 0.41 | `volume_surge_direction` (0.70) | +0.0002 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0975 | -0.1417 | -0.1417 | -1.6345 | 0.68 | 0/8 | 0.83 | 0.34 | `volume_surge_direction` (0.70) | -0.0001 | +0.0000 |
| `combo_min__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1002 | -0.0924 | -0.0924 | -1.1726 | 0.72 | 0/8 | 0.69 | 0.36 | `bar_body_rng_0` (0.73) | -0.0015 | -0.4261 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1074 | -0.0712 | -0.0712 | -0.5845 | 0.54 | 0/8 | 0.59 | 0.33 | `first_bar_return` (0.68) | +0.0021 | +0.0000 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0944 | -0.2114 | -0.2114 | -3.6368 | 0.71 | 0/8 | 1.02 | 0.76 | `volume_weighted_price_position` (1.03) | -0.0021 | -0.4261 |
| `combo_tri_median__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1125 | -0.0581 | -0.0581 | -2.1391 | 0.58 | 0/8 | 0.81 | 0.35 | `bar_body_rng_0` (0.73) | +0.0013 | +0.0000 |
...
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1095 | -0.0308 | -0.0308 | -0.1479 | 0.58 | 0/8 | 0.62 | 0.31 | `bar_body_rng_0` (0.73) | +0.0019 | +0.0000 |
| `combo_tri_min__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0943 | -0.0631 | -0.0631 | -1.1652 | 0.79 | 1/8 | 0.91 | 0.42 | `volume_weighted_price_position` (1.03) | +0.0000 | +0.0000 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0818 | -0.0648 | -0.0648 | -1.3198 | 0.66 | 0/8 | 0.67 | 0.16 | `first_bar_sentiment` (0.89) | -0.0005 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0977 | -0.0823 | -0.0823 | -0.8469 | 0.61 | 0/8 | 0.74 | 0.42 | `volume_surge_direction` (0.70) | +0.0004 | +0.0000 |
| `combo_rank_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0837 | -0.1503 | -0.1503 | -1.0912 | 0.65 | 0/8 | 0.91 | 0.42 | `volume_surge_direction` (0.70) | +0.0008 | +0.0000 |
| `combo_mean__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.0913 | +0.0709 | +0.0709 | -1.0140 | 0.62 | 0/8 | 0.54 | 0.27 | `limit_down_proximity_early` (0.90) | +0.0048 | +0.0000 |
| `combo_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0911 | -0.1615 | -0.1615 | -2.3451 | 0.67 | 0/8 | 0.72 | 0.59 | `max_up_ret` (0.69) | -0.0014 | +0.0000 |
| `combo_ratio__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0867 | -0.1087 | -0.1087 | -2.7122 | 0.70 | 0/8 | 0.59 | 0.28 | `volume_weighted_price_position` (1.03) | -0.0004 | +0.0000 |
| `combo_tri_min__max_up_ret__bar_ret_0__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0851 | -0.0691 | -0.0691 | -0.9513 | 0.72 | 0/8 | 0.72 | 0.31 | `bar_body_rng_0` (0.73) | +0.0001 | +0.0000 |
| `combo_tri_median__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0931 | -0.1563 | -0.1563 | -1.8076 | 0.75 | 0/8 | 0.79 | 0.41 | `volume_weighted_price_position` (1.03) | -0.0014 | -0.4261 |
| `combo_tri_median__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0941 | -0.1153 | -0.1153 | -1.6739 | 0.79 | 1/8 | 0.73 | 0.33 | `volume_weighted_price_position` (1.03) | +0.0001 | +0.0000 |
| `combo_rank_min__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.1000 | -0.1466 | -0.1466 | -1.4795 | 0.83 | 1/8 | 0.77 | 0.40 | `volume_weighted_price_position` (1.03) | -0.0001 | -0.4261 |
| `combo_tri_max__first_bar_return__bar_body_rng_0__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1065 | -0.1364 | -0.1364 | -2.1155 | 0.63 | 0/8 | 0.73 | 0.44 | `bar_body_rng_0` (0.73) | -0.0010 | -0.4261 |
| `combo_tri_max__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0945 | -0.1967 | -0.1967 | -2.8312 | 0.67 | 0/8 | 1.13 | 0.80 | `volume_weighted_price_position` (1.03) | -0.0012 | -0.4261 |
| `combo_rank_max__volume_weighted_price_position__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0866 | -0.1571 | -0.1571 | -2.4219 | 0.84 | 2/8 | 0.95 | 0.34 | `volume_weighted_price_position` (1.03) | -0.0021 | -0.4261 |
| `combo_rank_max__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0876 | -0.1476 | -0.1476 | -2.5718 | 0.66 | 0/8 | 0.94 | 0.69 | `max_up_ret` (0.69) | -0.0007 | +0.0000 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0937 | -0.1611 | -0.1611 | -1.2733 | 0.63 | 0/8 | 0.75 | 0.60 | `max_up_ret` (0.69) | +0.0000 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0937 | +0.0132 | +0.0132 | +0.8820 | 0.48 | 0/8 | 0.67 | 0.37 | `rbreaker_buy_setup_proximity_early` (0.90) | +0.0020 | +0.0000 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0923 | -0.0504 | -0.0504 | -0.6267 | 0.50 | 0/8 | 0.57 | 0.29 | `max_up_ret` (0.69) | +0.0018 | +0.0000 |
| `combo_tri_median__max_up_ret__bar_body_rng_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0917 | -0.1526 | -0.1526 | -2.5270 | 0.67 | 0/8 | 0.72 | 0.50 | `bar_body_rng_0` (0.73) | +0.0001 | +0.0000 |
| `combo_tri_mean__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1003 | -0.1480 | -0.1480 | -2.8449 | 0.58 | 0/8 | 0.77 | 0.51 | `max_up_ret` (0.69) | -0.0010 | +0.0000 |
| `combo_tri_max__volume_weighted_price_position__bar_body_rng_0__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0986 | -0.1708 | -0.1708 | -1.9174 | 0.73 | 1/8 | 1.00 | 0.58 | `volume_weighted_price_position` (1.03) | -0.0012 | -0.4261 |
| `combo_rank_min__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0795 | -0.0638 | -0.0638 | -0.4085 | 0.68 | 0/8 | 0.60 | 0.28 | `first_bar_sentiment` (0.89) | -0.0005 | +0.0000 |
| `combo_max__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1052 | -0.1306 | -0.1306 | -2.9603 | 0.62 | 0/8 | 0.82 | 0.48 | `bar_body_rng_0` (0.73) | -0.0004 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0974 | -0.0169 | -0.0169 | +0.1548 | 0.51 | 0/8 | 0.56 | 0.26 | `max_up_ret` (0.69) | +0.0029 | +0.3263 |
| `combo_tri_median__volume_weighted_price_position__bar_body_rng_0__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.1054 | -0.1287 | -0.1287 | -2.4666 | 0.72 | 0/8 | 0.83 | 0.36 | `volume_weighted_price_position` (1.03) | -0.0007 | -0.4261 |
| `first_bar_return` | Gap / Overnight Reversal | +1 | +0.0868 | -0.0827 | -0.0827 | +0.0937 | 0.68 | 0/8 | 0.62 | 0.30 | — | +0.0003 | +0.0000 |
| `combo_rank_min__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0880 | -0.0639 | -0.0639 | -2.1335 | 0.64 | 0/8 | 0.63 | 0.31 | `volume_surge_direction` (0.70) | -0.0017 | +0.0000 |
| `combo_tri_min__max_up_ret__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1000 | -0.1148 | -0.1148 | -1.8175 | 0.58 | 0/8 | 0.64 | 0.30 | `max_up_ret` (0.69) | +0.0001 | +0.0000 |
| `combo_sig_product__bar_ret_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0756 | -0.0908 | -0.0908 | -1.5036 | 0.94 | 1/8 | 0.53 | 0.08 | `volume_weighted_price_position` (1.03) | -0.0000 | -0.4261 |
| `combo_mean__volume_weighted_price_position__volume_surge_direction` | Volatility & Oscillators | +1 | +0.1010 | -0.1191 | -0.1191 | -2.6755 | 0.76 | 2/8 | 0.90 | 0.35 | `volume_weighted_price_position` (1.03) | -0.0012 | +0.0000 |
| `combo_min__bar_ret_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0837 | -0.0762 | -0.0762 | -1.6243 | 0.70 | 1/8 | 0.54 | 0.28 | `volume_surge_direction` (0.70) | +0.0007 | +0.0000 |
| `combo_sig_product__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0817 | -0.1002 | -0.1002 | -1.2031 | 0.83 | 1/8 | 0.62 | 0.17 | `volume_weighted_price_position` (1.03) | +0.0006 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1099 | -0.0539 | -0.0539 | -0.7695 | 0.59 | 0/8 | 0.73 | 0.33 | `first_bar_return` (0.68) | +0.0014 | +0.0000 |
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.0982 | -0.1510 | -0.1510 | -2.2099 | 0.64 | 0/8 | 0.76 | 0.40 | — | -0.0001 | -0.4261 |
| `combo_sig_product__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0866 | -0.0828 | -0.0828 | -2.2099 | 0.79 | 0/8 | 0.63 | 0.09 | `bar_body_rng_0` (0.73) | +0.0009 | -0.4261 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0951 | -0.1395 | -0.1395 | -2.7529 | 0.82 | 1/8 | 0.74 | 0.16 | `first_bar_sentiment` (0.89) | +0.0002 | +0.0000 |
| `combo_sig_product__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.1053 | -0.1294 | -0.1294 | -2.7464 | 0.73 | 0/8 | 1.01 | 0.49 | `volume_weighted_price_position` (1.03) | -0.0005 | -0.4261 |
| `combo_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0937 | -0.0121 | -0.0121 | +0.8779 | 0.59 | 0/8 | 0.60 | 0.34 | `rbreaker_buy_setup_proximity_early` (0.90) | +0.0024 | +0.0000 |
| `combo_min__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0889 | -0.0597 | -0.0597 | -2.1258 | 0.59 | 0/8 | 0.67 | 0.39 | `volume_surge_direction` (0.70) | -0.0001 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1035 | -0.0538 | -0.0538 | -1.4245 | 0.53 | 0/8 | 0.62 | 0.34 | `max_up_ret` (0.69) | +0.0025 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1050 | -0.0842 | -0.0842 | -1.0673 | 0.55 | 0/8 | 0.61 | 0.35 | `max_up_ret` (0.69) | +0.0001 | +0.0000 |
| `combo_rank_min__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0802 | -0.0956 | -0.0956 | -1.2359 | 0.72 | 0/8 | 0.58 | 0.21 | `max_up_ret` (0.69) | +0.0008 | +0.0000 |
| `combo_tri_max__max_up_ret__bar_body_rng_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1043 | -0.1421 | -0.1421 | -2.4325 | 0.62 | 0/8 | 0.89 | 0.70 | `bar_body_rng_0` (0.73) | -0.0006 | +0.0000 |
| `combo_tri_mean__bar_ret_0__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1024 | -0.1078 | -0.1078 | -2.1999 | 0.63 | 0/8 | 0.72 | 0.39 | `bar_body_rng_0` (0.73) | -0.0009 | +0.0000 |
| `combo_tri_min__first_bar_return__volume_weighted_price_position__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.1005 | -0.1081 | -0.1081 | -0.5121 | 0.69 | 1/8 | 0.79 | 0.43 | `volume_weighted_price_position` (1.03) | +0.0002 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0958 | -0.0023 | -0.0023 | +0.4698 | 0.56 | 0/8 | 0.63 | 0.27 | `rbreaker_buy_setup_proximity_early` (0.90) | +0.0024 | +0.0000 |
| `combo_sig_product__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0904 | +0.0628 | +0.0628 | -1.0546 | 0.57 | 1/8 | 0.72 | 0.29 | `opening_drive_thrust_ratio` (0.64) | +0.0018 | -0.1204 |
| `combo_min__volume_weighted_price_position__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0983 | -0.0557 | -0.0557 | -2.7098 | 0.83 | 2/8 | 0.89 | 0.34 | `volume_weighted_price_position` (1.03) | -0.0003 | +0.0000 |
| `combo_tri_median__smooth_momentum_structure__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0713 | -0.1823 | -0.1823 | -2.6806 | 0.97 | 1/8 | 1.22 | 0.64 | `volume_weighted_price_position` (1.03) | -0.0024 | -0.4261 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__first_bar_return__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.0866 | -0.0127 | -0.0127 | -1.1004 | 0.68 | 0/8 | 0.76 | 0.40 | `first_bar_return` (0.68) | +0.0016 | +0.0000 |
| `morning_volume_weighted_momentum` | Intraday Range Momentum | +1 | +0.0747 | -0.1752 | -0.1752 | -2.4148 | 0.61 | 0/8 | 1.26 | 1.85 | — | -0.0016 | -0.4261 |
| `combo_max__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0874 | -0.0930 | -0.0930 | -0.7198 | 0.74 | 1/8 | 0.57 | 0.23 | `first_bar_sentiment` (0.89) | +0.0005 | +0.0000 |
| `volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0854 | -0.1599 | -0.1599 | -1.5036 | 1.03 | 2/8 | 1.17 | 0.38 | — | -0.0014 | -0.4261 |
| `combo_max__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0852 | +0.0035 | +0.0035 | -0.5291 | 0.49 | 0/8 | 0.94 | 0.50 | `opening_drive_thrust_ratio` (0.64) | +0.0005 | +0.0000 |
| `combo_ratio__max_up_ret__bar_vol_0` | Intraday Range Momentum | +1 | +0.0832 | -0.1432 | -0.1432 | -2.6027 | 0.76 | 0/8 | 0.62 | 0.47 | `bar_vol_0` (2.33) | -0.0013 | +0.0000 |
...
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0707 | -0.2024 | -0.2024 | -2.3152 | 0.78 | 2/8 | 1.30 | 0.58 | — | -0.0000 | -0.4261 |
| `combo_min__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0804 | -0.0691 | -0.0691 | -1.5273 | 0.66 | 0/8 | 0.56 | 0.27 | `first_bar_sentiment` (0.89) | -0.0001 | +0.0000 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0819 | -0.0199 | -0.0199 | -1.3557 | 0.58 | 0/8 | 0.86 | 0.56 | `max_up_ret` (0.69) | +0.0004 | +0.0000 |
| `combo_tri_max__star50_limit_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0809 | +0.0844 | +0.0844 | -0.8307 | 0.75 | 0/8 | 0.60 | 0.29 | `bar_body_rng_0` (0.73) | +0.0028 | +0.0000 |
| `always_in_trend_persistence` | Volatility & Oscillators | +1 | +0.0613 | -0.2597 | -0.2597 | -3.4587 | 0.85 | 2/8 | 1.28 | 0.47 | — | -0.0015 | -0.4261 |
| `combo_sig_product__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0756 | -0.0580 | -0.0580 | -1.2501 | 0.68 | 1/8 | 0.79 | 0.32 | `bar_body_rng_0` (0.73) | +0.0002 | +0.0000 |
...
| `combo_sig_product__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0713 | -0.0717 | -0.0717 | -0.5279 | 0.99 | 1/8 | 0.40 | 0.14 | `max_up_ret` (0.69) | -0.0005 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0664 | -0.0969 | -0.0969 | -0.5930 | 0.57 | 0/8 | 1.10 | 0.60 | `volume_surge_direction` (0.70) | +0.0020 | +0.0000 |
| `combo_ratio__bar_ret_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0771 | -0.0934 | -0.0934 | -2.7239 | 0.76 | 1/8 | 0.61 | 0.27 | `volume_surge_direction` (0.70) | +0.0000 | +0.0000 |
| `combo_tri_mean__volume_weighted_momentum_acceleration__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0732 | -0.1947 | -0.1947 | -2.7376 | 0.46 | 0/8 | 1.10 | 1.04 | `volume_weighted_momentum_acceleration` (0.73) | +0.0001 | +0.0000 |
| `net_volume_flow` | Volatility & Oscillators | +1 | +0.0774 | -0.1763 | -0.1763 | -3.3539 | 0.62 | 0/8 | 1.09 | 0.89 | — | +0.0004 | -0.4261 |
...
_Null Baseline (un-gated candidate pool): 29.0% lock IC > 0, 14.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -1.0241_
...
| B4 Correlation Gate | 230 | 30 | 20.0% | 6.7% | -0.0451 | -0.6306 |

**Admitted Pool Summary**: 99 features, False Positive Rate = 98.0% (admitted but negative lock IC/Sharpe), Mean Lock IC = -0.0976, Mean Lock Sharpe = -1.5596
...
| `combo_tri_mean__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | +0.1146 | +0.0000 | -0.1573 | -1.37x | 2017-07-10 |
...
| `combo_max__max_up_ret__first_bar_return` | +0.0979 | +0.0000 | -0.1615 | -1.65x | 2014-07-04 |
...
| `combo_tri_median__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | +0.1084 | +0.0000 | -0.1563 | -1.44x | 2015-03-16 |
...
| `combo_tri_max__first_bar_return__bar_body_rng_0__opening_drive_thrust_ratio` | +0.1082 | +0.0000 | -0.1364 | -1.26x | 2015-02-06 |
...
| `combo_tri_mean__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | +0.1121 | +0.0000 | -0.1480 | -1.32x | 2017-06-09 |
...
| `combo_max__bar_body_rng_0__opening_drive_thrust_ratio` | +0.1096 | +0.0000 | -0.1306 | -1.19x | 2015-02-06 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | +0.1061 | +0.0000 | -0.0169 | -0.16x | 2017-05-09 |
| `combo_tri_median__volume_weighted_price_position__bar_body_rng_0__opening_drive_thrust_ratio` | +0.1115 | +0.0000 | -0.1287 | -1.15x | 2015-02-06 |
...
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | +0.1126 | +0.0000 | -0.0538 | -0.48x | 2015-02-06 |
...
| `combo_tri_max__max_up_ret__bar_body_rng_0__opening_drive_thrust_ratio` | +0.1104 | +0.0000 | -0.1421 | -1.29x | 2015-01-08 |
| `combo_tri_mean__bar_ret_0__bar_body_rng_0__opening_drive_thrust_ratio` | +0.1065 | +0.0000 | -0.1078 | -1.01x | 2015-02-06 |
...
| `combo_ratio__bar_ret_0__volume_surge_direction` | +0.0792 | +0.0000 | -0.0934 | -1.18x | 2010-10-15 |
