...
### 300ETF — `single` (Full Model Lockbox IC: +0.0258, Sharpe: -0.0904)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1068 | +0.0383 | +0.0383 | -0.0697 | 0.79 | 1/8 | 0.86 | 3.04 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0004 | +0.1662 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1019 | +0.0460 | +0.0460 | +0.1064 | 0.73 | 1/8 | 0.85 | 4.68 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0004 | +0.1662 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1023 | +0.0245 | +0.0245 | +0.1045 | 0.83 | 1/8 | 0.98 | 4.08 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0003 | +0.1662 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0989 | +0.0057 | +0.0057 | -0.2202 | 0.85 | 1/8 | 1.03 | 3.29 | `volume_weighted_price_position` (1.11) | -0.0005 | -0.0120 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0915 | -0.0023 | -0.0023 | -0.5759 | 0.82 | 0/8 | 1.74 | 3.10 | `volume_weighted_price_position` (1.11) | -0.0006 | -0.0900 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1022 | +0.0351 | +0.0351 | +0.1736 | 0.87 | 1/8 | 1.13 | -40.14 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0001 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1045 | +0.0512 | +0.0512 | +0.6322 | 0.77 | 1/8 | 0.86 | 5.39 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0000 | +0.0000 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1013 | +0.0094 | +0.0094 | +0.1080 | 0.78 | 1/8 | 0.82 | 1.96 | `volume_weighted_price_position` (1.11) | -0.0009 | +0.0147 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0924 | +0.0084 | +0.0084 | -0.0883 | 0.71 | 1/8 | 0.87 | 1.96 | `max_up_ret` (0.89) | -0.0008 | -0.0405 |
| `combo_mean__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0886 | +0.0067 | +0.0067 | -0.2911 | 0.83 | 1/8 | 1.37 | 3.88 | `max_up_ret` (0.89) | -0.0001 | -0.0615 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0939 | -0.0018 | -0.0018 | +0.1999 | 0.85 | 0/8 | 1.48 | 4.09 | `volume_weighted_price_position` (1.11) | -0.0008 | -0.0053 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0952 | +0.0270 | +0.0270 | +0.5172 | 0.78 | 1/8 | 1.27 | 5.19 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0002 | +0.1662 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1098 | +0.0362 | +0.0362 | +0.3660 | 0.56 | 0/8 | 0.77 | 1.61 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.1662 |
| `combo_tri_max__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0980 | +0.0083 | +0.0083 | -0.1271 | 0.77 | 1/8 | 1.51 | 3.34 | `max_up_ret` (0.89) | -0.0001 | -0.0662 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1008 | +0.0254 | +0.0254 | +0.4883 | 0.81 | 1/8 | 1.11 | 5.15 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | -0.0214 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1001 | +0.0183 | +0.0183 | -0.0646 | 0.69 | 0/8 | 0.96 | 1.64 | `max_up_ret` (0.89) | -0.0002 | -0.0662 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0998 | +0.0045 | +0.0045 | -0.5240 | 0.71 | 1/8 | 0.94 | 1.74 | `volume_weighted_price_position` (1.11) | -0.0010 | -0.0662 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0926 | +0.0134 | +0.0134 | +0.2457 | 0.66 | 0/8 | 1.20 | 1.53 | `max_up_ret` (0.89) | -0.0002 | +0.0047 |
| `combo_rank_min__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0995 | +0.0222 | +0.0222 | -0.2736 | 0.80 | 1/8 | 0.83 | 1.99 | `opening_drive_thrust_ratio` (0.83) | -0.0001 | +0.0119 |
| `combo_tri_max__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0876 | +0.0013 | +0.0013 | -0.3332 | 0.89 | 1/8 | 1.95 | 6.25 | `volume_weighted_price_position` (1.11) | -0.0002 | -0.0709 |
| `combo_min__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0955 | +0.0125 | +0.0125 | -0.4568 | 0.90 | 1/8 | 1.06 | 3.88 | `volume_weighted_price_position` (1.11) | -0.0008 | -0.0053 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0899 | +0.0334 | +0.0334 | +0.9753 | 0.74 | 1/8 | 1.18 | 3.01 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0007 | +0.1662 |
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1085 | +0.0362 | +0.0362 | +0.6343 | 0.68 | 1/8 | 0.87 | 2.26 | `star50_limit_proximity_early` (1.24) | +0.0001 | +0.1662 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0828 | -0.0138 | -0.0138 | -0.3231 | 0.92 | 0/8 | 1.93 | 5.15 | `volume_weighted_price_position` (1.11) | -0.0008 | +0.0047 |
| `combo_rank_max__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0962 | +0.0069 | +0.0069 | -0.3876 | 0.76 | 1/8 | 0.92 | 1.72 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0166 |
| `combo_sig_product__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0991 | +0.0304 | +0.0304 | -0.1439 | 0.68 | 1/8 | 0.73 | 1.22 | `bar_body_rng_0` (0.68) | -0.0001 | +0.0119 |
| `combo_tri_max__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0992 | -0.0121 | -0.0121 | -0.4620 | 0.80 | 1/8 | 1.40 | 4.38 | `volume_weighted_price_position` (1.11) | -0.0007 | +0.0047 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0882 | +0.0655 | +0.0655 | +0.9697 | 0.82 | 1/8 | 0.80 | 8.68 | `rbreaker_buy_setup_proximity_early` (2.08) | +0.0004 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1010 | +0.0317 | +0.0317 | +0.5329 | 0.80 | 1/8 | 1.12 | 5.24 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0000 | +0.1662 |
| `combo_mean__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0898 | +0.0161 | +0.0161 | +0.3850 | 0.75 | 1/8 | 1.04 | 4.63 | `volume_surge_direction` (0.95) | +0.0003 | -0.0081 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1095 | +0.0329 | +0.0329 | +0.3820 | 0.63 | 1/8 | 0.94 | 1.81 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0000 | +0.1662 |
| `combo_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0764 | +0.0092 | +0.0092 | +0.3974 | 0.98 | 2/8 | 1.02 | 175.30 | `volume_surge_direction` (0.95) | -0.0000 | -0.0662 |
| `combo_mean__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.1007 | +0.0123 | +0.0123 | -0.4689 | 0.80 | 1/8 | 0.86 | 2.06 | `volume_weighted_price_position` (1.11) | -0.0008 | +0.0489 |
| `combo_tri_median__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0953 | +0.0012 | +0.0012 | +0.0941 | 0.87 | 2/8 | 1.05 | 3.58 | `volume_weighted_price_position` (1.11) | -0.0007 | -0.0735 |
| `combo_rank_max__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0901 | +0.0189 | +0.0189 | +0.5330 | 0.74 | 1/8 | 0.52 | 1.64 | `volume_surge_direction` (0.95) | +0.0001 | +0.0000 |
| `combo_tri_mean__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.1034 | +0.0071 | +0.0071 | +0.2288 | 0.75 | 0/8 | 1.01 | 2.79 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0020 |
| `combo_tri_median__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1102 | +0.0337 | +0.0337 | +0.2687 | 0.74 | 1/8 | 0.87 | 3.16 | `star50_limit_proximity_early` (1.24) | +0.0002 | +0.0119 |
| `combo_sig_product__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0849 | +0.0427 | +0.0427 | -0.6213 | 0.77 | 1/8 | 1.27 | -59.25 | `star50_limit_proximity_early` (1.24) | +0.0004 | +0.1978 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1013 | +0.0215 | +0.0215 | +0.5132 | 0.84 | 1/8 | 0.97 | 5.06 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0003 | +0.0987 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0972 | +0.0166 | +0.0166 | +0.1134 | 0.63 | 0/8 | 0.65 | 1.27 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0002 | +0.1704 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0808 | +0.0306 | +0.0306 | -0.3020 | 0.63 | 1/8 | 1.41 | 1.24 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0005 | +0.0018 |
...
| `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0915 | -0.0131 | -0.0131 | -0.5701 | 0.90 | 2/8 | 1.54 | 6.91 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0047 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0841 | +0.0193 | +0.0193 | +0.2919 | 0.85 | 1/8 | 1.27 | 7.30 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0166 |
| `combo_rank_min__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0931 | +0.0256 | +0.0256 | +0.0903 | 0.82 | 1/8 | 0.89 | 6.19 | `volume_surge_direction` (0.95) | -0.0004 | -0.0081 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.0773 | -0.0047 | -0.0047 | +0.3486 | 0.89 | 1/8 | 1.65 | 3.65 | — | -0.0001 | -0.0662 |
| `combo_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0955 | +0.0000 | +0.0000 | +0.3515 | 0.76 | 0/8 | 1.14 | 2.94 | `max_up_ret` (0.89) | -0.0004 | -0.0662 |
...
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1045 | -0.0166 | -0.0166 | -0.3738 | 0.79 | 1/8 | 1.03 | 3.12 | `opening_drive_thrust_ratio` (0.83) | -0.0005 | +0.0000 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.0881 | +0.0572 | +0.0572 | +0.6639 | 0.86 | 1/8 | 0.74 | 7.30 | `limit_down_proximity_early` (2.08) | +0.0009 | +0.1662 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.0937 | +0.0512 | +0.0512 | +0.0639 | 0.68 | 0/8 | 0.85 | 0.89 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0006 | +0.0939 |
| `combo_ratio__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0938 | -0.0066 | -0.0066 | -0.7138 | 0.78 | 1/8 | 1.16 | 3.44 | `volume_weighted_price_position` (1.11) | -0.0006 | +0.0047 |
| `combo_mean__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1013 | +0.0496 | +0.0496 | +0.5363 | 0.59 | 1/8 | 0.75 | 1.63 | `star50_limit_proximity_early` (1.24) | +0.0003 | +0.1662 |
| `combo_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0918 | +0.0267 | +0.0267 | +0.3866 | 0.72 | 0/8 | 1.19 | 1.77 | `early_vwap_acceleration` (1.02) | -0.0000 | +0.0166 |
| `combo_mean__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1022 | +0.0022 | +0.0022 | -0.4646 | 0.78 | 1/8 | 0.95 | 2.88 | `opening_drive_thrust_ratio` (0.83) | -0.0005 | +0.0000 |
| `combo_tri_min__star50_limit_proximity_early__bar_ret_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0925 | +0.0377 | +0.0377 | +0.6416 | 0.82 | 1/8 | 0.81 | 7.29 | `star50_limit_proximity_early` (1.24) | +0.0008 | -0.1117 |
| `combo_tri_min__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0967 | +0.0081 | +0.0081 | +0.0717 | 0.74 | 1/8 | 0.87 | 3.14 | `max_up_ret` (0.89) | -0.0000 | -0.1117 |
| `combo_tri_median__smooth_momentum_structure__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0714 | -0.0006 | -0.0006 | -0.4264 | 0.88 | 1/8 | 2.09 | 6.50 | `max_up_ret` (0.89) | -0.0002 | +0.0166 |
| `combo_sig_product__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0892 | -0.0116 | -0.0116 | -0.6265 | 0.80 | 1/8 | 0.66 | 1.83 | `volume_weighted_price_position` (1.11) | -0.0006 | -0.0381 |
| `combo_rank_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.0856 | +0.0449 | +0.0449 | +0.4220 | 0.97 | 1/8 | 1.04 | -6.10 | `limit_down_proximity_early` (2.08) | +0.0002 | +0.0000 |
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0652 | -0.0189 | -0.0189 | -0.4041 | 1.12 | 2/8 | 2.03 | 31.17 | — | -0.0006 | +0.0747 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0727 | +0.0225 | +0.0225 | +0.1191 | 0.90 | 1/8 | 1.82 | 8.85 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | +0.0431 |
| `combo_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0719 | +0.0288 | +0.0288 | -0.2338 | 0.74 | 1/8 | 1.21 | 1.24 | `bar_vol_0` (2.19) | +0.0006 | +0.2254 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0609 | +0.0374 | +0.0374 | -0.6001 | 0.87 | 2/8 | 2.34 | -4.74 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | +0.1978 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0791 | +0.0285 | +0.0285 | -0.0878 | 0.83 | 1/8 | 1.94 | 3.50 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0005 | +0.0265 |
| `combo_rank_max__volume_weighted_price_position__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0976 | -0.0229 | -0.0229 | -1.8533 | 0.75 | 1/8 | 0.78 | 2.33 | `volume_weighted_price_position` (1.11) | -0.0007 | +0.0000 |
| `combo_tri_mean__smooth_momentum_structure__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0523 | +0.0203 | +0.0203 | +0.1467 | 0.65 | 1/8 | 0.64 | 1.19 | `smooth_momentum_structure` (0.77) | -0.0004 | -0.1117 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0681 | +0.0530 | +0.0530 | +0.6589 | 0.82 | 2/8 | 0.96 | 1.47 | `bar_vol_0` (2.19) | +0.0003 | +0.2254 |
| `combo_rel_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0854 | +0.0225 | +0.0225 | -0.2686 | 0.82 | 0/8 | 1.14 | 2.01 | `early_vwap_acceleration` (1.02) | +0.0002 | +0.0047 |
...
| `always_in_trend_persistence` | Volatility & Oscillators | +1 | +0.0640 | -0.0421 | -0.0421 | -0.1859 | 0.92 | 2/8 | 1.78 | 4.11 | — | -0.0007 | -0.0081 |
| `combo_ratio__first_bar_sentiment__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0817 | -0.0364 | -0.0364 | -1.1617 | 0.73 | 1/8 | 0.68 | 1.70 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0581 |
| `combo_min__volume_weighted_price_position__double_bottom_bull_flag_early` | Volatility & Oscillators | +1 | +0.0405 | -0.0158 | -0.0158 | -1.0471 | 0.88 | 1/8 | 0.77 | 20.36 | `volume_weighted_price_position` (1.11) | -0.0008 | +0.0581 |
| `net_volume_flow` | Volatility & Oscillators | +1 | +0.0673 | -0.0024 | -0.0024 | -0.6933 | 1.09 | 1/8 | 2.00 | 6.74 | — | -0.0002 | +0.0747 |
| `combo_rank_min__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0912 | +0.0112 | +0.0112 | +0.1352 | 0.55 | 0/8 | 0.73 | 1.05 | `first_bar_sentiment` (0.69) | -0.0002 | +0.0000 |
| `first_30min_return` | Intraday Range Momentum | +1 | +0.0560 | +0.0077 | +0.0077 | +0.0592 | 1.38 | 1/8 | 5.90 | -3.05 | — | +0.0001 | +0.0581 |

### 500ETF — `single` (Full Model Lockbox IC: +0.1090, Sharpe: +0.7813)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1297 | +0.1084 | +0.1084 | +1.0418 | 0.28 | 0/8 | 0.88 | 0.58 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0003 | +0.0415 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1412 | +0.1193 | +0.1193 | +0.5966 | 0.44 | 0/8 | 0.66 | 0.32 | `opening_drive_thrust_ratio` (0.40) | +0.0006 | +0.0467 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1304 | +0.0995 | +0.0995 | +0.1554 | 0.37 | 0/8 | 0.71 | 0.63 | `opening_drive_thrust_ratio` (0.40) | -0.0001 | +0.0119 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1302 | +0.0955 | +0.0955 | +0.5066 | 0.36 | 0/8 | 0.80 | 0.67 | `trend_bar_close_consistency` (0.66) | -0.0002 | +0.0095 |
| `combo_clamp_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1385 | +0.0855 | +0.0855 | +0.8416 | 0.33 | 0/8 | 0.72 | 0.58 | `body_size_progression` (0.60) | +0.0001 | -0.0099 |
| `combo_rel_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1349 | +0.0747 | +0.0747 | +0.0706 | 0.35 | 0/8 | 0.70 | 0.51 | `body_size_progression` (0.60) | +0.0001 | -0.0099 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1289 | +0.1105 | +0.1105 | +0.9584 | 0.40 | 0/8 | 0.73 | 0.48 | `volatility_expansion_trend_vector` (0.41) | +0.0003 | +0.0467 |
| `combo_rank_min__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1202 | +0.0742 | +0.0742 | +0.1097 | 0.42 | 0/8 | 0.52 | 0.42 | `bar_ret_0` (0.46) | -0.0001 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1367 | +0.0949 | +0.0949 | +0.4145 | 0.34 | 0/8 | 0.77 | 0.59 | `opening_drive_thrust_ratio` (0.40) | +0.0000 | +0.0104 |
...
| `combo_diff__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1351 | +0.0991 | +0.0991 | +0.4835 | 0.42 | 0/8 | 0.68 | 0.75 | `volume_weighted_momentum_acceleration` (0.62) | -0.0001 | +0.0119 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1336 | +0.1052 | +0.1052 | +0.4780 | 0.31 | 0/8 | 0.75 | 0.62 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0000 | +0.1451 |
| `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1433 | +0.0858 | +0.0858 | +0.9255 | 0.42 | 0/8 | 0.77 | 0.67 | `volume_weighted_momentum_acceleration` (0.62) | +0.0001 | +0.0119 |
| `combo_mean__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1176 | +0.1023 | +0.1023 | +0.7538 | 0.29 | 0/8 | 0.79 | 0.71 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0001 | +0.0095 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1162 | +0.1125 | +0.1125 | +1.2249 | 0.34 | 0/8 | 0.78 | 0.58 | `volatility_expansion_trend_vector` (0.41) | +0.0003 | +0.0443 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1343 | +0.1127 | +0.1127 | +0.8107 | 0.39 | 0/8 | 0.69 | 0.51 | `star50_limit_proximity_early` (0.55) | -0.0000 | +0.0119 |
| `combo_clamp_diff__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1327 | +0.0902 | +0.0902 | +0.1578 | 0.45 | 0/8 | 0.69 | 0.64 | `body_size_progression` (0.60) | +0.0002 | -0.0099 |
...
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0586 | +0.0586 | -0.0789 | 0.35 | 0/8 | 0.74 | 0.67 | `bar_ret_0` (0.46) | -0.0005 | +0.0000 |
...
| `combo_mean__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1232 | +0.0841 | +0.0841 | +0.5556 | 0.32 | 0/8 | 0.86 | 0.70 | `volatility_expansion_trend_vector` (0.41) | -0.0002 | +0.0095 |
...
| `combo_tri_median__opening_drive_thrust_ratio__smooth_momentum_structure__net_volume_flow` | Intraday Range Momentum | +1 | +0.1034 | +0.0929 | +0.0929 | +0.7066 | 0.23 | 0/8 | 0.84 | 0.89 | `smooth_momentum_structure` (0.62) | -0.0003 | +0.0119 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__trend_day_regime_conviction` | Other Technical | +1 | +0.1367 | +0.1157 | +0.1157 | +0.6030 | 0.33 | 0/8 | 0.78 | 0.68 | `trend_day_regime_conviction` (0.46) | +0.0002 | +0.0095 |
| `combo_rank_min__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1016 | +0.1246 | +0.1246 | +1.3362 | 0.49 | 0/8 | 0.75 | 0.48 | `star50_limit_proximity_early` (0.55) | +0.0002 | +0.0443 |
| `combo_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0954 | +0.0868 | +0.0868 | +0.2383 | 0.35 | 0/8 | 0.72 | 0.69 | `close_vs_open_range` (0.42) | -0.0001 | +0.0067 |
| `combo_rel_diff__max_up_ret__early_late_momentum_divergence` | Intraday Range Momentum | +1 | +0.1220 | +0.0684 | +0.0684 | -0.4386 | 0.38 | 0/8 | 0.63 | 0.40 | `early_late_momentum_divergence` (0.60) | +0.0002 | +0.0104 |
...
| `combo_tri_mean__star50_limit_proximity_early__trend_bar_close_consistency__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1003 | +0.0969 | +0.0969 | +0.9615 | 0.42 | 0/8 | 0.68 | 0.56 | `trend_bar_close_consistency` (0.66) | -0.0000 | +0.0095 |
| `combo_max__early_body_momentum__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1192 | +0.0580 | +0.0580 | -0.3703 | 0.38 | 0/8 | 0.74 | 0.69 | `first_bar_return` (0.46) | -0.0006 | +0.0000 |
...
| `combo_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1187 | +0.0735 | +0.0735 | +0.4772 | 0.39 | 0/8 | 0.80 | 0.83 | `early_body_momentum` (0.37) | -0.0004 | +0.0000 |
...
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1215 | +0.0918 | +0.0918 | +0.3712 | 0.32 | 0/8 | 0.87 | 0.77 | `trend_day_regime_conviction` (0.46) | -0.0000 | +0.0067 |
| `combo_sig_product__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1192 | +0.0774 | +0.0774 | +0.4480 | 0.44 | 0/8 | 0.75 | 0.70 | `opening_drive_thrust_ratio` (0.40) | -0.0002 | +0.0067 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1326 | +0.0856 | +0.0856 | +0.0926 | 0.30 | 0/8 | 0.78 | 0.62 | `first_bar_return` (0.46) | -0.0004 | +0.0000 |
| `combo_sig_product__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1096 | +0.0933 | +0.0933 | +0.5076 | 0.31 | 0/8 | 0.79 | 0.69 | `net_volume_flow` (0.31) | -0.0001 | +0.0067 |
| `combo_rank_min__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1012 | +0.0931 | +0.0931 | +0.2815 | 0.50 | 0/8 | 0.45 | 0.43 | `bar_ret_0` (0.46) | +0.0002 | +0.0147 |
| `combo_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1289 | +0.0905 | +0.0905 | +0.2004 | 0.50 | 0/8 | 0.50 | 0.41 | `bar_ret_0` (0.46) | +0.0001 | +0.0119 |
| `combo_mean__opening_drive_thrust_ratio__early_body_momentum` | Intraday Range Momentum | +1 | +0.1212 | +0.0857 | +0.0857 | -0.2639 | 0.32 | 0/8 | 0.86 | 0.77 | `opening_drive_thrust_ratio` (0.40) | -0.0002 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1242 | +0.0939 | +0.0939 | +0.9969 | 0.45 | 0/8 | 0.51 | 0.39 | `bar_ret_0` (0.46) | -0.0001 | +0.0467 |
| `combo_max__net_volume_flow__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1073 | +0.0803 | +0.0803 | +0.5993 | 0.36 | 0/8 | 0.70 | 0.67 | `first_bar_sentiment` (0.43) | -0.0004 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1223 | +0.0927 | +0.0927 | +0.9538 | 0.47 | 0/8 | 0.50 | 0.40 | `first_bar_return` (0.46) | +0.0005 | +0.0467 |
| `combo_mean__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1198 | +0.0871 | +0.0871 | +0.0841 | 0.36 | 0/8 | 0.64 | 0.63 | `first_bar_return` (0.46) | -0.0001 | +0.0119 |
| `combo_min__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1045 | +0.0967 | +0.0967 | +0.4715 | 0.38 | 0/8 | 0.62 | 0.64 | `first_bar_return` (0.46) | +0.0002 | +0.0214 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1321 | +0.0880 | +0.0880 | -0.3280 | 0.33 | 0/8 | 0.72 | 0.61 | `first_bar_sentiment` (0.43) | -0.0003 | +0.0119 |
...
| `combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1250 | +0.1253 | +0.1253 | +0.6575 | 0.51 | 0/8 | 0.67 | 0.36 | `star50_limit_proximity_early` (0.55) | +0.0007 | +0.0467 |
| `combo_rank_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1237 | +0.0836 | +0.0836 | -0.0273 | 0.52 | 0/8 | 0.46 | 0.40 | `bar_ret_0` (0.46) | -0.0003 | +0.0119 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1107 | +0.1075 | +0.1075 | +1.0068 | 0.37 | 0/8 | 0.81 | 0.51 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0000 | +0.0095 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1389 | +0.0890 | +0.0890 | +0.2357 | 0.36 | 0/8 | 0.79 | 0.57 | `opening_drive_thrust_ratio` (0.40) | -0.0002 | +0.0000 |
| `combo_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1344 | +0.0749 | +0.0749 | +0.0494 | 0.33 | 0/8 | 0.82 | 0.66 | `first_bar_return` (0.46) | -0.0003 | +0.0348 |
| `combo_min__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1123 | +0.0885 | +0.0885 | +0.1705 | 0.27 | 0/8 | 1.04 | 0.85 | `volatility_expansion_trend_vector` (0.41) | -0.0001 | +0.0095 |
| `combo_min__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1164 | +0.0946 | +0.0946 | +0.0682 | 0.39 | 0/8 | 0.78 | 0.63 | `close_vs_open_range` (0.42) | +0.0002 | +0.0119 |
...
| `combo_rank_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1349 | +0.0752 | +0.0752 | +0.1487 | 0.31 | 0/8 | 0.81 | 0.66 | `first_bar_return` (0.46) | -0.0003 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1252 | +0.0607 | +0.0607 | +0.2343 | 0.39 | 0/8 | 0.84 | 0.79 | `volatility_expansion_trend_vector` (0.41) | -0.0000 | +0.0095 |
...
| `combo_mean__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1006 | +0.1182 | +0.1182 | +0.6219 | 0.42 | 0/8 | 0.68 | 0.48 | `star50_limit_proximity_early` (0.55) | +0.0003 | +0.0095 |
...
| `combo_sig_product__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1077 | +0.0778 | +0.0778 | +0.0854 | 0.31 | 0/8 | 0.89 | 0.80 | `close_vs_open_range` (0.42) | -0.0001 | +0.0095 |
| `combo_mean__close_vs_open_range__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1092 | +0.0916 | +0.0916 | +0.1735 | 0.30 | 0/8 | 0.73 | 0.62 | `first_bar_sentiment` (0.43) | -0.0000 | +0.0000 |
| `combo_mean__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1215 | +0.0927 | +0.0927 | +0.2533 | 0.38 | 0/8 | 0.66 | 0.56 | `first_bar_return` (0.46) | -0.0000 | +0.0119 |
...
| `combo_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1234 | +0.0811 | +0.0811 | +0.2357 | 0.45 | 0/8 | 0.77 | 0.69 | `first_bar_sentiment` (0.43) | -0.0002 | +0.0000 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1106 | +0.0943 | +0.0943 | +0.6580 | 0.36 | 0/8 | 0.75 | 1.01 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0000 | +0.0095 |
| `combo_sig_product__opening_drive_thrust_ratio__trend_bar_close_consistency` | Other Technical | +1 | +0.1188 | +0.0579 | +0.0579 | +0.2946 | 0.44 | 0/8 | 0.92 | 0.68 | `trend_bar_close_consistency` (0.66) | -0.0005 | +0.0095 |
...
| `combo_clamp_diff__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1330 | +0.0898 | +0.0898 | +1.0714 | 0.42 | 0/8 | 0.85 | 0.75 | `smooth_momentum_structure` (0.62) | -0.0001 | +0.0119 |
...
| `combo_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1035 | +0.0891 | +0.0891 | +0.9407 | 0.38 | 0/8 | 0.74 | 0.94 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0004 | +0.1422 |
...
| `combo_mean__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1062 | +0.0775 | +0.0775 | +0.0450 | 0.29 | 0/8 | 0.78 | 0.83 | `first_bar_sentiment` (0.43) | -0.0001 | +0.0095 |
...
| `combo_rank_max__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1454 | +0.0885 | +0.0885 | +0.2644 | 0.35 | 0/8 | 0.74 | 0.61 | `bar_ret_0` (0.46) | -0.0004 | +0.0119 |
| `combo_rank_min__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1078 | +0.0961 | +0.0961 | +0.2697 | 0.49 | 0/8 | 0.68 | 0.51 | `max_down_ret` (0.62) | -0.0001 | +0.0119 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1286 | +0.0668 | +0.0668 | -0.1367 | 0.40 | 0/8 | 1.05 | 0.86 | `opening_drive_thrust_ratio` (0.40) | -0.0002 | -0.0015 |
| `combo_sig_product__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1164 | +0.0679 | +0.0679 | +0.2803 | 0.45 | 0/8 | 0.47 | 0.47 | `bar_ret_0` (0.46) | -0.0001 | +0.0104 |
| `combo_mean__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1165 | +0.0686 | +0.0686 | +0.2803 | 0.46 | 0/8 | 0.47 | 0.47 | `bar_ret_0` (0.46) | -0.0002 | +0.0119 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1124 | +0.0730 | +0.0730 | +0.1410 | 0.48 | 0/8 | 0.85 | 0.90 | `trend_bar_close_consistency` (0.66) | -0.0003 | +0.0000 |
| `combo_sig_product__close_vs_open_range__early_body_momentum` | Intraday Range Momentum | +1 | +0.0876 | +0.0706 | +0.0706 | -0.2198 | 0.37 | 0/8 | 0.86 | 0.82 | `close_vs_open_range` (0.42) | -0.0004 | +0.0095 |
| `combo_min__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1109 | +0.0739 | +0.0739 | -0.4096 | 0.25 | 0/8 | 1.11 | 0.97 | `early_body_momentum` (0.37) | -0.0006 | +0.0095 |
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.1384 | +0.0962 | +0.0962 | +0.5296 | 0.40 | 0/8 | 0.76 | 0.57 | — | -0.0000 | +0.0119 |
| `combo_mean__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1344 | +0.0919 | +0.0919 | +0.5194 | 0.35 | 0/8 | 0.68 | 0.59 | `first_bar_sentiment` (0.43) | -0.0001 | +0.0119 |
| `combo_sig_product__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1237 | +0.0540 | +0.0540 | -0.2136 | 0.36 | 0/8 | 0.88 | 0.83 | `close_vs_open_range` (0.42) | -0.0001 | +0.0095 |
...
| `combo_min__net_volume_flow__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1164 | +0.0882 | +0.0882 | +0.3496 | 0.26 | 0/8 | 0.71 | 0.69 | `first_bar_sentiment` (0.43) | +0.0001 | +0.0067 |
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0810 | +0.0431 | +0.0431 | -0.4332 | 0.68 | 1/8 | 1.29 | 4.35 | — | -0.0005 | +0.0119 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1064 | +0.0678 | +0.0678 | +0.0596 | 0.48 | 0/8 | 1.09 | 0.72 | `volume_weighted_momentum_acceleration` (0.62) | -0.0004 | +0.0095 |
| `combo_min__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0937 | +0.1023 | +0.1023 | +0.4955 | 0.50 | 0/8 | 0.43 | 0.43 | `first_bar_return` (0.46) | +0.0002 | +0.0214 |
| `combo_sig_product__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1181 | +0.0557 | +0.0557 | +0.2440 | 0.56 | 0/8 | 0.56 | 0.59 | `first_bar_return` (0.46) | -0.0004 | +0.0104 |
| `combo_mean__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1024 | +0.0969 | +0.0969 | +0.3003 | 0.46 | 0/8 | 0.66 | 0.51 | `max_down_ret` (0.62) | +0.0002 | +0.0000 |
| `combo_sig_product__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1000 | +0.0826 | +0.0826 | +0.6025 | 0.42 | 0/8 | 0.69 | 0.52 | `trend_bar_close_consistency` (0.66) | -0.0002 | +0.0095 |
...
| `combo_rank_max__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1277 | +0.1007 | +0.1007 | +0.6887 | 0.50 | 0/8 | 0.61 | 0.38 | `max_down_ret` (0.62) | -0.0002 | +0.0119 |
| `combo_sig_product__star50_limit_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.0944 | +0.1148 | +0.1148 | -0.0882 | 0.57 | 0/8 | 0.84 | 0.54 | `star50_limit_proximity_early` (0.55) | +0.0001 | +0.0443 |
| `combo_rank_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0935 | +0.0994 | +0.0994 | +0.6418 | 0.55 | 0/8 | 0.57 | 0.40 | `max_down_ret` (0.62) | -0.0002 | +0.0467 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1104 | +0.1566 | +0.1566 | +0.5389 | 0.44 | 0/8 | 0.51 | 0.67 | `max_down_ret` (0.62) | +0.0004 | +0.0467 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1144 | +0.0794 | +0.0794 | +0.3571 | 0.29 | 0/8 | 0.70 | 0.84 | `first_bar_return` (0.46) | -0.0002 | +0.0467 |
| `combo_sig_product__first_bar_sentiment__early_body_momentum` | Gap / Overnight Reversal | +1 | +0.1072 | +0.0595 | +0.0595 | +0.5616 | 0.31 | 0/8 | 0.85 | 0.82 | `first_bar_sentiment` (0.43) | -0.0001 | +0.0095 |
| `combo_rank_max__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1066 | +0.1033 | +0.1033 | +0.2208 | 0.38 | 0/8 | 0.73 | 0.89 | `star50_limit_proximity_early` (0.55) | -0.0000 | +0.0000 |
...
| `combo_diff__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.0701 | +0.0120 | +0.0120 | -0.8026 | 0.95 | 0/8 | 0.34 | 0.22 | `max_down_ret` (0.62) | -0.0004 | +0.0132 |
| `combo_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0914 | +0.1019 | +0.1019 | +0.5491 | 0.53 | 0/8 | 0.64 | 0.54 | `max_down_ret` (0.62) | +0.0006 | +0.0119 |
...
| `combo_rank_max__star50_limit_proximity_early__trend_bar_close_consistency` | Other Technical | +1 | +0.0906 | +0.0840 | +0.0840 | +0.6564 | 0.50 | 0/8 | 0.86 | 1.16 | `trend_bar_close_consistency` (0.66) | -0.0003 | +0.0000 |
...
| `combo_sig_product__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1032 | +0.0895 | +0.0895 | +0.9555 | 0.31 | 0/8 | 0.60 | 0.47 | `body_size_progression` (0.60) | -0.0001 | +0.0119 |
| `combo_max__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.0958 | +0.0913 | +0.0913 | -0.1427 | 0.47 | 0/8 | 0.53 | 0.42 | `max_down_ret` (0.62) | -0.0002 | +0.0119 |
| `combo_rank_max__star50_limit_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1003 | +0.1136 | +0.1136 | +0.5275 | 0.49 | 0/8 | 0.70 | 0.81 | `star50_limit_proximity_early` (0.55) | -0.0000 | +0.0000 |
| `combo_rank_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1243 | +0.0922 | +0.0922 | +0.6593 | 0.50 | 0/8 | 0.51 | 0.39 | `max_down_ret` (0.62) | -0.0003 | +0.0119 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.0592 | +0.0705 | +0.0705 | +0.5535 | 0.93 | 1/8 | 0.63 | 0.79 | `volume_weighted_momentum_acceleration` (0.62) | -0.0001 | +0.0095 |
| `combo_rank_max__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0965 | +0.1418 | +0.1418 | +1.1539 | 0.60 | 0/8 | 0.61 | 0.46 | `max_down_ret` (0.62) | +0.0000 | +0.0119 |
...
| `combo_mean__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1274 | +0.1011 | +0.1011 | +0.3129 | 0.43 | 0/8 | 0.72 | 0.55 | `max_down_ret` (0.62) | +0.0001 | +0.0119 |
| `combo_sig_product__star50_limit_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.0912 | +0.1529 | +0.1529 | +0.4587 | 0.72 | 1/8 | 0.54 | 0.41 | `volume_weighted_momentum_acceleration` (0.62) | +0.0004 | +0.0467 |
| `combo_min__close_vs_open_range__max_down_ret` | Intraday Range Momentum | +1 | +0.0999 | +0.1016 | +0.1016 | +0.1701 | 0.48 | 0/8 | 0.71 | 0.56 | `max_down_ret` (0.62) | +0.0005 | +0.0119 |
| `combo_tri_median__max_up_ret__net_volume_flow__body_size_progression` | Intraday Range Momentum | +1 | +0.0989 | +0.0770 | +0.0770 | +0.3299 | 0.21 | 0/8 | 1.13 | 1.23 | `body_size_progression` (0.60) | -0.0002 | +0.0000 |
| `combo_min__close_vs_open_range__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1036 | +0.0828 | +0.0828 | +0.1020 | 0.38 | 0/8 | 0.61 | 0.44 | `first_bar_sentiment` (0.43) | +0.0000 | +0.0000 |
| `morning_volume_weighted_momentum` | Intraday Range Momentum | +1 | +0.0958 | +0.0778 | +0.0778 | +0.6660 | 0.42 | 0/8 | 0.96 | 0.79 | — | -0.0001 | +0.0000 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__net_volume_flow` | Volatility & Oscillators | +1 | +0.0843 | +0.0762 | +0.0762 | +0.3899 | 0.35 | 0/8 | 1.17 | 1.08 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0001 | +0.0348 |
| `vwap_trend_channel_slope` | Other Technical | +1 | +0.0836 | +0.0712 | +0.0712 | -0.3626 | 0.51 | 0/8 | 1.11 | 0.90 | — | +0.0001 | +0.0119 |
| `open_to_current_return` | Intraday Range Momentum | +1 | +0.0975 | +0.0774 | +0.0774 | +0.5603 | 0.41 | 0/8 | 0.88 | 0.73 | — | +0.0001 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1096 | +0.0988 | +0.0988 | +0.3362 | 0.48 | 0/8 | 0.68 | 0.55 | `max_down_ret` (0.62) | -0.0001 | +0.0119 |
| `combo_min__first_bar_sentiment__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1065 | +0.0905 | +0.0905 | +0.2175 | 0.38 | 0/8 | 0.55 | 0.43 | `max_down_ret` (0.62) | +0.0001 | +0.0119 |
...
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__body_size_progression` | Other Technical | +1 | +0.0949 | +0.1236 | +0.1236 | -0.0797 | 0.46 | 0/8 | 0.88 | 0.84 | `body_size_progression` (0.60) | +0.0001 | +0.0495 |
| `trend_strength_intraday` | Other Technical | +1 | +0.0822 | +0.0894 | +0.0894 | +0.1836 | 0.36 | 0/8 | 0.93 | 1.36 | — | +0.0001 | +0.0095 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1363, Sharpe: +1.1795)
...
| `combo_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1386 | +0.1258 | +0.1258 | +1.4182 | 0.48 | 0/8 | 1.17 | 3.10 | `opening_drive_thrust_ratio` (0.53) | +0.0004 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1401 | +0.1277 | +0.1277 | +1.2801 | 0.54 | 1/8 | 1.04 | 2.19 | `bar_body_rng_0` (0.54) | +0.0004 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1417 | +0.1103 | +0.1103 | +1.0913 | 0.48 | 1/8 | 1.26 | 3.67 | `opening_drive_thrust_ratio` (0.53) | +0.0001 | +0.0000 |
...
| `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1298 | +0.1068 | +0.1068 | +1.2738 | 0.56 | 1/8 | 1.02 | 2.80 | `first_bar_sentiment` (0.76) | -0.0000 | +0.0000 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1127 | +0.1321 | +0.1321 | +1.4384 | 0.52 | 1/8 | 1.90 | 3.73 | `volatility_expansion_trend_vector` (0.74) | +0.0008 | +0.0000 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1324 | +0.1147 | +0.1147 | +1.0069 | 0.34 | 0/8 | 1.43 | 2.24 | `opening_drive_thrust_ratio` (0.53) | -0.0004 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1429 | +0.1164 | +0.1164 | +1.2316 | 0.39 | 0/8 | 1.23 | 1.73 | `bar_body_rng_0` (0.54) | +0.0000 | +0.0000 |
...
| `combo_rank_min__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1058 | +0.1409 | +0.1409 | +1.7299 | 0.74 | 1/8 | 1.13 | 4.05 | `volume_weighted_price_position` (0.77) | -0.0000 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1426 | +0.1231 | +0.1231 | +1.3859 | 0.38 | 0/8 | 1.34 | 1.76 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0007 | +0.0000 |
| `combo_tri_median__max_up_ret__first_bar_sentiment__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1210 | +0.0866 | +0.0866 | +0.0893 | 0.52 | 1/8 | 0.95 | 1.50 | `first_bar_sentiment` (0.76) | +0.0000 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1154 | +0.1291 | +0.1291 | +1.1684 | 0.49 | 1/8 | 1.95 | 3.70 | `volatility_expansion_trend_vector` (0.74) | +0.0007 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1196 | +0.0759 | +0.0759 | +0.6053 | 0.43 | 0/8 | 0.98 | 1.91 | `first_bar_sentiment` (0.76) | -0.0004 | +0.0000 |
| `combo_mean__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1289 | +0.1241 | +0.1241 | +1.6362 | 0.53 | 1/8 | 1.09 | 2.52 | `star50_limit_proximity_early` (0.68) | +0.0003 | +0.0000 |
| `combo_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0876 | +0.1119 | +0.1119 | +0.4883 | 0.81 | 1/8 | 1.67 | -68.28 | `yesterday_first_30min_return` (0.92) | +0.0006 | +0.0000 |
| `combo_mean__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1306 | +0.1191 | +0.1191 | +1.5664 | 0.45 | 0/8 | 1.14 | 2.90 | `star50_limit_proximity_early` (0.68) | +0.0000 | +0.0000 |
...
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1211 | +0.0922 | +0.0922 | -0.0879 | 0.46 | 0/8 | 1.26 | 2.77 | `bar_body_rng_0` (0.54) | -0.0002 | -0.0196 |
...
| `combo_rank_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0880 | +0.1109 | +0.1109 | +0.3355 | 0.82 | 1/8 | 1.76 | -34.61 | `yesterday_first_30min_return` (0.92) | +0.0006 | +0.0000 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1289 | +0.1145 | +0.1145 | +1.0216 | 0.47 | 0/8 | 1.05 | 2.22 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0002 | +0.0000 |
...
| `combo_mean__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1144 | +0.0853 | +0.0853 | +0.3259 | 0.43 | 0/8 | 1.55 | 2.67 | `opening_drive_thrust_ratio` (0.53) | -0.0005 | -0.0196 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1252 | +0.0846 | +0.0846 | +0.2222 | 0.42 | 0/8 | 1.27 | 1.80 | `bar_body_rng_0` (0.54) | -0.0003 | +0.0000 |
| `combo_tri_min__star50_limit_proximity_early__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1151 | +0.1290 | +0.1290 | +1.5409 | 0.70 | 1/8 | 1.13 | 5.27 | `star50_limit_proximity_early` (0.68) | +0.0003 | +0.0000 |
...
| `combo_rel_diff__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.1221 | +0.1093 | +0.1093 | +0.9727 | 0.46 | 0/8 | 1.30 | 3.22 | `demark_setup_reversal_early` (0.76) | -0.0002 | +0.0000 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1257 | +0.0989 | +0.0989 | +1.0037 | 0.59 | 1/8 | 0.84 | 1.33 | `first_bar_sentiment` (0.76) | -0.0002 | +0.0000 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1182 | +0.1236 | +0.1236 | +0.8328 | 0.37 | 0/8 | 1.49 | 2.06 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0002 | -0.0016 |
| `combo_rank_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1114 | +0.1247 | +0.1247 | +1.4204 | 0.66 | 1/8 | 1.08 | 4.36 | `star50_limit_proximity_early` (0.68) | +0.0001 | +0.0000 |
...
| `combo_rank_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1219 | +0.0954 | +0.0954 | +1.4524 | 0.63 | 1/8 | 0.85 | 1.33 | `first_bar_sentiment` (0.76) | -0.0003 | +0.0000 |
| `combo_tri_mean__star50_limit_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1074 | +0.1005 | +0.1005 | +0.4995 | 0.74 | 1/8 | 1.24 | 5.28 | `yesterday_early_vwap_dev` (1.10) | +0.0004 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0943 | +0.1204 | +0.1204 | +1.1103 | 0.81 | 2/8 | 1.49 | -9.71 | `rbreaker_buy_setup_proximity_early` (1.12) | +0.0003 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1233 | +0.1118 | +0.1118 | +0.8851 | 0.44 | 0/8 | 1.87 | 2.88 | `opening_drive_thrust_ratio` (0.53) | -0.0004 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1155 | +0.0909 | +0.0909 | +0.8829 | 0.52 | 0/8 | 1.08 | 1.69 | `bar_body_rng_0` (0.54) | -0.0003 | +0.0000 |
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1169 | +0.0861 | +0.0861 | +0.4034 | 0.45 | 0/8 | 1.46 | 1.85 | `bar_body_rng_0` (0.54) | -0.0003 | -0.0196 |
...
| `combo_rank_min__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0822 | +0.0966 | +0.0966 | +0.6825 | 0.69 | 0/8 | 3.54 | 6.25 | `volatility_expansion_trend_vector` (0.74) | +0.0003 | -0.0196 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1304 | +0.0976 | +0.0976 | +0.8959 | 0.37 | 0/8 | 1.37 | 1.88 | `star50_limit_proximity_early` (0.68) | +0.0000 | +0.0000 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1154 | +0.0702 | +0.0702 | +0.6069 | 0.43 | 0/8 | 0.88 | 1.29 | `first_bar_sentiment` (0.76) | -0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1019 | +0.1284 | +0.1284 | +1.2074 | 0.40 | 0/8 | 1.61 | 2.48 | `impulse_bar_dominance` (1.04) | +0.0007 | +0.0000 |
...
| `combo_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.1027 | +0.1270 | +0.1270 | +0.8942 | 0.73 | 1/8 | 1.27 | 48.39 | `limit_down_proximity_early` (1.12) | +0.0005 | +0.0000 |
...
| `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1108 | +0.1109 | +0.1109 | +0.9996 | 0.59 | 0/8 | 1.70 | 11.98 | `demark_setup_reversal_early` (0.76) | +0.0000 | +0.0000 |
...
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1146 | +0.0866 | +0.0866 | +0.4183 | 0.48 | 0/8 | 1.91 | 2.92 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | -0.0196 |
...
| `combo_rank_max__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0942 | +0.1242 | +0.1242 | +0.6361 | 0.62 | 1/8 | 1.59 | 4.28 | `yesterday_first_30min_return` (0.92) | +0.0005 | -0.0940 |
| `combo_mean__bar_body_rng_0__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1029 | +0.0988 | +0.0988 | +0.3616 | 0.50 | 0/8 | 1.54 | 2.67 | `volatility_expansion_trend_vector` (0.74) | -0.0000 | +0.0000 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1139 | +0.0883 | +0.0883 | +0.8073 | 0.52 | 0/8 | 1.27 | 1.44 | `volume_weighted_price_position` (0.77) | -0.0007 | +0.0000 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1165 | +0.0874 | +0.0874 | +0.4131 | 0.38 | 0/8 | 1.69 | 2.54 | `star50_limit_proximity_early` (0.68) | -0.0003 | +0.0000 |
| `combo_sig_product__volume_weighted_price_position__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0859 | +0.0677 | +0.0677 | -0.1117 | 0.63 | 0/8 | 1.66 | 3.03 | `volume_weighted_price_position` (0.77) | -0.0004 | +0.0000 |
| `combo_tri_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1233 | +0.1026 | +0.1026 | +0.2266 | 0.32 | 0/8 | 1.49 | 1.85 | `opening_drive_thrust_ratio` (0.53) | -0.0003 | +0.0000 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1024 | +0.1088 | +0.1088 | +0.4427 | 0.72 | 1/8 | 1.83 | 5.08 | `yesterday_early_vwap_dev` (1.10) | -0.0000 | -0.0940 |
...
| `combo_rank_min__first_bar_return__volatility_expansion_trend_vector` | Gap / Overnight Reversal | +1 | +0.0864 | +0.0944 | +0.0944 | +0.4751 | 0.57 | 0/8 | 1.37 | 2.79 | `volatility_expansion_trend_vector` (0.74) | +0.0000 | +0.0000 |
...
| `combo_max__max_up_ret__impulse_bar_dominance` | Intraday Range Momentum | +1 | +0.0929 | +0.0673 | +0.0673 | +0.2240 | 0.47 | 0/8 | 2.90 | 3.31 | `impulse_bar_dominance` (1.04) | -0.0002 | -0.0196 |
| `combo_mean__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1146 | +0.1250 | +0.1250 | +1.0832 | 0.41 | 0/8 | 2.08 | 3.62 | `impulse_bar_dominance` (1.04) | +0.0003 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0938 | +0.0898 | +0.0898 | +0.1198 | 0.90 | 1/8 | 1.25 | 5.52 | `yesterday_early_vwap_dev` (1.10) | +0.0000 | +0.0000 |
...
| `combo_rank_min__max_up_ret__impulse_bar_dominance` | Intraday Range Momentum | +1 | +0.0816 | +0.0702 | +0.0702 | +0.3954 | 0.63 | 0/8 | 3.42 | 4.61 | `impulse_bar_dominance` (1.04) | -0.0002 | -0.0196 |
| `combo_min__opening_drive_thrust_ratio__impulse_bar_dominance` | Other Technical | +1 | +0.0917 | +0.0659 | +0.0659 | +0.5416 | 0.59 | 0/8 | 2.24 | 6.60 | `impulse_bar_dominance` (1.04) | -0.0002 | +0.0000 |
| `combo_min__bar_ret_0__limit_down_proximity_early` | Other Technical | +1 | +0.0946 | +0.1271 | +0.1271 | +1.4730 | 0.78 | 1/8 | 1.02 | 6.45 | `limit_down_proximity_early` (1.12) | +0.0003 | +0.0000 |
...
| `combo_rank_max__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1011 | +0.0961 | +0.0961 | +0.5743 | 0.53 | 0/8 | 1.73 | 3.52 | `volatility_expansion_trend_vector` (0.74) | -0.0000 | +0.0000 |
...
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1153 | +0.0831 | +0.0831 | +0.6530 | 0.44 | 0/8 | 1.52 | 2.62 | `first_bar_sentiment` (0.76) | -0.0003 | +0.0000 |
| `combo_clamp_diff__star50_limit_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1016 | +0.1298 | +0.1298 | +0.0321 | 0.69 | 2/8 | 1.97 | -14.53 | `demark_setup_reversal_early` (0.76) | +0.0005 | +0.0000 |
...
| `combo_max__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1031 | +0.0770 | +0.0770 | +0.0324 | 0.46 | 0/8 | 2.11 | 2.69 | `volatility_expansion_trend_vector` (0.74) | -0.0003 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1072 | +0.0890 | +0.0890 | +0.3617 | 0.55 | 0/8 | 1.07 | 2.10 | `first_bar_sentiment` (0.76) | -0.0001 | +0.0000 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Other Technical | +1 | +0.0745 | +0.0196 | +0.0196 | +0.3480 | 0.42 | 0/8 | 1.36 | 1.18 | `limit_down_proximity_early` (1.12) | -0.0003 | +0.0000 |
...
| `combo_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0974 | +0.1273 | +0.1273 | +0.3112 | 0.43 | 0/8 | 2.10 | 3.36 | `volatility_expansion_trend_vector` (0.74) | +0.0001 | +0.0000 |
| `combo_diff__rbreaker_sell_setup_proximity_early__limit_down_proximity_early` | Other Technical | +1 | +0.0745 | +0.0200 | +0.0200 | +0.3480 | 0.42 | 0/8 | 1.36 | 1.19 | `limit_down_proximity_early` (1.12) | -0.0005 | +0.0000 |
...
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0818 | +0.1188 | +0.1188 | +0.0236 | 0.73 | 1/8 | 2.85 | 6.13 | `volatility_expansion_trend_vector` (0.74) | +0.0004 | +0.0000 |
| `combo_max__yesterday_first_30min_return__limit_down_proximity_early` | Intraday Range Momentum | +1 | +0.0798 | +0.0974 | +0.0974 | +0.4494 | 0.74 | 1/8 | 1.32 | 6.94 | `limit_down_proximity_early` (1.12) | +0.0003 | +0.0000 |
...
| `combo_z_sum__volume_weighted_price_position__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0856 | +0.0925 | +0.0925 | +0.5763 | 0.76 | 0/8 | 1.84 | 2.65 | `volume_weighted_price_position` (0.77) | -0.0002 | +0.0000 |
| `combo_min__limit_down_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0757 | +0.1167 | +0.1167 | +0.9419 | 0.75 | 0/8 | 2.18 | 15.45 | `limit_down_proximity_early` (1.12) | +0.0007 | +0.0000 |
...
| `combo_sig_product__bar_body_rng_0__bar_ret_0` | Other Technical | +1 | +0.1169 | +0.0702 | +0.0702 | +0.8068 | 0.41 | 0/8 | 0.93 | 1.19 | `bar_body_rng_0` (0.54) | -0.0003 | +0.0000 |
| `close_vs_open_range` | Other Technical | +1 | +0.0638 | +0.1017 | +0.1017 | +0.6838 | 0.72 | 0/8 | 3.56 | 3.79 | — | +0.0003 | +0.0000 |
...
_Null Baseline (un-gated candidate pool): 58.0% lock IC > 0, 35.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.2683_
...
| B4 Correlation Gate | 129 | 30 | 86.7% | 56.7% | +0.0174 | +0.0420 |

**Admitted Pool Summary**: 97 features, False Positive Rate = 49.5% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0170, Mean Lock Sharpe = +0.0042
...
_Null Baseline (un-gated candidate pool): 76.0% lock IC > 0, 48.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.0177_
...
| B4 Correlation Gate | 542 | 30 | 100.0% | 96.7% | +0.1010 | +0.5527 |

**Admitted Pool Summary**: 179 features, False Positive Rate = 11.2% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0904, Mean Lock Sharpe = +0.4134
...
_Null Baseline (un-gated candidate pool): 82.0% lock IC > 0, 59.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.2309_
...
| B4 Correlation Gate | 206 | 30 | 100.0% | 100.0% | +0.1213 | +1.3983 |

**Admitted Pool Summary**: 143 features, False Positive Rate = 2.8% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1022, Mean Lock Sharpe = +0.8092
...
1. **300ETF `single` — B4 Correlation Gate too strict**: 56.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 35.0%, mean lock Sharpe=+0.0420). Consider relaxing this gate.
...
7. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 93.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 48.0%, mean lock Sharpe=+0.5995). Consider relaxing this gate.
8. **500ETF `single` — B2 Rolling Guard too strict**: 90.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 48.0%, mean lock Sharpe=+0.4802). Consider relaxing this gate.
9. **500ETF `single` — B3 Composite Floor too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 48.0%, mean lock Sharpe=+0.2939). Consider relaxing this gate.
10. **500ETF `single` — B4 Correlation Gate too strict**: 96.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 48.0%, mean lock Sharpe=+0.5527). Consider relaxing this gate.
