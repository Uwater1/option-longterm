...
### 500ETF — `single` (Full Model Lockbox IC: +0.1110, Sharpe: +0.5111)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1302 | +0.0955 | +0.0955 | +0.5066 | 0.36 | 0/8 | 0.80 | 0.67 | `trend_bar_close_consistency` (0.66) | -0.0002 | -0.0857 |
| `combo_rank_max__opening_drive_thrust_ratio__early_body_momentum` | Intraday Range Momentum | +1 | +0.1174 | +0.0915 | +0.0915 | +0.4102 | 0.38 | 0/8 | 0.76 | 0.59 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | -0.0857 |
| `combo_tri_mean__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1343 | +0.1127 | +0.1127 | +0.8107 | 0.39 | 0/8 | 0.69 | 0.51 | `star50_limit_proximity_early` (0.55) | +0.0004 | -0.0315 |
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0586 | +0.0586 | -0.0789 | 0.35 | 0/8 | 0.74 | 0.67 | `bar_ret_0` (0.46) | -0.0005 | -0.0128 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1304 | +0.0995 | +0.0995 | +0.1554 | 0.37 | 0/8 | 0.71 | 0.63 | `opening_drive_thrust_ratio` (0.40) | -0.0000 | -0.0857 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1297 | +0.1084 | +0.1084 | +1.0418 | 0.28 | 0/8 | 0.88 | 0.58 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0006 | -0.0128 |
| `combo_tri_max__max_up_ret__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1315 | +0.0739 | +0.0739 | +0.1807 | 0.39 | 0/8 | 0.69 | 0.74 | `bar_ret_0` (0.46) | -0.0007 | -0.0857 |
| `combo_max__early_body_momentum__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1192 | +0.0580 | +0.0580 | -0.3703 | 0.38 | 0/8 | 0.74 | 0.69 | `first_bar_return` (0.46) | -0.0005 | -0.0128 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__trend_bar_close_consistency__bar_ret_0` | Other Technical | +1 | +0.1269 | +0.1011 | +0.1011 | +0.6858 | 0.36 | 0/8 | 0.68 | 0.55 | `trend_bar_close_consistency` (0.66) | -0.0001 | +0.0546 |
...
| `combo_mean__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1176 | +0.1023 | +0.1023 | +0.7538 | 0.29 | 0/8 | 0.79 | 0.71 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0002 | -0.0806 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1391 | +0.1128 | +0.1128 | +0.4001 | 0.29 | 0/8 | 0.80 | 0.72 | `opening_drive_thrust_ratio` (0.40) | +0.0002 | -0.0857 |
| `combo_tri_median__max_up_ret__net_volume_flow__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0637 | +0.0637 | +0.0275 | 0.38 | 0/8 | 0.71 | 0.58 | `bar_ret_0` (0.46) | -0.0003 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1412 | +0.1193 | +0.1193 | +0.5966 | 0.44 | 0/8 | 0.66 | 0.32 | `opening_drive_thrust_ratio` (0.40) | +0.0006 | -0.0220 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1496 | +0.1043 | +0.1043 | +0.4791 | 0.34 | 0/8 | 0.70 | 0.53 | `bar_ret_0` (0.46) | +0.0001 | -0.0220 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1350 | +0.1136 | +0.1136 | +1.3415 | 0.39 | 0/8 | 0.59 | 0.39 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0006 | +0.0546 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1314 | +0.1104 | +0.1104 | +0.7177 | 0.52 | 0/8 | 0.52 | 0.33 | `bar_ret_0` (0.46) | +0.0004 | -0.0220 |
| `combo_rel_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1349 | +0.0747 | +0.0747 | +0.0706 | 0.35 | 0/8 | 0.70 | 0.51 | `body_size_progression` (0.60) | +0.0002 | -0.0220 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1391 | +0.0836 | +0.0836 | +0.4618 | 0.35 | 0/8 | 0.64 | 0.55 | `bar_body_rng_0` (0.37) | -0.0003 | -0.0220 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1277 | +0.1056 | +0.1056 | +0.9169 | 0.42 | 0/8 | 0.56 | 0.41 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0007 | -0.0408 |
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1550 | +0.1142 | +0.1142 | +0.6523 | 0.39 | 0/8 | 0.66 | 0.47 | `bar_ret_0` (0.46) | +0.0001 | -0.0220 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1087 | +0.1123 | +0.1123 | +0.9259 | 0.45 | 0/8 | 0.58 | 0.46 | `bar_ret_0` (0.46) | +0.0006 | +0.0546 |
| `combo_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1390 | +0.0842 | +0.0842 | +0.4912 | 0.34 | 0/8 | 0.71 | 0.55 | `body_size_progression` (0.60) | +0.0001 | -0.0220 |
| `combo_rank_min__volatility_expansion_trend_vector__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0928 | +0.0800 | +0.0800 | +0.0855 | 0.42 | 0/8 | 0.99 | 0.89 | `vwap_close_divergence_trend` (0.50) | -0.0004 | -0.0857 |
| `combo_tri_max__opening_drive_thrust_ratio__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1417 | +0.0783 | +0.0783 | +0.1736 | 0.35 | 0/8 | 0.82 | 0.68 | `bar_ret_0` (0.46) | -0.0003 | -0.0128 |
| `combo_rank_max__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1349 | +0.0752 | +0.0752 | +0.1487 | 0.31 | 0/8 | 0.81 | 0.66 | `first_bar_return` (0.46) | -0.0002 | -0.0128 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1289 | +0.1105 | +0.1105 | +0.9584 | 0.40 | 0/8 | 0.73 | 0.48 | `volatility_expansion_trend_vector` (0.41) | +0.0005 | -0.0128 |
| `combo_clamp_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1385 | +0.0855 | +0.0855 | +0.8416 | 0.33 | 0/8 | 0.72 | 0.58 | `body_size_progression` (0.60) | +0.0000 | +0.0000 |
| `combo_diff__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.1356 | +0.1173 | +0.1173 | +0.5806 | 0.40 | 0/8 | 0.71 | 0.71 | `demark_setup_reversal_early` (0.57) | +0.0004 | +0.0546 |
| `combo_min__net_volume_flow__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0982 | +0.0779 | +0.0779 | +0.1726 | 0.39 | 0/8 | 0.88 | 0.85 | `vwap_close_divergence_trend` (0.50) | -0.0003 | -0.0857 |
| `combo_tri_mean__early_body_momentum__star50_limit_proximity_early__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1049 | +0.0978 | +0.0978 | +0.6135 | 0.38 | 0/8 | 0.68 | 0.61 | `star50_limit_proximity_early` (0.55) | +0.0002 | -0.0315 |
| `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1433 | +0.0858 | +0.0858 | +0.9255 | 0.42 | 0/8 | 0.77 | 0.67 | `volume_weighted_momentum_acceleration` (0.62) | +0.0001 | +0.0546 |
| `combo_tri_median__opening_drive_thrust_ratio__net_volume_flow__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1034 | +0.0929 | +0.0929 | +0.7066 | 0.23 | 0/8 | 0.84 | 0.89 | `smooth_momentum_structure` (0.62) | -0.0003 | -0.0857 |
| `combo_mean__rbreaker_sell_setup_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1198 | +0.1201 | +0.1201 | +1.0892 | 0.35 | 0/8 | 0.73 | 0.52 | `close_vs_open_range` (0.42) | +0.0002 | -0.0857 |
...
| `combo_max__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1344 | +0.0749 | +0.0749 | +0.0494 | 0.33 | 0/8 | 0.82 | 0.66 | `first_bar_return` (0.46) | -0.0003 | -0.0128 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1467 | +0.0912 | +0.0912 | +0.2017 | 0.38 | 0/8 | 0.69 | 0.58 | `bar_ret_0` (0.46) | -0.0002 | +0.0000 |
| `combo_min__close_vs_open_range__vwap_close_divergence_trend` | Other Technical | +1 | +0.0943 | +0.0800 | +0.0800 | +0.0807 | 0.39 | 0/8 | 1.07 | 0.90 | `vwap_close_divergence_trend` (0.50) | -0.0001 | -0.0857 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1474 | +0.1055 | +0.1055 | +0.9440 | 0.38 | 0/8 | 0.63 | 0.46 | `star50_limit_proximity_early` (0.55) | -0.0000 | +0.0546 |
| `combo_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1496 | +0.0874 | +0.0874 | +0.8706 | 0.42 | 0/8 | 0.70 | 0.61 | `volume_weighted_momentum_acceleration` (0.62) | +0.0001 | +0.0000 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1309 | +0.0903 | +0.0903 | +0.3727 | 0.30 | 0/8 | 0.75 | 0.65 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0001 | -0.0857 |
| `combo_tri_median__volatility_expansion_trend_vector__star50_limit_proximity_early__bar_ret_0` | Volatility & Oscillators | +1 | +0.1303 | +0.1105 | +0.1105 | +0.7811 | 0.44 | 0/8 | 0.55 | 0.51 | `star50_limit_proximity_early` (0.55) | +0.0001 | +0.0546 |
| `combo_mean__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1232 | +0.0841 | +0.0841 | +0.5556 | 0.32 | 0/8 | 0.86 | 0.70 | `volatility_expansion_trend_vector` (0.41) | -0.0005 | -0.0857 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1374 | +0.0813 | +0.0813 | +0.6652 | 0.33 | 0/8 | 0.67 | 0.74 | `bar_ret_0` (0.46) | +0.0000 | -0.0315 |
| `combo_rank_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0939 | +0.0890 | +0.0890 | +0.3159 | 0.37 | 0/8 | 0.71 | 0.70 | `close_vs_open_range` (0.42) | -0.0004 | -0.0857 |
| `combo_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1239 | +0.0818 | +0.0818 | +0.0961 | 0.51 | 0/8 | 0.50 | 0.39 | `max_down_ret` (0.62) | -0.0001 | -0.0220 |
| `combo_tri_min__max_up_ret__net_volume_flow__bar_ret_0` | Intraday Range Momentum | +1 | +0.1197 | +0.0945 | +0.0945 | +0.4270 | 0.30 | 0/8 | 0.76 | 0.77 | `bar_ret_0` (0.46) | -0.0001 | +0.0546 |
| `combo_mean__net_volume_flow__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1198 | +0.0871 | +0.0871 | +0.0841 | 0.36 | 0/8 | 0.64 | 0.63 | `first_bar_return` (0.46) | -0.0002 | +0.0546 |
| `combo_diff__opening_drive_thrust_ratio__h2_l2_pullback_continuation` | Other Technical | +1 | +0.1167 | +0.0815 | +0.0815 | +0.3462 | 0.30 | 0/8 | 0.81 | 0.67 | `h2_l2_pullback_continuation` (0.45) | -0.0003 | -0.0857 |
...
| `combo_sig_product__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1004 | +0.0599 | +0.0599 | +0.5033 | 0.34 | 0/8 | 1.00 | 1.16 | `max_down_ret` (0.62) | -0.0001 | -0.0857 |
| `combo_rel_diff__opening_drive_thrust_ratio__h2_l2_pullback_continuation` | Other Technical | +1 | +0.1133 | +0.0752 | +0.0752 | +0.3462 | 0.31 | 0/8 | 0.89 | 0.74 | `h2_l2_pullback_continuation` (0.45) | -0.0003 | -0.0188 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1329 | +0.0678 | +0.0678 | +0.5233 | 0.39 | 0/8 | 0.66 | 0.63 | `bar_body_rng_0` (0.37) | -0.0001 | -0.0220 |
| `combo_clamp_diff__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1327 | +0.0902 | +0.0902 | +0.1578 | 0.45 | 0/8 | 0.69 | 0.64 | `body_size_progression` (0.60) | -0.0000 | -0.0220 |
| `combo_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0954 | +0.0868 | +0.0868 | +0.2383 | 0.35 | 0/8 | 0.72 | 0.69 | `close_vs_open_range` (0.42) | -0.0003 | -0.0857 |
| `combo_rank_min__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1020 | +0.0898 | +0.0898 | +0.4472 | 0.54 | 0/8 | 0.63 | 0.51 | `max_down_ret` (0.62) | -0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1162 | +0.1125 | +0.1125 | +1.2249 | 0.34 | 0/8 | 0.78 | 0.58 | `volatility_expansion_trend_vector` (0.41) | +0.0006 | -0.0315 |
| `combo_max__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1302 | +0.0704 | +0.0704 | -0.1210 | 0.26 | 0/8 | 0.98 | 0.81 | `vwap_close_divergence_trend` (0.50) | -0.0006 | -0.0857 |
| `combo_tri_min__opening_drive_thrust_ratio__net_volume_flow__bar_ret_0` | Volatility & Oscillators | +1 | +0.1213 | +0.0963 | +0.0963 | +0.3889 | 0.41 | 0/8 | 0.64 | 0.65 | `bar_ret_0` (0.46) | -0.0002 | +0.0546 |
| `combo_tri_mean__opening_drive_thrust_ratio__trend_day_regime_conviction__bar_ret_0` | Other Technical | +1 | +0.1335 | +0.0955 | +0.0955 | +0.4321 | 0.41 | 0/8 | 0.69 | 0.59 | `trend_day_regime_conviction` (0.46) | -0.0003 | +0.0546 |
| `combo_max__max_up_ret__max_down_ret` | Intraday Range Momentum | +1 | +0.1295 | +0.0839 | +0.0839 | +0.4972 | 0.49 | 0/8 | 0.61 | 0.46 | `max_down_ret` (0.62) | -0.0007 | +0.0000 |
| `combo_rank_min__volatility_expansion_trend_vector__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1016 | +0.1246 | +0.1246 | +1.3362 | 0.49 | 0/8 | 0.75 | 0.48 | `star50_limit_proximity_early` (0.55) | +0.0002 | +0.0400 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1350 | +0.0894 | +0.0894 | +0.0870 | 0.43 | 0/8 | 0.58 | 0.48 | `bar_ret_0` (0.46) | -0.0001 | -0.0220 |
| `combo_mean__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1215 | +0.0927 | +0.0927 | +0.2533 | 0.38 | 0/8 | 0.66 | 0.56 | `first_bar_return` (0.46) | -0.0005 | -0.0128 |
| `combo_mean__opening_drive_thrust_ratio__vwap_close_divergence_trend` | Other Technical | +1 | +0.1203 | +0.0781 | +0.0781 | -0.2958 | 0.39 | 0/8 | 0.90 | 0.74 | `vwap_close_divergence_trend` (0.50) | -0.0002 | -0.0857 |
...
| `combo_rel_diff__max_up_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.1073 | +0.0633 | +0.0633 | +0.0279 | 0.27 | 0/8 | 0.93 | 0.82 | `h2_l2_pullback_continuation` (0.45) | -0.0006 | -0.0188 |
| `combo_min__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1010 | +0.0997 | +0.0997 | +0.7541 | 0.47 | 0/8 | 0.51 | 0.54 | `bar_ret_0` (0.46) | -0.0001 | +0.0546 |
| `combo_rank_min__vwap_close_divergence_trend__bar_body_rng_0` | Other Technical | +1 | +0.0926 | +0.0785 | +0.0785 | +0.5352 | 0.62 | 0/8 | 0.54 | 0.51 | `vwap_close_divergence_trend` (0.50) | -0.0004 | +0.0546 |
| `combo_rank_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1218 | +0.0760 | +0.0760 | +0.3554 | 0.38 | 0/8 | 0.84 | 0.85 | `early_body_momentum` (0.37) | -0.0005 | +0.0000 |
| `combo_mean__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1187 | +0.0758 | +0.0758 | +0.1995 | 0.41 | 0/8 | 0.50 | 0.44 | `first_bar_return` (0.46) | -0.0001 | +0.0546 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1502 | +0.1096 | +0.1096 | +0.7699 | 0.28 | 0/8 | 0.91 | 0.60 | `opening_drive_thrust_ratio` (0.40) | +0.0000 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1114 | +0.1196 | +0.1196 | +1.1815 | 0.41 | 0/8 | 0.79 | 0.49 | `close_vs_open_range` (0.42) | +0.0005 | -0.0315 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1381 | +0.1066 | +0.1066 | +0.6200 | 0.35 | 0/8 | 0.62 | 0.51 | `star50_limit_proximity_early` (0.55) | +0.0001 | +0.0546 |
| `combo_rank_min__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1012 | +0.0931 | +0.0931 | +0.2815 | 0.50 | 0/8 | 0.45 | 0.43 | `bar_ret_0` (0.46) | -0.0002 | +0.0546 |
| `combo_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1314 | +0.0802 | +0.0802 | -0.1927 | 0.35 | 0/8 | 0.68 | 0.56 | `first_bar_return` (0.46) | -0.0004 | +0.0000 |
| `combo_mean__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1128 | +0.1133 | +0.1133 | +0.6694 | 0.35 | 0/8 | 0.70 | 0.50 | `star50_limit_proximity_early` (0.55) | +0.0005 | -0.0315 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1373 | +0.0797 | +0.0797 | +0.4571 | 0.36 | 0/8 | 0.81 | 0.65 | `opening_drive_thrust_ratio` (0.40) | -0.0007 | -0.0857 |
| `combo_clamp_diff__bar_ret_0__body_size_progression` | Other Technical | +1 | +0.1272 | +0.0778 | +0.0778 | +0.4715 | 0.49 | 0/8 | 0.51 | 0.58 | `body_size_progression` (0.60) | -0.0002 | -0.0220 |
...
| `combo_sig_product__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1158 | +0.0370 | +0.0370 | -0.1907 | 0.47 | 0/8 | 0.53 | 0.65 | `vwap_close_divergence_trend` (0.50) | -0.0004 | -0.0857 |
| `combo_rank_max__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1454 | +0.0885 | +0.0885 | +0.2644 | 0.35 | 0/8 | 0.74 | 0.61 | `bar_ret_0` (0.46) | -0.0001 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__net_volume_flow` | Volatility & Oscillators | +1 | +0.1213 | +0.1215 | +0.1215 | +1.2167 | 0.37 | 0/8 | 0.75 | 0.47 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0004 | -0.0315 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1149 | +0.0841 | +0.0841 | +0.3166 | 0.48 | 0/8 | 0.77 | 0.93 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0008 | -0.0857 |
| `combo_sig_product__first_bar_return__vwap_close_divergence_trend` | Gap / Overnight Reversal | +1 | +0.1194 | +0.0244 | +0.0244 | -0.5970 | 0.37 | 0/8 | 0.80 | 1.56 | `vwap_close_divergence_trend` (0.50) | +0.0003 | -0.0188 |
...
| `combo_min__max_up_ret__max_down_ret` | Intraday Range Momentum | +1 | +0.1170 | +0.1039 | +0.1039 | +0.3390 | 0.30 | 0/8 | 1.00 | 0.72 | `max_down_ret` (0.62) | +0.0004 | +0.0000 |
| `combo_max__first_bar_return__early_order_flow_imbalance` | Gap / Overnight Reversal | +1 | +0.1030 | +0.0459 | +0.0459 | -0.4898 | 0.41 | 0/8 | 0.65 | 0.94 | `early_order_flow_imbalance` (0.68) | -0.0002 | +0.0546 |
| `combo_tri_median__max_up_ret__volatility_expansion_trend_vector__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1277 | +0.1079 | +0.1079 | +0.8366 | 0.33 | 0/8 | 0.87 | 0.88 | `star50_limit_proximity_early` (0.55) | -0.0000 | -0.0857 |
| `combo_tri_min__net_volume_flow__star50_limit_proximity_early__bar_ret_0` | Volatility & Oscillators | +1 | +0.1008 | +0.1214 | +0.1214 | +1.1911 | 0.45 | 0/8 | 0.61 | 0.44 | `star50_limit_proximity_early` (0.55) | +0.0006 | +0.0546 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1429 | +0.1149 | +0.1149 | +0.4770 | 0.35 | 0/8 | 0.87 | 0.75 | `demark_setup_reversal_early` (0.57) | -0.0001 | -0.0857 |
| `combo_rank_min__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1078 | +0.0961 | +0.0961 | +0.2697 | 0.49 | 0/8 | 0.68 | 0.51 | `max_down_ret` (0.62) | +0.0000 | +0.0000 |
| `combo_tri_max__max_up_ret__trend_bar_close_consistency__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1219 | +0.0636 | +0.0636 | +0.3582 | 0.39 | 0/8 | 0.82 | 0.71 | `trend_bar_close_consistency` (0.66) | -0.0005 | -0.0857 |
| `combo_mean__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1219 | +0.1147 | +0.1147 | +0.3396 | 0.37 | 0/8 | 0.81 | 0.58 | `vwap_close_divergence_trend` (0.50) | +0.0002 | -0.0857 |
| `combo_max__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1482 | +0.0866 | +0.0866 | +0.0051 | 0.35 | 0/8 | 0.77 | 0.63 | `first_bar_return` (0.46) | -0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1063 | +0.0928 | +0.0928 | +0.5738 | 0.55 | 0/8 | 0.75 | 0.42 | `vwap_close_divergence_trend` (0.50) | +0.0003 | -0.0315 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1178 | +0.0873 | +0.0873 | +0.0959 | 0.36 | 0/8 | 0.75 | 0.69 | `bar_ret_0` (0.46) | -0.0005 | -0.0128 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1257 | +0.0908 | +0.0908 | +0.8692 | 0.44 | 0/8 | 0.62 | 0.40 | `bar_ret_0` (0.46) | +0.0004 | -0.0220 |
| `combo_tri_min__max_up_ret__star50_limit_proximity_early__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1081 | +0.1143 | +0.1143 | +1.4452 | 0.38 | 0/8 | 0.79 | 0.46 | `star50_limit_proximity_early` (0.55) | +0.0005 | -0.0128 |
| `combo_mean__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.0973 | +0.0798 | +0.0798 | -0.0579 | 0.48 | 0/8 | 0.72 | 0.65 | `max_down_ret` (0.62) | -0.0000 | -0.0857 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1293 | +0.0813 | +0.0813 | +0.2357 | 0.30 | 0/8 | 0.93 | 0.64 | — | -0.0004 | +0.0000 |
| `combo_rank_max__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1303 | +0.0749 | +0.0749 | +0.1819 | 0.26 | 0/8 | 1.05 | 0.82 | `vwap_close_divergence_trend` (0.50) | -0.0000 | -0.0128 |
| `combo_clamp_diff__max_up_ret__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1473 | +0.0854 | +0.0854 | +0.4225 | 0.41 | 0/8 | 0.78 | 0.66 | `smooth_momentum_structure` (0.62) | -0.0001 | +0.0000 |
| `combo_rank_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1243 | +0.0922 | +0.0922 | +0.6593 | 0.50 | 0/8 | 0.51 | 0.39 | `max_down_ret` (0.62) | -0.0001 | +0.0546 |
| `combo_sig_product__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1181 | +0.0557 | +0.0557 | +0.2440 | 0.56 | 0/8 | 0.56 | 0.59 | `first_bar_return` (0.46) | -0.0005 | -0.0220 |
| `combo_min__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.0947 | +0.0721 | +0.0721 | -0.1601 | 0.45 | 0/8 | 1.14 | 0.73 | `vwap_close_divergence_trend` (0.50) | -0.0002 | -0.0857 |
| `combo_mean__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0825 | +0.1093 | +0.1093 | +0.6791 | 0.66 | 0/8 | 0.55 | 0.37 | `max_down_ret` (0.62) | +0.0005 | +0.0546 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1286 | +0.0668 | +0.0668 | -0.1367 | 0.40 | 0/8 | 1.05 | 0.86 | `opening_drive_thrust_ratio` (0.40) | -0.0005 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1064 | +0.0956 | +0.0956 | +0.5503 | 0.57 | 0/8 | 0.71 | 0.35 | `vwap_close_divergence_trend` (0.50) | +0.0000 | -0.0315 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1420, Sharpe: +1.6097)
...
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1401 | +0.1277 | +0.1277 | +1.2801 | 0.54 | 1/8 | 1.04 | 2.19 | `bar_body_rng_0` (0.54) | -0.0002 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1417 | +0.1103 | +0.1103 | +1.0913 | 0.48 | 1/8 | 1.26 | 3.67 | `opening_drive_thrust_ratio` (0.53) | -0.0006 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1429 | +0.1164 | +0.1164 | +1.2316 | 0.39 | 0/8 | 1.23 | 1.73 | `bar_body_rng_0` (0.54) | -0.0001 | +0.0443 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1364 | +0.1188 | +0.1188 | +0.9339 | 0.50 | 1/8 | 1.08 | 3.43 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1275 | +0.1267 | +0.1267 | +1.2245 | 0.39 | 0/8 | 1.38 | 2.86 | `star50_limit_proximity_early` (0.68) | -0.0001 | +0.0443 |
...
| `combo_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1386 | +0.1258 | +0.1258 | +1.4182 | 0.48 | 0/8 | 1.17 | 3.10 | `opening_drive_thrust_ratio` (0.53) | -0.0001 | +0.0000 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1163 | +0.0911 | +0.0911 | +0.5434 | 0.62 | 1/8 | 1.30 | 4.55 | `yesterday_early_vwap_dev` (1.10) | +0.0009 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1463 | +0.1269 | +0.1269 | +1.6160 | 0.46 | 1/8 | 1.11 | 1.74 | `bar_body_rng_0` (0.54) | -0.0003 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1248 | +0.1283 | +0.1283 | +1.6959 | 0.57 | 1/8 | 1.04 | 1.71 | `volume_weighted_price_position` (0.77) | -0.0001 | +0.0888 |
| `combo_mean__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1284 | +0.1327 | +0.1327 | +0.9738 | 0.39 | 0/8 | 1.62 | 3.11 | `star50_limit_proximity_early` (0.68) | -0.0000 | +0.0443 |
| `combo_rank_min__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1058 | +0.1409 | +0.1409 | +1.7299 | 0.74 | 1/8 | 1.13 | 4.05 | `volume_weighted_price_position` (0.77) | +0.0003 | +0.0888 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1252 | +0.0846 | +0.0846 | +0.2222 | 0.42 | 0/8 | 1.27 | 1.80 | `bar_body_rng_0` (0.54) | -0.0004 | +0.0000 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1237 | +0.1316 | +0.1316 | +1.5821 | 0.59 | 0/8 | 0.94 | 1.51 | `volume_weighted_price_position` (0.77) | +0.0003 | +0.0888 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1154 | +0.1291 | +0.1291 | +1.1684 | 0.49 | 1/8 | 1.95 | 3.70 | `volatility_expansion_trend_vector` (0.74) | +0.0003 | +0.0443 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1289 | +0.1146 | +0.1146 | +1.0966 | 0.47 | 0/8 | 1.05 | 2.22 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0000 | +0.0000 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1466 | +0.1334 | +0.1334 | +1.5762 | 0.36 | 0/8 | 1.05 | 2.19 | `volume_weighted_momentum_acceleration` (0.48) | -0.0003 | +0.0000 |
| `combo_tri_min__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1215 | +0.1330 | +0.1330 | +1.4975 | 0.58 | 1/8 | 1.11 | 2.58 | `star50_limit_proximity_early` (0.68) | +0.0001 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1144 | +0.0853 | +0.0853 | +0.3259 | 0.43 | 0/8 | 1.55 | 2.67 | `opening_drive_thrust_ratio` (0.53) | -0.0003 | +0.0443 |
...
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1426 | +0.1231 | +0.1231 | +1.3859 | 0.38 | 0/8 | 1.34 | 1.76 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0003 | +0.0443 |
| `combo_mean__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1374 | +0.1301 | +0.1301 | +1.0434 | 0.41 | 0/8 | 1.03 | 1.21 | `volume_weighted_price_position` (0.77) | +0.0001 | +0.0888 |
| `combo_diff__rbreaker_sell_setup_proximity_early__gap_pct` | Gap / Overnight Reversal | +1 | +0.1055 | +0.0639 | +0.0639 | +0.4993 | 0.39 | 0/8 | 1.92 | 2.16 | `gap_pct` (1.84) | -0.0002 | +0.0443 |
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1338 | +0.1202 | +0.1202 | +1.5593 | 0.47 | 1/8 | 1.04 | 2.10 | `star50_limit_proximity_early` (0.68) | -0.0004 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1127 | +0.1321 | +0.1321 | +1.4384 | 0.52 | 1/8 | 1.90 | 3.73 | `volatility_expansion_trend_vector` (0.74) | +0.0004 | +0.0443 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1451 | +0.1262 | +0.1262 | +1.3787 | 0.35 | 0/8 | 1.01 | 1.69 | `volume_weighted_momentum_acceleration` (0.48) | -0.0005 | +0.0000 |
| `combo_ifelse__gap_pct__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1337 | +0.1161 | +0.1161 | +1.2784 | 0.44 | 0/8 | 1.30 | 3.03 | `gap_pct` (1.84) | -0.0001 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1111 | +0.0659 | +0.0659 | +0.2315 | 0.38 | 0/8 | 1.61 | 1.77 | `demark_setup_reversal_early` (0.76) | -0.0007 | -0.0939 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1233 | +0.1118 | +0.1118 | +0.8851 | 0.44 | 0/8 | 1.87 | 2.88 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | +0.0538 |
| `combo_tri_min__star50_limit_proximity_early__bar_body_rng_0__bar_ret_0` | Other Technical | +1 | +0.1150 | +0.1291 | +0.1291 | +1.5409 | 0.70 | 1/8 | 1.13 | 5.36 | `star50_limit_proximity_early` (0.68) | +0.0003 | +0.0000 |
| `combo_mean__max_up_ret__gap_pct` | Gap / Overnight Reversal | +1 | +0.1335 | +0.1371 | +0.1371 | +1.1159 | 0.39 | 0/8 | 1.64 | 2.81 | `gap_pct` (1.84) | +0.0002 | +0.0562 |
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1169 | +0.0861 | +0.0861 | +0.4034 | 0.45 | 0/8 | 1.46 | 1.85 | `bar_body_rng_0` (0.54) | -0.0005 | +0.0000 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1304 | +0.0976 | +0.0976 | +0.8959 | 0.37 | 0/8 | 1.37 | 1.89 | `star50_limit_proximity_early` (0.68) | -0.0003 | +0.0443 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1226 | +0.0780 | +0.0780 | +0.0786 | 0.42 | 0/8 | 1.43 | 2.01 | `opening_drive_thrust_ratio` (0.53) | -0.0003 | +0.0443 |
...
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1211 | +0.0922 | +0.0922 | -0.0879 | 0.46 | 0/8 | 1.26 | 2.77 | `bar_body_rng_0` (0.54) | -0.0007 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0943 | +0.1204 | +0.1204 | +1.1103 | 0.81 | 2/8 | 1.49 | -9.71 | `rbreaker_buy_setup_proximity_early` (1.12) | +0.0002 | +0.0000 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1141 | +0.0985 | +0.0985 | +0.8687 | 0.52 | 0/8 | 2.01 | 5.46 | `demark_setup_reversal_early` (0.76) | -0.0001 | +0.0443 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1113 | +0.0888 | +0.0888 | +0.6277 | 0.32 | 0/8 | 1.23 | 0.82 | `demark_setup_reversal_early` (0.76) | +0.0002 | +0.0443 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_price_confirmation` | Volatility & Oscillators | +1 | +0.1164 | +0.1258 | +0.1258 | +1.5522 | 0.47 | 0/8 | 0.87 | 1.30 | `volume_price_confirmation` (0.55) | +0.0002 | +0.0000 |
| `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1197 | +0.0838 | +0.0838 | +0.6139 | 0.34 | 0/8 | 1.23 | 1.88 | `volume_weighted_momentum_acceleration` (0.48) | -0.0007 | +0.0000 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1024 | +0.1088 | +0.1088 | +0.4427 | 0.72 | 1/8 | 1.83 | 5.08 | `yesterday_early_vwap_dev` (1.10) | +0.0004 | +0.0538 |
...
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early__bar_body_rng_0` | Other Technical | +1 | +0.1316 | +0.0920 | +0.0920 | +1.2053 | 0.67 | 1/8 | 0.71 | 0.49 | `demark_setup_reversal_early` (0.76) | -0.0002 | +0.0000 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1285 | +0.1028 | +0.1028 | +1.0956 | 0.39 | 0/8 | 1.38 | 1.93 | `star50_limit_proximity_early` (0.68) | -0.0005 | +0.0000 |
| `combo_ifelse__gap_pct__max_up_ret__star50_limit_proximity_early` | Gap / Overnight Reversal | +1 | +0.1202 | +0.1295 | +0.1295 | +0.8774 | 0.42 | 0/8 | 1.40 | 1.86 | `gap_pct` (1.84) | +0.0005 | +0.0443 |
| `combo_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1133 | +0.1244 | +0.1244 | +0.2717 | 0.38 | 0/8 | 1.65 | 2.48 | `opening_drive_thrust_ratio` (0.53) | -0.0004 | +0.0443 |
| `combo_tri_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1233 | +0.1026 | +0.1026 | +0.2266 | 0.32 | 0/8 | 1.49 | 1.85 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | +0.0443 |
| `combo_mean__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1429 | +0.1193 | +0.1193 | +1.5252 | 0.40 | 0/8 | 1.19 | 2.01 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0000 | +0.0000 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1166 | +0.0872 | +0.0872 | +0.4131 | 0.38 | 0/8 | 1.69 | 2.55 | `star50_limit_proximity_early` (0.68) | -0.0003 | +0.0443 |
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1358 | +0.1169 | +0.1169 | +1.0451 | 0.34 | 0/8 | 0.90 | 1.06 | `demark_setup_reversal_early` (0.76) | -0.0002 | +0.0000 |
| `combo_tri_max__yesterday_early_momentum__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0973 | +0.1054 | +0.1054 | +0.5945 | 0.60 | 1/8 | 1.45 | 2.92 | `yesterday_early_momentum` (1.06) | +0.0002 | +0.0000 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.1000 | +0.1399 | +0.1399 | +1.6539 | 0.82 | 1/8 | 1.11 | 12.14 | `limit_down_proximity_early` (1.12) | +0.0001 | +0.0000 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1182 | +0.1236 | +0.1236 | +0.8328 | 0.37 | 0/8 | 1.49 | 2.06 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0007 | +0.0466 |
| `combo_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1202 | +0.0864 | +0.0864 | +0.4855 | 0.36 | 0/8 | 1.21 | 2.12 | `volume_weighted_momentum_acceleration` (0.48) | -0.0005 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1245 | +0.1249 | +0.1249 | +1.2583 | 0.46 | 0/8 | 1.23 | 2.00 | `bar_body_rng_0` (0.54) | -0.0002 | +0.0000 |
...
| `combo_tri_mean__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1074 | +0.1005 | +0.1005 | +0.4995 | 0.74 | 1/8 | 1.24 | 5.28 | `yesterday_early_vwap_dev` (1.10) | +0.0006 | +0.0000 |
| `combo_max__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1341 | +0.1084 | +0.1084 | +0.1964 | 0.30 | 0/8 | 1.32 | 1.43 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0002 | +0.0742 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1100 | +0.1329 | +0.1329 | +1.4350 | 0.45 | 0/8 | 1.91 | 2.40 | `demark_setup_reversal_early` (0.76) | +0.0001 | +0.0000 |
| `combo_rank_min__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0822 | +0.0966 | +0.0966 | +0.6825 | 0.69 | 0/8 | 3.54 | 6.25 | `volatility_expansion_trend_vector` (0.74) | -0.0004 | +0.0000 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1336 | +0.1099 | +0.1099 | +0.2013 | 0.30 | 0/8 | 1.37 | 1.53 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0001 | +0.0295 |
| `combo_mean__rbreaker_sell_setup_proximity_early__directional_volume_signature` | Volatility & Oscillators | +1 | +0.1230 | +0.1345 | +0.1345 | +1.8390 | 0.57 | 1/8 | 1.06 | 1.32 | `directional_volume_signature` (1.20) | +0.0003 | +0.0000 |
| `combo_tri_min__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_trend` | Intraday Range Momentum | +1 | +0.0893 | +0.1105 | +0.1105 | +0.6779 | 0.73 | 1/8 | 1.59 | 15.04 | `yesterday_early_trend` (1.03) | +0.0010 | +0.0000 |
...
| `combo_mean__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.1113 | +0.1183 | +0.1183 | +1.7926 | 0.61 | 1/8 | 1.03 | 3.37 | `rbreaker_buy_setup_proximity_early` (1.12) | -0.0002 | +0.0000 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early__bar_body_rng_0` | Other Technical | +1 | +0.1204 | +0.1209 | +0.1209 | +1.2194 | 0.55 | 1/8 | 1.10 | 1.05 | `demark_setup_reversal_early` (0.76) | +0.0003 | +0.0000 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1146 | +0.0866 | +0.0866 | +0.4183 | 0.48 | 0/8 | 1.91 | 2.92 | `opening_drive_thrust_ratio` (0.53) | -0.0004 | +0.0000 |
| `combo_tri_median__max_up_ret__demark_setup_reversal_early__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.0969 | +0.1156 | +0.1156 | +0.7244 | 0.55 | 0/8 | 2.10 | 2.00 | `demark_setup_reversal_early` (0.76) | +0.0001 | +0.0443 |
| `combo_tri_median__demark_setup_reversal_early__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1040 | +0.1171 | +0.1171 | +1.6028 | 0.56 | 1/8 | 1.19 | 1.13 | `demark_setup_reversal_early` (0.76) | +0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__directional_volume_signature` | Volatility & Oscillators | +1 | +0.1105 | +0.1348 | +0.1348 | +1.8997 | 0.62 | 0/8 | 0.95 | 1.36 | `directional_volume_signature` (1.20) | +0.0007 | +0.0000 |
| `combo_rank_max__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1094 | +0.0964 | +0.0964 | +0.0936 | 0.48 | 0/8 | 2.26 | 3.83 | `star50_limit_proximity_early` (0.68) | -0.0001 | +0.0023 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1286 | +0.1257 | +0.1257 | +1.6419 | 0.47 | 0/8 | 0.98 | 2.23 | `late_bar_momentum` (0.81) | +0.0000 | +0.0023 |
| `combo_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0974 | +0.1273 | +0.1273 | +0.3112 | 0.43 | 0/8 | 2.10 | 3.36 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | +0.0538 |
| `combo_mean__rbreaker_sell_setup_proximity_early__volume_price_confirmation` | Volatility & Oscillators | +1 | +0.1406 | +0.1220 | +0.1220 | +1.6687 | 0.41 | 0/8 | 0.87 | 1.04 | `volume_price_confirmation` (0.55) | +0.0000 | +0.0000 |
...
| `combo_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1172 | +0.0926 | +0.0926 | +0.6024 | 0.38 | 0/8 | 1.12 | 2.11 | `opening_drive_thrust_ratio` (0.53) | -0.0006 | +0.0000 |
| `combo_ifelse__gap_pct__rbreaker_sell_setup_proximity_early__max_up_ret` | Gap / Overnight Reversal | +1 | +0.1100 | +0.1004 | +0.1004 | +0.3556 | 0.41 | 0/8 | 2.45 | 3.26 | `gap_pct` (1.84) | -0.0001 | +0.0538 |
| `combo_min__rbreaker_sell_setup_proximity_early__rally_strength_max` | Other Technical | +1 | +0.1126 | +0.1080 | +0.1080 | +1.2363 | 0.64 | 0/8 | 1.13 | 2.20 | `rally_strength_max` (1.34) | -0.0002 | +0.0000 |
| `combo_rank_max__volatility_expansion_trend_vector__volume_price_confirmation` | Volatility & Oscillators | +1 | +0.1093 | +0.0782 | +0.0782 | +0.8340 | 0.50 | 0/8 | 1.22 | 1.37 | `volatility_expansion_trend_vector` (0.74) | -0.0005 | +0.0000 |
| `combo_rank_min__max_up_ret__gap_pct` | Gap / Overnight Reversal | +1 | +0.0974 | +0.1020 | +0.1020 | +1.2477 | 0.84 | 1/8 | 1.65 | 17.82 | `gap_pct` (1.84) | +0.0004 | +0.0000 |
| `combo_max__max_up_ret__volume_price_confirmation` | Intraday Range Momentum | +1 | +0.1185 | +0.0758 | +0.0758 | +0.7257 | 0.35 | 0/8 | 1.16 | 1.24 | `volume_price_confirmation` (0.55) | -0.0001 | +0.0443 |
| `combo_mean__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1018 | +0.1385 | +0.1385 | +1.1011 | 0.47 | 0/8 | 1.80 | 4.33 | `volatility_expansion_trend_vector` (0.74) | +0.0000 | +0.0000 |
...
| `combo_ifelse__gap_pct__max_up_ret__yesterday_early_trend` | Gap / Overnight Reversal | +1 | +0.1068 | +0.0685 | +0.0685 | +0.3465 | 0.51 | 0/8 | 0.56 | 0.53 | `gap_pct` (1.84) | -0.0001 | +0.0443 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1073 | +0.1227 | +0.1227 | +1.0991 | 0.45 | 0/8 | 2.17 | 2.04 | `demark_setup_reversal_early` (0.76) | +0.0000 | +0.0443 |
| `combo_mean__first_bar_return__limit_down_proximity_early` | Gap / Overnight Reversal | +1 | +0.1180 | +0.1170 | +0.1170 | +1.8672 | 0.50 | 1/8 | 1.06 | 3.25 | `limit_down_proximity_early` (1.12) | -0.0000 | +0.0000 |
| `combo_ifelse__gap_pct__max_up_ret__yesterday_early_vwap_dev` | Gap / Overnight Reversal | +1 | +0.0990 | +0.0720 | +0.0720 | +0.7769 | 0.48 | 0/8 | 0.76 | 0.85 | `gap_pct` (1.84) | +0.0002 | +0.0443 |
| `combo_min__bar_ret_0__limit_down_proximity_early` | Other Technical | +1 | +0.0946 | +0.1271 | +0.1271 | +1.4730 | 0.78 | 1/8 | 1.02 | 6.45 | `limit_down_proximity_early` (1.12) | +0.0001 | +0.0000 |
| `combo_tri_median__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.0938 | +0.0898 | +0.0898 | +0.1198 | 0.90 | 1/8 | 1.25 | 5.52 | `yesterday_early_vwap_dev` (1.10) | +0.0004 | +0.0000 |
| `combo_max__first_bar_return__volatility_expansion_trend_vector` | Gap / Overnight Reversal | +1 | +0.1103 | +0.0856 | +0.0856 | +0.3018 | 0.37 | 0/8 | 1.77 | 1.83 | `volatility_expansion_trend_vector` (0.74) | -0.0005 | +0.0000 |
| `combo_diff__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0984 | +0.1012 | +0.1012 | +0.8236 | 0.25 | 0/8 | 1.38 | 1.13 | `keltner_squeeze_width` (0.61) | +0.0003 | +0.0443 |
| `combo_clamp_diff__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0978 | +0.0975 | +0.0975 | +0.7347 | 0.25 | 0/8 | 1.39 | 1.12 | `keltner_squeeze_width` (0.61) | +0.0003 | +0.0443 |
| `combo_max__first_bar_return__rbreaker_buy_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1100 | +0.0792 | +0.0792 | +0.7948 | 0.41 | 0/8 | 1.23 | 2.25 | `rbreaker_buy_setup_proximity_early` (1.12) | -0.0003 | +0.0000 |
...
_Null Baseline (un-gated candidate pool): 67.0% lock IC > 0, 35.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.2096_
...
_Null Baseline (un-gated candidate pool): 80.0% lock IC > 0, 51.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.0268_
...
| B4 Correlation Gate | 463 | 30 | 100.0% | 90.0% | +0.0986 | +0.5029 |

**Admitted Pool Summary**: 111 features, False Positive Rate = 12.6% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0902, Mean Lock Sharpe = +0.4192
...
- `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow`: Train IC=+0.2671, Lock IC=+0.1077, Lock Sharpe=+0.7168
...
_Null Baseline (un-gated candidate pool): 74.0% lock IC > 0, 55.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.2154_
...
| B4 Correlation Gate | 183 | 30 | 100.0% | 100.0% | +0.1209 | +1.3372 |

**Admitted Pool Summary**: 100 features, False Positive Rate = 1.0% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1113, Mean Lock Sharpe = +0.9975
...
| `combo_clamp_diff__max_up_ret__smooth_momentum_structure` | +0.1871 | +0.0000 | +0.0854 | 0.46x | 2025-07-24 |
...
5. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 96.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 51.0%, mean lock Sharpe=+0.7245). Consider relaxing this gate.
6. **500ETF `single` — B2 Rolling Guard too strict**: 93.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 51.0%, mean lock Sharpe=+0.6125). Consider relaxing this gate.
7. **500ETF `single` — B3 Composite Floor too strict**: 77.8% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 51.0%, mean lock Sharpe=+0.2710). Consider relaxing this gate.
8. **500ETF `single` — B4 Correlation Gate too strict**: 90.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 51.0%, mean lock Sharpe=+0.5029). Consider relaxing this gate.
