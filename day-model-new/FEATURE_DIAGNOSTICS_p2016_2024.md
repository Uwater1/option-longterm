...
### 300ETF — `single` (Full Model Lockbox IC: +0.0307, Sharpe: -0.7350)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0999 | +0.0354 | +0.0354 | -0.3491 | 85.44 | +8.8 | 1.11x | +0.0043 | -0.6596 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1022 | +0.0366 | +0.0366 | -0.5842 | 87.82 | +6.5 | 0.81x | +0.0017 | -0.0659 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1012 | +0.0094 | +0.0094 | -0.4218 | 89.41 | +9.4 | 1.17x | -0.0012 | +0.2338 |
| `combo_min__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0911 | -0.0067 | -0.0067 | -1.6023 | 88.22 | -6.0 | -0.76x | -0.0020 | +0.1551 |
| `combo_z_sum__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0952 | +0.0270 | +0.0270 | +0.1230 | 87.03 | +16.4 | 2.04x | +0.0013 | -0.0696 |
| `combo_rank_min__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1008 | +0.0645 | +0.0645 | +0.5284 | 84.64 | +21.6 | 2.70x | +0.0032 | -0.4874 |
| `combo_tri_max__max_up_ret__bar_ret_0__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0986 | +0.0234 | +0.0234 | -0.6582 | 86.23 | +4.8 | 0.60x | +0.0003 | +0.1832 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0998 | +0.0045 | +0.0045 | -1.0539 | 89.41 | +1.4 | 0.18x | -0.0014 | +0.0877 |
| `combo_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0845 | -0.0088 | -0.0088 | -0.7278 | 88.62 | +5.9 | 0.74x | -0.0006 | +0.2587 |
| `combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0968 | -0.0033 | -0.0033 | -1.2072 | 91.00 | +3.6 | 0.45x | -0.0003 | +0.0877 |
| `bar_body_rng_0` | Other Technical | +1 | +0.0988 | +0.0301 | +0.0301 | -0.6404 | 87.03 | +6.2 | 0.77x | +0.0006 | -0.3563 |
| `combo_rank_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0836 | -0.0055 | -0.0055 | -0.8381 | 67.95 | +1.9 | 0.23x | -0.0018 | -0.0279 |
| `combo_sig_product__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0849 | +0.0427 | +0.0427 | -1.1309 | 87.43 | +0.2 | 0.03x | +0.0036 | -0.1388 |
| `combo_sig_product__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0884 | -0.0007 | -0.0007 | -1.2926 | 89.81 | -1.4 | -0.18x | -0.0002 | +0.0139 |
| `combo_clamp_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0918 | +0.0266 | +0.0266 | -0.1199 | 89.81 | +13.2 | 1.65x | +0.0009 | +0.1927 |
| `combo_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0913 | -0.0033 | -0.0033 | -0.4464 | 73.12 | +4.6 | 0.58x | -0.0028 | +0.0472 |
| `combo_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0719 | +0.0288 | +0.0288 | -0.5423 | 76.30 | +4.5 | 0.56x | +0.0045 | -0.0508 |
| `combo_sig_product__bar_ret_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0832 | -0.0080 | -0.0080 | -1.0044 | 90.61 | +2.4 | 0.30x | -0.0011 | +0.0764 |
| `combo_mean__volume_weighted_price_position__double_bottom_bull_flag_early` | Volatility & Oscillators | +1 | +0.0318 | +0.0535 | +0.0535 | -1.0074 | 82.66 | +3.5 | 0.44x | +0.0031 | +0.1395 |

### 500ETF — `single` (Full Model Lockbox IC: +0.1131, Sharpe: +0.3882)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Standalone Lock Net Sharpe | Annual Turnover | Avg Trade Ret (bps) | Friction Eff | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1412 | +0.1193 | +0.1193 | +0.2422 | 87.82 | +19.0 | 2.37x | +0.0019 | +0.0428 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1346 | +0.0910 | +0.0910 | +0.0732 | 89.81 | +15.9 | 1.99x | +0.0000 | +0.0486 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__trend_bar_close_consistency` | Intraday Range Momentum | +1 | +0.1302 | +0.0955 | +0.0955 | +0.2044 | 85.84 | +18.4 | 2.30x | +0.0001 | +0.1325 |
| `combo_clamp_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1385 | +0.0855 | +0.0855 | +0.5052 | 85.84 | +23.5 | 2.93x | +0.0007 | +0.0766 |
| `combo_rel_diff__opening_auction_imbalance__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1283 | +0.0887 | +0.0887 | -0.0130 | 90.21 | +14.7 | 1.84x | -0.0003 | -0.1569 |
| `combo_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1332 | +0.0698 | +0.0698 | -0.3372 | 73.12 | +6.5 | 0.81x | -0.0009 | -0.0046 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1161 | +0.1193 | +0.1193 | +0.7763 | 83.85 | +29.7 | 3.72x | +0.0017 | +0.3113 |
| `combo_rel_diff__max_up_ret__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1403 | +0.0869 | +0.0869 | +0.0875 | 90.21 | +16.4 | 2.05x | -0.0001 | -0.1569 |
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0591 | +0.0591 | -0.7835 | 85.04 | -1.5 | -0.19x | -0.0011 | -0.0968 |
| `combo_rank_max__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0891 | +0.0833 | +0.0833 | -0.0910 | 73.12 | +10.7 | 1.33x | +0.0005 | +0.0080 |
| `combo_min__opening_auction_imbalance__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1029 | +0.1235 | +0.1235 | +0.7688 | 86.23 | +30.1 | 3.76x | +0.0030 | +0.2333 |
| `combo_min__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1289 | +0.0905 | +0.0905 | -0.1233 | 83.85 | +11.6 | 1.45x | +0.0008 | +0.0079 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1242 | +0.0972 | +0.0972 | +0.7833 | 80.67 | +31.3 | 3.91x | +0.0006 | -0.0471 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1223 | +0.0926 | +0.0926 | +0.7209 | 79.88 | +29.7 | 3.71x | +0.0015 | +0.1759 |
| `combo_min__volatility_expansion_trend_vector__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0941 | +0.0848 | +0.0848 | -0.2413 | 86.63 | +10.8 | 1.36x | +0.0006 | +0.0963 |
| `combo_max__first_bar_sentiment__bar_ret_0` | Gap / Overnight Reversal | +1 | +0.1185 | +0.0673 | +0.0673 | -0.4723 | 83.06 | +3.8 | 0.47x | -0.0005 | -0.0766 |
| `combo_max__close_vs_open_range__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1344 | +0.0749 | +0.0749 | -0.2700 | 87.43 | +9.0 | 1.12x | -0.0009 | -0.1735 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1252 | +0.0607 | +0.0607 | -0.1655 | 87.43 | +11.8 | 1.47x | -0.0005 | +0.1141 |
| `combo_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1239 | +0.0818 | +0.0818 | -0.1349 | 79.88 | +10.2 | 1.27x | +0.0003 | +0.1446 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1293 | +0.0813 | +0.0813 | -0.0733 | 85.84 | +12.7 | 1.59x | -0.0003 | +0.1023 |
| `combo_rank_max__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1454 | +0.0872 | +0.0872 | -0.2020 | 88.62 | +10.6 | 1.32x | -0.0002 | -0.1492 |
| `combo_max__star50_limit_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.0887 | +0.0916 | +0.0916 | +0.0703 | 86.63 | +15.6 | 1.95x | -0.0001 | +0.2634 |
| `combo_rank_min__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1078 | +0.0999 | +0.0999 | +0.1009 | 87.03 | +16.2 | 2.02x | +0.0005 | -0.1168 |
| `combo_sig_product__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1181 | +0.0557 | +0.0557 | -0.0463 | 85.44 | +13.1 | 1.64x | -0.0005 | +0.0653 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1104 | +0.1566 | +0.1566 | +0.2157 | 87.82 | +18.8 | 2.35x | +0.0022 | +0.0085 |
| `combo_rank_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0935 | +0.1046 | +0.1046 | +0.4052 | 79.08 | +21.7 | 2.71x | +0.0013 | +0.0590 |
| `combo_sig_product__opening_auction_imbalance__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0794 | +0.0538 | +0.0538 | -0.3051 | 84.64 | +7.2 | 0.90x | -0.0012 | +0.0653 |
| `combo_mean__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0825 | +0.1093 | +0.1093 | +0.4426 | 81.47 | +23.7 | 2.96x | +0.0018 | +0.1953 |
| `vwap_close_divergence_trend` | Other Technical | +1 | +0.0837 | +0.0582 | +0.0582 | -0.5326 | 87.43 | +3.0 | 0.38x | -0.0003 | +0.0260 |
| `combo_rel_diff__opening_drive_thrust_ratio__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1162 | +0.0876 | +0.0876 | +0.4478 | 89.41 | +21.5 | 2.69x | +0.0006 | -0.1569 |
| `combo_z_sum__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1274 | +0.1011 | +0.1011 | -0.0960 | 91.80 | +13.5 | 1.68x | +0.0006 | -0.0205 |
| `combo_z_sum__first_bar_sentiment__max_down_ret` | Gap / Overnight Reversal | +1 | +0.1068 | +0.0982 | +0.0982 | +0.3203 | 85.44 | +19.8 | 2.48x | +0.0006 | -0.0205 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1447, Sharpe: +0.9456)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Standalone Lock Net Sharpe | Annual Turnover | Avg Trade Ret (bps) | Friction Eff | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1446 | +0.1235 | +0.1235 | +0.5461 | 88.62 | +25.9 | 3.24x | -0.0004 | -0.1314 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__yesterday_early_vwap_dev__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1163 | +0.0911 | +0.0911 | +0.3186 | 83.85 | +22.1 | 2.77x | +0.0009 | -0.2422 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1433 | +0.1156 | +0.1156 | +1.1752 | 83.06 | +42.0 | 5.25x | -0.0011 | -0.1219 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1237 | +0.1316 | +0.1316 | +1.2887 | 86.23 | +42.5 | 5.31x | +0.0015 | +0.0116 |
| `combo_rank_min__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0981 | +0.1273 | +0.1273 | +0.9833 | 83.85 | +36.6 | 4.58x | -0.0003 | +0.0451 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1415 | +0.1181 | +0.1181 | +1.2510 | 87.03 | +44.7 | 5.59x | -0.0004 | +0.0204 |
| `combo_rel_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1142 | +0.1085 | +0.1085 | +0.6332 | 87.43 | +29.0 | 3.63x | +0.0003 | -0.0010 |
| `combo_rank_min__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0880 | +0.1090 | +0.1090 | +0.0124 | 77.49 | +13.1 | 1.64x | +0.0007 | +0.0083 |
...
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1182 | +0.1236 | +0.1236 | +0.5605 | 85.44 | +26.9 | 3.36x | -0.0003 | -0.0772 |
| `combo_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1137 | +0.1246 | +0.1246 | +1.2584 | 79.08 | +46.3 | 5.78x | +0.0003 | +0.0320 |
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1169 | +0.0872 | +0.0872 | +0.0736 | 88.62 | +16.3 | 2.04x | -0.0002 | -0.0061 |
| `combo_mean__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.1014 | +0.1330 | +0.1330 | +0.8015 | 81.07 | +33.3 | 4.17x | +0.0002 | -0.1482 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0943 | +0.1192 | +0.1192 | +0.8728 | 84.64 | +32.4 | 4.04x | +0.0001 | -0.0302 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1233 | +0.1118 | +0.1118 | +0.5971 | 87.82 | +28.2 | 3.53x | +0.0001 | -0.1569 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0965 | +0.0779 | +0.0779 | -0.0215 | 67.95 | +10.8 | 1.35x | -0.0011 | +0.0294 |
| `combo_min__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.1019 | +0.1284 | +0.1284 | +0.9565 | 84.64 | +37.4 | 4.68x | -0.0001 | +0.0715 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1202 | +0.1214 | +0.1214 | +0.6641 | 82.26 | +26.9 | 3.36x | -0.0003 | +0.0360 |
| `combo_rank_max__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0942 | +0.1243 | +0.1243 | +0.5212 | 85.44 | +25.8 | 3.23x | +0.0012 | -0.0660 |
| `combo_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0613 | +0.0486 | +0.0486 | +0.5769 | 83.06 | +28.7 | 3.59x | +0.0001 | -0.0083 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1165 | +0.0874 | +0.0874 | +0.1633 | 83.85 | +17.7 | 2.21x | -0.0005 | -0.0410 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | Other Technical | +1 | +0.0697 | +0.0804 | +0.0804 | +0.2268 | 72.72 | +16.4 | 2.05x | -0.0008 | -0.0550 |
| `combo_rank_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1142 | +0.1274 | +0.1274 | +0.5997 | 86.23 | +28.3 | 3.54x | +0.0008 | -0.1146 |
| `combo_min__yesterday_first_30min_return__rbreaker_buy_setup_proximity_early` | Intraday Range Momentum | +1 | +0.0635 | +0.1067 | +0.1067 | -0.1148 | 75.11 | +9.3 | 1.17x | -0.0005 | -0.0199 |
| `combo_clamp_diff__star50_limit_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1016 | +0.1298 | +0.1298 | -0.2127 | 80.67 | +8.7 | 1.09x | -0.0006 | -0.0568 |
| `combo_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0974 | +0.1273 | +0.1273 | +0.0566 | 85.44 | +15.5 | 1.93x | -0.0002 | +0.0751 |
| `combo_z_sum__first_bar_sentiment__rbreaker_buy_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1009 | +0.1020 | +0.1020 | +1.0549 | 85.44 | +40.8 | 5.11x | -0.0008 | +0.0315 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1021 | +0.0789 | +0.0789 | +0.1411 | 85.44 | +17.3 | 2.17x | -0.0007 | -0.1749 |
| `combo_ratio__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0962 | +0.1348 | +0.1348 | +0.8488 | 82.26 | +35.3 | 4.41x | -0.0006 | +0.0315 |
...
_Null Baseline (un-gated candidate pool): 56.0% lock IC > 0, 9.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.7958_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 1031 | 30 | 90.0% | 23.3% | +0.0170 | -0.4545 |
| B2 Rolling Guard | 51 | 30 | 63.3% | 6.7% | +0.0019 | -0.6864 |
| BH-FDR Gate | 10 | 10 | 20.0% | 10.0% | -0.0138 | -0.9581 |
| B3 Composite Floor | 164 | 30 | 90.0% | 20.0% | +0.0216 | -0.3713 |
| B4 Correlation Gate | 83 | 30 | 83.3% | 10.0% | +0.0153 | -0.4276 |

**Admitted Pool Summary**: 19 features, False Positive Rate = 89.5% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0182, Mean Lock Sharpe = -0.6829
...
- `combo_max__first_bar_return__volume_surge_direction`: Train IC=+0.1880, Lock IC=+0.0141, Lock Sharpe=+0.4252
...
_Null Baseline (un-gated candidate pool): 38.0% lock IC > 0, 19.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.4860_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 528 | 30 | 83.3% | 60.0% | +0.0227 | -0.0472 |
| B2 Rolling Guard | 48 | 30 | 20.0% | 10.0% | -0.0071 | -0.3190 |
| BH-FDR Gate | 10 | 10 | 40.0% | 0.0% | -0.0141 | -0.8789 |
...
| B2 Rolling Guard | 62 | 30 | 43.3% | 3.3% | -0.0021 | -0.7976 |
...
_Null Baseline (un-gated candidate pool): 63.0% lock IC > 0, 18.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.5220_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 711 | 30 | 96.7% | 66.7% | +0.0458 | +0.2518 |
| B2 Rolling Guard | 21 | 21 | 33.3% | 0.0% | +0.0022 | -0.5212 |
| BH-FDR Gate | 10 | 10 | 10.0% | 0.0% | -0.0314 | -1.4970 |
...
_Null Baseline (un-gated candidate pool): 64.0% lock IC > 0, 18.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.7001_
...
_Null Baseline (un-gated candidate pool): 52.0% lock IC > 0, 9.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.6456_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 275 | 30 | 73.3% | 43.3% | +0.0304 | -0.1061 |
| B2 Rolling Guard | 42 | 30 | 33.3% | 0.0% | -0.0001 | -0.5612 |
...
_Null Baseline (un-gated candidate pool): 81.0% lock IC > 0, 33.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.3128_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 1762 | 30 | 96.7% | 80.0% | +0.1013 | +0.3245 |
| B2 Rolling Guard | 168 | 30 | 100.0% | 50.0% | +0.0559 | -0.1631 |
| BH-FDR Gate | 9 | 9 | 88.9% | 22.2% | +0.0297 | -0.2030 |
| B3 Composite Floor | 457 | 30 | 100.0% | 73.3% | +0.0978 | +0.2726 |
| B4 Correlation Gate | 296 | 30 | 100.0% | 56.7% | +0.0937 | +0.1033 |

**Admitted Pool Summary**: 32 features, False Positive Rate = 50.0% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0893, Mean Lock Sharpe = +0.0712
...
_Null Baseline (un-gated candidate pool): 68.0% lock IC > 0, 17.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.4430_
...
_Null Baseline (un-gated candidate pool): 55.0% lock IC > 0, 16.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.4906_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 377 | 30 | 50.0% | 20.0% | +0.0159 | -0.4622 |
| B2 Rolling Guard | 43 | 30 | 50.0% | 13.3% | +0.0021 | -0.4240 |
...
_Null Baseline (un-gated candidate pool): 78.0% lock IC > 0, 47.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = +0.0121_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 1140 | 30 | 96.7% | 63.3% | +0.0961 | +0.2439 |
| B2 Rolling Guard | 109 | 30 | 96.7% | 80.0% | +0.0703 | +0.3632 |
| BH-FDR Gate | 7 | 7 | 85.7% | 42.9% | +0.0526 | -0.1896 |
| B3 Composite Floor | 274 | 30 | 100.0% | 76.7% | +0.0980 | +0.5296 |
| B4 Correlation Gate | 168 | 30 | 100.0% | 100.0% | +0.1222 | +1.0275 |

**Admitted Pool Summary**: 29 features, False Positive Rate = 10.3% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1106, Mean Lock Sharpe = +0.5716
...
- `combo_min__star50_limit_proximity_early__first_bar_sentiment`: Train IC=+0.1921, Lock IC=+0.1128, Lock Sharpe=+1.0822
...
- `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment`: Train IC=+0.2449, Lock IC=+0.1240, Lock Sharpe=+1.2793
- `combo_tri_min__max_up_ret__star50_limit_proximity_early__first_bar_sentiment`: Train IC=+0.2295, Lock IC=+0.1054, Lock Sharpe=+1.2704
...
_Null Baseline (un-gated candidate pool): 44.0% lock IC > 0, 17.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.4826_

| Gate | N Rejected | N Sampled | % Lock IC > 0 | True FN Rate (IC>0 & Sharpe>0) | Mean Lock IC | Mean Lock Sharpe |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife Sign Stability | 247 | 30 | 76.7% | 30.0% | +0.0305 | -0.3048 |
| B2 Rolling Guard | 50 | 30 | 63.3% | 36.7% | +0.0232 | -0.1398 |
...
| Mono Thr | IR Thr | N Would Pass | Mean Lock IC | % Positive Lock IC |
| ---: | ---: | ---: | ---: | ---: |
| 0.45 | 0.10 | 17 | -0.0256 | 20.0% |
| 0.45 | 0.20 | 13 | -0.0256 | 20.0% |
| 0.45 | 0.30 | 10 | -0.0314 | 10.0% |
| 0.45 | 0.40 | 3 | -0.0180 | 33.3% |
| 0.45 | 0.50 | 2 | -0.0008 | 50.0% |
| 0.50 | 0.15 | 13 | -0.0256 | 20.0% |
| 0.50 | 0.25 | 13 | -0.0256 | 20.0% |
| 0.50 | 0.35 | 7 | -0.0323 | 14.3% |
| 0.50 | 0.45 | 2 | -0.0008 | 50.0% |
| 0.55 | 0.10 | 14 | -0.0256 | 20.0% |
| 0.55 | 0.20 | 13 | -0.0256 | 20.0% |
| 0.55 | 0.30 | 10 | -0.0314 | 10.0% |
| 0.55 | 0.40 | 3 | -0.0180 | 33.3% |
| 0.55 | 0.50 | 2 | -0.0008 | 50.0% |
| 0.60 | 0.15 | 12 | -0.0273 | 20.0% |
| 0.60 | 0.25 | 12 | -0.0273 | 20.0% |
...
1. **300ETF `single` — 7-Year Jackknife Sign Stability too strict**: 23.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 9.0%, mean lock Sharpe=-0.4545). Consider relaxing this gate.
2. **300ETF `single` — B3 Composite Floor too strict**: 20.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 9.0%, mean lock Sharpe=-0.3713). Consider relaxing this gate.
3. **300ETF `single` — Admission too loose**: 89% of admitted features have negative lockbox IC or Sharpe. Tighten B3 composite floor or add OOS validation gate.
...
5. **50ETF `single` — 7-Year Jackknife Sign Stability too strict**: 66.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 18.0%, mean lock Sharpe=+0.2518). Consider relaxing this gate.
6. **50ETF `short` — 7-Year Jackknife Sign Stability too strict**: 43.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 9.0%, mean lock Sharpe=-0.1061). Consider relaxing this gate.
7. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 80.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 33.0%, mean lock Sharpe=+0.3245). Consider relaxing this gate.
8. **500ETF `single` — B2 Rolling Guard too strict**: 50.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 33.0%, mean lock Sharpe=-0.1631). Consider relaxing this gate.
9. **500ETF `single` — B3 Composite Floor too strict**: 73.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 33.0%, mean lock Sharpe=+0.2726). Consider relaxing this gate.
10. **500ETF `single` — B4 Correlation Gate too strict**: 56.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 33.0%, mean lock Sharpe=+0.1033). Consider relaxing this gate.
11. **500ETF `short` — BH-FDR Gate too strict**: 50.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 16.0%, mean lock Sharpe=-0.1162). Consider relaxing this gate.
12. **159915ETF `single` — B2 Rolling Guard too strict**: 80.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 47.0%, mean lock Sharpe=+0.3632). Consider relaxing this gate.
13. **159915ETF `single` — B3 Composite Floor too strict**: 76.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 47.0%, mean lock Sharpe=+0.5296). Consider relaxing this gate.
14. **159915ETF `single` — B4 Correlation Gate too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 47.0%, mean lock Sharpe=+1.0275). Consider relaxing this gate.
15. **159915ETF `long` — B2 Rolling Guard too strict**: 76.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.4725). Consider relaxing this gate.
16. **159915ETF `long` — BH-FDR Gate too strict**: 86.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.4524). Consider relaxing this gate.
17. **159915ETF `long` — B3 Composite Floor too strict**: 90.9% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.4691). Consider relaxing this gate.
18. **159915ETF `short` — 7-Year Jackknife Sign Stability too strict**: 30.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 17.0%, mean lock Sharpe=-0.3048). Consider relaxing this gate.
19. **159915ETF `short` — B2 Rolling Guard too strict**: 36.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 17.0%, mean lock Sharpe=-0.1398). Consider relaxing this gate.
