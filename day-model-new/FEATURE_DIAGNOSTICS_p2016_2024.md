...
### 300ETF — `single` (Full Model Lockbox IC: +0.0361, Sharpe: +0.1204)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1068 | +0.0383 | +0.0383 | -0.0697 | 0.79 | 1/8 | 0.86 | 3.04 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0004 | +0.0046 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1045 | +0.0512 | +0.0512 | +0.6322 | 0.77 | 1/8 | 0.86 | 5.39 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0005 | -0.0216 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0939 | -0.0018 | -0.0018 | +0.1999 | 0.85 | 0/8 | 1.48 | 4.09 | `volume_weighted_price_position` (1.11) | -0.0009 | +0.0000 |
| `combo_mean__bar_body_rng_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1007 | +0.0123 | +0.0123 | -0.4689 | 0.80 | 1/8 | 0.86 | 2.06 | `volume_weighted_price_position` (1.11) | -0.0008 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1019 | +0.0460 | +0.0460 | +0.1064 | 0.73 | 1/8 | 0.85 | 4.68 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0007 | -0.0170 |
| `combo_rank_max__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0915 | -0.0131 | -0.0131 | -0.5701 | 0.90 | 2/8 | 1.54 | 6.91 | `volume_weighted_price_position` (1.11) | -0.0008 | -0.0362 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1023 | +0.0245 | +0.0245 | +0.1045 | 0.83 | 1/8 | 0.98 | 4.08 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0012 |
| `combo_mean__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.0886 | +0.0067 | +0.0067 | -0.2911 | 0.83 | 1/8 | 1.37 | 3.88 | `max_up_ret` (0.89) | -0.0003 | +0.0046 |
| `combo_tri_min__max_up_ret__bar_body_rng_0__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.1013 | +0.0094 | +0.0094 | +0.1080 | 0.78 | 1/8 | 0.82 | 1.96 | `volume_weighted_price_position` (1.11) | -0.0004 | +0.0000 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1008 | +0.0254 | +0.0254 | +0.4883 | 0.81 | 1/8 | 1.11 | 5.15 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0046 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0924 | +0.0084 | +0.0084 | -0.0883 | 0.71 | 1/8 | 0.87 | 1.96 | `max_up_ret` (0.89) | -0.0013 | -0.0543 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0882 | +0.0655 | +0.0655 | +0.9697 | 0.82 | 1/8 | 0.80 | 8.68 | `rbreaker_buy_setup_proximity_early` (2.08) | +0.0016 | -0.0216 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0915 | -0.0023 | -0.0023 | -0.5759 | 0.82 | 0/8 | 1.74 | 3.10 | `volume_weighted_price_position` (1.11) | -0.0009 | -0.0362 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__rbreaker_buy_setup_proximity_early` | Intraday Range Momentum | +1 | +0.0985 | +0.0311 | +0.0311 | +0.7153 | 0.79 | 1/8 | 1.21 | 6.50 | `rbreaker_buy_setup_proximity_early` (2.08) | -0.0004 | +0.0046 |
| `combo_min__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0955 | +0.0125 | +0.0125 | -0.4568 | 0.90 | 1/8 | 1.06 | 3.88 | `volume_weighted_price_position` (1.11) | -0.0003 | +0.0000 |
| `combo_tri_max__first_bar_return__bar_body_rng_0__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0998 | +0.0045 | +0.0045 | -0.5240 | 0.71 | 1/8 | 0.94 | 1.74 | `volume_weighted_price_position` (1.11) | -0.0007 | -0.0362 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__volume_concentration` | Intraday Range Momentum | +1 | +0.0795 | +0.0048 | +0.0048 | +0.0349 | 0.84 | 2/8 | 1.35 | 2.05 | `volume_concentration` (0.95) | -0.0002 | +0.0046 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0828 | -0.0138 | -0.0138 | -0.3231 | 0.92 | 0/8 | 1.93 | 5.15 | `volume_weighted_price_position` (1.11) | -0.0014 | -0.0362 |
| `combo_rank_max__bar_body_rng_0__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0962 | +0.0069 | +0.0069 | -0.3876 | 0.76 | 1/8 | 0.92 | 1.72 | `volume_weighted_price_position` (1.11) | -0.0006 | -0.0362 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1098 | +0.0362 | +0.0362 | +0.3660 | 0.56 | 0/8 | 0.77 | 1.61 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0005 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0989 | +0.0057 | +0.0057 | -0.2202 | 0.85 | 1/8 | 1.03 | 3.29 | `volume_weighted_price_position` (1.11) | -0.0004 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__limit_down_proximity_early` | Intraday Range Momentum | +1 | +0.0886 | +0.0352 | +0.0352 | +0.4654 | 0.89 | 1/8 | 1.31 | -15.67 | `limit_down_proximity_early` (2.08) | -0.0002 | +0.0046 |
| `combo_tri_min__opening_drive_thrust_ratio__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0919 | +0.0483 | +0.0483 | +0.3089 | 0.88 | 1/8 | 0.72 | 3.36 | `rbreaker_buy_setup_proximity_early` (2.08) | +0.0010 | +0.0000 |
| `combo_max__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0909 | +0.0124 | +0.0124 | +0.1247 | 0.68 | 0/8 | 1.13 | 1.40 | `max_up_ret` (0.89) | -0.0004 | +0.0000 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1022 | +0.0351 | +0.0351 | +0.1736 | 0.87 | 1/8 | 1.13 | -40.14 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0338 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.0841 | +0.0193 | +0.0193 | +0.2919 | 0.85 | 1/8 | 1.27 | 7.30 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0046 |
| `combo_tri_median__star50_limit_proximity_early__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1102 | +0.0337 | +0.0337 | +0.2687 | 0.74 | 1/8 | 0.87 | 3.16 | `star50_limit_proximity_early` (1.24) | -0.0001 | -0.0033 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1095 | +0.0329 | +0.0329 | +0.3820 | 0.63 | 1/8 | 0.94 | 1.81 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0004 | +0.0046 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.0881 | +0.0572 | +0.0572 | +0.6639 | 0.86 | 1/8 | 0.74 | 7.30 | `limit_down_proximity_early` (2.08) | +0.0014 | -0.0216 |
| `combo_tri_median__max_up_ret__bar_body_rng_0__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0953 | +0.0012 | +0.0012 | +0.0941 | 0.87 | 2/8 | 1.05 | 3.58 | `volume_weighted_price_position` (1.11) | -0.0010 | +0.0000 |
| `combo_tri_median__max_up_ret__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Intraday Range Momentum | +1 | +0.1032 | +0.0238 | +0.0238 | +0.3693 | 0.77 | 1/8 | 1.13 | 6.91 | `rbreaker_buy_setup_proximity_early` (2.08) | -0.0005 | -0.0543 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0876 | +0.0013 | +0.0013 | -0.3332 | 0.89 | 1/8 | 1.95 | 6.25 | `volume_weighted_price_position` (1.11) | -0.0001 | -0.0362 |
...
| `combo_mean__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1013 | +0.0496 | +0.0496 | +0.5363 | 0.59 | 1/8 | 0.75 | 1.63 | `star50_limit_proximity_early` (1.24) | +0.0002 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0899 | +0.0334 | +0.0334 | +0.9753 | 0.74 | 1/8 | 1.18 | 3.01 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0006 | +0.0046 |
| `combo_tri_min__star50_limit_proximity_early__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.0925 | +0.0377 | +0.0377 | +0.6416 | 0.82 | 1/8 | 0.81 | 7.29 | `star50_limit_proximity_early` (1.24) | +0.0011 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__morning_volume_weighted_momentum` | Intraday Range Momentum | +1 | +0.0814 | +0.0231 | +0.0231 | +0.3889 | 0.97 | 1/8 | 2.71 | -7.24 | `morning_volume_weighted_momentum` (1.71) | +0.0009 | -0.0543 |

### 500ETF — `single` (Full Model Lockbox IC: +0.1064, Sharpe: +0.6523)
...
| `combo_rank_max__opening_drive_thrust_ratio__early_body_momentum` | Intraday Range Momentum | +1 | +0.1174 | +0.0915 | +0.0915 | +0.4102 | 0.38 | 0/8 | 0.76 | 0.59 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | +0.0000 |
...
| `combo_rank_max__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0586 | +0.0586 | -0.0789 | 0.35 | 0/8 | 0.74 | 0.67 | `bar_ret_0` (0.46) | -0.0006 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1304 | +0.0995 | +0.0995 | +0.1554 | 0.37 | 0/8 | 0.71 | 0.63 | `opening_drive_thrust_ratio` (0.40) | -0.0001 | -0.0520 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1297 | +0.1084 | +0.1084 | +1.0418 | 0.28 | 0/8 | 0.88 | 0.58 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0003 | +0.0000 |
| `combo_tri_max__max_up_ret__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1315 | +0.0739 | +0.0739 | +0.1807 | 0.39 | 0/8 | 0.69 | 0.74 | `bar_ret_0` (0.46) | -0.0003 | -0.0520 |
| `combo_max__early_body_momentum__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1192 | +0.0580 | +0.0580 | -0.3703 | 0.38 | 0/8 | 0.74 | 0.69 | `first_bar_return` (0.46) | -0.0006 | -0.0520 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__trend_bar_close_consistency__bar_ret_0` | Other Technical | +1 | +0.1269 | +0.1011 | +0.1011 | +0.6858 | 0.36 | 0/8 | 0.68 | 0.55 | `trend_bar_close_consistency` (0.66) | -0.0000 | +0.0000 |
| `combo_rel_diff__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.1335 | +0.1206 | +0.1206 | +0.6620 | 0.33 | 0/8 | 0.69 | 0.62 | `demark_setup_reversal_early` (0.57) | -0.0001 | +0.0000 |
...
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1391 | +0.1128 | +0.1128 | +0.4001 | 0.29 | 0/8 | 0.80 | 0.72 | `opening_drive_thrust_ratio` (0.40) | -0.0001 | +0.0000 |
| `combo_tri_median__max_up_ret__net_volume_flow__bar_ret_0` | Intraday Range Momentum | +1 | +0.1231 | +0.0637 | +0.0637 | +0.0275 | 0.38 | 0/8 | 0.71 | 0.58 | `bar_ret_0` (0.46) | -0.0003 | -0.0520 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1412 | +0.1193 | +0.1193 | +0.5966 | 0.44 | 0/8 | 0.66 | 0.32 | `opening_drive_thrust_ratio` (0.40) | +0.0002 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1496 | +0.1043 | +0.1043 | +0.4791 | 0.34 | 0/8 | 0.70 | 0.53 | `bar_ret_0` (0.46) | -0.0001 | -0.0520 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1350 | +0.1136 | +0.1136 | +1.3415 | 0.39 | 0/8 | 0.59 | 0.39 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0001 | +0.0000 |
...
| `combo_rel_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1349 | +0.0747 | +0.0747 | +0.0706 | 0.35 | 0/8 | 0.70 | 0.51 | `body_size_progression` (0.60) | -0.0000 | -0.0520 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1391 | +0.0836 | +0.0836 | +0.4618 | 0.35 | 0/8 | 0.64 | 0.55 | `bar_body_rng_0` (0.37) | -0.0000 | -0.0520 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1277 | +0.1056 | +0.1056 | +0.9169 | 0.42 | 0/8 | 0.56 | 0.41 | `rbreaker_sell_setup_proximity_early` (0.38) | +0.0006 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1550 | +0.1142 | +0.1142 | +0.6523 | 0.39 | 0/8 | 0.66 | 0.47 | `bar_ret_0` (0.46) | +0.0000 | -0.0520 |
| `combo_min__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1367 | +0.0949 | +0.0949 | +0.4145 | 0.34 | 0/8 | 0.77 | 0.59 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | -0.0520 |
...
| `combo_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1390 | +0.0842 | +0.0842 | +0.4912 | 0.34 | 0/8 | 0.71 | 0.55 | `body_size_progression` (0.60) | +0.0001 | -0.0520 |
| `combo_rank_min__volatility_expansion_trend_vector__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0928 | +0.0800 | +0.0800 | +0.0855 | 0.42 | 0/8 | 0.99 | 0.89 | `vwap_close_divergence_trend` (0.50) | -0.0005 | +0.0000 |
| `combo_tri_max__opening_drive_thrust_ratio__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1417 | +0.0783 | +0.0783 | +0.1736 | 0.35 | 0/8 | 0.82 | 0.68 | `bar_ret_0` (0.46) | -0.0003 | -0.0520 |
| `combo_rank_max__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1349 | +0.0752 | +0.0752 | +0.1487 | 0.31 | 0/8 | 0.81 | 0.66 | `first_bar_return` (0.46) | -0.0004 | -0.0520 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1289 | +0.1105 | +0.1105 | +0.9584 | 0.40 | 0/8 | 0.73 | 0.48 | `volatility_expansion_trend_vector` (0.41) | +0.0001 | +0.0000 |
| `combo_clamp_diff__max_up_ret__body_size_progression` | Intraday Range Momentum | +1 | +0.1385 | +0.0855 | +0.0855 | +0.8416 | 0.33 | 0/8 | 0.72 | 0.58 | `body_size_progression` (0.60) | +0.0002 | -0.0520 |
| `combo_diff__first_bar_return__demark_setup_reversal_early` | Gap / Overnight Reversal | +1 | +0.1356 | +0.1173 | +0.1173 | +0.5806 | 0.40 | 0/8 | 0.71 | 0.71 | `demark_setup_reversal_early` (0.57) | +0.0001 | -0.0520 |
| `combo_min__net_volume_flow__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0982 | +0.0779 | +0.0779 | +0.1726 | 0.39 | 0/8 | 0.88 | 0.85 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_tri_mean__early_body_momentum__star50_limit_proximity_early__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1049 | +0.0978 | +0.0978 | +0.6135 | 0.38 | 0/8 | 0.68 | 0.61 | `star50_limit_proximity_early` (0.55) | -0.0002 | +0.0000 |
...
| `combo_tri_median__opening_drive_thrust_ratio__net_volume_flow__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1034 | +0.0929 | +0.0929 | +0.7066 | 0.23 | 0/8 | 0.84 | 0.89 | `smooth_momentum_structure` (0.62) | -0.0003 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1198 | +0.1201 | +0.1201 | +1.0892 | 0.35 | 0/8 | 0.73 | 0.52 | `close_vs_open_range` (0.42) | -0.0000 | +0.0000 |
| `combo_min__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1008 | +0.0912 | +0.0912 | +0.5728 | 0.50 | 0/8 | 0.71 | 0.64 | `max_down_ret` (0.62) | -0.0001 | +0.0000 |
| `combo_max__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1344 | +0.0749 | +0.0749 | +0.0494 | 0.33 | 0/8 | 0.82 | 0.66 | `first_bar_return` (0.46) | -0.0003 | -0.0520 |
| `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1467 | +0.0912 | +0.0912 | +0.2017 | 0.38 | 0/8 | 0.69 | 0.58 | `bar_ret_0` (0.46) | +0.0000 | -0.0520 |
| `combo_min__close_vs_open_range__vwap_close_divergence_trend` | Other Technical | +1 | +0.0943 | +0.0800 | +0.0800 | +0.0807 | 0.39 | 0/8 | 1.07 | 0.90 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1474 | +0.1055 | +0.1055 | +0.9440 | 0.38 | 0/8 | 0.63 | 0.46 | `star50_limit_proximity_early` (0.55) | -0.0000 | +0.0000 |
| `combo_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1496 | +0.0874 | +0.0874 | +0.8706 | 0.42 | 0/8 | 0.70 | 0.61 | `volume_weighted_momentum_acceleration` (0.62) | -0.0001 | -0.0520 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1309 | +0.0903 | +0.0903 | +0.3727 | 0.30 | 0/8 | 0.75 | 0.65 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0004 | +0.0000 |
| `combo_tri_median__volatility_expansion_trend_vector__star50_limit_proximity_early__bar_ret_0` | Volatility & Oscillators | +1 | +0.1303 | +0.1105 | +0.1105 | +0.7811 | 0.44 | 0/8 | 0.55 | 0.51 | `star50_limit_proximity_early` (0.55) | +0.0000 | +0.0000 |
| `combo_mean__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1232 | +0.0841 | +0.0841 | +0.5556 | 0.32 | 0/8 | 0.86 | 0.70 | `volatility_expansion_trend_vector` (0.41) | -0.0004 | +0.0000 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1374 | +0.0813 | +0.0813 | +0.6652 | 0.33 | 0/8 | 0.67 | 0.74 | `bar_ret_0` (0.46) | -0.0003 | +0.0000 |
| `combo_rank_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0939 | +0.0890 | +0.0890 | +0.3159 | 0.37 | 0/8 | 0.71 | 0.70 | `close_vs_open_range` (0.42) | -0.0003 | +0.0000 |
| `combo_max__bar_ret_0__max_down_ret` | Intraday Range Momentum | +1 | +0.1239 | +0.0818 | +0.0818 | +0.0961 | 0.51 | 0/8 | 0.50 | 0.39 | `max_down_ret` (0.62) | -0.0000 | -0.0520 |
| `combo_tri_min__max_up_ret__net_volume_flow__bar_ret_0` | Intraday Range Momentum | +1 | +0.1197 | +0.0945 | +0.0945 | +0.4270 | 0.30 | 0/8 | 0.76 | 0.77 | `bar_ret_0` (0.46) | +0.0002 | +0.0000 |
...
| `combo_diff__opening_drive_thrust_ratio__h2_l2_pullback_continuation` | Other Technical | +1 | +0.1167 | +0.0815 | +0.0815 | +0.3462 | 0.30 | 0/8 | 0.81 | 0.67 | `h2_l2_pullback_continuation` (0.45) | -0.0004 | +0.0000 |
| `combo_mean__max_up_ret__max_down_ret` | Intraday Range Momentum | +1 | +0.1253 | +0.0997 | +0.0997 | +0.5811 | 0.41 | 0/8 | 0.78 | 0.65 | `max_down_ret` (0.62) | +0.0002 | -0.0520 |
...
| `combo_rel_diff__opening_drive_thrust_ratio__h2_l2_pullback_continuation` | Other Technical | +1 | +0.1133 | +0.0752 | +0.0752 | +0.3462 | 0.31 | 0/8 | 0.89 | 0.74 | `h2_l2_pullback_continuation` (0.45) | -0.0002 | +0.0000 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1329 | +0.0678 | +0.0678 | +0.5233 | 0.39 | 0/8 | 0.66 | 0.63 | `bar_body_rng_0` (0.37) | -0.0001 | -0.0520 |
| `combo_clamp_diff__opening_drive_thrust_ratio__body_size_progression` | Other Technical | +1 | +0.1327 | +0.0902 | +0.0902 | +0.1578 | 0.45 | 0/8 | 0.69 | 0.64 | `body_size_progression` (0.60) | +0.0001 | -0.0520 |
| `combo_min__net_volume_flow__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0954 | +0.0868 | +0.0868 | +0.2383 | 0.35 | 0/8 | 0.72 | 0.69 | `close_vs_open_range` (0.42) | -0.0002 | +0.0000 |
| `combo_rank_min__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1020 | +0.0898 | +0.0898 | +0.4472 | 0.54 | 0/8 | 0.63 | 0.51 | `max_down_ret` (0.62) | -0.0000 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1162 | +0.1125 | +0.1125 | +1.2249 | 0.34 | 0/8 | 0.78 | 0.58 | `volatility_expansion_trend_vector` (0.41) | +0.0002 | +0.0000 |
| `combo_max__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1302 | +0.0704 | +0.0704 | -0.1210 | 0.26 | 0/8 | 0.98 | 0.81 | `vwap_close_divergence_trend` (0.50) | -0.0003 | -0.0520 |
| `combo_mean__opening_drive_thrust_ratio__early_body_momentum` | Intraday Range Momentum | +1 | +0.1212 | +0.0857 | +0.0857 | -0.2639 | 0.32 | 0/8 | 0.86 | 0.77 | `opening_drive_thrust_ratio` (0.40) | -0.0005 | +0.0000 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__trend_day_regime_conviction__bar_ret_0` | Other Technical | +1 | +0.1335 | +0.0955 | +0.0955 | +0.4321 | 0.41 | 0/8 | 0.69 | 0.59 | `trend_day_regime_conviction` (0.46) | +0.0000 | -0.0520 |
| `combo_max__max_up_ret__max_down_ret` | Intraday Range Momentum | +1 | +0.1295 | +0.0839 | +0.0839 | +0.4972 | 0.49 | 0/8 | 0.61 | 0.46 | `max_down_ret` (0.62) | +0.0000 | -0.0520 |
| `combo_rank_min__volatility_expansion_trend_vector__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1016 | +0.1246 | +0.1246 | +1.3362 | 0.49 | 0/8 | 0.75 | 0.48 | `star50_limit_proximity_early` (0.55) | +0.0002 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1350 | +0.0894 | +0.0894 | +0.0870 | 0.43 | 0/8 | 0.58 | 0.48 | `bar_ret_0` (0.46) | +0.0000 | -0.0520 |
| `combo_mean__first_bar_return__close_vs_open_range` | Gap / Overnight Reversal | +1 | +0.1215 | +0.0927 | +0.0927 | +0.2533 | 0.38 | 0/8 | 0.66 | 0.56 | `first_bar_return` (0.46) | -0.0001 | -0.0520 |
| `combo_mean__opening_drive_thrust_ratio__vwap_close_divergence_trend` | Other Technical | +1 | +0.1203 | +0.0781 | +0.0781 | -0.2958 | 0.39 | 0/8 | 0.90 | 0.74 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_tri_median__opening_drive_thrust_ratio__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1249 | +0.0852 | +0.0852 | -0.1000 | 0.41 | 0/8 | 0.66 | 0.51 | `bar_ret_0` (0.46) | -0.0003 | +0.0000 |
| `combo_rel_diff__max_up_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.1073 | +0.0633 | +0.0633 | +0.0279 | 0.27 | 0/8 | 0.93 | 0.82 | `h2_l2_pullback_continuation` (0.45) | -0.0004 | +0.0000 |
| `combo_min__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1010 | +0.0997 | +0.0997 | +0.7541 | 0.47 | 0/8 | 0.51 | 0.54 | `bar_ret_0` (0.46) | +0.0001 | +0.0000 |
...
| `combo_rank_min__vwap_close_divergence_trend__bar_body_rng_0` | Other Technical | +1 | +0.0926 | +0.0785 | +0.0785 | +0.5352 | 0.62 | 0/8 | 0.54 | 0.51 | `vwap_close_divergence_trend` (0.50) | -0.0000 | +0.0000 |
| `combo_rank_max__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1218 | +0.0760 | +0.0760 | +0.3554 | 0.38 | 0/8 | 0.84 | 0.85 | `early_body_momentum` (0.37) | -0.0003 | +0.0000 |
| `combo_mean__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1187 | +0.0758 | +0.0758 | +0.1995 | 0.41 | 0/8 | 0.50 | 0.44 | `first_bar_return` (0.46) | +0.0001 | -0.0520 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1502 | +0.1096 | +0.1096 | +0.7699 | 0.28 | 0/8 | 0.91 | 0.60 | `opening_drive_thrust_ratio` (0.40) | -0.0000 | -0.0520 |
| `combo_diff__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1351 | +0.0991 | +0.0991 | +0.4835 | 0.42 | 0/8 | 0.68 | 0.75 | `volume_weighted_momentum_acceleration` (0.62) | -0.0000 | +0.0000 |
...
| `combo_mean__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1373 | +0.0987 | +0.0987 | +0.6068 | 0.39 | 0/8 | 0.63 | 0.50 | `opening_drive_thrust_ratio` (0.40) | -0.0001 | -0.0520 |
| `combo_min__rbreaker_sell_setup_proximity_early__close_vs_open_range` | Other Technical | +1 | +0.1114 | +0.1196 | +0.1196 | +1.1815 | 0.41 | 0/8 | 0.79 | 0.49 | `close_vs_open_range` (0.42) | +0.0002 | +0.0000 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1381 | +0.1066 | +0.1066 | +0.6200 | 0.35 | 0/8 | 0.62 | 0.51 | `star50_limit_proximity_early` (0.55) | +0.0001 | -0.0520 |
...
| `combo_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1314 | +0.0802 | +0.0802 | -0.1927 | 0.35 | 0/8 | 0.68 | 0.56 | `first_bar_return` (0.46) | -0.0001 | -0.0520 |
| `combo_mean__max_up_ret__early_order_flow_imbalance` | Intraday Range Momentum | +1 | +0.1246 | +0.0632 | +0.0632 | +0.3295 | 0.32 | 0/8 | 1.00 | 1.22 | `early_order_flow_imbalance` (0.68) | -0.0003 | +0.0000 |
| `combo_mean__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1128 | +0.1133 | +0.1133 | +0.6694 | 0.35 | 0/8 | 0.70 | 0.50 | `star50_limit_proximity_early` (0.55) | +0.0002 | +0.0000 |
| `combo_sig_product__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1132 | +0.0802 | +0.0802 | +0.4497 | 0.22 | 0/8 | 0.88 | 0.88 | `volatility_expansion_trend_vector` (0.41) | -0.0004 | +0.0000 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1226 | +0.0881 | +0.0881 | +0.2537 | 0.31 | 0/8 | 0.90 | 0.82 | `volatility_expansion_trend_vector` (0.41) | -0.0002 | -0.0520 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1373 | +0.0797 | +0.0797 | +0.4571 | 0.36 | 0/8 | 0.81 | 0.65 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | +0.0000 |
| `combo_clamp_diff__bar_ret_0__body_size_progression` | Other Technical | +1 | +0.1272 | +0.0778 | +0.0778 | +0.4715 | 0.49 | 0/8 | 0.51 | 0.58 | `body_size_progression` (0.60) | +0.0002 | -0.0520 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1326 | +0.0856 | +0.0856 | +0.0926 | 0.30 | 0/8 | 0.78 | 0.62 | `first_bar_return` (0.46) | -0.0001 | -0.0520 |
...
| `combo_rank_min__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1211 | +0.0904 | +0.0904 | +0.2350 | 0.37 | 0/8 | 0.85 | 0.79 | `volatility_expansion_trend_vector` (0.41) | -0.0003 | -0.0520 |
| `combo_sig_product__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1158 | +0.0370 | +0.0370 | -0.1907 | 0.47 | 0/8 | 0.53 | 0.65 | `vwap_close_divergence_trend` (0.50) | -0.0004 | +0.0000 |
...
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__early_body_momentum` | Intraday Range Momentum | +1 | +0.1149 | +0.0841 | +0.0841 | +0.3166 | 0.48 | 0/8 | 0.77 | 0.93 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0003 | +0.0000 |
| `combo_sig_product__first_bar_return__vwap_close_divergence_trend` | Gap / Overnight Reversal | +1 | +0.1194 | +0.0244 | +0.0244 | -0.5970 | 0.37 | 0/8 | 0.80 | 1.56 | `vwap_close_divergence_trend` (0.50) | -0.0001 | +0.0000 |
| `combo_mean__volatility_expansion_trend_vector__max_down_ret` | Intraday Range Momentum | +1 | +0.1024 | +0.0969 | +0.0969 | +0.3003 | 0.46 | 0/8 | 0.66 | 0.51 | `max_down_ret` (0.62) | +0.0000 | +0.0000 |
...
| `combo_mean__opening_drive_thrust_ratio__early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.1219 | +0.0793 | +0.0793 | -0.5241 | 0.42 | 0/8 | 0.88 | 1.00 | `early_order_flow_imbalance` (0.68) | -0.0004 | +0.0000 |
| `combo_rel_diff__max_up_ret__early_late_momentum_divergence` | Intraday Range Momentum | +1 | +0.1220 | +0.0684 | +0.0684 | -0.4386 | 0.38 | 0/8 | 0.63 | 0.40 | `early_late_momentum_divergence` (0.60) | +0.0001 | -0.0520 |
| `combo_max__first_bar_return__early_order_flow_imbalance` | Gap / Overnight Reversal | +1 | +0.1030 | +0.0459 | +0.0459 | -0.4898 | 0.41 | 0/8 | 0.65 | 0.94 | `early_order_flow_imbalance` (0.68) | -0.0003 | +0.0000 |
| `combo_diff__max_up_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.1105 | +0.0639 | +0.0639 | +0.0800 | 0.28 | 0/8 | 0.96 | 0.85 | `h2_l2_pullback_continuation` (0.45) | -0.0004 | +0.0000 |
| `combo_tri_median__max_up_ret__volatility_expansion_trend_vector__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1277 | +0.1079 | +0.1079 | +0.8366 | 0.33 | 0/8 | 0.87 | 0.88 | `star50_limit_proximity_early` (0.55) | -0.0004 | +0.0000 |
| `combo_tri_min__net_volume_flow__star50_limit_proximity_early__bar_ret_0` | Volatility & Oscillators | +1 | +0.1008 | +0.1214 | +0.1214 | +1.1911 | 0.45 | 0/8 | 0.61 | 0.44 | `star50_limit_proximity_early` (0.55) | +0.0006 | +0.0000 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1429 | +0.1149 | +0.1149 | +0.4770 | 0.35 | 0/8 | 0.87 | 0.75 | `demark_setup_reversal_early` (0.57) | -0.0002 | -0.0520 |
| `combo_min__vwap_close_divergence_trend__bar_body_rng_0` | Other Technical | +1 | +0.1040 | +0.0808 | +0.0808 | +0.2788 | 0.50 | 0/8 | 0.57 | 0.51 | `vwap_close_divergence_trend` (0.50) | -0.0000 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__net_volume_flow` | Volatility & Oscillators | +1 | +0.1192 | +0.0774 | +0.0774 | +0.4480 | 0.44 | 0/8 | 0.75 | 0.70 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | +0.0000 |
...
| `combo_clamp_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1489 | +0.0857 | +0.0857 | +0.4882 | 0.44 | 0/8 | 0.69 | 0.59 | `volume_weighted_momentum_acceleration` (0.62) | +0.0001 | -0.0520 |
| `combo_min__net_volume_flow__shaved_bar_trend_conviction` | Volatility & Oscillators | +1 | +0.0700 | +0.0598 | +0.0598 | +0.8130 | 0.55 | 0/8 | 0.97 | 0.81 | `shaved_bar_trend_conviction` (1.19) | -0.0003 | -0.0520 |
| `combo_tri_max__max_up_ret__trend_bar_close_consistency__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1219 | +0.0636 | +0.0636 | +0.3582 | 0.39 | 0/8 | 0.82 | 0.71 | `trend_bar_close_consistency` (0.66) | -0.0004 | +0.0000 |
| `combo_mean__early_order_flow_imbalance__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.1094 | +0.0668 | +0.0668 | -0.1367 | 0.41 | 0/8 | 0.71 | 0.92 | `early_order_flow_imbalance` (0.68) | -0.0002 | +0.0000 |
| `combo_mean__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1219 | +0.1147 | +0.1147 | +0.3396 | 0.37 | 0/8 | 0.81 | 0.58 | `vwap_close_divergence_trend` (0.50) | -0.0001 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1482 | +0.0866 | +0.0866 | +0.0051 | 0.35 | 0/8 | 0.77 | 0.63 | `first_bar_return` (0.46) | -0.0001 | -0.0520 |
| `combo_sig_product__max_up_ret__net_volume_flow` | Intraday Range Momentum | +1 | +0.1096 | +0.0933 | +0.0933 | +0.5076 | 0.31 | 0/8 | 0.79 | 0.69 | `net_volume_flow` (0.31) | -0.0003 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1063 | +0.0928 | +0.0928 | +0.5738 | 0.55 | 0/8 | 0.75 | 0.42 | `vwap_close_divergence_trend` (0.50) | +0.0000 | +0.0000 |
| `combo_rel_diff__volatility_expansion_trend_vector__h2_l2_pullback_continuation` | Volatility & Oscillators | +1 | +0.0898 | +0.0662 | +0.0662 | +0.5029 | 0.33 | 0/8 | 0.92 | 0.80 | `h2_l2_pullback_continuation` (0.45) | -0.0002 | +0.0000 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__early_body_momentum__bar_ret_0` | Intraday Range Momentum | +1 | +0.1178 | +0.0873 | +0.0873 | +0.0959 | 0.36 | 0/8 | 0.75 | 0.69 | `bar_ret_0` (0.46) | -0.0003 | -0.0520 |
| `combo_diff__volatility_expansion_trend_vector__h2_l2_pullback_continuation` | Volatility & Oscillators | +1 | +0.0877 | +0.0701 | +0.0701 | +0.5499 | 0.36 | 0/8 | 0.87 | 0.77 | `h2_l2_pullback_continuation` (0.45) | -0.0004 | +0.0000 |
| `combo_tri_mean__trend_bar_close_consistency__volatility_expansion_trend_vector__bar_ret_0` | Volatility & Oscillators | +1 | +0.1066 | +0.0835 | +0.0835 | +0.4536 | 0.41 | 0/8 | 0.74 | 0.67 | `trend_bar_close_consistency` (0.66) | -0.0003 | +0.0000 |
| `combo_rel_diff__first_bar_return__h2_l2_pullback_continuation` | Gap / Overnight Reversal | +1 | +0.1045 | +0.0669 | +0.0669 | -0.3064 | 0.26 | 0/8 | 0.71 | 0.70 | `first_bar_return` (0.46) | -0.0001 | +0.0000 |
...
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1257 | +0.0908 | +0.0908 | +0.8692 | 0.44 | 0/8 | 0.62 | 0.40 | `bar_ret_0` (0.46) | +0.0003 | -0.0313 |
| `combo_rel_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1380 | +0.1177 | +0.1177 | +0.5773 | 0.33 | 0/8 | 0.83 | 0.65 | `demark_setup_reversal_early` (0.57) | -0.0000 | +0.0000 |
| `combo_rank_max__first_bar_return__early_order_flow_imbalance` | Gap / Overnight Reversal | +1 | +0.1073 | +0.0480 | +0.0480 | -0.5454 | 0.39 | 0/8 | 0.65 | 0.84 | `early_order_flow_imbalance` (0.68) | -0.0003 | +0.0000 |
| `combo_tri_min__max_up_ret__star50_limit_proximity_early__trend_day_regime_conviction` | Intraday Range Momentum | +1 | +0.1081 | +0.1143 | +0.1143 | +1.4452 | 0.38 | 0/8 | 0.79 | 0.46 | `star50_limit_proximity_early` (0.55) | +0.0003 | +0.0000 |
| `combo_mean__max_down_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.0973 | +0.0798 | +0.0798 | -0.0579 | 0.48 | 0/8 | 0.72 | 0.65 | `max_down_ret` (0.62) | -0.0002 | +0.0000 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.1293 | +0.0813 | +0.0813 | +0.2357 | 0.30 | 0/8 | 0.93 | 0.64 | — | -0.0002 | -0.0520 |
| `combo_min__vwap_close_divergence_trend__shaved_bar_trend_conviction` | Other Technical | +1 | +0.0660 | +0.0577 | +0.0577 | +0.3163 | 0.73 | 0/8 | 1.15 | 0.84 | `shaved_bar_trend_conviction` (1.19) | -0.0006 | -0.0520 |
| `combo_rank_max__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.1303 | +0.0749 | +0.0749 | +0.1819 | 0.26 | 0/8 | 1.05 | 0.82 | `vwap_close_divergence_trend` (0.50) | -0.0003 | -0.0520 |
| `combo_clamp_diff__max_down_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.0876 | +0.0794 | +0.0794 | -0.3704 | 0.34 | 0/8 | 0.69 | 0.60 | `max_down_ret` (0.62) | -0.0004 | +0.0000 |
| `combo_rank_max__opening_drive_thrust_ratio__vwap_close_divergence_trend` | Other Technical | +1 | +0.1209 | +0.0819 | +0.0819 | -0.3162 | 0.37 | 0/8 | 0.88 | 0.67 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_mean__vwap_close_divergence_trend__bar_body_rng_0` | Other Technical | +1 | +0.1179 | +0.0807 | +0.0807 | -0.0811 | 0.34 | 0/8 | 0.66 | 0.57 | `vwap_close_divergence_trend` (0.50) | -0.0002 | +0.0000 |
| `combo_rank_min__volatility_expansion_trend_vector__early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0948 | +0.0693 | +0.0693 | +0.2543 | 0.41 | 0/8 | 0.91 | 1.23 | `early_order_flow_imbalance` (0.68) | -0.0004 | +0.0000 |
| `combo_max__rbreaker_sell_setup_proximity_early__early_body_momentum` | Intraday Range Momentum | +1 | +0.1035 | +0.0891 | +0.0891 | +0.9407 | 0.38 | 0/8 | 0.74 | 0.94 | `rbreaker_sell_setup_proximity_early` (0.38) | -0.0005 | +0.0000 |
| `combo_rank_max__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1277 | +0.1007 | +0.1007 | +0.6887 | 0.50 | 0/8 | 0.61 | 0.38 | `max_down_ret` (0.62) | -0.0001 | -0.0520 |
| `opening_drive_thrust_ratio` | Other Technical | +1 | +0.1384 | +0.0962 | +0.0962 | +0.5296 | 0.40 | 0/8 | 0.76 | 0.57 | — | -0.0003 | -0.0520 |
| `combo_min__early_order_flow_imbalance__max_down_ret` | Intraday Range Momentum | +1 | +0.1031 | +0.0683 | +0.0683 | +0.4863 | 0.39 | 0/8 | 1.03 | 1.28 | `early_order_flow_imbalance` (0.68) | +0.0002 | +0.0000 |
| `combo_min__net_volume_flow__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.1029 | +0.1235 | +0.1235 | +1.0733 | 0.46 | 0/8 | 0.69 | 0.50 | `star50_limit_proximity_early` (0.55) | +0.0005 | +0.0000 |
| `combo_min__early_order_flow_imbalance__close_vs_open_range` | Volatility & Oscillators | +1 | +0.0927 | +0.0608 | +0.0608 | +0.0246 | 0.40 | 0/8 | 0.91 | 1.16 | `early_order_flow_imbalance` (0.68) | -0.0002 | +0.0000 |
| `combo_diff__max_down_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.0868 | +0.0818 | +0.0818 | +0.1956 | 0.33 | 0/8 | 0.69 | 0.63 | `max_down_ret` (0.62) | -0.0001 | +0.0000 |
| `combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1252 | +0.0607 | +0.0607 | +0.2343 | 0.39 | 0/8 | 0.84 | 0.79 | `volatility_expansion_trend_vector` (0.41) | -0.0005 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1164 | +0.0946 | +0.0946 | +0.0682 | 0.39 | 0/8 | 0.78 | 0.63 | `close_vs_open_range` (0.42) | -0.0002 | +0.0000 |
...
| `combo_sig_product__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1181 | +0.0557 | +0.0557 | +0.2440 | 0.56 | 0/8 | 0.56 | 0.59 | `first_bar_return` (0.46) | -0.0003 | -0.0520 |
...
| `combo_rank_max__bar_ret_0__vwap_close_divergence_trend` | Other Technical | +1 | +0.1288 | +0.0639 | +0.0639 | -0.3337 | 0.24 | 0/8 | 0.96 | 0.79 | `vwap_close_divergence_trend` (0.50) | -0.0004 | -0.0520 |
| `combo_min__max_up_ret__vwap_close_divergence_trend` | Intraday Range Momentum | +1 | +0.0947 | +0.0721 | +0.0721 | -0.1601 | 0.45 | 0/8 | 1.14 | 0.73 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_mean__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0825 | +0.1093 | +0.1093 | +0.6791 | 0.66 | 0/8 | 0.55 | 0.37 | `max_down_ret` (0.62) | +0.0003 | +0.0000 |
...
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1286 | +0.0668 | +0.0668 | -0.1367 | 0.40 | 0/8 | 1.05 | 0.86 | `opening_drive_thrust_ratio` (0.40) | -0.0003 | -0.0520 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__vwap_close_divergence_trend` | Other Technical | +1 | +0.1064 | +0.0956 | +0.0956 | +0.5503 | 0.57 | 0/8 | 0.71 | 0.35 | `vwap_close_divergence_trend` (0.50) | -0.0001 | +0.0000 |
| `combo_max__bar_ret_0__vwap_close_divergence_trend` | Other Technical | +1 | +0.1284 | +0.0644 | +0.0644 | -0.4181 | 0.24 | 0/8 | 0.98 | 0.81 | `vwap_close_divergence_trend` (0.50) | -0.0004 | -0.0520 |
| `combo_rel_diff__opening_drive_thrust_ratio__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1162 | +0.0877 | +0.0877 | +1.0117 | 0.47 | 0/8 | 0.69 | 0.57 | `late_bar_momentum` (0.60) | +0.0001 | -0.0520 |
| `combo_clamp_diff__opening_drive_thrust_ratio__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.1330 | +0.0898 | +0.0898 | +1.0714 | 0.42 | 0/8 | 0.85 | 0.75 | `smooth_momentum_structure` (0.62) | +0.0000 | -0.0520 |
| `combo_rank_max__early_body_momentum__close_vs_open_range` | Intraday Range Momentum | +1 | +0.0877 | +0.0793 | +0.0793 | +0.6809 | 0.38 | 0/8 | 0.90 | 0.79 | `close_vs_open_range` (0.42) | -0.0004 | +0.0000 |
| `combo_rank_min__opening_drive_thrust_ratio__vwap_close_divergence_trend` | Other Technical | +1 | +0.1070 | +0.0780 | +0.0780 | +0.2753 | 0.42 | 0/8 | 0.94 | 0.84 | `vwap_close_divergence_trend` (0.50) | -0.0003 | -0.0520 |
...
| `combo_tri_median__trend_bar_close_consistency__volatility_expansion_trend_vector__star50_limit_proximity_early` | Volatility & Oscillators | +1 | +0.0982 | +0.0816 | +0.0816 | +0.1952 | 0.41 | 0/8 | 0.76 | 0.75 | `trend_bar_close_consistency` (0.66) | -0.0004 | +0.0000 |
| `combo_tri_max__volatility_expansion_trend_vector__early_body_momentum__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.0967 | +0.0992 | +0.0992 | +0.3583 | 0.42 | 0/8 | 0.74 | 0.79 | `star50_limit_proximity_early` (0.55) | -0.0004 | +0.0000 |
...
| `combo_max__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.0958 | +0.0913 | +0.0913 | -0.1427 | 0.47 | 0/8 | 0.53 | 0.42 | `max_down_ret` (0.62) | +0.0000 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1266 | +0.0998 | +0.0998 | +0.6467 | 0.42 | 0/8 | 0.82 | 0.54 | `close_vs_open_range` (0.42) | -0.0002 | -0.0520 |
| `combo_max__max_up_ret__early_order_flow_imbalance` | Intraday Range Momentum | +1 | +0.1148 | +0.0679 | +0.0679 | +0.2608 | 0.37 | 0/8 | 0.90 | 1.25 | `early_order_flow_imbalance` (0.68) | -0.0004 | +0.0000 |
| `combo_min__net_volume_flow__max_down_ret` | Intraday Range Momentum | +1 | +0.1034 | +0.1016 | +0.1016 | +0.5225 | 0.36 | 0/8 | 0.78 | 0.69 | `max_down_ret` (0.62) | +0.0003 | +0.0000 |
| `combo_rank_max__early_order_flow_imbalance__max_down_ret` | Intraday Range Momentum | +1 | +0.0888 | +0.0900 | +0.0900 | +0.1144 | 0.63 | 1/8 | 0.56 | 0.55 | `early_order_flow_imbalance` (0.68) | -0.0001 | +0.0000 |
...
| `combo_min__max_up_ret__early_order_flow_imbalance` | Intraday Range Momentum | +1 | +0.1210 | +0.0573 | +0.0573 | -0.3285 | 0.40 | 0/8 | 1.23 | 1.29 | `early_order_flow_imbalance` (0.68) | -0.0003 | +0.0000 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.1104 | +0.1566 | +0.1566 | +0.5389 | 0.44 | 0/8 | 0.51 | 0.67 | `max_down_ret` (0.62) | +0.0003 | +0.0000 |
| `combo_tri_mean__opening_drive_thrust_ratio__volume_weighted_momentum_acceleration__bar_ret_0` | Intraday Range Momentum | +1 | +0.1067 | +0.0776 | +0.0776 | -0.1178 | 0.49 | 0/8 | 0.70 | 0.52 | `volume_weighted_momentum_acceleration` (0.62) | -0.0002 | -0.0520 |
...
| `combo_min__first_bar_return__early_order_flow_imbalance` | Gap / Overnight Reversal | +1 | +0.1078 | +0.0742 | +0.0742 | +0.6558 | 0.49 | 0/8 | 0.90 | 1.42 | `early_order_flow_imbalance` (0.68) | -0.0000 | +0.0000 |
| `combo_rank_max__early_body_momentum__early_order_flow_imbalance` | Intraday Range Momentum | +1 | +0.0814 | +0.0530 | +0.0530 | -0.1975 | 0.43 | 0/8 | 1.13 | 1.85 | `early_order_flow_imbalance` (0.68) | -0.0004 | +0.0000 |
...
| `combo_sig_product__opening_drive_thrust_ratio__close_vs_open_range` | Other Technical | +1 | +0.1237 | +0.0540 | +0.0540 | -0.2136 | 0.36 | 0/8 | 0.88 | 0.83 | `close_vs_open_range` (0.42) | -0.0003 | +0.0000 |
| `combo_rank_min__vwap_close_divergence_trend__shaved_bar_trend_conviction` | Other Technical | +1 | +0.0678 | +0.0597 | +0.0597 | +0.5081 | 0.66 | 0/8 | 1.16 | 0.84 | `shaved_bar_trend_conviction` (1.19) | -0.0005 | -0.0520 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1235 | +0.0908 | +0.0908 | +0.3829 | 0.35 | 0/8 | 0.93 | 0.63 | `volume_weighted_momentum_acceleration` (0.62) | -0.0002 | -0.0520 |
| `combo_clamp_diff__bar_ret_0__h2_l2_pullback_continuation` | Other Technical | +1 | +0.1122 | +0.0748 | +0.0748 | +0.0395 | 0.29 | 0/8 | 0.71 | 0.68 | `bar_ret_0` (0.46) | -0.0002 | +0.0000 |
| `combo_rank_max__bar_ret_0__shaved_bar_trend_conviction` | Other Technical | +1 | +0.1192 | +0.0631 | +0.0631 | +0.1674 | 0.49 | 0/8 | 0.76 | 0.46 | `shaved_bar_trend_conviction` (1.19) | -0.0003 | -0.0520 |
| `combo_clamp_diff__max_up_ret__h2_l2_pullback_continuation` | Intraday Range Momentum | +1 | +0.1097 | +0.0695 | +0.0695 | +0.3252 | 0.29 | 0/8 | 0.99 | 0.88 | `h2_l2_pullback_continuation` (0.45) | -0.0003 | +0.0000 |
| `combo_rel_diff__first_bar_return__body_size_progression` | Gap / Overnight Reversal | +1 | +0.1216 | +0.0690 | +0.0690 | +0.4411 | 0.47 | 0/8 | 0.53 | 0.51 | `body_size_progression` (0.60) | -0.0001 | -0.0520 |
| `combo_tri_median__opening_drive_thrust_ratio__volume_weighted_momentum_acceleration__bar_ret_0` | Intraday Range Momentum | +1 | +0.1144 | +0.0907 | +0.0907 | +0.2213 | 0.38 | 0/8 | 0.70 | 0.52 | `volume_weighted_momentum_acceleration` (0.62) | +0.0000 | -0.0520 |
| `combo_rank_min__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1228 | +0.1294 | +0.1294 | +1.0283 | 0.48 | 0/8 | 0.74 | 0.49 | `star50_limit_proximity_early` (0.55) | +0.0002 | -0.0520 |
| `combo_rank_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0935 | +0.0994 | +0.0994 | +0.6418 | 0.55 | 0/8 | 0.57 | 0.40 | `max_down_ret` (0.62) | +0.0000 | +0.0000 |
| `combo_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1465 | +0.0877 | +0.0877 | +0.2021 | 0.36 | 0/8 | 0.84 | 0.58 | `opening_drive_thrust_ratio` (0.40) | -0.0002 | -0.0520 |
| `combo_min__max_down_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.0999 | +0.1016 | +0.1016 | +0.1701 | 0.48 | 0/8 | 0.71 | 0.56 | `max_down_ret` (0.62) | +0.0001 | +0.0000 |
| `combo_min__max_up_ret__close_vs_open_range` | Intraday Range Momentum | +1 | +0.1042 | +0.0977 | +0.0977 | +0.0827 | 0.28 | 0/8 | 1.09 | 0.73 | `close_vs_open_range` (0.42) | +0.0000 | +0.0000 |
| `open_to_current_return` | Intraday Range Momentum | +1 | +0.0975 | +0.0774 | +0.0774 | +0.5603 | 0.41 | 0/8 | 0.88 | 0.73 | — | -0.0001 | +0.0000 |
| `combo_rank_min__early_order_flow_imbalance__max_down_ret` | Intraday Range Momentum | +1 | +0.1007 | +0.0702 | +0.0702 | +0.2248 | 0.33 | 0/8 | 0.92 | 1.02 | `early_order_flow_imbalance` (0.68) | -0.0000 | +0.0000 |
| `combo_min__first_bar_return__vwap_close_divergence_trend` | Gap / Overnight Reversal | +1 | +0.0912 | +0.0838 | +0.0838 | +0.4349 | 0.66 | 0/8 | 0.41 | 0.36 | `vwap_close_divergence_trend` (0.50) | +0.0001 | +0.0000 |
...
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__smooth_momentum_structure` | Intraday Range Momentum | +1 | +0.0934 | +0.0994 | +0.0994 | +0.6449 | 0.54 | 0/8 | 0.65 | 0.48 | `smooth_momentum_structure` (0.62) | -0.0002 | +0.0000 |
| `combo_rank_max__max_up_ret__max_down_ret` | Intraday Range Momentum | +1 | +0.1252 | +0.0983 | +0.0983 | +0.8388 | 0.45 | 0/8 | 0.63 | 0.47 | `max_down_ret` (0.62) | -0.0001 | -0.0520 |
| `combo_max__vwap_close_divergence_trend__bar_body_rng_0` | Other Technical | +1 | +0.1201 | +0.0760 | +0.0760 | -0.5936 | 0.23 | 0/8 | 0.82 | 0.71 | `vwap_close_divergence_trend` (0.50) | -0.0002 | +0.0000 |
| `combo_rank_max__net_volume_flow__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0943 | +0.0731 | +0.0731 | -0.3285 | 0.34 | 0/8 | 1.07 | 0.99 | `vwap_close_divergence_trend` (0.50) | -0.0003 | +0.0000 |
| `combo_max__volatility_expansion_trend_vector__vwap_close_divergence_trend` | Volatility & Oscillators | +1 | +0.0932 | +0.0700 | +0.0700 | -0.1626 | 0.47 | 0/8 | 0.82 | 0.71 | `vwap_close_divergence_trend` (0.50) | -0.0004 | +0.0000 |
| `combo_mean__opening_drive_thrust_ratio__max_down_ret` | Intraday Range Momentum | +1 | +0.1274 | +0.1011 | +0.1011 | +0.3129 | 0.43 | 0/8 | 0.72 | 0.55 | `max_down_ret` (0.62) | -0.0000 | +0.0000 |
| `vwap_trend_channel_slope` | Other Technical | +1 | +0.0836 | +0.0712 | +0.0712 | -0.3626 | 0.51 | 0/8 | 1.11 | 0.90 | — | -0.0002 | -0.0520 |
| `combo_tri_median__max_up_ret__smooth_momentum_structure__bar_ret_0` | Intraday Range Momentum | +1 | +0.1166 | +0.0578 | +0.0578 | +0.6416 | 0.31 | 0/8 | 0.81 | 0.65 | `smooth_momentum_structure` (0.62) | -0.0003 | -0.0520 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.0592 | +0.0705 | +0.0705 | +0.5535 | 0.93 | 1/8 | 0.63 | 0.79 | `volume_weighted_momentum_acceleration` (0.62) | -0.0002 | +0.0000 |
| `combo_min__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0914 | +0.1019 | +0.1019 | +0.5491 | 0.53 | 0/8 | 0.64 | 0.54 | `max_down_ret` (0.62) | +0.0004 | +0.0000 |
| `combo_max__first_bar_return__shaved_bar_trend_conviction` | Gap / Overnight Reversal | +1 | +0.1172 | +0.0610 | +0.0610 | +0.0246 | 0.52 | 0/8 | 0.81 | 0.52 | `shaved_bar_trend_conviction` (1.19) | -0.0002 | -0.0520 |
| `combo_tri_median__max_up_ret__net_volume_flow__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.0869 | +0.0821 | +0.0821 | +0.5332 | 0.22 | 0/8 | 1.10 | 1.16 | `volume_weighted_momentum_acceleration` (0.62) | +0.0002 | +0.0000 |
| `combo_rank_max__star50_limit_proximity_early__max_down_ret` | Intraday Range Momentum | +1 | +0.0965 | +0.1418 | +0.1418 | +1.1539 | 0.60 | 0/8 | 0.61 | 0.46 | `max_down_ret` (0.62) | +0.0003 | +0.0000 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1144 | +0.0794 | +0.0794 | +0.3571 | 0.29 | 0/8 | 0.70 | 0.84 | `first_bar_return` (0.46) | +0.0002 | -0.0520 |

### 159915ETF — `single` (Full Model Lockbox IC: +0.1399, Sharpe: +1.6078)

| Feature | Family | Sign | Train IC | OOS IC | Lock IC | Lock Sharpe | IC CV | Neg Yrs | Half Ratio | Recency Ratio | Weak Component | LOO ΔLock IC | LOO ΔLock Sharpe |
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1446 | +0.1235 | +0.1235 | +0.8704 | 0.52 | 1/8 | 1.10 | 2.97 | `bar_body_rng_0` (0.54) | -0.0001 | -0.0141 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1401 | +0.1277 | +0.1277 | +1.2801 | 0.54 | 1/8 | 1.04 | 2.19 | `bar_body_rng_0` (0.54) | -0.0002 | -0.0141 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1417 | +0.1103 | +0.1103 | +1.0913 | 0.48 | 1/8 | 1.26 | 3.67 | `opening_drive_thrust_ratio` (0.53) | -0.0006 | -0.0449 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1429 | +0.1164 | +0.1164 | +1.2316 | 0.39 | 0/8 | 1.23 | 1.73 | `bar_body_rng_0` (0.54) | -0.0003 | -0.0141 |
| `combo_tri_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1364 | +0.1188 | +0.1188 | +0.9339 | 0.50 | 1/8 | 1.08 | 3.43 | `opening_drive_thrust_ratio` (0.53) | -0.0001 | -0.0141 |
...
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1376 | +0.1248 | +0.1248 | +1.0992 | 0.52 | 1/8 | 1.14 | 2.47 | `bar_body_rng_0` (0.54) | -0.0002 | -0.0141 |
| `combo_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1386 | +0.1258 | +0.1258 | +1.4182 | 0.48 | 0/8 | 1.17 | 3.10 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | -0.0449 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1163 | +0.0911 | +0.0911 | +0.5434 | 0.62 | 1/8 | 1.30 | 4.55 | `yesterday_early_vwap_dev` (1.10) | -0.0003 | -0.1635 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1463 | +0.1269 | +0.1269 | +1.6160 | 0.46 | 1/8 | 1.11 | 1.74 | `bar_body_rng_0` (0.54) | -0.0002 | -0.0338 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1248 | +0.1283 | +0.1283 | +1.6959 | 0.57 | 1/8 | 1.04 | 1.71 | `volume_weighted_price_position` (0.77) | -0.0007 | +0.0408 |
| `combo_mean__max_up_ret__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.1284 | +0.1327 | +0.1327 | +0.9738 | 0.39 | 0/8 | 1.62 | 3.11 | `star50_limit_proximity_early` (0.68) | -0.0002 | -0.1635 |
| `combo_rank_min__star50_limit_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1058 | +0.1409 | +0.1409 | +1.7299 | 0.74 | 1/8 | 1.13 | 4.05 | `volume_weighted_price_position` (0.77) | -0.0009 | +0.0408 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1252 | +0.0846 | +0.0846 | +0.2222 | 0.42 | 0/8 | 1.27 | 1.80 | `bar_body_rng_0` (0.54) | -0.0005 | -0.0141 |
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1420 | +0.1262 | +0.1262 | +1.6796 | 0.43 | 0/8 | 1.09 | 1.90 | `bar_body_rng_0` (0.54) | -0.0003 | +0.0000 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1237 | +0.1316 | +0.1316 | +1.5821 | 0.59 | 0/8 | 0.94 | 1.51 | `volume_weighted_price_position` (0.77) | -0.0004 | +0.0235 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1154 | +0.1291 | +0.1291 | +1.1684 | 0.49 | 1/8 | 1.95 | 3.70 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0478 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1289 | +0.1146 | +0.1146 | +1.0966 | 0.47 | 0/8 | 1.05 | 2.22 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0002 | -0.0141 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1466 | +0.1334 | +0.1334 | +1.5762 | 0.36 | 0/8 | 1.05 | 2.19 | `volume_weighted_momentum_acceleration` (0.48) | -0.0002 | +0.0000 |
| `combo_tri_min__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1215 | +0.1330 | +0.1330 | +1.4975 | 0.58 | 1/8 | 1.11 | 2.58 | `star50_limit_proximity_early` (0.68) | -0.0002 | -0.0192 |
| `combo_mean__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1144 | +0.0853 | +0.0853 | +0.3259 | 0.43 | 0/8 | 1.55 | 2.67 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | -0.0141 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1433 | +0.1191 | +0.1191 | +1.3989 | 0.41 | 0/8 | 1.44 | 2.17 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0004 | -0.0478 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1426 | +0.1231 | +0.1231 | +1.3859 | 0.38 | 0/8 | 1.34 | 1.76 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0002 | -0.0195 |
| `combo_mean__rbreaker_sell_setup_proximity_early__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.1374 | +0.1301 | +0.1301 | +1.0434 | 0.41 | 0/8 | 1.03 | 1.21 | `volume_weighted_price_position` (0.77) | -0.0004 | +0.0989 |
| `combo_diff__rbreaker_sell_setup_proximity_early__gap_pct` | Gap / Overnight Reversal | +1 | +0.1055 | +0.0639 | +0.0639 | +0.4993 | 0.39 | 0/8 | 1.92 | 2.16 | `gap_pct` (1.84) | -0.0004 | -0.0141 |
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1338 | +0.1202 | +0.1202 | +1.5593 | 0.47 | 1/8 | 1.04 | 2.10 | `star50_limit_proximity_early` (0.68) | -0.0002 | +0.0440 |
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1127 | +0.1321 | +0.1321 | +1.4384 | 0.52 | 1/8 | 1.90 | 3.73 | `volatility_expansion_trend_vector` (0.74) | -0.0001 | -0.0478 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1451 | +0.1262 | +0.1262 | +1.3787 | 0.35 | 0/8 | 1.01 | 1.69 | `volume_weighted_momentum_acceleration` (0.48) | -0.0003 | -0.0258 |
| `combo_ifelse__gap_pct__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1337 | +0.1161 | +0.1161 | +1.2784 | 0.44 | 0/8 | 1.30 | 3.03 | `gap_pct` (1.84) | -0.0003 | -0.0449 |
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1111 | +0.0659 | +0.0659 | +0.2315 | 0.38 | 0/8 | 1.61 | 1.77 | `demark_setup_reversal_early` (0.76) | -0.0004 | -0.0141 |
...
| `combo_tri_min__star50_limit_proximity_early__bar_body_rng_0__bar_ret_0` | Other Technical | +1 | +0.1150 | +0.1291 | +0.1291 | +1.5409 | 0.70 | 1/8 | 1.13 | 5.36 | `star50_limit_proximity_early` (0.68) | -0.0002 | -0.0192 |
| `combo_mean__max_up_ret__gap_pct` | Gap / Overnight Reversal | +1 | +0.1335 | +0.1371 | +0.1371 | +1.1159 | 0.39 | 0/8 | 1.64 | 2.81 | `gap_pct` (1.84) | -0.0004 | -0.1635 |
| `combo_rank_max__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1169 | +0.0861 | +0.0861 | +0.4034 | 0.45 | 0/8 | 1.46 | 1.85 | `bar_body_rng_0` (0.54) | -0.0003 | -0.0141 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1304 | +0.0976 | +0.0976 | +0.8959 | 0.37 | 0/8 | 1.37 | 1.89 | `star50_limit_proximity_early` (0.68) | -0.0005 | -0.0141 |
| `combo_tri_max__opening_drive_thrust_ratio__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.1226 | +0.0780 | +0.0780 | +0.0786 | 0.42 | 0/8 | 1.43 | 2.01 | `opening_drive_thrust_ratio` (0.53) | -0.0004 | -0.0141 |
| `combo_mean__opening_drive_thrust_ratio__star50_limit_proximity_early` | Other Technical | +1 | +0.1225 | +0.1315 | +0.1315 | +1.4786 | 0.46 | 0/8 | 1.23 | 3.43 | `star50_limit_proximity_early` (0.68) | -0.0001 | -0.0449 |
| `combo_tri_min__opening_drive_thrust_ratio__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1211 | +0.0922 | +0.0922 | -0.0879 | 0.46 | 0/8 | 1.26 | 2.77 | `bar_body_rng_0` (0.54) | -0.0005 | -0.0141 |
| `combo_rank_min__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0943 | +0.1204 | +0.1204 | +1.1103 | 0.81 | 2/8 | 1.49 | -9.71 | `rbreaker_buy_setup_proximity_early` (1.12) | -0.0003 | -0.0449 |
| `combo_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1141 | +0.0985 | +0.0985 | +0.8687 | 0.52 | 0/8 | 2.01 | 5.46 | `demark_setup_reversal_early` (0.76) | -0.0002 | -0.0398 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1113 | +0.0888 | +0.0888 | +0.6277 | 0.32 | 0/8 | 1.23 | 0.82 | `demark_setup_reversal_early` (0.76) | -0.0002 | -0.0971 |
| `combo_min__rbreaker_sell_setup_proximity_early__volume_price_confirmation` | Volatility & Oscillators | +1 | +0.1164 | +0.1258 | +0.1258 | +1.5522 | 0.47 | 0/8 | 0.87 | 1.30 | `volume_price_confirmation` (0.55) | -0.0001 | -0.0141 |
| `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1197 | +0.0838 | +0.0838 | +0.6139 | 0.34 | 0/8 | 1.23 | 1.88 | `volume_weighted_momentum_acceleration` (0.48) | -0.0005 | +0.0000 |
| `combo_rank_min__star50_limit_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1114 | +0.1247 | +0.1247 | +1.4204 | 0.66 | 1/8 | 1.08 | 4.36 | `star50_limit_proximity_early` (0.68) | -0.0005 | -0.0192 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1024 | +0.1088 | +0.1088 | +0.4427 | 0.72 | 1/8 | 1.83 | 5.08 | `yesterday_early_vwap_dev` (1.10) | -0.0003 | -0.1635 |
| `combo_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.1027 | +0.1270 | +0.1270 | +0.8942 | 0.73 | 1/8 | 1.27 | 48.39 | `limit_down_proximity_early` (1.12) | -0.0001 | -0.0192 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early__bar_body_rng_0` | Other Technical | +1 | +0.1316 | +0.0920 | +0.0920 | +1.2053 | 0.67 | 1/8 | 0.71 | 0.49 | `demark_setup_reversal_early` (0.76) | -0.0001 | +0.0582 |
| `combo_tri_median__max_up_ret__star50_limit_proximity_early__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1285 | +0.1028 | +0.1028 | +1.0956 | 0.39 | 0/8 | 1.38 | 1.93 | `star50_limit_proximity_early` (0.68) | -0.0005 | -0.0141 |
| `combo_ifelse__gap_pct__max_up_ret__star50_limit_proximity_early` | Gap / Overnight Reversal | +1 | +0.1202 | +0.1295 | +0.1295 | +0.8774 | 0.42 | 0/8 | 1.40 | 1.86 | `gap_pct` (1.84) | -0.0001 | -0.0053 |
| `combo_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | Other Technical | +1 | +0.1133 | +0.1244 | +0.1244 | +0.2717 | 0.38 | 0/8 | 1.65 | 2.48 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | -0.1635 |
| `combo_tri_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_ret_0` | Other Technical | +1 | +0.1233 | +0.1026 | +0.1026 | +0.2266 | 0.32 | 0/8 | 1.49 | 1.85 | `opening_drive_thrust_ratio` (0.53) | -0.0005 | -0.1635 |
| `combo_mean__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1429 | +0.1193 | +0.1193 | +1.5252 | 0.40 | 0/8 | 1.19 | 2.01 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0002 | -0.0338 |
| `combo_tri_max__max_up_ret__star50_limit_proximity_early__bar_ret_0` | Intraday Range Momentum | +1 | +0.1166 | +0.0872 | +0.0872 | +0.4131 | 0.38 | 0/8 | 1.69 | 2.55 | `star50_limit_proximity_early` (0.68) | -0.0004 | -0.1296 |
| `combo_tri_mean__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1358 | +0.1169 | +0.1169 | +1.0451 | 0.34 | 0/8 | 0.90 | 1.06 | `demark_setup_reversal_early` (0.76) | -0.0002 | -0.1296 |
| `combo_tri_max__yesterday_early_momentum__star50_limit_proximity_early__yesterday_first_30min_return` | Intraday Range Momentum | +1 | +0.0973 | +0.1054 | +0.1054 | +0.5945 | 0.60 | 1/8 | 1.45 | 2.92 | `yesterday_early_momentum` (1.06) | -0.0003 | -0.1635 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.1000 | +0.1399 | +0.1399 | +1.6539 | 0.82 | 1/8 | 1.11 | 12.14 | `limit_down_proximity_early` (1.12) | +0.0000 | -0.0192 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.1182 | +0.1236 | +0.1236 | +0.8328 | 0.37 | 0/8 | 1.49 | 2.06 | `rbreaker_sell_setup_proximity_early` (0.43) | +0.0002 | -0.0398 |
| `combo_diff__max_up_ret__volume_weighted_momentum_acceleration` | Intraday Range Momentum | +1 | +0.1202 | +0.0864 | +0.0864 | +0.4855 | 0.36 | 0/8 | 1.21 | 2.12 | `volume_weighted_momentum_acceleration` (0.48) | -0.0004 | -0.0141 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1245 | +0.1249 | +0.1249 | +1.2583 | 0.46 | 0/8 | 1.23 | 2.00 | `bar_body_rng_0` (0.54) | +0.0000 | -0.0141 |
| `combo_rel_diff__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1142 | +0.1088 | +0.1088 | +0.9171 | 0.51 | 0/8 | 1.87 | 4.15 | `demark_setup_reversal_early` (0.76) | -0.0004 | -0.0258 |
| `combo_tri_mean__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.1074 | +0.1005 | +0.1005 | +0.4995 | 0.74 | 1/8 | 1.24 | 5.28 | `yesterday_early_vwap_dev` (1.10) | +0.0000 | -0.1635 |
| `combo_max__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1341 | +0.1084 | +0.1084 | +0.1964 | 0.30 | 0/8 | 1.32 | 1.43 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0006 | -0.1635 |
| `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1100 | +0.1329 | +0.1329 | +1.4350 | 0.45 | 0/8 | 1.91 | 2.40 | `demark_setup_reversal_early` (0.76) | -0.0000 | -0.0528 |
| `combo_rank_min__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.0822 | +0.0966 | +0.0966 | +0.6825 | 0.69 | 0/8 | 3.54 | 6.25 | `volatility_expansion_trend_vector` (0.74) | -0.0001 | -0.0141 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1336 | +0.1099 | +0.1099 | +0.2013 | 0.30 | 0/8 | 1.37 | 1.53 | `rbreaker_sell_setup_proximity_early` (0.43) | -0.0001 | -0.0315 |
| `combo_mean__rbreaker_sell_setup_proximity_early__directional_volume_signature` | Volatility & Oscillators | +1 | +0.1230 | +0.1345 | +0.1345 | +1.8390 | 0.57 | 1/8 | 1.06 | 1.32 | `directional_volume_signature` (1.20) | +0.0000 | -0.0258 |
| `combo_tri_min__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_trend` | Intraday Range Momentum | +1 | +0.0893 | +0.1105 | +0.1105 | +0.6779 | 0.73 | 1/8 | 1.59 | 15.04 | `yesterday_early_trend` (1.03) | +0.0001 | -0.1635 |
| `combo_max__opening_drive_thrust_ratio__bar_body_rng_0` | Other Technical | +1 | +0.1155 | +0.0909 | +0.0909 | +0.8829 | 0.52 | 0/8 | 1.08 | 1.69 | `bar_body_rng_0` (0.54) | -0.0003 | -0.0141 |
| `combo_mean__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.1113 | +0.1183 | +0.1183 | +1.7926 | 0.61 | 1/8 | 1.03 | 3.37 | `rbreaker_buy_setup_proximity_early` (1.12) | +0.0000 | -0.0528 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__rally_strength_max` | Other Technical | +1 | +0.1096 | +0.1190 | +0.1190 | +1.3567 | 0.55 | 0/8 | 1.25 | 2.14 | `rally_strength_max` (1.34) | -0.0005 | -0.0398 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early__bar_body_rng_0` | Other Technical | +1 | +0.1204 | +0.1209 | +0.1209 | +1.2194 | 0.55 | 1/8 | 1.10 | 1.05 | `demark_setup_reversal_early` (0.76) | +0.0001 | -0.0478 |
| `combo_rank_max__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1146 | +0.0866 | +0.0866 | +0.4183 | 0.48 | 0/8 | 1.91 | 2.92 | `opening_drive_thrust_ratio` (0.53) | -0.0002 | -0.0141 |
| `combo_tri_median__max_up_ret__demark_setup_reversal_early__star50_limit_proximity_early` | Intraday Range Momentum | +1 | +0.0969 | +0.1156 | +0.1156 | +0.7244 | 0.55 | 0/8 | 2.10 | 2.00 | `demark_setup_reversal_early` (0.76) | -0.0005 | -0.0528 |
| `combo_tri_median__demark_setup_reversal_early__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1040 | +0.1171 | +0.1171 | +1.6028 | 0.56 | 1/8 | 1.19 | 1.13 | `demark_setup_reversal_early` (0.76) | -0.0001 | -0.0528 |
| `combo_min__rbreaker_sell_setup_proximity_early__directional_volume_signature` | Volatility & Oscillators | +1 | +0.1105 | +0.1348 | +0.1348 | +1.8997 | 0.62 | 0/8 | 0.95 | 1.36 | `directional_volume_signature` (1.20) | +0.0000 | -0.0258 |
...
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__late_bar_momentum` | Intraday Range Momentum | +1 | +0.1286 | +0.1257 | +0.1257 | +1.6419 | 0.47 | 0/8 | 0.98 | 2.23 | `late_bar_momentum` (0.81) | +0.0000 | +0.0022 |
| `combo_max__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0974 | +0.1273 | +0.1273 | +0.3112 | 0.43 | 0/8 | 2.10 | 3.36 | `volatility_expansion_trend_vector` (0.74) | -0.0003 | -0.1635 |
...
| `combo_rank_max__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1011 | +0.0961 | +0.0961 | +0.5743 | 0.53 | 0/8 | 1.73 | 3.52 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0141 |
| `combo_min__opening_drive_thrust_ratio__bar_ret_0` | Other Technical | +1 | +0.1172 | +0.0926 | +0.0926 | +0.6024 | 0.38 | 0/8 | 1.12 | 2.11 | `opening_drive_thrust_ratio` (0.53) | -0.0003 | -0.0141 |
| `combo_diff__opening_drive_thrust_ratio__demark_setup_reversal_early` | Other Technical | +1 | +0.1108 | +0.1109 | +0.1109 | +0.9996 | 0.59 | 0/8 | 1.70 | 11.98 | `demark_setup_reversal_early` (0.76) | -0.0004 | -0.0398 |
| `combo_ifelse__gap_pct__rbreaker_sell_setup_proximity_early__max_up_ret` | Gap / Overnight Reversal | +1 | +0.1100 | +0.1004 | +0.1004 | +0.3556 | 0.41 | 0/8 | 2.45 | 3.26 | `gap_pct` (1.84) | -0.0005 | -0.1296 |
| `combo_min__rbreaker_sell_setup_proximity_early__rally_strength_max` | Other Technical | +1 | +0.1126 | +0.1080 | +0.1080 | +1.2363 | 0.64 | 0/8 | 1.13 | 2.20 | `rally_strength_max` (1.34) | -0.0004 | +0.0222 |
| `combo_rank_max__volatility_expansion_trend_vector__volume_price_confirmation` | Volatility & Oscillators | +1 | +0.1093 | +0.0782 | +0.0782 | +0.8340 | 0.50 | 0/8 | 1.22 | 1.37 | `volatility_expansion_trend_vector` (0.74) | -0.0003 | -0.0141 |
| `combo_rank_min__max_up_ret__gap_pct` | Gap / Overnight Reversal | +1 | +0.0974 | +0.1020 | +0.1020 | +1.2477 | 0.84 | 1/8 | 1.65 | 17.82 | `gap_pct` (1.84) | -0.0001 | -0.0528 |
| `combo_max__max_up_ret__volume_price_confirmation` | Intraday Range Momentum | +1 | +0.1185 | +0.0758 | +0.0758 | +0.7257 | 0.35 | 0/8 | 1.16 | 1.24 | `volume_price_confirmation` (0.55) | -0.0003 | -0.0141 |
| `combo_mean__star50_limit_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1018 | +0.1385 | +0.1385 | +1.1011 | 0.47 | 0/8 | 1.80 | 4.33 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0528 |
| `combo_min__limit_down_proximity_early__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0757 | +0.1167 | +0.1167 | +0.9419 | 0.75 | 0/8 | 2.18 | 15.45 | `limit_down_proximity_early` (1.12) | -0.0001 | -0.0528 |
| `combo_ifelse__gap_pct__max_up_ret__yesterday_early_trend` | Gap / Overnight Reversal | +1 | +0.1068 | +0.0685 | +0.0685 | +0.3465 | 0.51 | 0/8 | 0.56 | 0.53 | `gap_pct` (1.84) | -0.0003 | +0.0020 |
| `combo_rank_max__opening_drive_thrust_ratio__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0916 | +0.1042 | +0.1042 | +1.2122 | 0.53 | 0/8 | 1.46 | 4.49 | `rbreaker_buy_setup_proximity_early` (1.12) | -0.0001 | -0.0258 |
| `combo_min__opening_drive_thrust_ratio__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0822 | +0.0987 | +0.0987 | +0.6482 | 0.71 | 0/8 | 2.37 | 8.28 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0141 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__demark_setup_reversal_early` | Intraday Range Momentum | +1 | +0.1073 | +0.1227 | +0.1227 | +1.0991 | 0.45 | 0/8 | 2.17 | 2.04 | `demark_setup_reversal_early` (0.76) | -0.0001 | +0.0339 |
| `combo_mean__first_bar_return__limit_down_proximity_early` | Gap / Overnight Reversal | +1 | +0.1180 | +0.1170 | +0.1170 | +1.8672 | 0.50 | 1/8 | 1.06 | 3.25 | `limit_down_proximity_early` (1.12) | -0.0002 | -0.0338 |
| `combo_ifelse__gap_pct__max_up_ret__yesterday_early_vwap_dev` | Gap / Overnight Reversal | +1 | +0.0990 | +0.0720 | +0.0720 | +0.7769 | 0.48 | 0/8 | 0.76 | 0.85 | `gap_pct` (1.84) | -0.0001 | +0.0020 |
| `combo_mean__max_up_ret__rally_strength_max` | Intraday Range Momentum | +1 | +0.0948 | +0.0728 | +0.0728 | +0.6410 | 0.58 | 0/8 | 1.64 | 1.88 | `rally_strength_max` (1.34) | -0.0006 | +0.0915 |
| `combo_min__bar_ret_0__limit_down_proximity_early` | Other Technical | +1 | +0.0946 | +0.1271 | +0.1271 | +1.4730 | 0.78 | 1/8 | 1.02 | 6.45 | `limit_down_proximity_early` (1.12) | +0.0000 | -0.0192 |
| `combo_sig_product__volume_weighted_price_position__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.0859 | +0.0677 | +0.0677 | -0.1117 | 0.63 | 0/8 | 1.66 | 3.03 | `volume_weighted_price_position` (0.77) | -0.0004 | +0.0092 |
| `combo_tri_median__star50_limit_proximity_early__yesterday_first_30min_return__yesterday_early_vwap_dev` | Intraday Range Momentum | +1 | +0.0938 | +0.0898 | +0.0898 | +0.1198 | 0.90 | 1/8 | 1.25 | 5.52 | `yesterday_early_vwap_dev` (1.10) | -0.0002 | -0.1635 |
| `combo_mean__bar_body_rng_0__volatility_expansion_trend_vector` | Volatility & Oscillators | +1 | +0.1029 | +0.0988 | +0.0988 | +0.3616 | 0.50 | 0/8 | 1.54 | 2.67 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0141 |
| `combo_rank_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1192 | +0.0810 | +0.0810 | +0.8246 | 0.39 | 0/8 | 1.31 | 1.96 | `bar_body_rng_0` (0.54) | -0.0005 | -0.0141 |
| `combo_max__first_bar_return__volatility_expansion_trend_vector` | Gap / Overnight Reversal | +1 | +0.1103 | +0.0856 | +0.0856 | +0.3018 | 0.37 | 0/8 | 1.77 | 1.83 | `volatility_expansion_trend_vector` (0.74) | -0.0004 | -0.0141 |
| `combo_rel_diff__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0947 | +0.1071 | +0.1071 | +0.6274 | 0.30 | 0/8 | 1.42 | 1.05 | `keltner_squeeze_width` (0.61) | +0.0003 | -0.0141 |
| `combo_diff__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0984 | +0.1012 | +0.1012 | +0.8236 | 0.25 | 0/8 | 1.38 | 1.13 | `keltner_squeeze_width` (0.61) | +0.0003 | -0.0141 |
| `combo_max__max_up_ret__volatility_expansion_trend_vector` | Intraday Range Momentum | +1 | +0.1031 | +0.0770 | +0.0770 | +0.0324 | 0.46 | 0/8 | 2.11 | 2.69 | `volatility_expansion_trend_vector` (0.74) | -0.0002 | -0.0141 |
| `combo_clamp_diff__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0978 | +0.0975 | +0.0975 | +0.7347 | 0.25 | 0/8 | 1.39 | 1.12 | `keltner_squeeze_width` (0.61) | +0.0004 | -0.0141 |
| `combo_sig_product__opening_drive_thrust_ratio__max_up_ret` | Intraday Range Momentum | +1 | +0.1021 | +0.0789 | +0.0789 | +0.4086 | 0.45 | 0/8 | 1.23 | 2.17 | `opening_drive_thrust_ratio` (0.53) | -0.0005 | -0.0141 |
| `combo_min__max_up_ret__rally_strength_max` | Intraday Range Momentum | +1 | +0.0907 | +0.0812 | +0.0812 | +0.4028 | 0.66 | 0/8 | 1.68 | 1.87 | `rally_strength_max` (1.34) | -0.0007 | -0.0141 |
| `combo_max__max_up_ret__rally_strength_max` | Intraday Range Momentum | +1 | +0.0912 | +0.0649 | +0.0649 | +0.2842 | 0.58 | 0/8 | 1.65 | 2.63 | `rally_strength_max` (1.34) | -0.0007 | +0.0440 |
| `combo_clamp_diff__rbreaker_sell_setup_proximity_early__demark_setup_reversal_early` | Other Technical | +1 | +0.1148 | +0.1316 | +0.1316 | -0.2817 | 0.55 | 1/8 | 1.76 | 7.89 | `demark_setup_reversal_early` (0.76) | -0.0004 | -0.0449 |
| `combo_rank_min__first_bar_return__volatility_expansion_trend_vector` | Gap / Overnight Reversal | +1 | +0.0864 | +0.0944 | +0.0944 | +0.4751 | 0.57 | 0/8 | 1.37 | 2.79 | `volatility_expansion_trend_vector` (0.74) | -0.0003 | -0.0141 |
| `combo_ifelse__gap_pct__opening_drive_thrust_ratio__max_up_ret` | Gap / Overnight Reversal | +1 | +0.1102 | +0.0683 | +0.0683 | -0.2283 | 0.53 | 0/8 | 1.81 | 4.38 | `gap_pct` (1.84) | -0.0006 | +0.0000 |
| `combo_max__first_bar_return__rbreaker_buy_setup_proximity_early` | Gap / Overnight Reversal | +1 | +0.1100 | +0.0792 | +0.0792 | +0.7948 | 0.41 | 0/8 | 1.23 | 2.25 | `rbreaker_buy_setup_proximity_early` (1.12) | -0.0002 | -0.0338 |
| `combo_ifelse__gap_pct__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.1221 | +0.0614 | +0.0614 | +0.5184 | 0.28 | 0/8 | 1.08 | 1.22 | `gap_pct` (1.84) | -0.0005 | -0.0141 |
| `combo_z_sum__volume_weighted_price_position__limit_down_proximity_early` | Volatility & Oscillators | +1 | +0.1040 | +0.1254 | +0.1254 | +1.0792 | 0.64 | 0/8 | 0.85 | 1.62 | `limit_down_proximity_early` (1.12) | -0.0004 | +0.0389 |
| `combo_ifelse__gap_pct__opening_drive_thrust_ratio__yesterday_early_momentum` | Gap / Overnight Reversal | +1 | +0.1039 | +0.0660 | +0.0660 | +0.6358 | 0.39 | 0/8 | 0.69 | 0.98 | `gap_pct` (1.84) | -0.0000 | -0.0316 |
| `combo_ratio__max_up_ret__keltner_squeeze_width` | Intraday Range Momentum | +1 | +0.0960 | +0.0538 | +0.0538 | +0.3166 | 0.49 | 0/8 | 2.67 | 2.97 | `keltner_squeeze_width` (0.61) | -0.0010 | -0.0192 |
| `combo_ifelse__gap_pct__max_up_ret__yesterday_first_30min_return` | Gap / Overnight Reversal | +1 | +0.1028 | +0.1005 | +0.1005 | +0.6911 | 0.43 | 0/8 | 0.57 | 0.53 | `gap_pct` (1.84) | +0.0000 | -0.0053 |
| `combo_ifelse__gap_pct__yesterday_early_momentum__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1027 | +0.0174 | +0.0174 | -0.0890 | 0.81 | 1/8 | 1.97 | 4.52 | `gap_pct` (1.84) | -0.0003 | -0.0279 |
...
_Null Baseline (un-gated candidate pool): 67.0% lock IC > 0, 34.0% true FN rate (IC>0 & Sharpe>0), Mean Lock Sharpe = -0.2000_
...
| B4 Correlation Gate | 58 | 30 | 86.7% | 50.0% | +0.0188 | +0.0118 |

**Admitted Pool Summary**: 37 features, False Positive Rate = 37.8% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0224, Mean Lock Sharpe = +0.1575
...
- `combo_rank_min__bar_body_rng_0__limit_down_proximity_early`: Train IC=+0.2082, Lock IC=+0.0662, Lock Sharpe=+1.2725
...
| B4 Correlation Gate | 857 | 30 | 100.0% | 93.3% | +0.0980 | +0.5777 |

**Admitted Pool Summary**: 205 features, False Positive Rate = 17.6% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0869, Mean Lock Sharpe = +0.3580
...
| B4 Correlation Gate | 204 | 30 | 100.0% | 100.0% | +0.1209 | +1.3372 |

**Admitted Pool Summary**: 120 features, False Positive Rate = 4.2% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.1067, Mean Lock Sharpe = +0.8993
