...
### 300ETF — `single` (Full Model Lockbox IC: +0.0241, Sharpe: -0.1561)
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1068 | +0.0383 | +0.0383 | -0.0697 | 0.79 | 1/8 | 0.86 | 3.04 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0007 | +0.0719 |
| `combo_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1019 | +0.0460 | +0.0460 | +0.1064 | 0.73 | 1/8 | 0.85 | 4.68 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0007 | +0.0409 |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.1023 | +0.0245 | +0.0245 | +0.1045 | 0.83 | 1/8 | 0.98 | 4.08 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0006 | +0.0719 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0989 | +0.0057 | +0.0057 | -0.2202 | 0.85 | 1/8 | 1.03 | 3.29 | `volume_weighted_price_position` (1.11) | -0.0000 | +0.0000 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0915 | -0.0023 | -0.0023 | -0.5759 | 0.82 | 0/8 | 1.74 | 3.10 | `volume_weighted_price_position` (1.11) | -0.0004 | +0.0393 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1022 | +0.0351 | +0.0351 | +0.1736 | 0.87 | 1/8 | 1.13 | -40.14 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0003 | +0.0670 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1045 | +0.0512 | +0.0512 | +0.6322 | 0.77 | 1/8 | 0.86 | 5.39 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0005 | +0.0360 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1013 | +0.0094 | +0.0094 | +0.1080 | 0.78 | 1/8 | 0.82 | 1.96 | `volume_weighted_price_position` (1.11) | -0.0005 | -0.0116 |
| `combo_min__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0924 | +0.0084 | +0.0084 | -0.0883 | 0.71 | 1/8 | 0.87 | 1.96 | `max_up_ret` (0.89) | -0.0007 | +0.0000 |
| `combo_mean__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0886 | +0.0067 | +0.0067 | -0.2911 | 0.83 | 1/8 | 1.37 | 3.88 | `max_up_ret` (0.89) | -0.0002 | +0.0311 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0939 | -0.0018 | -0.0018 | +0.1999 | 0.85 | 0/8 | 1.48 | 4.09 | `volume_weighted_price_position` (1.11) | -0.0007 | -0.0012 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0952 | +0.0270 | +0.0270 | +0.5172 | 0.78 | 1/8 | 1.27 | 5.19 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0002 | +0.0000 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.1098 | +0.0362 | +0.0362 | +0.3660 | 0.56 | 0/8 | 0.77 | 1.61 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0004 | -0.0945 |
| `combo_tri_max__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0980 | +0.0083 | +0.0083 | -0.1271 | 0.77 | 1/8 | 1.51 | 3.34 | `max_up_ret` (0.89) | -0.0001 | +0.0409 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1008 | +0.0254 | +0.0254 | +0.4883 | 0.81 | 1/8 | 1.11 | 5.15 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | +0.0000 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1001 | +0.0183 | +0.0183 | -0.0646 | 0.69 | 0/8 | 0.96 | 1.64 | `max_up_ret` (0.89) | -0.0002 | +0.0000 |
| `combo_tri_max__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0998 | +0.0045 | +0.0045 | -0.5240 | 0.71 | 1/8 | 0.94 | 1.74 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0393 |
| `combo_rank_max__max_up_ret__first_bar_return` | Gap / Overnight Reversal | +1 | +0.0926 | +0.0134 | +0.0134 | +0.2457 | 0.66 | 0/8 | 1.20 | 1.53 | `max_up_ret` (0.89) | -0.0001 | +0.0409 |
| `combo_rank_min__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0995 | +0.0222 | +0.0222 | -0.2736 | 0.80 | 1/8 | 0.83 | 1.99 | `opening_drive_thrust_ratio` (0.83) | -0.0003 | +0.0670 |
| `combo_tri_max__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0876 | +0.0013 | +0.0013 | -0.3332 | 0.89 | 1/8 | 1.95 | 6.25 | `volume_weighted_price_position` (1.11) | -0.0002 | +0.0393 |
| `combo_min__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0955 | +0.0125 | +0.0125 | -0.4568 | 0.90 | 1/8 | 1.06 | 3.88 | `volume_weighted_price_position` (1.11) | +0.0003 | +0.0075 |
| `combo_rank_min__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0999 | +0.0141 | +0.0141 | -0.2026 | 0.89 | 1/8 | 0.89 | 2.80 | `volume_weighted_price_position` (1.11) | -0.0000 | -0.0012 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0899 | +0.0334 | +0.0334 | +0.9753 | 0.74 | 1/8 | 1.18 | 3.01 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0005 | +0.0409 |
| `combo_tri_mean__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1085 | +0.0362 | +0.0362 | +0.6343 | 0.68 | 1/8 | 0.87 | 2.26 | `star50_limit_proximity_early` (1.24) | +0.0003 | +0.0409 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0828 | -0.0138 | -0.0138 | -0.3231 | 0.92 | 0/8 | 1.93 | 5.15 | `volume_weighted_price_position` (1.11) | -0.0007 | +0.0393 |
| `combo_rank_max__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.0962 | +0.0069 | +0.0069 | -0.3876 | 0.76 | 1/8 | 0.92 | 1.72 | `volume_weighted_price_position` (1.11) | -0.0002 | +0.0393 |
| `combo_sig_product__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0991 | +0.0304 | +0.0304 | -0.1439 | 0.68 | 1/8 | 0.73 | 1.22 | `bar_body_rng_0` (0.68) | -0.0001 | +0.0409 |
| `combo_tri_max__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0992 | -0.0121 | -0.0121 | -0.4620 | 0.80 | 1/8 | 1.40 | 4.38 | `volume_weighted_price_position` (1.11) | -0.0007 | +0.0393 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Other Technical | +1 | +0.0882 | +0.0655 | +0.0655 | +0.9697 | 0.82 | 1/8 | 0.80 | 8.68 | `rbreaker_buy_setup_proximity_early` (2.08) | +0.0006 | +0.0075 |
| `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1010 | +0.0317 | +0.0317 | +0.5329 | 0.80 | 1/8 | 1.12 | 5.24 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0000 | +0.0360 |
| `combo_mean__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0898 | +0.0161 | +0.0161 | +0.3850 | 0.75 | 1/8 | 1.04 | 4.63 | `volume_surge_direction` (0.95) | -0.0001 | +0.0311 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.1095 | +0.0329 | +0.0329 | +0.3820 | 0.63 | 1/8 | 0.94 | 1.81 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0002 | +0.0000 |
| `combo_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0764 | +0.0092 | +0.0092 | +0.3974 | 0.98 | 2/8 | 1.02 | 175.30 | `volume_surge_direction` (0.95) | -0.0002 | +0.0000 |
| `combo_mean__volume_weighted_price_position__bar_body_rng_0` | Volatility & Oscillators | +1 | +0.1007 | +0.0123 | +0.0123 | -0.4689 | 0.80 | 1/8 | 0.86 | 2.06 | `volume_weighted_price_position` (1.11) | -0.0001 | -0.0012 |
| `combo_tri_median__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0953 | +0.0012 | +0.0012 | +0.0941 | 0.87 | 2/8 | 1.05 | 3.58 | `volume_weighted_price_position` (1.11) | -0.0005 | +0.0409 |
| `combo_rank_max__max_up_ret__volume_surge_direction` | Intraday Range Momentum | +1 | +0.0776 | +0.0095 | +0.0095 | +0.4295 | 0.90 | 2/8 | 0.95 | 6.23 | `volume_surge_direction` (0.95) | -0.0004 | +0.0311 |
| `combo_rank_max__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0901 | +0.0189 | +0.0189 | +0.5330 | 0.74 | 1/8 | 0.52 | 1.64 | `volume_surge_direction` (0.95) | -0.0003 | +0.0000 |
| `combo_tri_mean__bar_ret_0__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.1034 | +0.0071 | +0.0071 | +0.2288 | 0.75 | 0/8 | 1.01 | 2.79 | `volume_weighted_price_position` (1.11) | -0.0001 | +0.0409 |
| `combo_tri_median__star50_limit_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.1102 | +0.0337 | +0.0337 | +0.2687 | 0.74 | 1/8 | 0.87 | 3.16 | `star50_limit_proximity_early` (1.24) | -0.0000 | +0.0670 |
| `combo_tri_min__max_up_ret__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0971 | +0.0171 | +0.0171 | +0.4208 | 0.78 | 2/8 | 0.81 | 2.29 | `volume_weighted_price_position` (1.11) | -0.0002 | +0.1282 |
| `combo_sig_product__star50_limit_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0849 | +0.0427 | +0.0427 | -0.6213 | 0.77 | 1/8 | 1.27 | -59.25 | `star50_limit_proximity_early` (1.24) | -0.0001 | +0.0899 |
...
| `combo_tri_median__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0972 | +0.0166 | +0.0166 | +0.1134 | 0.63 | 0/8 | 0.65 | 1.27 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0003 | +0.0409 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__bar_ret_0` | Intraday Range Momentum | +1 | +0.0808 | +0.0306 | +0.0306 | -0.3020 | 0.63 | 1/8 | 1.41 | 1.24 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0006 | +0.0409 |
| `combo_rank_min__bar_body_rng_0__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0897 | +0.0311 | +0.0311 | +0.6361 | 0.83 | 0/8 | 1.02 | 5.77 | `volume_surge_direction` (0.95) | -0.0002 | +0.0311 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0929 | -0.0025 | -0.0025 | -0.2554 | 0.62 | 1/8 | 0.89 | 2.08 | `max_up_ret` (0.89) | -0.0006 | +0.0000 |
| `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0915 | -0.0131 | -0.0131 | -0.5701 | 0.90 | 2/8 | 1.54 | 6.91 | `volume_weighted_price_position` (1.11) | -0.0003 | +0.0393 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0841 | +0.0193 | +0.0193 | +0.2919 | 0.85 | 1/8 | 1.27 | 7.30 | `rbreaker_sell_setup_proximity_early` (1.07) | +0.0001 | +0.0311 |
| `combo_min__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0922 | +0.0291 | +0.0291 | +0.1524 | 0.85 | 1/8 | 0.91 | 6.14 | `volume_surge_direction` (0.95) | +0.0004 | -0.1448 |
| `max_up_ret` | Intraday Range Momentum | +1 | +0.0773 | -0.0047 | -0.0047 | +0.3486 | 0.89 | 1/8 | 1.65 | 3.65 | — | -0.0001 | +0.0000 |
...
| `combo_rank_max__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0807 | +0.0117 | +0.0117 | -0.3080 | 0.93 | 1/8 | 1.76 | 5.15 | `max_up_ret` (0.89) | -0.0000 | +0.0719 |
| `combo_tri_median__smooth_momentum_structure__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0617 | -0.0176 | -0.0176 | +0.0126 | 1.38 | 2/8 | 5.59 | -6.49 | `volume_weighted_price_position` (1.11) | -0.0002 | -0.0421 |
| `combo_max__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1045 | -0.0166 | -0.0166 | -0.3738 | 0.79 | 1/8 | 1.03 | 3.12 | `opening_drive_thrust_ratio` (0.83) | -0.0005 | +0.0719 |
| `combo_min__bar_body_rng_0__limit_down_proximity_early` | Other Technical | +1 | +0.0881 | +0.0572 | +0.0572 | +0.6639 | 0.86 | 1/8 | 0.74 | 7.30 | `limit_down_proximity_early` (2.08) | +0.0010 | -0.0945 |
| `combo_sig_product__volume_weighted_price_position__opening_drive_thrust_ratio` | Volatility & Oscillators | +1 | +0.0884 | -0.0007 | -0.0007 | -0.7513 | 1.01 | 2/8 | 1.43 | -29.47 | `volume_weighted_price_position` (1.11) | +0.0000 | +0.0344 |
| `combo_max__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0962 | -0.0050 | -0.0050 | +0.4800 | 0.65 | 0/8 | 0.72 | 2.17 | `first_bar_sentiment` (0.69) | -0.0005 | +0.0409 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Other Technical | +1 | +0.0937 | +0.0512 | +0.0512 | +0.0639 | 0.68 | 0/8 | 0.85 | 0.89 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0003 | +0.0409 |
| `combo_ratio__opening_drive_thrust_ratio__volume_weighted_price_position` | Volatility & Oscillators | +1 | +0.0938 | -0.0066 | -0.0066 | -0.7138 | 0.78 | 1/8 | 1.16 | 3.44 | `volume_weighted_price_position` (1.11) | -0.0004 | +0.0670 |
| `combo_tri_median__volume_weighted_momentum_acceleration__max_up_ret__bar_body_rng_0` | Intraday Range Momentum | +1 | +0.0701 | -0.0114 | -0.0114 | +0.2004 | 1.01 | 1/8 | 2.14 | 3.09 | `max_up_ret` (0.89) | -0.0001 | +0.0000 |
| `combo_mean__star50_limit_proximity_early__bar_body_rng_0` | Other Technical | +1 | +0.1013 | +0.0496 | +0.0496 | +0.5363 | 0.59 | 1/8 | 0.75 | 1.63 | `star50_limit_proximity_early` (1.24) | +0.0007 | -0.0945 |
| `combo_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0918 | +0.0267 | +0.0267 | +0.3866 | 0.72 | 0/8 | 1.19 | 1.77 | `early_vwap_acceleration` (1.02) | +0.0002 | +0.0311 |
| `combo_rank_max__opening_drive_thrust_ratio__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0908 | +0.0019 | +0.0019 | +0.2448 | 0.88 | 1/8 | 1.00 | 16.25 | `volume_surge_direction` (0.95) | -0.0005 | +0.0311 |
| `combo_mean__opening_drive_thrust_ratio__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.1022 | +0.0022 | +0.0022 | -0.4646 | 0.78 | 1/8 | 0.95 | 2.88 | `opening_drive_thrust_ratio` (0.83) | -0.0004 | +0.0670 |
| `combo_tri_min__star50_limit_proximity_early__bar_ret_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0925 | +0.0377 | +0.0377 | +0.6416 | 0.82 | 1/8 | 0.81 | 7.29 | `star50_limit_proximity_early` (1.24) | +0.0008 | -0.0945 |
| `combo_tri_min__max_up_ret__bar_ret_0__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0967 | +0.0081 | +0.0081 | +0.0717 | 0.74 | 1/8 | 0.87 | 3.14 | `max_up_ret` (0.89) | +0.0002 | -0.1448 |
| `combo_sig_product__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0730 | -0.0001 | -0.0001 | -0.7392 | 1.01 | 2/8 | 1.17 | 2.90 | `max_up_ret` (0.89) | -0.0003 | +0.0670 |
| `combo_tri_median__smooth_momentum_structure__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0714 | -0.0006 | -0.0006 | -0.4264 | 0.88 | 1/8 | 2.09 | 6.50 | `max_up_ret` (0.89) | -0.0002 | +0.0311 |
| `combo_max__volume_weighted_price_position__volume_surge_direction` | Volatility & Oscillators | +1 | +0.0848 | -0.0098 | -0.0098 | +0.0633 | 0.91 | 1/8 | 1.13 | 7.83 | `volume_weighted_price_position` (1.11) | -0.0008 | -0.0421 |
| `combo_tri_min__first_bar_return__volume_weighted_price_position__opening_drive_thrust_ratio` | Gap / Overnight Reversal | +1 | +0.0972 | +0.0275 | +0.0275 | +0.3270 | 0.74 | 1/8 | 0.74 | 1.97 | `volume_weighted_price_position` (1.11) | +0.0001 | -0.0945 |
| `combo_sig_product__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0892 | -0.0116 | -0.0116 | -0.6265 | 0.80 | 1/8 | 0.66 | 1.83 | `volume_weighted_price_position` (1.11) | -0.0006 | -0.0012 |
| `combo_tri_mean__smooth_momentum_structure__volume_weighted_price_position__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0621 | -0.0082 | -0.0082 | -0.6030 | 1.25 | 2/8 | 2.83 | 29.64 | `volume_weighted_price_position` (1.11) | -0.0002 | +0.0409 |
| `combo_rank_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.0856 | +0.0449 | +0.0449 | +0.4220 | 0.97 | 1/8 | 1.04 | -6.10 | `limit_down_proximity_early` (2.08) | +0.0003 | +0.0386 |
| `combo_rank_min__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0884 | +0.0043 | +0.0043 | +0.0263 | 0.96 | 2/8 | 1.18 | 3.37 | `volume_weighted_price_position` (1.11) | -0.0001 | +0.0409 |
| `combo_tri_median__volume_weighted_momentum_acceleration__bar_ret_0__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0722 | +0.0124 | +0.0124 | -0.4105 | 1.03 | 1/8 | 1.70 | 4.37 | `volume_weighted_price_position` (1.11) | -0.0000 | +0.0409 |
| `early_order_flow_imbalance` | Volatility & Oscillators | +1 | +0.0652 | -0.0189 | -0.0189 | -0.4041 | 1.12 | 2/8 | 2.03 | 31.17 | — | -0.0003 | +0.0000 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Intraday Range Momentum | +1 | +0.0727 | +0.0225 | +0.0225 | +0.1191 | 0.90 | 1/8 | 1.82 | 8.85 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0002 | +0.0000 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__bar_ret_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0906 | +0.0261 | +0.0261 | -0.0655 | 0.77 | 2/8 | 1.44 | 1.97 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0006 | +0.0409 |
| `combo_ratio__first_bar_return__volume_weighted_price_position` | Gap / Overnight Reversal | +1 | +0.0957 | +0.0041 | +0.0041 | +0.0910 | 0.57 | 0/8 | 0.64 | 1.09 | `volume_weighted_price_position` (1.11) | -0.0002 | +0.1701 |
| `combo_tri_mean__smooth_momentum_structure__max_up_ret__volume_weighted_price_position` | Intraday Range Momentum | +1 | +0.0519 | -0.0128 | -0.0128 | -0.5117 | 1.25 | 2/8 | 5.09 | 62.14 | `volume_weighted_price_position` (1.11) | -0.0006 | +0.0000 |
| `combo_min__opening_drive_thrust_ratio__limit_down_proximity_early` | Other Technical | +1 | +0.0856 | +0.0427 | +0.0427 | +0.6518 | 1.06 | 1/8 | 0.92 | -5.11 | `limit_down_proximity_early` (2.08) | +0.0008 | -0.0945 |
| `combo_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0719 | +0.0288 | +0.0288 | -0.2338 | 0.74 | 1/8 | 1.21 | 1.24 | `bar_vol_0` (2.19) | +0.0007 | -0.1361 |
| `combo_sig_product__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0859 | -0.0092 | -0.0092 | -0.4475 | 0.90 | 2/8 | 0.79 | 3.18 | `opening_drive_thrust_ratio` (0.83) | -0.0004 | +0.0670 |
| `combo_sig_product__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0609 | +0.0374 | +0.0374 | -0.6001 | 0.87 | 2/8 | 2.34 | -4.74 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0002 | +0.0360 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__max_up_ret__opening_drive_thrust_ratio` | Intraday Range Momentum | +1 | +0.0791 | +0.0285 | +0.0285 | -0.0878 | 0.83 | 1/8 | 1.94 | 3.50 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0004 | +0.0409 |
| `combo_rank_max__volume_weighted_price_position__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0976 | -0.0229 | -0.0229 | -1.8533 | 0.75 | 1/8 | 0.78 | 2.33 | `volume_weighted_price_position` (1.11) | -0.0006 | -0.0421 |
| `combo_tri_mean__smooth_momentum_structure__first_bar_return__bar_body_rng_0` | Gap / Overnight Reversal | +1 | +0.0523 | +0.0203 | +0.0203 | +0.1467 | 0.65 | 1/8 | 0.64 | 1.19 | `smooth_momentum_structure` (0.77) | -0.0002 | +0.0000 |
| `combo_rel_diff__rbreaker_sell_setup_proximity_early__bar_vol_0` | Volatility & Oscillators | +1 | +0.0681 | +0.0530 | +0.0530 | +0.6589 | 0.82 | 2/8 | 0.96 | 1.47 | `bar_vol_0` (2.19) | -0.0003 | +0.0075 |
| `combo_rel_diff__max_up_ret__early_vwap_acceleration` | Intraday Range Momentum | +1 | +0.0854 | +0.0225 | +0.0225 | -0.2686 | 0.82 | 0/8 | 1.14 | 2.01 | `early_vwap_acceleration` (1.02) | -0.0000 | +0.0670 |
| `first_bar_return` | Gap / Overnight Reversal | +1 | +0.0942 | +0.0107 | +0.0107 | +0.4827 | 0.57 | 0/8 | 0.64 | 1.16 | — | -0.0002 | +0.1701 |
...
| `always_in_trend_persistence` | Volatility & Oscillators | +1 | +0.0640 | -0.0421 | -0.0421 | -0.1859 | 0.92 | 2/8 | 1.78 | 4.11 | — | -0.0005 | +0.0000 |
...
| `combo_min__volume_weighted_price_position__double_bottom_bull_flag_early` | Volatility & Oscillators | +1 | +0.0405 | -0.0158 | -0.0158 | -1.0471 | 0.88 | 1/8 | 0.77 | 20.36 | `volume_weighted_price_position` (1.11) | -0.0000 | -0.0012 |
| `net_volume_flow` | Volatility & Oscillators | +1 | +0.0673 | -0.0024 | -0.0024 | -0.6933 | 1.09 | 1/8 | 2.00 | 6.74 | — | -0.0000 | +0.0000 |
| `combo_rank_min__first_bar_return__first_bar_sentiment` | Gap / Overnight Reversal | +1 | +0.0912 | +0.0112 | +0.0112 | +0.1352 | 0.55 | 0/8 | 0.73 | 1.05 | `first_bar_sentiment` (0.69) | -0.0004 | +0.0409 |
| `combo_tri_max__rbreaker_sell_setup_proximity_early__bar_body_rng_0__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0911 | +0.0387 | +0.0387 | -0.1453 | 0.73 | 1/8 | 1.13 | 1.24 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | +0.0409 |
| `first_30min_return` | Intraday Range Momentum | +1 | +0.0560 | +0.0077 | +0.0077 | +0.0592 | 1.38 | 1/8 | 5.90 | -3.05 | — | +0.0000 | +0.0000 |
| `combo_max__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Other Technical | +1 | +0.0814 | +0.0378 | +0.0378 | +0.1611 | 0.79 | 1/8 | 1.46 | 3.13 | `rbreaker_sell_setup_proximity_early` (1.07) | -0.0001 | +0.0360 |
...
**Admitted Pool Summary**: 126 features, False Positive Rate = 50.8% (admitted but negative lock IC/Sharpe), Mean Lock IC = +0.0152, Mean Lock Sharpe = -0.0042
...
| `combo_tri_median__smooth_momentum_structure__max_up_ret__volume_weighted_price_position` | +0.0771 | +0.0000 | -0.0176 | -0.23x | 2015-02-06 |
...
2. **300ETF `single` — Admission too loose**: 51% of admitted features have negative lockbox IC or Sharpe. Tighten B3 composite floor or add OOS validation gate.
...
8. **500ETF `single` — 7-Year Jackknife Sign Stability too strict**: 93.3% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.5995). Consider relaxing this gate.
9. **500ETF `single` — B2 Rolling Guard too strict**: 90.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.4802). Consider relaxing this gate.
10. **500ETF `single` — B3 Composite Floor too strict**: 100.0% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.3293). Consider relaxing this gate.
11. **500ETF `single` — B4 Correlation Gate too strict**: 96.7% of top rejects are true false negatives (lock IC > 0 AND Sharpe > 0 vs null baseline 46.0%, mean lock Sharpe=+0.5527). Consider relaxing this gate.
