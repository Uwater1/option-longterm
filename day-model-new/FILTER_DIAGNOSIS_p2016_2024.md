...
| 500ETF | single | 111 | 41 | `[8, 8, 7, 6, 6, 6, 5, 4, 4, 3, 3, 3, ... (41 clusters)]` | 0.2278 | 0 | 12 | 99 | 0% | 0.83 |
| 159915ETF | single | 100 | 43 | `[5, 5, 4, 4, 4, 4, 4, 4, 3, 3, 3, 2, ... (43 clusters)]` | 0.3217 | 0 | 1 | 99 | 0% | 0.94 |
...
- Admission: Train IC=+0.2091, Deflated=+0.2092, IR=0.59, Mono=0.67, p=0.0000, MaxCorr=0.80
...
**`combo_clamp_diff__max_up_ret__smooth_momentum_structure`** (Lock IC=+0.0854, Sharpe=+0.4225)
- Admission: Train IC=+0.2316, Deflated=+0.2307, IR=0.63, Mono=0.73, p=0.0000, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.293 | 2016: +0.091 | 2017: +0.144 | 2018: +0.251 | 2019: +0.165 | 2020: +0.190 | 2021: +0.166 | 2022: +0.049 | 2023: +0.105 | 2024: +0.155 | 2025: +0.051 | 2026: +0.009
- Yearly Tail ICs:   2015: +0.460 | 2016: +0.174 | 2017: +0.349 | 2018: +0.549 | 2019: +0.217 | 2020: +0.069 | 2021: +0.257 | 2022: +0.111 | 2023: +0.011 | 2024: +0.238 | 2025: -0.025 | 2026: +0.012
- IC CV=0.41, Neg years (linear/tail)=0/0 of 8, Half ratio=0.78, Recency ratio=0.66
- Early IC=+0.1171, Recent IC=+0.0771, 1st-half IC=+0.1658, 2nd-half IC=+0.1295, Neg regimes=0/5
- Weak component: `smooth_momentum_structure` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.162, Q2=+0.005, Q3_mid=+0.143, Q4=+0.154, Q5_high_vol=+0.240
...
- Admission: Train IC=+0.1983, Deflated=+0.1986, IR=0.61, Mono=0.74, p=0.0002, MaxCorr=0.91
...
- Admission: Train IC=+0.1884, Deflated=+0.1897, IR=0.54, Mono=0.70, p=0.0002, MaxCorr=0.75
...
- Admission: Train IC=+0.1777, Deflated=+0.1776, IR=0.37, Mono=0.66, p=0.0010, MaxCorr=0.89
...
| `combo_clamp_diff__max_up_ret__smooth_momentum_structure` | TP | persistent | +0.1548 | +0.0509 | +0.0093 | 1y |
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=57, persistent=54
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=22, persistent=78
...
| B4 Correlation Gate | 463 | 78 | 0 | 17 | 61 | 0% | 78% |
...
| B4 Correlation Gate | 183 | 78 | 0 | 0 | 78 | 0% | 100% |
...
| :--- | ---: | ---: | ---: | ---: | :--- |
| `volume_weighted_price_position` | 4 | 6 | 10 | 40% |  |
| `first_bar_return` | 1 | 19 | 20 | 5% |  |
| `max_up_ret` | 3 | 86 | 89 | 3% |  |
| `opening_drive_thrust_ratio` | 1 | 57 | 58 | 2% |  |
| `early_body_momentum` | 0 | 13 | 13 | 0% |  |
| `volume_weighted_momentum_acceleration` | 0 | 6 | 6 | 0% |  |
| `rally_strength_max` | 0 | 2 | 2 | 0% |  |
| `gap_pct` | 0 | 8 | 8 | 0% |  |
| `demark_setup_reversal_early` | 0 | 14 | 14 | 0% |  |
| `yesterday_early_trend` | 0 | 2 | 2 | 0% |  |
| `rbreaker_buy_setup_proximity_early` | 0 | 9 | 9 | 0% |  |
| `close_vs_open_range` | 0 | 8 | 8 | 0% |  |
| `rbreaker_sell_setup_proximity_early` | 0 | 82 | 82 | 0% |  |
| `yesterday_early_vwap_dev` | 0 | 5 | 5 | 0% |  |
| `max_down_ret` | 0 | 12 | 12 | 0% |  |
| `star50_limit_proximity_early` | 0 | 35 | 35 | 0% |  |
| `volatility_expansion_trend_vector` | 0 | 22 | 22 | 0% |  |
| `h2_l2_pullback_continuation` | 0 | 3 | 3 | 0% |  |
| `smooth_momentum_structure` | 0 | 2 | 2 | 0% |  |
| `bar_body_rng_0` | 0 | 40 | 40 | 0% |  |
| `keltner_squeeze_width` | 0 | 2 | 2 | 0% |  |
| `vwap_close_divergence_trend` | 0 | 11 | 11 | 0% |  |
| `bar_ret_0` | 0 | 37 | 37 | 0% |  |
| `directional_volume_signature` | 0 | 2 | 2 | 0% |  |
| `limit_down_proximity_early` | 0 | 7 | 7 | 0% |  |
| `trend_bar_close_consistency` | 0 | 3 | 3 | 0% |  |
| `body_size_progression` | 0 | 5 | 5 | 0% |  |
| `trend_day_regime_conviction` | 0 | 3 | 3 | 0% |  |
| `yesterday_first_30min_return` | 0 | 6 | 6 | 0% |  |
| `net_volume_flow` | 0 | 14 | 14 | 0% |  |
...
- **Symmetric** (`max, mean, min, rank_max, rank_min`): FP=3, TP=107, FP rate=3%
- **Conditional** (`abs_diff, clamp_diff, diff, ifelse, product, ratio`): FP=0, TP=21, FP rate=0%
- **3-way** (`tri_ifelse, tri_max, tri_mean, tri_median, tri_min`): FP=1, TP=82, FP rate=1%
