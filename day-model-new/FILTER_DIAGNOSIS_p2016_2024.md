...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 19 | 7 | 6 | 6 | 37% | 0.34 |
| 500ETF | single | 32 | 0 | 5 | 27 | 0% | 0.84 |
| 159915ETF | single | 29 | 0 | 0 | 29 | 0% | 0.94 |
...
### 300ETF — `single` (FP=7, TP=6)

| Metric | FP Mean | TP Mean | FP Median | TP Median | Cohen's d | Best Threshold | Accuracy |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| weak_link_cv | 0.974 | 1.095 | 0.889 | 1.067 | -1.27 | 1.086 | 54% |
| n_negative_years | 1.429 | 0.667 | 2.000 | 1.000 | +1.24 | 1.500 | 77% |
| ic_cv | 0.859 | 0.753 | 0.887 | 0.759 | +1.15 | 0.800 | 85% |
| ic_std_across_regimes | 0.042 | 0.057 | 0.043 | 0.060 | -1.09 | 0.028 | 46% |
| half_ratio | 1.151 | 1.017 | 1.087 | 0.983 | +0.46 | 0.875 | 62% |
| recency_ratio | -1.328 | -4.044 | 2.695 | 1.979 | +0.19 | 2.013 | 77% |
| n_negative_regimes | 0.000 | 0.000 | 0.000 | 0.000 | +0.00 | 0.000 | 46% |
...
**`combo_rank_max__max_up_ret__first_bar_sentiment`** (Lock IC=-0.0055, Sharpe=-0.5508)
...
**`combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio`** (Lock IC=-0.0033, Sharpe=-0.4708)
- Yearly ICs: 2016: +0.054 | 2017: -0.002 | 2018: +0.205 | 2019: +0.066 | 2020: -0.008 | 2021: +0.179 | 2022: +0.048 | 2023: +0.186
- IC CV=0.89, Neg years=2/8, Half ratio=1.23, Recency ratio=4.53
- Weak component: `volume_weighted_price_position` (CV=1.11, neg years=1)
- Regime ICs: Q1_low_vol=+0.059, Q2=+0.117, Q3_mid=+0.090, Q4=+0.034, Q5_high_vol=+0.181

**`combo_sig_product__bar_ret_0__opening_drive_thrust_ratio`** (Lock IC=-0.0080, Sharpe=-0.4475)
...
**`combo_min__max_up_ret__first_bar_sentiment`** (Lock IC=-0.0033, Sharpe=-0.1920)
- Yearly ICs: 2016: +0.103 | 2017: -0.011 | 2018: +0.157 | 2019: +0.087 | 2020: +0.031 | 2021: +0.118 | 2022: +0.056 | 2023: +0.150
- IC CV=0.63, Neg years=1/8, Half ratio=0.91, Recency ratio=2.23
- Weak component: `max_up_ret` (CV=0.89, neg years=1)
- Regime ICs: Q1_low_vol=+0.113, Q2=+0.090, Q3_mid=+0.043, Q4=+0.079, Q5_high_vol=+0.127

**`combo_max__max_up_ret__volume_weighted_price_position`** (Lock IC=-0.0088, Sharpe=-0.1775)
...
**`combo_mean__volume_weighted_price_position__double_bottom_bull_flag_early`** (Lock IC=+0.0535, Sharpe=-0.4500)
...
**`combo_tri_max__max_up_ret__bar_ret_0__bar_body_rng_0`** (Lock IC=+0.0234, Sharpe=-0.2236)
...
**`combo_min__max_up_ret__first_bar_sentiment`** (Lock IC=+0.0698, Sharpe=-0.0354)
- Yearly ICs: 2016: +0.140 | 2017: +0.182 | 2018: +0.232 | 2019: +0.136 | 2020: +0.137 | 2021: +0.082 | 2022: +0.107 | 2023: +0.072
- IC CV=0.36, Neg years=0/8, Half ratio=0.62, Recency ratio=0.56
- Weak component: `first_bar_sentiment` (CV=0.43)
- Regime ICs: Q1_low_vol=+0.195, Q2=-0.026, Q3_mid=+0.098, Q4=+0.190, Q5_high_vol=+0.183

**`combo_max__first_bar_sentiment__bar_ret_0`** (Lock IC=+0.0673, Sharpe=-0.2018)
- Yearly ICs: 2016: +0.105 | 2017: +0.119 | 2018: +0.257 | 2019: +0.129 | 2020: +0.094 | 2021: +0.108 | 2022: +0.097 | 2023: +0.045
- IC CV=0.48, Neg years=0/8, Half ratio=0.56, Recency ratio=0.63
- Weak component: `bar_ret_0` (CV=0.46)
- Regime ICs: Q1_low_vol=+0.174, Q2=-0.039, Q3_mid=+0.112, Q4=+0.173, Q5_high_vol=+0.147
...
**`vwap_close_divergence_trend`** (Lock IC=+0.0582, Sharpe=-0.2335)
...
**`combo_sig_product__opening_auction_imbalance__first_bar_return`** (Lock IC=+0.0538, Sharpe=-0.0373)
...
**`combo_rank_min__star50_limit_proximity_early__bar_body_rng_0`** (Lock IC=+0.0636, Sharpe=+0.7076)
...
**`combo_z_sum__rbreaker_sell_setup_proximity_early__max_up_ret`** (Lock IC=+0.0270, Sharpe=+0.5172)
...
**`combo_min__opening_auction_imbalance__star50_limit_proximity_early`** (Lock IC=+0.1235, Sharpe=+1.0733)
...
**`combo_rel_diff__opening_drive_thrust_ratio__late_bar_momentum`** (Lock IC=+0.0876, Sharpe=+0.8970)
...
**`combo_z_sum__first_bar_sentiment__max_down_ret`** (Lock IC=+0.0982, Sharpe=+0.6653)
...
**`combo_rel_diff__max_up_ret__smooth_momentum_structure`** (Lock IC=+0.0869, Sharpe=+0.4937)
...
**`combo_rel_diff__opening_auction_imbalance__volume_weighted_momentum_acceleration`** (Lock IC=+0.0887, Sharpe=+0.4835)
...
**`combo_max__star50_limit_proximity_early__early_body_momentum`** (Lock IC=+0.0916, Sharpe=+0.4036)
...
**`combo_z_sum__opening_drive_thrust_ratio__max_down_ret`** (Lock IC=+0.1011, Sharpe=+0.3129)
...
**`combo_rank_max__max_up_ret__first_bar_sentiment`** (Lock IC=+0.0833, Sharpe=+0.1730)
...
**`combo_min__star50_limit_proximity_early__first_bar_return`** (Lock IC=+0.1246, Sharpe=+1.4623)
...
**`combo_z_sum__first_bar_sentiment__rbreaker_buy_setup_proximity_early`** (Lock IC=+0.1020, Sharpe=+1.3030)
...
**`combo_ratio__star50_limit_proximity_early__volume_weighted_price_position`** (Lock IC=+0.1348, Sharpe=+1.0720)
...
**`combo_rank_min__star50_limit_proximity_early__volatility_expansion_trend_vector`** (Lock IC=+0.1315, Sharpe=+1.0185)
...
**`combo_rel_diff__first_bar_return__demark_setup_reversal_early`** (Lock IC=+0.1094, Sharpe=+0.9727)
...
- Yearly ICs: 2016: +0.115 | 2017: +0.033 | 2018: +0.083 | 2019: +0.241 | 2020: +0.121 | 2021: +0.127 | 2022: +0.098 | 2023: +0.133
- IC CV=0.46, Neg years=0/8, Half ratio=0.99, Recency ratio=1.56
...
- Yearly ICs: 2016: +0.078 | 2017: +0.029 | 2018: +0.074 | 2019: +0.187 | 2020: +0.138 | 2021: +0.153 | 2022: +0.125 | 2023: +0.182
- IC CV=0.44, Neg years=0/8, Half ratio=1.87, Recency ratio=2.88
...
**`combo_product__rbreaker_sell_setup_proximity_early__max_up_ret`** (Lock IC=+0.0486, Sharpe=+0.8021)
...
**`combo_rank_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early`** (Lock IC=+0.1364, Sharpe=+0.6490)
...
**`combo_rank_max__rbreaker_sell_setup_proximity_early__impulse_bar_dominance`** (Lock IC=+0.0804, Sharpe=+0.4337)
...
- Yearly ICs: 2016: +0.039 | 2017: +0.082 | 2018: +0.101 | 2019: +0.177 | 2020: +0.058 | 2021: +0.126 | 2022: +0.086 | 2023: +0.176
- IC CV=0.45, Neg years=0/8, Half ratio=1.23, Recency ratio=2.17
- Weak component: `opening_drive_thrust_ratio` (CV=0.53)
...
**`combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_sentiment`** (Lock IC=+0.0779, Sharpe=+0.1434)
- Yearly ICs: 2016: +0.116 | 2017: -0.030 | 2018: +0.100 | 2019: +0.153 | 2020: +0.167 | 2021: +0.117 | 2022: +0.078 | 2023: +0.066
- IC CV=0.60, Neg years=1/8, Half ratio=1.21, Recency ratio=1.67
- Weak component: `first_bar_sentiment` (CV=0.76)

**`combo_min__yesterday_first_30min_return__rbreaker_buy_setup_proximity_early`** (Lock IC=+0.1067, Sharpe=+0.0497)
...
| `combo_rank_min__star50_limit_proximity_early__bar_body_rng_0` | TP | persistent | +0.0475 | +0.0974 | +0.0281 | ∞ |
...
| `combo_min__max_up_ret__first_bar_sentiment` | FP | gradual | +0.0094 | +0.0322 | -0.0657 | ∞ |
| `combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio` | FP | gradual | +0.0011 | +0.1144 | -0.1844 | ∞ |
...
**Decay distribution**: immediate=3, fast(1-2y)=0, gradual=14, persistent=2

**FP decay trajectories:**

- `combo_rank_max__max_up_ret__first_bar_sentiment`: Y1:-0.025 → Y2:+0.066 → Y3:-0.109
- `combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio`: Y1:+0.001 → Y2:+0.114 → Y3:-0.184
- `combo_min__max_up_ret__first_bar_sentiment`: Y1:+0.009 → Y2:+0.032 → Y3:-0.066
...
| `combo_z_sum__opening_drive_thrust_ratio__max_down_ret` | TP | persistent | +0.1356 | +0.1097 | +0.0226 | 2y |
...
| `combo_rank_max__max_up_ret__first_bar_sentiment` | TP | gradual | +0.1300 | +0.0741 | -0.0035 | 2y |
| `combo_rank_max__early_body_momentum__bar_ret_0` | Median | gradual | +0.1272 | +0.1213 | -0.1240 | 2y |
| `combo_rel_diff__opening_auction_imbalance__volume_weighted_momentum_acceleration` | TP | persistent | +0.1264 | +0.0968 | +0.0042 | 2y |
...
| `combo_max__first_bar_sentiment__bar_ret_0` | Median | persistent | +0.0988 | +0.0628 | +0.0212 | 2y |
...
| `combo_min__max_up_ret__first_bar_sentiment` | Median | gradual | +0.0854 | +0.1076 | -0.0026 | 2y |
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=12, persistent=20

### 159915ETF — `single`

| Feature | Tier | Decay | Y1 IC | Y2 IC | Y3+ IC | Half-life |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: |
| `combo_rank_max__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early` | TP | persistent | +0.1349 | +0.1542 | +0.1185 | ∞ |
...
| `combo_rank_max__rbreaker_sell_setup_proximity_early__impulse_bar_dominance` | TP | persistent | +0.0916 | +0.1194 | +0.0122 | 2y |
...
| `combo_rank_min__star50_limit_proximity_early__volatility_expansion_trend_vector` | TP | persistent | +0.0835 | +0.1949 | +0.0887 | ∞ |
...
| `combo_min__yesterday_first_30min_return__rbreaker_buy_setup_proximity_early` | TP | persistent | +0.0719 | +0.1280 | +0.1150 | ∞ |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__first_bar_sentiment` | TP | persistent | +0.0692 | +0.0842 | +0.0816 | ∞ |
...
**Decay distribution**: immediate=1, fast(1-2y)=0, gradual=3, persistent=25
...
| :--- | :--- | :--- | ---: | :--- |
| monotonicity | 0.718±0.055 | 0.719±0.036 | 61% | WEAK |
| ic_ir | 0.587±0.151 | 0.614±0.093 | 66% | WEAK |
| p_value | 0.000±0.001 | 0.000±0.000 | 12% | USEFUL |
| max_corr | 0.827±0.020 | 0.641±0.292 | 7% | USEFUL |
| deflated_ic | 0.195±0.027 | 0.235±0.028 | 60% | WEAK |
| overall_ic | 0.195±0.028 | 0.235±0.028 | 61% | WEAK |
| raw_ic | 0.088±0.005 | 0.099±0.004 | 22% | USEFUL |
...
- `combo_min__first_bar_return__volume_surge_direction`: Train IC=+0.1389, Lock IC=+0.0101, Sharpe=+0.2834
- `combo_min__bar_ret_0__volume_surge_direction`: Train IC=+0.1387, Lock IC=+0.0100, Sharpe=+0.2834
- `combo_rel_diff__smooth_momentum_structure__bar_body_rng_0`: Train IC=+0.1676, Lock IC=+0.0217, Sharpe=+0.1912
...
**B3 Composite Floor**: 10/20 top rejects are profitable (50%)

- `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret`: Train IC=+0.2350, Lock IC=+0.0270, Sharpe=+0.5172
- `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0`: Train IC=+0.2251, Lock IC=+0.0254, Sharpe=+0.4883
...
- `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret`: Train IC=+0.2249, Lock IC=+0.0346, Sharpe=+1.1999
- `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0`: Train IC=+0.2492, Lock IC=+0.0505, Sharpe=+0.7439
- `combo_rank_max__max_up_ret__bar_ret_0`: Train IC=+0.2199, Lock IC=+0.0109, Sharpe=+0.1585

### 500ETF — `single`

**7-Year Jackknife**: 19/20 top rejects are profitable (95%)

- `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret`: Train IC=+0.2706, Lock IC=+0.1225, Sharpe=+1.2571
...
- `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__body_size_progression`: Train IC=+0.1879, Lock IC=+0.0666, Sharpe=+0.7913
- `combo_tri_z_mean__opening_drive_thrust_ratio__max_up_ret__body_size_progression`: Train IC=+0.1879, Lock IC=+0.0666, Sharpe=+0.7913
- `combo_tri_max__rbreaker_sell_setup_proximity_early__opening_auction_imbalance__volume_weighted_momentum_acceleration`: Train IC=+0.1765, Lock IC=+0.0288, Sharpe=+0.6398

**BH-FDR Gate**: 2/9 top rejects are profitable (22%)

- `combo_tri_median__max_up_ret__smooth_momentum_structure__trend_day_regime_conviction`: Train IC=+0.0891, Lock IC=+0.0815, Sharpe=+1.5172
- `combo_rank_min__first_bar_sentiment__max_down_ret`: Train IC=+0.0692, Lock IC=+0.0856, Sharpe=+0.2051

**B3 Composite Floor**: 20/20 top rejects are profitable (100%)

- `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector`: Train IC=+0.2415, Lock IC=+0.1182, Sharpe=+1.2158
- `combo_tri_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__opening_auction_imbalance`: Train IC=+0.2414, Lock IC=+0.1134, Sharpe=+0.9635
- `combo_tri_z_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__opening_auction_imbalance`: Train IC=+0.2414, Lock IC=+0.1134, Sharpe=+0.9635
...
- `combo_rel_diff__max_up_ret__volume_weighted_momentum_acceleration`: Train IC=+0.2566, Lock IC=+0.0857, Sharpe=+0.8706
- `combo_diff__max_up_ret__volume_weighted_momentum_acceleration`: Train IC=+0.2513, Lock IC=+0.0874, Sharpe=+0.8706

### 159915ETF — `single`

**7-Year Jackknife**: 19/20 top rejects are profitable (95%)

- `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early`: Train IC=+0.1899, Lock IC=+0.1399, Sharpe=+1.4951
- `combo_rank_min__bar_body_rng_0__limit_down_proximity_early`: Train IC=+0.1899, Lock IC=+0.1399, Sharpe=+1.4951
- `combo_min__star50_limit_proximity_early__first_bar_sentiment`: Train IC=+0.1921, Lock IC=+0.1128, Sharpe=+1.2866

**B2 Rolling Guard**: 18/20 top rejects are profitable (90%)

- `combo_mean__bar_body_rng_0__volume_weighted_price_position`: Train IC=+0.1514, Lock IC=+0.0813, Sharpe=+1.2504
- `combo_z_sum__bar_body_rng_0__volume_weighted_price_position`: Train IC=+0.1514, Lock IC=+0.0813, Sharpe=+1.2504
- `combo_mean__first_bar_return__volume_weighted_price_position`: Train IC=+0.1523, Lock IC=+0.0775, Sharpe=+0.9535

**BH-FDR Gate**: 5/7 top rejects are profitable (71%)

- `combo_sig_product__yesterday_first_30min_return__rbreaker_buy_setup_proximity_early`: Train IC=+0.0665, Lock IC=+0.0430, Sharpe=+0.3701
- `combo_sig_product__yesterday_first_30min_return__limit_down_proximity_early`: Train IC=+0.0665, Lock IC=+0.0430, Sharpe=+0.3701
- `early_skew`: Train IC=+0.0611, Lock IC=+0.0865, Sharpe=+0.3693

**B3 Composite Floor**: 20/20 top rejects are profitable (100%)

- `combo_tri_median__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early__first_bar_sentiment`: Train IC=+0.2449, Lock IC=+0.1240, Sharpe=+1.5787
- `combo_tri_mean__max_up_ret__star50_limit_proximity_early__first_bar_return`: Train IC=+0.2522, Lock IC=+0.1236, Sharpe=+1.5562
- `combo_tri_z_mean__max_up_ret__star50_limit_proximity_early__first_bar_return`: Train IC=+0.2522, Lock IC=+0.1236, Sharpe=+1.5562
...
- `combo_rank_min__rbreaker_sell_setup_proximity_early__volume_weighted_price_position`: Train IC=+0.2829, Lock IC=+0.1357, Sharpe=+1.4845
...
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife | 1031 | 78 | 30 | 33 | 15 | 38% | 19% |
| B2 Rolling Guard | 51 | 51 | 27 | 13 | 11 | 53% | 22% |
| BH-FDR Gate | 10 | 10 | 8 | 1 | 1 | 80% | 10% |
| B3 Composite Floor | 164 | 78 | 21 | 18 | 39 | 27% | 50% |
| B4 Correlation Gate | 83 | 78 | 14 | 26 | 38 | 18% | 49% |

**B2 Rolling Guard** — top TP casualties:
- `combo_sig_product__rbreaker_sell_setup_proximity_early__max_up_ret`: Train IC=+0.0937, Lock IC=+0.0411, Sharpe=+0.5207
- `combo_diff__opening_drive_thrust_ratio__volume_surge_direction`: Train IC=+0.0731, Lock IC=+0.0270, Sharpe=+0.4919
- `combo_z_diff__opening_drive_thrust_ratio__volume_surge_direction`: Train IC=+0.0731, Lock IC=+0.0270, Sharpe=+0.4919

**B3 Composite Floor** — top TP casualties:
- `combo_rank_min__opening_drive_thrust_ratio__limit_down_proximity_early`: Train IC=+0.1733, Lock IC=+0.0450, Sharpe=+0.7347
- `combo_rel_diff__rbreaker_sell_setup_proximity_early__bar_vol_0`: Train IC=+0.1458, Lock IC=+0.0531, Sharpe=+0.6589
- `combo_rel_diff__rbreaker_sell_setup_proximity_early__first_bar_volume`: Train IC=+0.1458, Lock IC=+0.0531, Sharpe=+0.6589

**B4 Correlation Gate** — top TP casualties:
- `combo_rank_min__bar_body_rng_0__limit_down_proximity_early`: Train IC=+0.2077, Lock IC=+0.0662, Sharpe=+1.2725
- `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early`: Train IC=+0.2077, Lock IC=+0.0662, Sharpe=+1.2725
- `combo_rank_min__rbreaker_sell_setup_proximity_early__max_up_ret`: Train IC=+0.2249, Lock IC=+0.0346, Sharpe=+1.1999
...
| Gate | Total Rej | Evaluated | FP Caught | Median | TP Killed | Precision | Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife | 1762 | 78 | 33 | 15 | 30 | 42% | 38% |
| B2 Rolling Guard | 168 | 78 | 17 | 17 | 44 | 22% | 56% |
| BH-FDR Gate | 9 | 9 | 1 | 6 | 2 | 11% | 22% |
| B3 Composite Floor | 457 | 78 | 1 | 5 | 72 | 1% | 92% |
| B4 Correlation Gate | 296 | 78 | 0 | 11 | 67 | 0% | 86% |
...
**B2 Rolling Guard** — top TP casualties:
- `combo_tri_min__star50_limit_proximity_early__volume_weighted_momentum_acceleration__trend_day_regime_conviction`: Train IC=+0.1156, Lock IC=+0.0384, Sharpe=+1.0946
- `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__body_size_progression`: Train IC=+0.1879, Lock IC=+0.0666, Sharpe=+0.7913
- `combo_tri_z_mean__opening_drive_thrust_ratio__max_up_ret__body_size_progression`: Train IC=+0.1879, Lock IC=+0.0666, Sharpe=+0.7913
...
**B3 Composite Floor** — top TP casualties:
- `combo_tri_min__smooth_momentum_structure__star50_limit_proximity_early__trend_day_regime_conviction`: Train IC=+0.1153, Lock IC=+0.0513, Sharpe=+1.2530
- `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector`: Train IC=+0.2415, Lock IC=+0.1182, Sharpe=+1.2158
- `combo_tri_min__opening_drive_thrust_ratio__opening_auction_imbalance__star50_limit_proximity_early`: Train IC=+0.2313, Lock IC=+0.1170, Sharpe=+1.0936

**B4 Correlation Gate** — top TP casualties:
- `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__trend_day_regime_conviction`: Train IC=+0.2501, Lock IC=+0.1080, Sharpe=+1.3025
- `combo_min__rbreaker_sell_setup_proximity_early__trend_day_regime_conviction`: Train IC=+0.2224, Lock IC=+0.1119, Sharpe=+1.1506
- `combo_rel_diff__opening_drive_thrust_ratio__early_late_momentum_divergence`: Train IC=+0.1523, Lock IC=+0.0871, Sharpe=+1.0837

### 159915ETF — `single`

| Gate | Total Rej | Evaluated | FP Caught | Median | TP Killed | Precision | Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife | 1140 | 78 | 28 | 15 | 35 | 36% | 45% |
| B2 Rolling Guard | 109 | 78 | 18 | 12 | 48 | 23% | 62% |
| BH-FDR Gate | 7 | 7 | 1 | 1 | 5 | 14% | 71% |
| B3 Composite Floor | 274 | 78 | 5 | 5 | 68 | 6% | 87% |
| B4 Correlation Gate | 168 | 78 | 0 | 2 | 76 | 0% | 97% |
...
**B4 Correlation Gate** — top TP casualties:
- `combo_z_sum__first_bar_return__rbreaker_buy_setup_proximity_early`: Train IC=+0.1912, Lock IC=+0.1170, Sharpe=+1.8672
- `combo_z_sum__first_bar_return__limit_down_proximity_early`: Train IC=+0.1912, Lock IC=+0.1170, Sharpe=+1.8672
- `combo_z_sum__bar_ret_0__rbreaker_buy_setup_proximity_early`: Train IC=+0.1908, Lock IC=+0.1173, Sharpe=+1.8672
...
- `weak_link_cv`: FP is lower (d=-1.27). Threshold 1.086 → 54% accuracy.
- `n_negative_years`: FP is higher (d=+1.24). Threshold 1.500 → 77% accuracy.
- `ic_cv`: FP is higher (d=+1.15). Threshold 0.800 → 85% accuracy.
- `ic_std_across_regimes`: FP is lower (d=-1.09). Threshold 0.028 → 46% accuracy.
...
| :--- | ---: | ---: | ---: | ---: | :--- |
| `volume_weighted_price_position` | 3 | 3 | 6 | 50% |  |
| `first_bar_sentiment` | 2 | 5 | 7 | 29% |  |
| `opening_drive_thrust_ratio` | 4 | 14 | 18 | 22% |  |
| `bar_ret_0` | 1 | 4 | 5 | 20% |  |
| `max_up_ret` | 4 | 19 | 23 | 17% |  |
| `star50_limit_proximity_early` | 0 | 15 | 15 | 0% |  |
| `close_vs_open_range` | 0 | 2 | 2 | 0% |  |
| `first_bar_return` | 0 | 7 | 7 | 0% |  |
| `rbreaker_sell_setup_proximity_early` | 0 | 21 | 21 | 0% |  |
| `max_down_ret` | 0 | 7 | 7 | 0% |  |
| `volatility_expansion_trend_vector` | 0 | 6 | 6 | 0% |  |
...
| `opening_auction_imbalance` | 0 | 2 | 2 | 0% |  |

---

## 9. Operator Class FP Rate

- **Symmetric** (`max, mean, min, rank_max, rank_min`): FP=5, TP=31, FP rate=14%
- **Conditional** (`abs_diff, clamp_diff, diff, ifelse, product, ratio`): FP=0, TP=5, FP rate=0%
- **3-way** (`tri_ifelse, tri_max, tri_mean, tri_median, tri_min`): FP=0, TP=11, FP rate=0%
