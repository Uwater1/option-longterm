...
| :--- | :--- | ---: | ---: | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 81 | 31 | `[6, 5, 5, 4, 3, 3, 3, 3, 2, 2, 2, 2, ... (31 clusters)]` | 0.2818 | 0 | 16 | 65 | 0% | 0.67 |
| 500ETF | single | 259 | 59 | `[14, 12, 11, 10, 9, 8, 7, 6, 6, 6, 5, 5, ... (59 clusters)]` | 0.2993 | 1 | 21 | 237 | 0% | 0.85 |
| 159915ETF | single | 98 | 28 | `[13, 5, 4, 4, 4, 4, 4, 3, 3, 3, 3, 3, ... (28 clusters)]` | 0.2671 | 1 | 0 | 97 | 1% | 0.92 |
...
**`combo_min__high_low_sequence_momentum__max_down_ret`** (Lock IC=+0.0980, Sharpe=+0.8219)
- Admission: Train IC=+0.2056, Deflated=+0.2075, IR=0.64, Mono=0.72, p=0.0000, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.247 | 2016: +0.060 | 2017: +0.221 | 2018: +0.126 | 2019: +0.095 | 2020: +0.127 | 2021: +0.046 | 2022: +0.091 | 2023: +0.075 | 2024: +0.124 | 2025: +0.138 | 2026: -0.000
- Yearly Tail ICs:   2015: +0.328 | 2016: -0.047 | 2017: +0.263 | 2018: +0.117 | 2019: +0.269 | 2020: +0.113 | 2021: +0.294 | 2022: +0.207 | 2023: +0.097 | 2024: +0.310 | 2025: +0.199 | 2026: +0.075
- IC CV=0.54, Neg years (linear/tail)=0/1 of 8, Half ratio=0.59, Recency ratio=0.44
- Early IC=+0.1536, Recent IC=+0.0681, 1st-half IC=+0.1575, 2nd-half IC=+0.0933, Neg regimes=1/5
- Weak component: `max_down_ret` (CV=0.60)
- Regime ICs: Q1_low_vol=+0.159, Q2=-0.008, Q3_mid=+0.156, Q4=+0.141, Q5_high_vol=+0.167
...
**`combo_min__trend_day_regime_conviction__max_down_ret`** (Lock IC=+0.0966, Sharpe=+0.7232)
- Admission: Train IC=+0.2044, Deflated=+0.2062, IR=0.58, Mono=0.70, p=0.0000, MaxCorr=1.00
- Yearly Linear ICs: 2015: +0.245 | 2016: +0.064 | 2017: +0.214 | 2018: +0.129 | 2019: +0.097 | 2020: +0.122 | 2021: +0.051 | 2022: +0.089 | 2023: +0.077 | 2024: +0.119 | 2025: +0.140 | 2026: +0.001
- Yearly Tail ICs:   2015: +0.328 | 2016: -0.060 | 2017: +0.253 | 2018: +0.107 | 2019: +0.287 | 2020: +0.058 | 2021: +0.294 | 2022: +0.193 | 2023: +0.096 | 2024: +0.292 | 2025: +0.245 | 2026: +0.066
- IC CV=0.51, Neg years (linear/tail)=0/1 of 8, Half ratio=0.59, Recency ratio=0.45
- Early IC=+0.1547, Recent IC=+0.0701, 1st-half IC=+0.1569, 2nd-half IC=+0.0928, Neg regimes=1/5
- Weak component: `max_down_ret` (CV=0.60)
- Regime ICs: Q1_low_vol=+0.161, Q2=-0.010, Q3_mid=+0.155, Q4=+0.139, Q5_high_vol=+0.168
...
- Admission: Train IC=+0.2037, Deflated=+0.2059, IR=0.58, Mono=0.71, p=0.0000, MaxCorr=0.96
...
- Admission: Train IC=+0.2672, Deflated=+0.2686, IR=0.70, Mono=0.76, p=0.0000, MaxCorr=0.91
...
**Decay distribution**: immediate=0, fast(1-2y)=8, gradual=65, persistent=8
...
| `combo_min__trend_day_regime_conviction__max_down_ret` | TP | persistent | +0.0773 | +0.1189 | +0.0008 | 3y |
...
| `combo_min__high_low_sequence_momentum__max_down_ret` | TP | gradual | +0.0753 | +0.1239 | -0.0004 | 3y |
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=118, persistent=141
...
**Decay distribution**: immediate=0, fast(1-2y)=1, gradual=26, persistent=71
...
| B4 Correlation Gate | 85 | 78 | 0 | 10 | 68 | 0% | 87% |
...
| B4 Correlation Gate | 537 | 78 | 0 | 16 | 62 | 0% | 79% |
...
| B4 Correlation Gate | 100 | 78 | 0 | 0 | 78 | 0% | 100% |
...
| :--- | ---: | ---: | ---: | ---: | :--- |
| `volatility_expansion_trend_vector` | 1 | 26 | 27 | 4% |  |
| `close_vs_open_range` | 1 | 37 | 38 | 3% |  |
| `max_up_ret` | 2 | 130 | 132 | 2% |  |
...
| `opening_drive_thrust_ratio` | 0 | 118 | 118 | 0% |  |
| `yesterday_first_30min_return` | 0 | 7 | 7 | 0% |  |
| `trend_bar_close_consistency` | 0 | 23 | 23 | 0% |  |
...
| `rbreaker_sell_setup_proximity_early` | 0 | 91 | 91 | 0% |  |
| `early_body_momentum` | 0 | 16 | 16 | 0% |  |
| `rbreaker_buy_setup_proximity_early` | 0 | 5 | 5 | 0% |  |
| `early_late_momentum_divergence` | 0 | 3 | 3 | 0% |  |
| `bar_body_rng_0` | 0 | 47 | 47 | 0% |  |
| `star50_limit_proximity_early` | 0 | 67 | 67 | 0% |  |
| `first_bar_return` | 0 | 51 | 51 | 0% |  |
...
- **Symmetric** (`max, mean, min, rank_max, rank_min`): FP=0, TP=224, FP rate=0%
- **Conditional** (`abs_diff, clamp_diff, diff, ifelse, product, ratio`): FP=2, TP=22, FP rate=8%
- **3-way** (`tri_ifelse, tri_max, tri_mean, tri_median, tri_min`): FP=0, TP=101, FP rate=0%
