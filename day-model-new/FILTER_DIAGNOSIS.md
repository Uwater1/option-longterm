...
| :--- | :--- | ---: | ---: | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 18 | 9 | `[3, 3, 2, 2, 2, 2, 2, 1, 1]` | 0.3251 | 0 | 1 | 17 | 0% | 0.80 |
| 500ETF | single | 190 | 54 | `[12, 9, 8, 7, 6, 6, 6, 6, 6, 5, 5, 4, ... (54 clusters)]` | 0.3031 | 0 | 12 | 178 | 0% | 0.86 |
| 159915ETF | single | 16 | 3 | `[13, 2, 1]` | 0.3825 | 0 | 0 | 16 | 0% | 0.91 |
...
- Admission: Train IC=+0.1816, Deflated=+0.1799, IR=0.67, Mono=0.76, p=0.0006, MaxCorr=0.73
...
**`combo_max__opening_drive_thrust_ratio__first_bar_return`** (Lock IC=+0.0944, Sharpe=-0.0195)
- Admission: Train IC=+0.2037, Deflated=+0.2027, IR=0.52, Mono=0.73, p=0.0006, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.255 | 2016: +0.086 | 2017: +0.225 | 2018: +0.244 | 2019: +0.136 | 2020: +0.162 | 2021: +0.165 | 2022: +0.100 | 2023: +0.107 | 2024: +0.146 | 2025: +0.071 | 2026: -0.013
- Yearly Tail ICs:   2015: +0.235 | 2016: -0.060 | 2017: +0.161 | 2018: +0.342 | 2019: +0.134 | 2020: +0.232 | 2021: +0.287 | 2022: +0.134 | 2023: +0.068 | 2024: +0.267 | 2025: -0.040 | 2026: -0.291
- IC CV=0.32, Neg years (linear/tail)=0/1 of 7, Half ratio=0.92, Recency ratio=0.96
- Early IC=+0.1706, Recent IC=+0.1636, 1st-half IC=+0.1980, 2nd-half IC=+0.1818, Neg regimes=0/5
...
**`combo_clamp_diff__opening_drive_thrust_ratio__volume_weighted_momentum_acceleration`** (Lock IC=+0.0832, Sharpe=-0.1914)
- Admission: Train IC=+0.2057, Deflated=+0.2053, IR=0.64, Mono=0.73, p=0.0006, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.248 | 2016: +0.052 | 2017: +0.155 | 2018: +0.230 | 2019: +0.183 | 2020: +0.189 | 2021: +0.149 | 2022: +0.042 | 2023: +0.090 | 2024: +0.140 | 2025: +0.067 | 2026: +0.036
- Yearly Tail ICs:   2015: +0.283 | 2016: -0.048 | 2017: +0.078 | 2018: +0.394 | 2019: +0.241 | 2020: +0.168 | 2021: +0.153 | 2022: +0.174 | 2023: +0.000 | 2024: +0.162 | 2025: +0.223 | 2026: -0.169
- IC CV=0.34, Neg years (linear/tail)=0/1 of 7, Half ratio=1.24, Recency ratio=1.13
- Early IC=+0.1502, Recent IC=+0.1693, 1st-half IC=+0.1589, 2nd-half IC=+0.1965, Neg regimes=0/5
- Weak component: `volume_weighted_momentum_acceleration` (CV=0.46)
- Regime ICs: Q1_low_vol=+0.155, Q2=+0.107, Q3_mid=+0.160, Q4=+0.121, Q5_high_vol=+0.303

**`combo_max__net_volume_flow__first_bar_sentiment`** (Lock IC=+0.0815, Sharpe=-0.0085)
- Admission: Train IC=+0.2182, Deflated=+0.2180, IR=0.55, Mono=0.71, p=0.0004, MaxCorr=0.94
...
**`combo_max__net_volume_flow__first_bar_return`** (Lock IC=+0.0784, Sharpe=-0.0612)
- Admission: Train IC=+0.1964, Deflated=+0.1958, IR=0.57, Mono=0.71, p=0.0008, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.192 | 2016: +0.107 | 2017: +0.170 | 2018: +0.235 | 2019: +0.119 | 2020: +0.108 | 2021: +0.106 | 2022: +0.094 | 2023: +0.074 | 2024: +0.110 | 2025: +0.105 | 2026: -0.069
- Yearly Tail ICs:   2015: +0.219 | 2016: +0.037 | 2017: +0.154 | 2018: +0.279 | 2019: +0.140 | 2020: +0.257 | 2021: +0.277 | 2022: +0.158 | 2023: +0.362 | 2024: +0.186 | 2025: -0.075 | 2026: -0.486
- IC CV=0.32, Neg years (linear/tail)=0/0 of 7, Half ratio=0.80, Recency ratio=0.72
- Early IC=+0.1494, Recent IC=+0.1075, 1st-half IC=+0.1774, 2nd-half IC=+0.1413, Neg regimes=0/5
- Weak component: `first_bar_return` (CV=0.35)
- Regime ICs: Q1_low_vol=+0.179, Q2=+0.016, Q3_mid=+0.169, Q4=+0.149, Q5_high_vol=+0.234
...
**`combo_rank_min__close_vs_open_range__first_bar_sentiment`** (Lock IC=+0.0751, Sharpe=-0.1701)
- Admission: Train IC=+0.2813, Deflated=+0.2805, IR=0.79, Mono=0.80, p=0.0000, MaxCorr=0.89
...
- IC CV=0.40, Neg years (linear/tail)=0/0 of 7, Half ratio=0.64, Recency ratio=0.43
- Early IC=+0.1931, Recent IC=+0.0831, 1st-half IC=+0.1816, 2nd-half IC=+0.1165, Neg regimes=1/5
- Weak component: `close_vs_open_range` (CV=0.48)
...
- Admission: Train IC=+0.1951, Deflated=+0.1951, IR=0.70, Mono=0.75, p=0.0008, MaxCorr=0.64
...
- Admission: Train IC=+0.2124, Deflated=+0.2111, IR=0.67, Mono=0.74, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.2194, Deflated=+0.2197, IR=0.57, Mono=0.73, p=0.0000, MaxCorr=0.87
...
- Admission: Train IC=+0.2949, Deflated=+0.2950, IR=0.76, Mono=0.73, p=0.0000, MaxCorr=0.86
...
- Admission: Train IC=+0.2285, Deflated=+0.2280, IR=0.54, Mono=0.65, p=0.0000, MaxCorr=0.83
...
- Admission: Train IC=+0.2240, Deflated=+0.2229, IR=0.80, Mono=0.79, p=0.0000, MaxCorr=0.92
...
- Admission: Train IC=+0.2874, Deflated=+0.2868, IR=0.82, Mono=0.81, p=0.0000, MaxCorr=0.00
...
- Admission: Train IC=+0.1898, Deflated=+0.1897, IR=0.65, Mono=0.75, p=0.0000, MaxCorr=0.73
...
**`combo_min__net_volume_flow__star50_limit_proximity_early`** (Lock IC=+0.1044, Sharpe=+1.3464)
- Admission: Train IC=+0.2911, Deflated=+0.2898, IR=0.69, Mono=0.72, p=0.0000, MaxCorr=0.95
- Yearly Linear ICs: 2015: +0.222 | 2016: +0.057 | 2017: +0.225 | 2018: +0.109 | 2019: +0.122 | 2020: +0.116 | 2021: +0.103 | 2022: +0.070 | 2023: +0.085 | 2024: +0.138 | 2025: +0.133 | 2026: +0.062
- Yearly Tail ICs:   2015: +0.238 | 2016: +0.157 | 2017: +0.246 | 2018: +0.308 | 2019: +0.279 | 2020: +0.331 | 2021: -0.011 | 2022: +0.272 | 2023: +0.193 | 2024: +0.347 | 2025: +0.057 | 2026: +0.154
- IC CV=0.43, Neg years (linear/tail)=0/1 of 7, Half ratio=0.71, Recency ratio=0.79
- Early IC=+0.1395, Recent IC=+0.1096, 1st-half IC=+0.1630, 2nd-half IC=+0.1165, Neg regimes=1/5
- Weak component: `star50_limit_proximity_early` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.193, Q2=-0.009, Q3_mid=+0.116, Q4=+0.164, Q5_high_vol=+0.182

**`combo_rank_min__net_volume_flow__star50_limit_proximity_early`** (Lock IC=+0.1098, Sharpe=+1.3146)
- Admission: Train IC=+0.2846, Deflated=+0.2837, IR=0.74, Mono=0.75, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.3044, Deflated=+0.3038, IR=1.04, Mono=0.81, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.2669, Deflated=+0.2662, IR=0.67, Mono=0.73, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.2535, Deflated=+0.2526, IR=0.74, Mono=0.77, p=0.0000, MaxCorr=0.84
...
- Admission: Train IC=+0.2848, Deflated=+0.2842, IR=0.85, Mono=0.79, p=0.0000, MaxCorr=0.94
...
**`combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector`** (Lock IC=+0.1076, Sharpe=+0.9766)
- Admission: Train IC=+0.2751, Deflated=+0.2741, IR=0.71, Mono=0.73, p=0.0000, MaxCorr=0.86
- Yearly Linear ICs: 2015: +0.206 | 2016: +0.093 | 2017: +0.217 | 2018: +0.145 | 2019: +0.100 | 2020: +0.112 | 2021: +0.118 | 2022: +0.084 | 2023: +0.114 | 2024: +0.122 | 2025: +0.141 | 2026: +0.028
- Yearly Tail ICs:   2015: +0.264 | 2016: +0.162 | 2017: +0.309 | 2018: +0.365 | 2019: +0.195 | 2020: +0.296 | 2021: +0.165 | 2022: +0.238 | 2023: +0.203 | 2024: +0.297 | 2025: +0.213 | 2026: +0.234
- IC CV=0.33, Neg years (linear/tail)=0/0 of 7, Half ratio=0.61, Recency ratio=0.77
- Early IC=+0.1494, Recent IC=+0.1153, 1st-half IC=+0.1849, 2nd-half IC=+0.1124, Neg regimes=0/5
- Weak component: `volatility_expansion_trend_vector` (CV=0.43)
- Regime ICs: Q1_low_vol=+0.191, Q2=+0.050, Q3_mid=+0.093, Q4=+0.199, Q5_high_vol=+0.163

**`combo_tri_mean__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early`** (Lock IC=+0.1025, Sharpe=+0.9501)
- Admission: Train IC=+0.2756, Deflated=+0.2750, IR=0.90, Mono=0.79, p=0.0000, MaxCorr=0.89
...
- Admission: Train IC=+0.2676, Deflated=+0.2674, IR=0.95, Mono=0.81, p=0.0000, MaxCorr=0.85
...
- Admission: Train IC=+0.2443, Deflated=+0.2433, IR=0.65, Mono=0.74, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2777, Deflated=+0.2764, IR=0.71, Mono=0.75, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.2789, Deflated=+0.2783, IR=0.62, Mono=0.71, p=0.0000, MaxCorr=0.84
...
**`combo_min__high_low_sequence_momentum__bar_ret_0`** (Lock IC=+0.0918, Sharpe=+0.8678)
- Admission: Train IC=+0.2328, Deflated=+0.2315, IR=0.70, Mono=0.72, p=0.0000, MaxCorr=0.92
- Yearly Linear ICs: 2015: +0.176 | 2016: +0.063 | 2017: +0.208 | 2018: +0.187 | 2019: +0.111 | 2020: +0.089 | 2021: +0.060 | 2022: +0.061 | 2023: +0.083 | 2024: +0.150 | 2025: +0.133 | 2026: -0.018
- Yearly Tail ICs:   2015: +0.358 | 2016: +0.021 | 2017: +0.349 | 2018: +0.327 | 2019: +0.136 | 2020: +0.114 | 2021: +0.275 | 2022: +0.210 | 2023: +0.170 | 2024: +0.324 | 2025: +0.182 | 2026: +0.022
- IC CV=0.45, Neg years (linear/tail)=0/0 of 7, Half ratio=0.75, Recency ratio=0.62
- Early IC=+0.1198, Recent IC=+0.0743, 1st-half IC=+0.1504, 2nd-half IC=+0.1131, Neg regimes=1/5
- Weak component: `high_low_sequence_momentum` (CV=0.50)
- Regime ICs: Q1_low_vol=+0.199, Q2=-0.023, Q3_mid=+0.131, Q4=+0.142, Q5_high_vol=+0.172

**`combo_rel_diff__max_up_ret__smooth_momentum_structure`** (Lock IC=+0.0867, Sharpe=+0.8522)
- Admission: Train IC=+0.2768, Deflated=+0.2765, IR=1.04, Mono=0.83, p=0.0000, MaxCorr=0.82
...
- Admission: Train IC=+0.3140, Deflated=+0.3135, IR=0.71, Mono=0.76, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.2726, Deflated=+0.2717, IR=0.60, Mono=0.69, p=0.0000, MaxCorr=0.91
...
- Admission: Train IC=+0.2881, Deflated=+0.2877, IR=0.89, Mono=0.81, p=0.0000, MaxCorr=0.95
...
**`combo_mean__max_up_ret__net_volume_flow`** (Lock IC=+0.0979, Sharpe=+0.8077)
- Admission: Train IC=+0.2706, Deflated=+0.2696, IR=0.98, Mono=0.83, p=0.0000, MaxCorr=0.90
- Yearly Linear ICs: 2015: +0.216 | 2016: +0.087 | 2017: +0.187 | 2018: +0.195 | 2019: +0.102 | 2020: +0.130 | 2021: +0.116 | 2022: +0.115 | 2023: +0.104 | 2024: +0.140 | 2025: +0.113 | 2026: -0.049
- Yearly Tail ICs:   2015: +0.283 | 2016: +0.247 | 2017: +0.208 | 2018: +0.368 | 2019: +0.112 | 2020: +0.292 | 2021: +0.255 | 2022: +0.163 | 2023: +0.332 | 2024: +0.256 | 2025: -0.098 | 2026: -0.249
- IC CV=0.32, Neg years (linear/tail)=0/0 of 7, Half ratio=0.74, Recency ratio=0.81
- Early IC=+0.1514, Recent IC=+0.1230, 1st-half IC=+0.1846, 2nd-half IC=+0.1370, Neg regimes=0/5
- Weak component: `net_volume_flow` (CV=0.32)
- Regime ICs: Q1_low_vol=+0.188, Q2=+0.009, Q3_mid=+0.192, Q4=+0.152, Q5_high_vol=+0.236

**`combo_sig_product__opening_drive_thrust_ratio__volatility_expansion_trend_vector`** (Lock IC=+0.0924, Sharpe=+0.7891)
- Admission: Train IC=+0.2168, Deflated=+0.2169, IR=0.53, Mono=0.71, p=0.0004, MaxCorr=0.89
...
- Admission: Train IC=+0.2166, Deflated=+0.2160, IR=0.73, Mono=0.73, p=0.0004, MaxCorr=0.94
...
- Admission: Train IC=+0.3177, Deflated=+0.3175, IR=0.90, Mono=0.80, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.3068, Deflated=+0.3067, IR=0.61, Mono=0.73, p=0.0000, MaxCorr=0.83
...
- Admission: Train IC=+0.2734, Deflated=+0.2732, IR=0.84, Mono=0.77, p=0.0000, MaxCorr=0.71
...
- Admission: Train IC=+0.2400, Deflated=+0.2388, IR=0.75, Mono=0.77, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2692, Deflated=+0.2684, IR=0.81, Mono=0.80, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2051, Deflated=+0.2044, IR=0.70, Mono=0.76, p=0.0006, MaxCorr=0.91
...
- Admission: Train IC=+0.2488, Deflated=+0.2487, IR=0.71, Mono=0.75, p=0.0000, MaxCorr=0.94
...
**`combo_tri_median__opening_drive_thrust_ratio__max_up_ret__trend_bar_close_consistency`** (Lock IC=+0.0990, Sharpe=+0.6856)
- Admission: Train IC=+0.3089, Deflated=+0.3086, IR=0.91, Mono=0.81, p=0.0000, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.264 | 2016: +0.076 | 2017: +0.221 | 2018: +0.207 | 2019: +0.104 | 2020: +0.159 | 2021: +0.113 | 2022: +0.090 | 2023: +0.120 | 2024: +0.121 | 2025: +0.128 | 2026: -0.053
- Yearly Tail ICs:   2015: +0.444 | 2016: +0.303 | 2017: +0.281 | 2018: +0.438 | 2019: +0.060 | 2020: +0.199 | 2021: +0.232 | 2022: +0.204 | 2023: +0.279 | 2024: +0.236 | 2025: +0.078 | 2026: -0.143
- IC CV=0.40, Neg years (linear/tail)=0/0 of 7, Half ratio=0.74, Recency ratio=0.80
- Early IC=+0.1696, Recent IC=+0.1360, 1st-half IC=+0.2015, 2nd-half IC=+0.1497, Neg regimes=0/5
- Weak component: `trend_bar_close_consistency` (CV=0.73)
- Regime ICs: Q1_low_vol=+0.190, Q2=+0.055, Q3_mid=+0.191, Q4=+0.179, Q5_high_vol=+0.255

**`combo_diff__net_volume_flow__volume_weighted_momentum_acceleration`** (Lock IC=+0.0934, Sharpe=+0.6839)
- Admission: Train IC=+0.2901, Deflated=+0.2895, IR=0.97, Mono=0.83, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2584, Deflated=+0.2578, IR=0.76, Mono=0.80, p=0.0000, MaxCorr=0.70
...
- Admission: Train IC=+0.2252, Deflated=+0.2249, IR=0.49, Mono=0.67, p=0.0002, MaxCorr=0.82
...
- Admission: Train IC=+0.3278, Deflated=+0.3273, IR=0.75, Mono=0.76, p=0.0000, MaxCorr=0.71
...
- Admission: Train IC=+0.2468, Deflated=+0.2465, IR=0.64, Mono=0.70, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.3040, Deflated=+0.3040, IR=1.03, Mono=0.84, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.3136, Deflated=+0.3128, IR=0.91, Mono=0.84, p=0.0000, MaxCorr=0.90
...
- Admission: Train IC=+0.2776, Deflated=+0.2768, IR=0.86, Mono=0.80, p=0.0000, MaxCorr=0.94
...
**`combo_mean__star50_limit_proximity_early__early_body_momentum`** (Lock IC=+0.0960, Sharpe=+0.6149)
- Admission: Train IC=+0.2503, Deflated=+0.2494, IR=0.70, Mono=0.74, p=0.0000, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.207 | 2016: +0.088 | 2017: +0.154 | 2018: +0.131 | 2019: +0.093 | 2020: +0.126 | 2021: +0.056 | 2022: +0.104 | 2023: +0.060 | 2024: +0.096 | 2025: +0.107 | 2026: +0.068
- Yearly Tail ICs:   2015: +0.266 | 2016: +0.117 | 2017: +0.232 | 2018: +0.257 | 2019: +0.288 | 2020: +0.164 | 2021: +0.142 | 2022: +0.291 | 2023: +0.166 | 2024: +0.175 | 2025: +0.087 | 2026: -0.047
- IC CV=0.37, Neg years (linear/tail)=0/0 of 7, Half ratio=0.61, Recency ratio=0.62
- Early IC=+0.1474, Recent IC=+0.0911, 1st-half IC=+0.1675, 2nd-half IC=+0.1029, Neg regimes=0/5
- Weak component: `star50_limit_proximity_early` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.170, Q2=+0.006, Q3_mid=+0.123, Q4=+0.154, Q5_high_vol=+0.178

**`combo_min__rbreaker_sell_setup_proximity_early__first_bar_return`** (Lock IC=+0.0803, Sharpe=+0.6137)
- Admission: Train IC=+0.2950, Deflated=+0.2950, IR=0.60, Mono=0.70, p=0.0000, MaxCorr=0.85
...
- Admission: Train IC=+0.2983, Deflated=+0.2980, IR=1.04, Mono=0.85, p=0.0000, MaxCorr=0.89
...
- Admission: Train IC=+0.2469, Deflated=+0.2464, IR=0.57, Mono=0.71, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.2897, Deflated=+0.2894, IR=0.81, Mono=0.78, p=0.0000, MaxCorr=0.95
...
- Admission: Train IC=+0.2441, Deflated=+0.2432, IR=0.93, Mono=0.80, p=0.0000, MaxCorr=0.86
...
- Admission: Train IC=+0.1810, Deflated=+0.1802, IR=0.43, Mono=0.70, p=0.0014, MaxCorr=0.86
...
- Admission: Train IC=+0.2212, Deflated=+0.2205, IR=0.57, Mono=0.71, p=0.0004, MaxCorr=0.90
...
- Admission: Train IC=+0.3331, Deflated=+0.3327, IR=1.00, Mono=0.82, p=0.0000, MaxCorr=0.00
...
- Admission: Train IC=+0.3007, Deflated=+0.2999, IR=1.12, Mono=0.87, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2377, Deflated=+0.2372, IR=0.64, Mono=0.73, p=0.0000, MaxCorr=0.86
...
- Admission: Train IC=+0.2602, Deflated=+0.2591, IR=0.92, Mono=0.82, p=0.0000, MaxCorr=0.93
...
**`combo_rank_min__first_bar_sentiment__bar_ret_0`** (Lock IC=+0.0713, Sharpe=+0.5545)
- Admission: Train IC=+0.2378, Deflated=+0.2366, IR=0.87, Mono=0.80, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2593, Deflated=+0.2590, IR=0.93, Mono=0.78, p=0.0000, MaxCorr=0.91
...
- Admission: Train IC=+0.1985, Deflated=+0.1974, IR=0.41, Mono=0.66, p=0.0006, MaxCorr=0.94
...
- Admission: Train IC=+0.2016, Deflated=+0.2007, IR=0.50, Mono=0.69, p=0.0006, MaxCorr=0.86
...
- Admission: Train IC=+0.2151, Deflated=+0.2146, IR=0.47, Mono=0.67, p=0.0004, MaxCorr=0.92
...
**`combo_max__close_vs_open_range__first_bar_sentiment`** (Lock IC=+0.0859, Sharpe=+0.5301)
...
- Admission: Train IC=+0.2480, Deflated=+0.2473, IR=0.79, Mono=0.76, p=0.0000, MaxCorr=0.90
...
- Admission: Train IC=+0.2348, Deflated=+0.2342, IR=0.70, Mono=0.73, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2082, Deflated=+0.2077, IR=0.62, Mono=0.71, p=0.0006, MaxCorr=0.94
...
- Admission: Train IC=+0.2595, Deflated=+0.2588, IR=0.75, Mono=0.75, p=0.0000, MaxCorr=0.86
...
**`combo_mean__first_bar_sentiment__bar_ret_0`** (Lock IC=+0.0680, Sharpe=+0.5073)
- Admission: Train IC=+0.1937, Deflated=+0.1931, IR=0.59, Mono=0.71, p=0.0008, MaxCorr=0.91
- Yearly Linear ICs: 2015: +0.209 | 2016: +0.112 | 2017: +0.153 | 2018: +0.238 | 2019: +0.148 | 2020: +0.088 | 2021: +0.099 | 2022: +0.063 | 2023: +0.062 | 2024: +0.107 | 2025: +0.092 | 2026: -0.011
- Yearly Tail ICs:   2015: +0.202 | 2016: -0.004 | 2017: +0.297 | 2018: +0.423 | 2019: +0.144 | 2020: +0.207 | 2021: +0.212 | 2022: +0.189 | 2023: +0.121 | 2024: +0.212 | 2025: +0.043 | 2026: -0.189
- IC CV=0.35, Neg years (linear/tail)=0/1 of 7, Half ratio=0.81, Recency ratio=0.58
- Early IC=+0.1605, Recent IC=+0.0933, 1st-half IC=+0.1765, 2nd-half IC=+0.1437, Neg regimes=0/5
...
**`combo_clamp_diff__opening_drive_thrust_ratio__late_bar_momentum`** (Lock IC=+0.0812, Sharpe=+0.5051)
- Admission: Train IC=+0.2983, Deflated=+0.2975, IR=0.66, Mono=0.74, p=0.0000, MaxCorr=0.87
- Yearly Linear ICs: 2015: +0.291 | 2016: +0.045 | 2017: +0.198 | 2018: +0.189 | 2019: +0.165 | 2020: +0.151 | 2021: +0.135 | 2022: +0.047 | 2023: +0.099 | 2024: +0.110 | 2025: +0.040 | 2026: +0.105
- Yearly Tail ICs:   2015: +0.334 | 2016: +0.105 | 2017: +0.232 | 2018: +0.301 | 2019: +0.439 | 2020: +0.156 | 2021: +0.111 | 2022: +0.183 | 2023: +0.298 | 2024: +0.156 | 2025: +0.183 | 2026: +0.000
- IC CV=0.41, Neg years (linear/tail)=0/0 of 7, Half ratio=1.02, Recency ratio=0.85
- Early IC=+0.1683, Recent IC=+0.1426, 1st-half IC=+0.1694, 2nd-half IC=+0.1734, Neg regimes=0/5
- Weak component: `late_bar_momentum` (CV=0.56)
...
- Admission: Train IC=+0.2418, Deflated=+0.2411, IR=0.78, Mono=0.77, p=0.0000, MaxCorr=0.90
...
- Admission: Train IC=+0.2869, Deflated=+0.2863, IR=0.73, Mono=0.78, p=0.0000, MaxCorr=0.89
...
- Admission: Train IC=+0.2007, Deflated=+0.1999, IR=0.34, Mono=0.66, p=0.0006, MaxCorr=0.62
...
- Admission: Train IC=+0.3310, Deflated=+0.3310, IR=0.84, Mono=0.79, p=0.0000, MaxCorr=0.86
...
- Admission: Train IC=+0.2694, Deflated=+0.2690, IR=0.76, Mono=0.74, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2708, Deflated=+0.2703, IR=0.70, Mono=0.78, p=0.0000, MaxCorr=0.81
...
- Admission: Train IC=+0.2792, Deflated=+0.2789, IR=0.87, Mono=0.79, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2549, Deflated=+0.2541, IR=0.91, Mono=0.80, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2673, Deflated=+0.2666, IR=1.05, Mono=0.80, p=0.0000, MaxCorr=0.73
...
- Admission: Train IC=+0.2103, Deflated=+0.2096, IR=0.72, Mono=0.75, p=0.0006, MaxCorr=0.87
...
- Admission: Train IC=+0.1461, Deflated=+0.1453, IR=0.47, Mono=0.70, p=0.0086, MaxCorr=0.84
...
- Admission: Train IC=+0.2636, Deflated=+0.2642, IR=0.70, Mono=0.75, p=0.0000, MaxCorr=0.45
...
- Admission: Train IC=+0.2135, Deflated=+0.2128, IR=0.71, Mono=0.76, p=0.0006, MaxCorr=0.79
...
- Admission: Train IC=+0.2246, Deflated=+0.2240, IR=0.55, Mono=0.71, p=0.0002, MaxCorr=0.91
...
- Admission: Train IC=+0.2145, Deflated=+0.2135, IR=0.58, Mono=0.70, p=0.0006, MaxCorr=0.84
...
- Admission: Train IC=+0.2969, Deflated=+0.2957, IR=0.70, Mono=0.77, p=0.0000, MaxCorr=0.81
...
- Admission: Train IC=+0.2527, Deflated=+0.2517, IR=0.68, Mono=0.75, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2867, Deflated=+0.2865, IR=0.88, Mono=0.79, p=0.0000, MaxCorr=0.93
...
- Admission: Train IC=+0.2072, Deflated=+0.2067, IR=0.75, Mono=0.77, p=0.0006, MaxCorr=0.85
...
**`combo_rank_max__early_body_momentum__bar_ret_0`** (Lock IC=+0.0761, Sharpe=+0.3976)
- Admission: Train IC=+0.2085, Deflated=+0.2076, IR=0.69, Mono=0.74, p=0.0006, MaxCorr=0.94
...
- IC CV=0.32, Neg years (linear/tail)=0/0 of 7, Half ratio=0.77, Recency ratio=0.77
- Early IC=+0.1554, Recent IC=+0.1199, 1st-half IC=+0.1790, 2nd-half IC=+0.1374, Neg regimes=0/5
- Weak component: `early_body_momentum` (CV=0.39)
- Regime ICs: Q1_low_vol=+0.159, Q2=+0.041, Q3_mid=+0.168, Q4=+0.149, Q5_high_vol=+0.233

**`combo_sig_product__max_up_ret__bar_ret_0`** (Lock IC=+0.0882, Sharpe=+0.3945)
- Admission: Train IC=+0.1805, Deflated=+0.1805, IR=0.65, Mono=0.74, p=0.0014, MaxCorr=0.79
...
- Admission: Train IC=+0.2231, Deflated=+0.2228, IR=0.54, Mono=0.66, p=0.0002, MaxCorr=0.95
...
- Admission: Train IC=+0.2500, Deflated=+0.2496, IR=0.75, Mono=0.78, p=0.0000, MaxCorr=0.88
...
- Admission: Train IC=+0.2088, Deflated=+0.2083, IR=0.73, Mono=0.72, p=0.0006, MaxCorr=0.95
...
- Admission: Train IC=+0.2642, Deflated=+0.2624, IR=0.92, Mono=0.82, p=0.0000, MaxCorr=0.26
...
- Admission: Train IC=+0.2204, Deflated=+0.2200, IR=0.40, Mono=0.66, p=0.0004, MaxCorr=0.86
...
- Admission: Train IC=+0.2634, Deflated=+0.2630, IR=0.64, Mono=0.71, p=0.0000, MaxCorr=0.94
...
- Admission: Train IC=+0.2581, Deflated=+0.2574, IR=0.69, Mono=0.77, p=0.0000, MaxCorr=0.90
...
- Admission: Train IC=+0.1947, Deflated=+0.1940, IR=0.58, Mono=0.71, p=0.0008, MaxCorr=0.91
...
- Admission: Train IC=+0.2174, Deflated=+0.2166, IR=0.52, Mono=0.67, p=0.0004, MaxCorr=0.85
...
- Admission: Train IC=+0.2115, Deflated=+0.2110, IR=0.63, Mono=0.72, p=0.0006, MaxCorr=0.93
...
- Admission: Train IC=+0.2752, Deflated=+0.2746, IR=0.98, Mono=0.78, p=0.0000, MaxCorr=0.93
...
**`combo_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment`** (Lock IC=+0.0791, Sharpe=+0.3114)
- Admission: Train IC=+0.2932, Deflated=+0.2925, IR=0.87, Mono=0.80, p=0.0000, MaxCorr=0.83
...
- Admission: Train IC=+0.2835, Deflated=+0.2832, IR=0.84, Mono=0.76, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.2298, Deflated=+0.2291, IR=0.52, Mono=0.72, p=0.0000, MaxCorr=0.86
...
- Admission: Train IC=+0.2207, Deflated=+0.2199, IR=0.56, Mono=0.75, p=0.0004, MaxCorr=0.90
...
- Admission: Train IC=+0.2940, Deflated=+0.2932, IR=0.78, Mono=0.80, p=0.0000, MaxCorr=0.90
...
- Admission: Train IC=+0.1951, Deflated=+0.1946, IR=0.73, Mono=0.72, p=0.0008, MaxCorr=0.87
...
**`combo_mean__close_vs_open_range__high_low_sequence_momentum`** (Lock IC=+0.0926, Sharpe=+0.2734)
- Admission: Train IC=+0.2200, Deflated=+0.2190, IR=0.47, Mono=0.70, p=0.0004, MaxCorr=0.92
- Yearly Linear ICs: 2015: +0.167 | 2016: +0.060 | 2017: +0.190 | 2018: +0.118 | 2019: +0.066 | 2020: +0.102 | 2021: +0.058 | 2022: +0.099 | 2023: +0.077 | 2024: +0.132 | 2025: +0.141 | 2026: -0.070
- Yearly Tail ICs:   2015: +0.333 | 2016: +0.210 | 2017: +0.318 | 2018: +0.165 | 2019: +0.174 | 2020: +0.189 | 2021: +0.151 | 2022: +0.155 | 2023: +0.087 | 2024: +0.248 | 2025: -0.020 | 2026: -0.030
- IC CV=0.45, Neg years (linear/tail)=0/0 of 7, Half ratio=0.67, Recency ratio=0.70
- Early IC=+0.1137, Recent IC=+0.0799, 1st-half IC=+0.1342, 2nd-half IC=+0.0897, Neg regimes=1/5
- Weak component: `high_low_sequence_momentum` (CV=0.50)
- Regime ICs: Q1_low_vol=+0.188, Q2=-0.012, Q3_mid=+0.121, Q4=+0.124, Q5_high_vol=+0.132

**`combo_rank_max__max_up_ret__first_bar_return`** (Lock IC=+0.0926, Sharpe=+0.2677)
- Admission: Train IC=+0.2284, Deflated=+0.2276, IR=0.83, Mono=0.78, p=0.0000, MaxCorr=0.86
...
**`combo_rank_min__max_up_ret__first_bar_sentiment`** (Lock IC=+0.0781, Sharpe=+0.2662)
- Admission: Train IC=+0.2773, Deflated=+0.2766, IR=0.87, Mono=0.80, p=0.0000, MaxCorr=0.91
...
- Admission: Train IC=+0.2210, Deflated=+0.2199, IR=0.59, Mono=0.73, p=0.0004, MaxCorr=0.86
...
- Admission: Train IC=+0.2011, Deflated=+0.2008, IR=0.54, Mono=0.69, p=0.0006, MaxCorr=0.94
...
**`combo_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early`** (Lock IC=+0.0714, Sharpe=+0.2422)
- Admission: Train IC=+0.2659, Deflated=+0.2662, IR=0.70, Mono=0.76, p=0.0000, MaxCorr=0.80
- Yearly Linear ICs: 2015: +0.208 | 2016: +0.054 | 2017: +0.162 | 2018: +0.182 | 2019: +0.149 | 2020: +0.193 | 2021: +0.148 | 2022: +0.007 | 2023: +0.106 | 2024: +0.096 | 2025: +0.070 | 2026: +0.053
- Yearly Tail ICs:   2015: +0.238 | 2016: +0.227 | 2017: +0.128 | 2018: +0.440 | 2019: +0.145 | 2020: +0.106 | 2021: +0.405 | 2022: +0.156 | 2023: -0.124 | 2024: +0.008 | 2025: +0.080 | 2026: +0.182
- IC CV=0.30, Neg years (linear/tail)=0/0 of 7, Half ratio=1.40, Recency ratio=1.30
- Early IC=+0.1310, Recent IC=+0.1701, 1st-half IC=+0.1357, 2nd-half IC=+0.1904, Neg regimes=0/5
- Weak component: `double_bottom_bull_flag_early` (CV=0.69)
- Regime ICs: Q1_low_vol=+0.168, Q2=+0.094, Q3_mid=+0.142, Q4=+0.092, Q5_high_vol=+0.272

**`combo_min__star50_limit_proximity_early__max_down_ret`** (Lock IC=+0.0939, Sharpe=+0.2138)
- Admission: Train IC=+0.2591, Deflated=+0.2586, IR=0.78, Mono=0.76, p=0.0000, MaxCorr=0.68
...
- Admission: Train IC=+0.2066, Deflated=+0.2061, IR=0.71, Mono=0.78, p=0.0006, MaxCorr=0.88
...
- Admission: Train IC=+0.1990, Deflated=+0.1985, IR=0.68, Mono=0.71, p=0.0006, MaxCorr=0.79
...
**`combo_rel_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early`** (Lock IC=+0.0728, Sharpe=+0.1783)
- Admission: Train IC=+0.2604, Deflated=+0.2605, IR=0.68, Mono=0.77, p=0.0000, MaxCorr=0.92
- Yearly Linear ICs: 2015: +0.214 | 2016: +0.054 | 2017: +0.158 | 2018: +0.195 | 2019: +0.126 | 2020: +0.197 | 2021: +0.138 | 2022: +0.005 | 2023: +0.107 | 2024: +0.095 | 2025: +0.078 | 2026: +0.049
- Yearly Tail ICs:   2015: +0.254 | 2016: +0.231 | 2017: +0.113 | 2018: +0.405 | 2019: +0.117 | 2020: +0.116 | 2021: +0.405 | 2022: +0.154 | 2023: -0.117 | 2024: +0.003 | 2025: +0.094 | 2026: +0.093
- IC CV=0.33, Neg years (linear/tail)=0/0 of 7, Half ratio=1.32, Recency ratio=1.25
- Early IC=+0.1339, Recent IC=+0.1672, 1st-half IC=+0.1378, 2nd-half IC=+0.1821, Neg regimes=0/5
- Weak component: `double_bottom_bull_flag_early` (CV=0.69)
- Regime ICs: Q1_low_vol=+0.159, Q2=+0.091, Q3_mid=+0.139, Q4=+0.092, Q5_high_vol=+0.273

**`combo_rank_max__opening_drive_thrust_ratio__star50_limit_proximity_early`** (Lock IC=+0.1166, Sharpe=+0.1778)
- Admission: Train IC=+0.2083, Deflated=+0.2076, IR=0.47, Mono=0.71, p=0.0006, MaxCorr=0.92
...
- Admission: Train IC=+0.2106, Deflated=+0.2106, IR=0.64, Mono=0.72, p=0.0006, MaxCorr=0.84
...
- Admission: Train IC=+0.2453, Deflated=+0.2445, IR=0.64, Mono=0.70, p=0.0000, MaxCorr=0.89
...
**`combo_min__close_vs_open_range__first_bar_sentiment`** (Lock IC=+0.0766, Sharpe=+0.1226)
- Admission: Train IC=+0.2194, Deflated=+0.2187, IR=0.68, Mono=0.76, p=0.0004, MaxCorr=0.93
...
- Admission: Train IC=+0.2190, Deflated=+0.2185, IR=0.62, Mono=0.74, p=0.0004, MaxCorr=0.78
...
**`combo_min__first_bar_sentiment__max_down_ret`** (Lock IC=+0.0746, Sharpe=+0.0973)
- Admission: Train IC=+0.1963, Deflated=+0.1950, IR=0.58, Mono=0.70, p=0.0008, MaxCorr=0.90
- Yearly Linear ICs: 2015: +0.295 | 2016: +0.105 | 2017: +0.190 | 2018: +0.167 | 2019: +0.129 | 2020: +0.102 | 2021: +0.096 | 2022: +0.063 | 2023: +0.041 | 2024: +0.092 | 2025: +0.135 | 2026: +0.010
- Yearly Tail ICs:   2015: +0.346 | 2016: +0.021 | 2017: +0.170 | 2018: +0.127 | 2019: +0.322 | 2020: +0.084 | 2021: +0.214 | 2022: +0.153 | 2023: +0.022 | 2024: +0.271 | 2025: +0.236 | 2026: +0.035
- IC CV=0.43, Neg years (linear/tail)=0/0 of 7, Half ratio=0.72, Recency ratio=0.49
- Early IC=+0.2000, Recent IC=+0.0986, 1st-half IC=+0.1786, 2nd-half IC=+0.1285, Neg regimes=0/5
- Weak component: `max_down_ret` (CV=0.55)
...
- Admission: Train IC=+0.2674, Deflated=+0.2672, IR=0.71, Mono=0.76, p=0.0000, MaxCorr=0.92
...
- Admission: Train IC=+0.2091, Deflated=+0.2087, IR=0.68, Mono=0.74, p=0.0006, MaxCorr=0.84
...
- Admission: Train IC=+0.2248, Deflated=+0.2252, IR=0.64, Mono=0.71, p=0.0002, MaxCorr=0.92
...
- Admission: Train IC=+0.1669, Deflated=+0.1666, IR=0.40, Mono=0.68, p=0.0026, MaxCorr=0.87
...
**`combo_z_sum__bar_body_rng_0__limit_down_proximity_early`** (Lock IC=+0.1128, Sharpe=+1.4945)
- Admission: Train IC=+0.2548, Deflated=+0.2527, IR=0.64, Mono=0.69, p=0.0000, MaxCorr=0.87
- Yearly Linear ICs: 2015: +0.217 | 2016: +0.098 | 2017: -0.029 | 2018: +0.150 | 2019: +0.229 | 2020: +0.133 | 2021: +0.132 | 2022: +0.086 | 2023: +0.112 | 2024: +0.073 | 2025: +0.140 | 2026: +0.132
- Yearly Tail ICs:   2015: +0.205 | 2016: +0.068 | 2017: +0.122 | 2018: +0.353 | 2019: +0.449 | 2020: +0.169 | 2021: +0.311 | 2022: +0.158 | 2023: +0.205 | 2024: +0.449 | 2025: +0.260 | 2026: +0.168
- IC CV=0.60, Neg years (linear/tail)=1/0 of 7, Half ratio=1.53, Recency ratio=0.84
- Early IC=+0.1574, Recent IC=+0.1327, 1st-half IC=+0.1145, 2nd-half IC=+0.1752, Neg regimes=0/5
- Weak component: `limit_down_proximity_early` (CV=1.21)
- Regime ICs: Q1_low_vol=+0.049, Q2=+0.031, Q3_mid=+0.150, Q4=+0.176, Q5_high_vol=+0.203

**`combo_z_sum__star50_limit_proximity_early__first_bar_sentiment`** (Lock IC=+0.1034, Sharpe=+1.2735)
- Admission: Train IC=+0.2225, Deflated=+0.2202, IR=0.65, Mono=0.74, p=0.0000, MaxCorr=0.93
- Yearly Linear ICs: 2015: +0.236 | 2016: +0.089 | 2017: -0.021 | 2018: +0.133 | 2019: +0.234 | 2020: +0.173 | 2021: +0.121 | 2022: +0.100 | 2023: +0.076 | 2024: +0.084 | 2025: +0.111 | 2026: +0.135
- Yearly Tail ICs:   2015: +0.026 | 2016: +0.167 | 2017: +0.160 | 2018: +0.272 | 2019: +0.351 | 2020: +0.182 | 2021: +0.144 | 2022: +0.251 | 2023: +0.056 | 2024: +0.269 | 2025: +0.175 | 2026: +0.347
- IC CV=0.60, Neg years (linear/tail)=1/0 of 7, Half ratio=1.47, Recency ratio=0.90
- Early IC=+0.1625, Recent IC=+0.1470, 1st-half IC=+0.1295, 2nd-half IC=+0.1901, Neg regimes=0/5
- Weak component: `star50_limit_proximity_early` (CV=0.77)
- Regime ICs: Q1_low_vol=+0.081, Q2=+0.061, Q3_mid=+0.162, Q4=+0.189, Q5_high_vol=+0.211

**`combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment`** (Lock IC=+0.0993, Sharpe=+1.2019)
- Admission: Train IC=+0.2917, Deflated=+0.2894, IR=0.70, Mono=0.74, p=0.0000, MaxCorr=0.00
...
- Admission: Train IC=+0.2232, Deflated=+0.2213, IR=0.41, Mono=0.67, p=0.0000, MaxCorr=0.81
...
- Admission: Train IC=+0.2150, Deflated=+0.2131, IR=0.60, Mono=0.77, p=0.0000, MaxCorr=0.87
...
- Admission: Train IC=+0.2449, Deflated=+0.2443, IR=0.74, Mono=0.78, p=0.0000, MaxCorr=0.57
...
**`combo_min__star50_limit_proximity_early__first_bar_sentiment`** (Lock IC=+0.0935, Sharpe=+1.0136)
- Admission: Train IC=+0.2509, Deflated=+0.2487, IR=0.57, Mono=0.70, p=0.0000, MaxCorr=0.92
...
**`combo_z_sum__max_up_ret__first_bar_sentiment`** (Lock IC=+0.0913, Sharpe=+0.7523)
- Admission: Train IC=+0.2154, Deflated=+0.2129, IR=0.55, Mono=0.71, p=0.0000, MaxCorr=0.89
- Yearly Linear ICs: 2015: +0.235 | 2016: +0.126 | 2017: +0.019 | 2018: +0.110 | 2019: +0.180 | 2020: +0.146 | 2021: +0.146 | 2022: +0.098 | 2023: +0.157 | 2024: +0.055 | 2025: +0.141 | 2026: -0.040
...
- IC CV=0.45, Neg years (linear/tail)=0/0 of 7, Half ratio=1.28, Recency ratio=0.81
- Early IC=+0.1809, Recent IC=+0.1461, 1st-half IC=+0.1361, 2nd-half IC=+0.1746, Neg regimes=0/5
- Weak component: `first_bar_sentiment` (CV=0.70)
...
- Admission: Train IC=+0.2510, Deflated=+0.2513, IR=0.53, Mono=0.70, p=0.0000, MaxCorr=0.87
...
- Admission: Train IC=+0.2252, Deflated=+0.2233, IR=0.49, Mono=0.70, p=0.0000, MaxCorr=0.89
...
- Admission: Train IC=+0.2105, Deflated=+0.2079, IR=0.47, Mono=0.66, p=0.0000, MaxCorr=0.84
...
- Admission: Train IC=+0.2224, Deflated=+0.2203, IR=0.51, Mono=0.71, p=0.0000, MaxCorr=0.76
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=13, persistent=5
...
| `combo_mean__max_up_ret__net_volume_flow` | TP | gradual | +0.1150 | +0.1043 | -0.0493 | 4y |
...
| `combo_rank_max__early_body_momentum__bar_ret_0` | TP | gradual | +0.1070 | +0.0823 | -0.1223 | 4y |
...
| `combo_mean__star50_limit_proximity_early__early_body_momentum` | TP | persistent | +0.1039 | +0.0595 | +0.0682 | ∞ |
...
| `combo_rank_min__max_up_ret__first_bar_sentiment` | TP | gradual | +0.1024 | +0.0725 | -0.0114 | 4y |
...
| `combo_max__opening_drive_thrust_ratio__first_bar_return` | Median | gradual | +0.1001 | +0.1065 | -0.0126 | 4y |
...
| `combo_mean__close_vs_open_range__high_low_sequence_momentum` | TP | gradual | +0.0993 | +0.0770 | -0.0703 | 4y |
...
| `combo_max__net_volume_flow__first_bar_return` | Median | gradual | +0.0940 | +0.0744 | -0.0693 | 4y |
...
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__trend_bar_close_consistency` | TP | gradual | +0.0903 | +0.1195 | -0.0530 | 4y |
...
| `combo_min__rbreaker_sell_setup_proximity_early__volatility_expansion_trend_vector` | TP | persistent | +0.0838 | +0.1138 | +0.0278 | 4y |
...
| `combo_min__net_volume_flow__star50_limit_proximity_early` | TP | persistent | +0.0696 | +0.0851 | +0.0625 | ∞ |
...
| `combo_rank_min__close_vs_open_range__first_bar_sentiment` | Median | gradual | +0.0646 | +0.0596 | -0.0000 | 4y |
...
| `combo_min__first_bar_sentiment__max_down_ret` | TP | persistent | +0.0632 | +0.0412 | +0.0097 | 4y |
| `first_bar_return` | TP | gradual | +0.0630 | +0.0618 | -0.0114 | 4y |
| `combo_mean__first_bar_sentiment__bar_ret_0` | TP | gradual | +0.0630 | +0.0618 | -0.0114 | 4y |
| `combo_min__high_low_sequence_momentum__bar_ret_0` | TP | gradual | +0.0605 | +0.0828 | -0.0181 | 4y |
...
| `combo_clamp_diff__opening_drive_thrust_ratio__late_bar_momentum` | TP | persistent | +0.0473 | +0.0986 | +0.1046 | ∞ |
...
| `combo_clamp_diff__opening_drive_thrust_ratio__volume_weighted_momentum_acceleration` | Median | persistent | +0.0421 | +0.0902 | +0.0363 | ∞ |
...
| `combo_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | TP | persistent | +0.0074 | +0.1057 | +0.0535 | ∞ |
| `combo_rel_diff__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | TP | persistent | +0.0053 | +0.1075 | +0.0490 | ∞ |
...
**Decay distribution**: immediate=4, fast(1-2y)=1, gradual=73, persistent=112
...
| `combo_z_sum__star50_limit_proximity_early__first_bar_sentiment` | TP | persistent | +0.1004 | +0.0761 | +0.1347 | ∞ |
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=6, persistent=10
...
- `combo_tri_mean__star50_limit_proximity_early__bar_ret_0__bar_body_rng_0`: Train IC=+0.2278, Lock IC=+0.0687, Sharpe=+0.5206
- `combo_tri_z_mean__star50_limit_proximity_early__bar_ret_0__bar_body_rng_0`: Train IC=+0.2278, Lock IC=+0.0687, Sharpe=+0.5206
- `combo_tri_min__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0`: Train IC=+0.2394, Lock IC=+0.0724, Sharpe=+0.4279

**BH-FDR Gate**: 2/4 top rejects are profitable (50%)

- `combo_diff__max_up_ret__early_vwap_acceleration`: Train IC=+0.1327, Lock IC=+0.0557, Sharpe=+0.2131
- `combo_z_diff__max_up_ret__early_vwap_acceleration`: Train IC=+0.1327, Lock IC=+0.0557, Sharpe=+0.2131

**B3 Composite Floor**: 12/14 top rejects are profitable (86%)

- `combo_max__max_up_ret__volume_weighted_price_position`: Train IC=+0.1972, Lock IC=+0.0551, Sharpe=+0.6412
- `combo_tri_mean__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio`: Train IC=+0.1904, Lock IC=+0.0538, Sharpe=+0.5308
- `combo_tri_z_mean__max_up_ret__volume_weighted_price_position__opening_drive_thrust_ratio`: Train IC=+0.1904, Lock IC=+0.0538, Sharpe=+0.5308

**B6 Yearly IC CV Gate**: 8/9 top rejects are profitable (89%)

- `combo_max__rbreaker_sell_setup_proximity_early__limit_down_proximity_early`: Train IC=+0.2037, Lock IC=+0.0722, Sharpe=+0.3588
- `combo_max__rbreaker_sell_setup_proximity_early__rbreaker_buy_setup_proximity_early`: Train IC=+0.2037, Lock IC=+0.0722, Sharpe=+0.3588
- `combo_rank_max__rbreaker_sell_setup_proximity_early__limit_down_proximity_early`: Train IC=+0.1833, Lock IC=+0.0722, Sharpe=+0.3125

**B4 Correlation Gate**: 10/10 top rejects are profitable (100%)
...
- `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__net_volume_flow`: Train IC=+0.2978, Lock IC=+0.1003, Sharpe=+0.9373
- `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__opening_auction_imbalance`: Train IC=+0.2978, Lock IC=+0.1003, Sharpe=+0.9373
...
**BH-FDR Gate**: 7/8 top rejects are profitable (88%)

- `close_vs_open_range`: Train IC=+0.0863, Lock IC=+0.1156, Sharpe=+0.8924
- `net_volume_flow`: Train IC=+0.1144, Lock IC=+0.1088, Sharpe=+0.7707
- `opening_auction_imbalance`: Train IC=+0.1144, Lock IC=+0.1088, Sharpe=+0.7707

**B3 Composite Floor**: 20/20 top rejects are profitable (100%)

- `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__first_bar_sentiment`: Train IC=+0.2735, Lock IC=+0.1265, Sharpe=+1.4952
- `combo_mean__bar_body_rng_0__limit_down_proximity_early`: Train IC=+0.2548, Lock IC=+0.1128, Sharpe=+1.4945
- `combo_mean__bar_body_rng_0__rbreaker_buy_setup_proximity_early`: Train IC=+0.2548, Lock IC=+0.1128, Sharpe=+1.4945

**B4 Correlation Gate**: 8/8 top rejects are profitable (100%)

- `combo_z_sum__bar_body_rng_0__rbreaker_buy_setup_proximity_early`: Train IC=+0.2548, Lock IC=+0.1128, Sharpe=+1.4945
- `combo_min__rbreaker_sell_setup_proximity_early__first_bar_sentiment`: Train IC=+0.2616, Lock IC=+0.0992, Sharpe=+1.3569
- `combo_tri_median__star50_limit_proximity_early__first_bar_sentiment__bar_body_rng_0`: Train IC=+0.2735, Lock IC=+0.1117, Sharpe=+1.1121
...
| Temporal Validation Gate | 223 | 78 | 8 | 25 | 45 | 10% | 58% |
| BH-FDR Gate | 4 | 4 | 1 | 1 | 2 | 25% | 50% |
| B3 Composite Floor | 14 | 14 | 0 | 2 | 12 | 0% | 86% |
| B6 Yearly IC CV Gate | 9 | 9 | 1 | 0 | 8 | 11% | 89% |
| B4 Correlation Gate | 10 | 10 | 0 | 0 | 10 | 0% | 100% |
...
| Gate | Total Rej | Evaluated | FP Caught | Median | TP Killed | Precision | Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife | 1491 | 78 | 21 | 28 | 29 | 27% | 37% |
| B2 Rolling Guard | 310 | 78 | 18 | 10 | 50 | 23% | 64% |
| Temporal Validation Gate | 258 | 78 | 15 | 16 | 47 | 19% | 60% |
| BH-FDR Gate | 11 | 11 | 8 | 3 | 0 | 73% | 0% |
| B3 Composite Floor | 251 | 78 | 2 | 9 | 67 | 3% | 86% |
| B6 Yearly IC CV Gate | 5 | 5 | 3 | 2 | 0 | 60% | 0% |
| B6 Temporal Stability Gate | 4 | 4 | 0 | 0 | 4 | 0% | 100% |
| B4 Correlation Gate | 517 | 78 | 0 | 10 | 68 | 0% | 87% |
...
- `combo_rank_max__net_volume_flow__close_vs_open_range`: Train IC=+0.2097, Lock IC=+0.0972, Sharpe=+1.0262
...
**B4 Correlation Gate** — top TP casualties:
- `combo_min__rbreaker_sell_setup_proximity_early__net_volume_flow`: Train IC=+0.2960, Lock IC=+0.1086, Sharpe=+1.1207
...
| Temporal Validation Gate | 197 | 78 | 3 | 1 | 74 | 4% | 95% |
| BH-FDR Gate | 8 | 8 | 1 | 0 | 7 | 12% | 88% |
| B3 Composite Floor | 148 | 78 | 0 | 10 | 68 | 0% | 87% |
| B4 Correlation Gate | 8 | 8 | 0 | 0 | 8 | 0% | 100% |
...
**Temporal Validation Gate** — top TP casualties:
- `combo_tri_mean__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0`: Train IC=+0.2331, Lock IC=+0.1302, Sharpe=+1.7748
- `combo_tri_z_mean__opening_drive_thrust_ratio__star50_limit_proximity_early__bar_body_rng_0`: Train IC=+0.2331, Lock IC=+0.1302, Sharpe=+1.7748
- `combo_tri_mean__opening_drive_thrust_ratio__max_up_ret__star50_limit_proximity_early`: Train IC=+0.2317, Lock IC=+0.1331, Sharpe=+1.6482
...
| recency_ratio >= 2.5 (late-concentrated) | 137 | 50 | 0 | 45 | 5 | 0% | 90% |
...
- `combo_tri_min__star50_limit_proximity_early__first_bar_return__opening_drive_thrust_ratio`: Train IC=+0.2101, Lock IC=+0.0597, Sharpe=+0.5554

### 500ETF — `single` (258 total temporal rejects)

| Condition | N | Evaluated | FP Caught | TP Killed | Median | FP Precision | TP Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| recent_ic <= 0 (decayed) | 236 | 50 | 0 | 48 | 2 | 0% | 96% |
| recency_ratio >= 2.5 (late-concentrated) | 22 | 22 | 5 | 13 | 4 | 23% | 59% |

**Top TP killed by recency_ratio cap:**
- `combo_sig_product__star50_limit_proximity_early__max_down_ret`: Train IC=+0.2059, Lock IC=+0.1231, Sharpe=+0.7781
...
- `combo_diff__star50_limit_proximity_early__volume_weighted_momentum_acceleration`: Train IC=+0.2871, Lock IC=+0.0883, Sharpe=+0.5405

### 159915ETF — `single` (197 total temporal rejects)

| Condition | N | Evaluated | FP Caught | TP Killed | Median | FP Precision | TP Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| recent_ic <= 0 (decayed) | 24 | 24 | 3 | 20 | 1 | 12% | 83% |
| recency_ratio >= 2.5 (late-concentrated) | 163 | 50 | 0 | 50 | 0 | 0% | 100% |

**Top TP killed by recency_ratio cap:**
- `combo_rank_min__opening_drive_thrust_ratio__rbreaker_sell_setup_proximity_early`: Train IC=+0.2551, Lock IC=+0.1322, Sharpe=+1.5659
...
- `combo_tri_min__opening_drive_thrust_ratio__star50_limit_proximity_early__first_bar_sentiment`: Train IC=+0.2957, Lock IC=+0.1128, Sharpe=+1.5313
- `combo_min__star50_limit_proximity_early__volume_weighted_price_position`: Train IC=+0.2565, Lock IC=+0.1160, Sharpe=+1.5059
...
| :--- | ---: | ---: | ---: | ---: | :--- |
| `volatility_expansion_trend_vector` | 0 | 13 | 13 | 0% |  |
| `max_down_ret` | 0 | 20 | 20 | 0% |  |
| `volume_weighted_momentum_acceleration` | 0 | 9 | 9 | 0% |  |
| `yesterday_first_30min_return` | 0 | 2 | 2 | 0% |  |
| `net_volume_flow` | 0 | 17 | 17 | 0% |  |
| `early_body_momentum` | 0 | 13 | 13 | 0% |  |
| `double_bottom_bull_flag_early` | 0 | 3 | 3 | 0% |  |
| `late_bar_momentum` | 0 | 3 | 3 | 0% |  |
| `first_bar_sentiment` | 0 | 20 | 20 | 0% |  |
| `star50_limit_proximity_early` | 0 | 34 | 34 | 0% |  |
| `rbreaker_sell_setup_proximity_early` | 0 | 42 | 42 | 0% |  |
| `smooth_momentum_structure` | 0 | 3 | 3 | 0% |  |
| `close_vs_open_range` | 0 | 29 | 29 | 0% |  |
| `bar_ret_0` | 0 | 30 | 30 | 0% |  |
| `volume_weighted_price_position` | 0 | 4 | 4 | 0% |  |
| `max_up_ret` | 0 | 67 | 67 | 0% |  |
| `opening_drive_thrust_ratio` | 0 | 61 | 61 | 0% |  |
| `body_size_progression` | 0 | 11 | 11 | 0% |  |
| `trend_bar_close_consistency` | 0 | 11 | 11 | 0% |  |
| `demark_setup_reversal_early` | 0 | 2 | 2 | 0% |  |
| `high_low_sequence_momentum` | 0 | 3 | 3 | 0% |  |
| `first_bar_return` | 0 | 12 | 12 | 0% |  |
| `bar_body_rng_0` | 0 | 8 | 8 | 0% |  |

---

## 9. Operator Class FP Rate

- **Symmetric** (`max, mean, min, rank_max, rank_min`): FP=0, TP=118, FP rate=0%
- **Conditional** (`abs_diff, clamp_diff, diff, ifelse, product, ratio`): FP=0, TP=18, FP rate=0%
- **3-way** (`tri_ifelse, tri_max, tri_mean, tri_median, tri_min`): FP=0, TP=24, FP rate=0%
