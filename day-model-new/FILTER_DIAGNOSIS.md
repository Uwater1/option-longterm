...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 17 | 0 | 5 | 12 | 0% | 0.68 |
| 500ETF | single | 43 | 0 | 4 | 39 | 0% | 0.81 |
...
**`combo_rank_min__first_bar_sentiment__early_body_momentum`** (Lock IC=+0.0773, Sharpe=-0.6460)
- Admission: Train IC=+0.2742, Deflated=+0.2735, IR=0.70, Mono=0.76, p=0.0000, MaxCorr=0.84
...
- Admission: Train IC=+0.2819, Deflated=+0.2805, IR=0.78, Mono=0.78, p=0.0000, MaxCorr=0.70
...
- Admission: Train IC=+0.1863, Deflated=+0.1849, IR=0.72, Mono=0.78, p=0.0004, MaxCorr=0.74
...
- Admission: Train IC=+0.1816, Deflated=+0.1804, IR=0.65, Mono=0.73, p=0.0006, MaxCorr=0.79
...
- Admission: Train IC=+0.1600, Deflated=+0.1586, IR=0.45, Mono=0.67, p=0.0026, MaxCorr=0.72
...
- Admission: Train IC=+0.2911, Deflated=+0.2898, IR=0.69, Mono=0.72, p=0.0000, MaxCorr=0.76
...
**`combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector`** (Lock IC=+0.1067, Sharpe=+1.0390)
- Admission: Train IC=+0.2806, Deflated=+0.2794, IR=0.81, Mono=0.80, p=0.0000, MaxCorr=0.97
- Yearly Linear ICs: 2015: +0.265 | 2016: +0.065 | 2017: +0.218 | 2018: +0.200 | 2019: +0.124 | 2020: +0.170 | 2021: +0.092 | 2022: +0.091 | 2023: +0.114 | 2024: +0.157 | 2025: +0.120 | 2026: -0.007
- Yearly Tail ICs:   2015: +0.386 | 2016: +0.178 | 2017: +0.210 | 2018: +0.313 | 2019: +0.233 | 2020: +0.255 | 2021: +0.232 | 2022: +0.342 | 2023: +0.234 | 2024: +0.202 | 2025: +0.034 | 2026: -0.201
- IC CV=0.41, Neg years (linear/tail)=0/0 of 7, Half ratio=0.79, Recency ratio=0.79
- Early IC=+0.1651, Recent IC=+0.1307, 1st-half IC=+0.1883, 2nd-half IC=+0.1489, Neg regimes=0/5
- Weak component: `star50_limit_proximity_early` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.219, Q2=+0.032, Q3_mid=+0.173, Q4=+0.151, Q5_high_vol=+0.247
...
- Yearly Linear ICs: 2015: +0.269 | 2016: +0.085 | 2017: +0.123 | 2018: +0.244 | 2019: +0.173 | 2020: +0.192 | 2021: +0.169 | 2022: +0.037 | 2023: +0.102 | 2024: +0.137 | 2025: +0.067 | 2026: +0.050
- Yearly Tail ICs:   2015: +0.255 | 2016: +0.161 | 2017: +0.308 | 2018: +0.519 | 2019: +0.259 | 2020: +0.130 | 2021: +0.287 | 2022: +0.126 | 2023: +0.169 | 2024: +0.187 | 2025: -0.034 | 2026: +0.015
- IC CV=0.33, Neg years (linear/tail)=0/0 of 7, Half ratio=1.08, Recency ratio=1.02
- Early IC=+0.1767, Recent IC=+0.1807, 1st-half IC=+0.1867, 2nd-half IC=+0.2011, Neg regimes=0/5
...
- Admission: Train IC=+0.2059, Deflated=+0.2050, IR=0.54, Mono=0.67, p=0.0006, MaxCorr=0.78
...
- Admission: Train IC=+0.2965, Deflated=+0.2961, IR=0.55, Mono=0.70, p=0.0000, MaxCorr=0.72
...
- Admission: Train IC=+0.3177, Deflated=+0.3175, IR=0.90, Mono=0.80, p=0.0000, MaxCorr=0.74
...
- Admission: Train IC=+0.2569, Deflated=+0.2566, IR=0.64, Mono=0.75, p=0.0000, MaxCorr=0.77
...
**`combo_min__opening_drive_thrust_ratio__star50_limit_proximity_early`** (Lock IC=+0.1005, Sharpe=+0.6578)
- Admission: Train IC=+0.3277, Deflated=+0.3272, IR=0.87, Mono=0.78, p=0.0000, MaxCorr=0.67
- Yearly Linear ICs: 2015: +0.270 | 2016: +0.058 | 2017: +0.232 | 2018: +0.171 | 2019: +0.151 | 2020: +0.152 | 2021: +0.140 | 2022: +0.016 | 2023: +0.100 | 2024: +0.181 | 2025: +0.081 | 2026: +0.102
- Yearly Tail ICs:   2015: +0.300 | 2016: +0.153 | 2017: +0.319 | 2018: +0.435 | 2019: +0.350 | 2020: +0.259 | 2021: +0.084 | 2022: +0.201 | 2023: -0.002 | 2024: +0.249 | 2025: -0.143 | 2026: +0.170
- IC CV=0.38, Neg years (linear/tail)=0/0 of 7, Half ratio=0.81, Recency ratio=0.89
- Early IC=+0.1638, Recent IC=+0.1462, 1st-half IC=+0.1956, 2nd-half IC=+0.1586, Neg regimes=0/5
- Weak component: `star50_limit_proximity_early` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.183, Q2=+0.086, Q3_mid=+0.132, Q4=+0.168, Q5_high_vol=+0.251

**`combo_rel_diff__star50_limit_proximity_early__volume_weighted_momentum_acceleration`** (Lock IC=+0.1030, Sharpe=+0.6526)
- Admission: Train IC=+0.3278, Deflated=+0.3273, IR=0.75, Mono=0.76, p=0.0000, MaxCorr=0.00
...
- Admission: Train IC=+0.2748, Deflated=+0.2744, IR=0.72, Mono=0.75, p=0.0000, MaxCorr=0.90
...
**`combo_tri_median__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early`** (Lock IC=+0.1084, Sharpe=+0.5862)
- Admission: Train IC=+0.2909, Deflated=+0.2898, IR=1.01, Mono=0.87, p=0.0000, MaxCorr=0.77
- Yearly Linear ICs: 2015: +0.252 | 2016: +0.059 | 2017: +0.214 | 2018: +0.197 | 2019: +0.153 | 2020: +0.156 | 2021: +0.108 | 2022: +0.103 | 2023: +0.107 | 2024: +0.157 | 2025: +0.115 | 2026: -0.005
- Yearly Tail ICs:   2015: +0.389 | 2016: +0.178 | 2017: +0.297 | 2018: +0.333 | 2019: +0.243 | 2020: +0.302 | 2021: +0.242 | 2022: +0.354 | 2023: +0.204 | 2024: +0.213 | 2025: -0.008 | 2026: -0.234
- IC CV=0.37, Neg years (linear/tail)=0/0 of 7, Half ratio=0.82, Recency ratio=0.85
- Early IC=+0.1557, Recent IC=+0.1320, 1st-half IC=+0.1884, 2nd-half IC=+0.1552, Neg regimes=0/5
- Weak component: `star50_limit_proximity_early` (CV=0.62)
- Regime ICs: Q1_low_vol=+0.231, Q2=+0.033, Q3_mid=+0.178, Q4=+0.151, Q5_high_vol=+0.253

**`combo_sig_product__opening_drive_thrust_ratio__trend_day_regime_conviction`** (Lock IC=+0.0932, Sharpe=+0.5510)
- Admission: Train IC=+0.2063, Deflated=+0.2064, IR=0.44, Mono=0.68, p=0.0006, MaxCorr=0.92
- Yearly Linear ICs: 2015: +0.169 | 2016: +0.059 | 2017: +0.216 | 2018: +0.190 | 2019: +0.107 | 2020: +0.186 | 2021: +0.051 | 2022: +0.129 | 2023: +0.118 | 2024: +0.112 | 2025: +0.069 | 2026: -0.023
- Yearly Tail ICs:   2015: +0.304 | 2016: +0.101 | 2017: +0.271 | 2018: +0.206 | 2019: +0.227 | 2020: +0.127 | 2021: -0.005 | 2022: +0.139 | 2023: +0.120 | 2024: +0.257 | 2025: -0.019 | 2026: +0.067
- IC CV=0.44, Neg years (linear/tail)=0/1 of 7, Half ratio=1.04, Recency ratio=1.04
- Early IC=+0.1140, Recent IC=+0.1183, 1st-half IC=+0.1401, 2nd-half IC=+0.1460, Neg regimes=0/5
- Weak component: `trend_day_regime_conviction` (CV=0.46)
- Regime ICs: Q1_low_vol=+0.189, Q2=+0.064, Q3_mid=+0.152, Q4=+0.127, Q5_high_vol=+0.188

**`combo_max__bar_ret_0__max_down_ret`** (Lock IC=+0.0799, Sharpe=+0.5160)
- Admission: Train IC=+0.2083, Deflated=+0.2078, IR=0.62, Mono=0.71, p=0.0006, MaxCorr=0.77
...
- Admission: Train IC=+0.2438, Deflated=+0.2430, IR=0.83, Mono=0.75, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.2232, Deflated=+0.2230, IR=0.69, Mono=0.77, p=0.0002, MaxCorr=0.77
...
- Admission: Train IC=+0.2549, Deflated=+0.2541, IR=0.91, Mono=0.80, p=0.0000, MaxCorr=0.80
...
- Admission: Train IC=+0.2470, Deflated=+0.2471, IR=0.62, Mono=0.72, p=0.0000, MaxCorr=0.78
...
**`combo_sig_product__opening_drive_thrust_ratio__early_body_momentum`** (Lock IC=+0.0825, Sharpe=+0.4160)
- Admission: Train IC=+0.2183, Deflated=+0.2183, IR=0.60, Mono=0.75, p=0.0004, MaxCorr=0.96
- Yearly Linear ICs: 2015: +0.202 | 2016: +0.069 | 2017: +0.228 | 2018: +0.163 | 2019: +0.059 | 2020: +0.151 | 2021: +0.083 | 2022: +0.103 | 2023: +0.124 | 2024: +0.086 | 2025: +0.064 | 2026: -0.012
- Yearly Tail ICs:   2015: +0.318 | 2016: +0.048 | 2017: +0.269 | 2018: +0.119 | 2019: +0.165 | 2020: +0.266 | 2021: +0.188 | 2022: +0.119 | 2023: +0.159 | 2024: +0.240 | 2025: -0.001 | 2026: -0.137
- IC CV=0.46, Neg years (linear/tail)=0/0 of 7, Half ratio=0.90, Recency ratio=0.86
- Early IC=+0.1354, Recent IC=+0.1171, 1st-half IC=+0.1470, 2nd-half IC=+0.1325, Neg regimes=0/5
- Weak component: `early_body_momentum` (CV=0.39)
- Regime ICs: Q1_low_vol=+0.176, Q2=+0.055, Q3_mid=+0.180, Q4=+0.107, Q5_high_vol=+0.186
...
- Admission: Train IC=+0.1732, Deflated=+0.1723, IR=0.47, Mono=0.66, p=0.0016, MaxCorr=0.64
...
- Admission: Train IC=+0.2835, Deflated=+0.2832, IR=0.84, Mono=0.76, p=0.0000, MaxCorr=0.62
...
- Admission: Train IC=+0.2752, Deflated=+0.2746, IR=0.98, Mono=0.78, p=0.0000, MaxCorr=0.80
...
- Admission: Train IC=+0.3133, Deflated=+0.3127, IR=0.95, Mono=0.82, p=0.0000, MaxCorr=0.74
...
- Admission: Train IC=+0.2403, Deflated=+0.2401, IR=0.46, Mono=0.68, p=0.0000, MaxCorr=0.77
...
- Admission: Train IC=+0.1640, Deflated=+0.1634, IR=0.44, Mono=0.67, p=0.0028, MaxCorr=0.71
...
- Admission: Train IC=+0.1848, Deflated=+0.1844, IR=0.45, Mono=0.66, p=0.0012, MaxCorr=0.78
...
**`combo_rank_min__close_vs_open_range__early_body_momentum`** (Lock IC=+0.0877, Sharpe=+0.0980)
- Admission: Train IC=+0.2333, Deflated=+0.2323, IR=0.57, Mono=0.73, p=0.0000, MaxCorr=0.79
- Yearly Linear ICs: 2015: +0.131 | 2016: +0.062 | 2017: +0.156 | 2018: +0.109 | 2019: +0.050 | 2020: +0.095 | 2021: +0.052 | 2022: +0.109 | 2023: +0.093 | 2024: +0.108 | 2025: +0.142 | 2026: -0.082
- Yearly Tail ICs:   2015: +0.240 | 2016: +0.171 | 2017: +0.321 | 2018: +0.215 | 2019: +0.054 | 2020: +0.279 | 2021: +0.221 | 2022: +0.115 | 2023: +0.089 | 2024: +0.216 | 2025: -0.051 | 2026: -0.105
- IC CV=0.41, Neg years (linear/tail)=0/0 of 7, Half ratio=0.66, Recency ratio=0.76
- Early IC=+0.0966, Recent IC=+0.0732, 1st-half IC=+0.1176, 2nd-half IC=+0.0778, Neg regimes=1/5
- Weak component: `close_vs_open_range` (CV=0.48)
- Regime ICs: Q1_low_vol=+0.162, Q2=-0.016, Q3_mid=+0.127, Q4=+0.115, Q5_high_vol=+0.113
...
- Admission: Train IC=+0.2674, Deflated=+0.2672, IR=0.71, Mono=0.76, p=0.0000, MaxCorr=0.69
...
- Admission: Train IC=+0.2248, Deflated=+0.2252, IR=0.64, Mono=0.71, p=0.0002, MaxCorr=0.60
...
**Decay distribution**: immediate=0, fast(1-2y)=0, gradual=14, persistent=3

### 500ETF — `single`

| Feature | Tier | Decay | Y1 IC | Y2 IC | Y3+ IC | Half-life |
| :--- | :--- | :--- | ---: | ---: | ---: | ---: |
| `combo_sig_product__opening_drive_thrust_ratio__trend_day_regime_conviction` | TP | gradual | +0.1286 | +0.1180 | -0.0233 | 4y |
...
| `combo_rank_min__close_vs_open_range__early_body_momentum` | TP | gradual | +0.1088 | +0.0942 | -0.0815 | 4y |
...
| `combo_tri_median__opening_drive_thrust_ratio__net_volume_flow__star50_limit_proximity_early` | TP | gradual | +0.1026 | +0.1068 | -0.0050 | 4y |
| `combo_sig_product__opening_drive_thrust_ratio__early_body_momentum` | TP | gradual | +0.1025 | +0.1242 | -0.0121 | 4y |
...
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__volatility_expansion_trend_vector` | TP | gradual | +0.0907 | +0.1141 | -0.0071 | 4y |
...
| `combo_rel_diff__max_up_ret__smooth_momentum_structure` | TP | persistent | +0.0372 | +0.1017 | +0.0500 | ∞ |
...
**Decay distribution**: immediate=3, fast(1-2y)=1, gradual=13, persistent=26
...
- `combo_tri_min__opening_drive_thrust_ratio__opening_auction_imbalance__star50_limit_proximity_early`: Train IC=+0.3140, Lock IC=+0.0983, Sharpe=+0.8497

**Adaptive Correlation Gate**: 20/20 top rejects are profitable (100%)

- `combo_sig_product__max_up_ret__volume_weighted_momentum_acceleration`: Train IC=+0.2552, Lock IC=+0.0972, Sharpe=+0.8261
- `combo_tri_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio__trend_bar_close_consistency`: Train IC=+0.2867, Lock IC=+0.0921, Sharpe=+0.7978
- `combo_rank_max__opening_drive_thrust_ratio__max_down_ret`: Train IC=+0.2386, Lock IC=+0.0860, Sharpe=+0.7354
...
| B4 Correlation Gate | 65 | 65 | 0 | 2 | 63 | 0% | 97% |
...
| Gate | Total Rej | Evaluated | FP Caught | Median | TP Killed | Precision | Collateral |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 7-Year Jackknife | 1490 | 78 | 17 | 31 | 30 | 22% | 38% |
| B2 Rolling Guard | 310 | 78 | 20 | 8 | 50 | 26% | 64% |
...
| B6 Temporal Stability Gate | 216 | 78 | 0 | 8 | 70 | 0% | 90% |
| B4 Correlation Gate | 432 | 78 | 0 | 12 | 66 | 0% | 85% |
| Adaptive Correlation Gate | 28 | 28 | 0 | 1 | 27 | 0% | 96% |
...
**B4 Correlation Gate** — top TP casualties:
- `combo_min__opening_auction_imbalance__star50_limit_proximity_early`: Train IC=+0.2911, Lock IC=+0.1044, Sharpe=+1.3464
- `combo_sig_product__max_up_ret__volatility_expansion_trend_vector`: Train IC=+0.2335, Lock IC=+0.1190, Sharpe=+0.9993
- `combo_min__volatility_expansion_trend_vector__first_bar_return`: Train IC=+0.2305, Lock IC=+0.0940, Sharpe=+0.9350
...
| :--- | ---: | ---: | ---: | ---: | :--- |
| `body_size_progression` | 0 | 4 | 4 | 0% |  |
| `volume_weighted_price_position` | 0 | 5 | 5 | 0% |  |
| `max_down_ret` | 0 | 4 | 4 | 0% |  |
| `close_vs_open_range` | 0 | 3 | 3 | 0% |  |
| `bar_ret_0` | 0 | 6 | 6 | 0% |  |
| `opening_drive_thrust_ratio` | 0 | 18 | 18 | 0% |  |
| `bar_body_rng_0` | 0 | 4 | 4 | 0% |  |
| `rbreaker_sell_setup_proximity_early` | 0 | 10 | 10 | 0% |  |
| `early_body_momentum` | 0 | 3 | 3 | 0% |  |
...
| `max_up_ret` | 0 | 20 | 20 | 0% |  |
| `first_bar_return` | 0 | 6 | 6 | 0% |  |
| `volume_surge_direction` | 0 | 2 | 2 | 0% |  |
| `volume_weighted_momentum_acceleration` | 0 | 3 | 3 | 0% |  |
| `volatility_expansion_trend_vector` | 0 | 3 | 3 | 0% |  |
...
- **3-way** (`tri_ifelse, tri_max, tri_mean, tri_median, tri_min`): FP=0, TP=12, FP rate=0%
