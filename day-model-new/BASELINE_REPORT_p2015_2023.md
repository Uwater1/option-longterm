...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | :--- |
| 300ETF | single | 1,287 | 404 | 255 | 167 | 161 | 148 | 135 | 135 | 55 | 53 | 25 | `[7, 4, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, ... (25 clusters)]` |
...
| :--- | :--- | ---: | ---: | :--- | :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 53 | 25 | `[7, 4, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, ... (25 clusters)]` | +0.1253 | [+0.0831, +0.1678] | +0.2289 | [+0.1075, +0.3238] | +0.8424 | 5.95% | 1.5098 | 4.31% | 1.1099 | 2.0907 | 5.06% |
...
| ETF | Side | Features | Clusters | Cluster Sizes | Overall IC | Overall IC 95% CI | Tail IC | Tail IC 95% CI | Monotonicity | Raw Ann. Ret | Raw Sharpe | Cost Ann. Ret | Cost Sharpe | Sortino | Max DD |
| :--- | :--- | ---: | ---: | :--- | :--- | :--- | :--- | :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| 300ETF | single | 53 | 25 | `[7, 4, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, ... (25 clusters)]` | +0.0750 | [+0.0005, +0.1515] | +0.1433* | [-0.0231, +0.3103] | +0.8182 | 3.36% | 0.9756 | 1.76% | 0.5154 | 0.9916 | 3.06% |
| 300ETF | long | 0 | - | `-` | +0.0000* | [+0.0000, +0.0000] | +0.0000* | [+0.0000, +0.0000] | +0.0000 | 0.00% | 0.0000 | 0.00% | 0.0000 | 0.0000 | 0.00% |
| 300ETF | short | 0 | - | `-` | +0.0000* | [+0.0000, +0.0000] | +0.0000* | [+0.0000, +0.0000] | +0.0000 | 0.00% | 0.0000 | 0.00% | 0.0000 | 0.0000 | 0.00% |
| 50ETF | long | 0 | - | `-` | +0.0000* | [+0.0000, +0.0000] | +0.0000* | [+0.0000, +0.0000] | +0.0000 | 0.00% | 0.0000 | 0.00% | 0.0000 | 0.0000 | 0.00% |
| 50ETF | short | 0 | - | `-` | +0.0000* | [+0.0000, +0.0000] | +0.0000* | [+0.0000, +0.0000] | +0.0000 | 0.00% | 0.0000 | 0.00% | 0.0000 | 0.0000 | 0.00% |
...
| :--- | :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Cluster 21 | +1 | +0.1187 | +0.2800 | +0.2807 | 0.0000 | +0.7370 | +0.7191 | 0.872 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Cluster 11 | +1 | +0.1188 | +0.2764 | +0.2775 | 0.0000 | +0.8678 | +0.8074 | 0.000 |
| `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret` | Cluster 11 | +1 | +0.1156 | +0.2691 | +0.2697 | 0.0000 | +0.5471 | +0.7072 | 0.773 |
| `combo_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Cluster 11 | +1 | +0.1153 | +0.2658 | +0.2670 | 0.0000 | +0.8242 | +0.7884 | 0.905 |
| `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret` | Cluster 11 | +1 | +0.1119 | +0.2634 | +0.2636 | 0.0000 | +0.6357 | +0.7155 | 0.822 |
| `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Cluster 21 | +1 | +0.1132 | +0.2593 | +0.2602 | 0.0000 | +0.6700 | +0.7042 | 0.791 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` | Cluster 20 | +1 | +0.1197 | +0.2427 | +0.2434 | 0.0000 | +0.5780 | +0.7119 | 0.941 |
| `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Cluster 8 | +1 | +0.0941 | +0.2409 | +0.2417 | 0.0000 | +0.5785 | +0.7062 | 0.853 |
| `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | Cluster 11 | +1 | +0.1165 | +0.2329 | +0.2342 | 0.0000 | +0.7329 | +0.7678 | 0.869 |
| `combo_mean__max_up_ret__volume_weighted_price_position` | Cluster 14 | +1 | +0.0872 | +0.2244 | +0.2251 | 0.0000 | +0.7215 | +0.7571 | 0.749 |
| `rbreaker_sell_setup_proximity_early` | Cluster 24 | +1 | +0.0965 | +0.2243 | +0.2248 | 0.0000 | +0.5652 | +0.7360 | 0.818 |
| `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | Cluster 20 | +1 | +0.1235 | +0.2218 | +0.2227 | 0.0000 | +0.6181 | +0.7427 | 0.873 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Cluster 9 | +1 | +0.0995 | +0.2197 | +0.2208 | 0.0000 | +0.5241 | +0.6769 | 0.920 |
| `combo_min__max_up_ret__bar_body_rng_0` | Cluster 3 | +1 | +0.0912 | +0.2181 | +0.2193 | 0.0000 | +0.5315 | +0.6533 | 0.895 |
| `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position` | Cluster 14 | +1 | +0.0811 | +0.2172 | +0.2175 | 0.0000 | +0.7860 | +0.7750 | 0.924 |
| `combo_min__star50_limit_proximity_early__bar_body_rng_0` | Cluster 22 | +1 | +0.1074 | +0.2134 | +0.2144 | 0.0000 | +0.6836 | +0.7191 | 0.935 |
| `combo_tri_mean__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | Cluster 1 | +1 | +0.0980 | +0.2134 | +0.2142 | 0.0000 | +0.5718 | +0.7155 | 0.949 |
| `combo_mean__max_up_ret__opening_drive_thrust_ratio` | Cluster 15 | +1 | +0.0859 | +0.2129 | +0.2140 | 0.0000 | +0.6572 | +0.7483 | 0.943 |
| `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | Cluster 20 | +1 | +0.1222 | +0.2128 | +0.2133 | 0.0000 | +0.5504 | +0.7062 | 0.921 |
| `combo_min__max_up_ret__opening_drive_thrust_ratio` | Cluster 15 | +1 | +0.0898 | +0.2103 | +0.2113 | 0.0002 | +0.5473 | +0.7083 | 0.880 |
| `combo_rank_max__max_up_ret__bar_ret_0` | Cluster 2 | +1 | +0.0890 | +0.2083 | +0.2087 | 0.0002 | +0.5712 | +0.6918 | 0.903 |
| `combo_min__max_up_ret__volume_weighted_price_position` | Cluster 19 | +1 | +0.0878 | +0.2076 | +0.2080 | 0.0002 | +0.6010 | +0.7185 | 0.922 |
| `combo_tri_min__max_up_ret__bar_ret_0__bar_body_rng_0` | Cluster 3 | +1 | +0.0893 | +0.2054 | +0.2064 | 0.0002 | +0.3937 | +0.6636 | 0.938 |
| `combo_max__max_up_ret__first_bar_return` | Cluster 2 | +1 | +0.0883 | +0.2020 | +0.2023 | 0.0002 | +0.6234 | +0.7221 | 1.000 |
| `combo_tri_mean__first_bar_return__volume_weighted_price_position__bar_body_rng_0` | Cluster 1 | +1 | +0.0947 | +0.2018 | +0.2028 | 0.0002 | +0.4961 | +0.6831 | 0.942 |
| `combo_tri_median__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0` | Cluster 5 | +1 | +0.0963 | +0.2000 | +0.2009 | 0.0002 | +0.5073 | +0.6882 | 0.950 |
| `combo_rank_min__bar_body_rng_0__opening_drive_thrust_ratio` | Cluster 0 | +1 | +0.0911 | +0.1943 | +0.1961 | 0.0002 | +0.4624 | +0.6805 | 0.929 |
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | Cluster 14 | +1 | +0.0754 | +0.1940 | +0.1950 | 0.0002 | +0.7475 | +0.7807 | 0.885 |
| `combo_max__first_bar_return__bar_body_rng_0` | Cluster 5 | +1 | +0.0944 | +0.1938 | +0.1949 | 0.0002 | +0.5724 | +0.7191 | 0.890 |
...
| `combo_rel_diff__limit_down_proximity_early__volume_concentration` | Cluster 12 | +1 | +0.0665 | +0.1925 | +0.1927 | 0.0002 | +0.5928 | +0.7401 | 0.795 |
| `combo_ratio__limit_down_proximity_early__volume_concentration` | Cluster 12 | +1 | +0.0660 | +0.1858 | +0.1864 | 0.0004 | +0.6574 | +0.7488 | 0.742 |
| `combo_min__opening_drive_thrust_ratio__first_bar_sentiment` | Cluster 0 | +1 | +0.0872 | +0.1852 | +0.1865 | 0.0004 | +0.5869 | +0.7057 | 0.812 |
| `combo_tri_max__bar_ret_0__volume_weighted_price_position__bar_body_rng_0` | Cluster 4 | +1 | +0.0902 | +0.1839 | +0.1847 | 0.0004 | +0.5811 | +0.7026 | 0.906 |
| `combo_ratio__bar_body_rng_0__volume_weighted_price_position` | Cluster 5 | +1 | +0.0917 | +0.1836 | +0.1849 | 0.0004 | +0.5672 | +0.7304 | 0.747 |
| `combo_ratio__opening_drive_thrust_ratio__volume_weighted_price_position` | Cluster 17 | +1 | +0.0833 | +0.1830 | +0.1846 | 0.0004 | +0.6883 | +0.7576 | 0.768 |
| `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` | Cluster 22 | +1 | +0.0910 | +0.1818 | +0.1831 | 0.0004 | +0.5267 | +0.6780 | 0.880 |
| `combo_mean__max_up_ret__bar_body_rng_0` | Cluster 10 | +1 | +0.0958 | +0.1806 | +0.1814 | 0.0006 | +0.4582 | +0.6703 | 0.942 |
| `combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio` | Cluster 18 | +1 | +0.0842 | +0.1748 | +0.1761 | 0.0006 | +0.7139 | +0.7442 | 0.948 |
| `combo_clamp_diff__rbreaker_buy_setup_proximity_early__volume_concentration` | Cluster 12 | +1 | +0.0619 | +0.1738 | +0.1741 | 0.0006 | +0.4638 | +0.6965 | 0.910 |
| `star50_limit_proximity_early` | Cluster 24 | +1 | +0.0915 | +0.1720 | +0.1727 | 0.0012 | +0.4589 | +0.6954 | 0.945 |
| `max_up_ret` | Cluster 16 | +1 | +0.0767 | +0.1676 | +0.1683 | 0.0018 | +0.3955 | +0.6549 | 0.939 |
| `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | Cluster 18 | +1 | +0.0803 | +0.1660 | +0.1672 | 0.0018 | +0.6402 | +0.7191 | 0.879 |
...
| `combo_ratio__first_bar_return__volume_weighted_price_position` | Cluster 5 | +1 | +0.0929 | +0.1632 | +0.1640 | 0.0018 | +0.4797 | +0.6564 | 0.889 |
| `combo_rank_min__max_up_ret__first_bar_sentiment` | Cluster 7 | +1 | +0.0909 | +0.1527 | +0.1532 | 0.0024 | +0.4236 | +0.6610 | 0.909 |
| `combo_rank_max__volume_weighted_price_position__first_bar_sentiment` | Cluster 6 | +1 | +0.0901 | +0.1492 | +0.1501 | 0.0030 | +0.5479 | +0.7016 | 0.878 |
| `combo_rank_max__volume_weighted_price_position__bar_body_rng_0` | Cluster 4 | +1 | +0.0848 | +0.1476 | +0.1484 | 0.0036 | +0.6663 | +0.7149 | 0.931 |
| `combo_clamp_diff__max_up_ret__early_vwap_acceleration` | Cluster 23 | +1 | +0.0894 | +0.1467 | +0.1473 | 0.0040 | +0.4503 | +0.6646 | 0.947 |
| `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` | Cluster 11 | +1 | +0.0757 | +0.1356 | +0.1361 | 0.0080 | +0.4172 | +0.6888 | 0.792 |
| `combo_rel_diff__max_up_ret__early_vwap_acceleration` | Cluster 23 | +1 | +0.0768 | +0.1267 | +0.1277 | 0.0146 | +0.5022 | +0.6805 | 0.927 |
| `combo_diff__max_up_ret__early_vwap_acceleration` | Cluster 23 | +1 | +0.0890 | +0.1262 | +0.1270 | 0.0152 | +0.4936 | +0.6841 | 0.834 |
...
| :--- | :--- | ---: | ---: | ---: | :--- |
| 300ETF | single | 53 | 25 | 0.3410 | `[7, 4, 4, 3, 3, 3, 2, 2, 2, 2, 2, 2, ... (25 clusters)]` |
...
| :--- | :--- | ---: | ---: | ---: | :--- | :--- |
| 300ETF | single | Cluster 0 | 2 | 0.3410 | `combo_min__opening_drive_thrust_ratio__first_bar_sentiment` | `combo_rank_min__bar_body_rng_0__opening_drive_thrust_ratio` |
| 300ETF | single | Cluster 1 | 2 | 0.3410 | `combo_tri_mean__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | `combo_tri_mean__first_bar_return__volume_weighted_price_position__bar_body_rng_0` |
| 300ETF | single | Cluster 2 | 2 | 0.3410 | `combo_max__max_up_ret__first_bar_return` | `combo_rank_max__max_up_ret__bar_ret_0` |
| 300ETF | single | Cluster 3 | 2 | 0.3410 | `combo_min__max_up_ret__bar_body_rng_0` | `combo_tri_min__max_up_ret__bar_ret_0__bar_body_rng_0` |
| 300ETF | single | Cluster 4 | 2 | 0.3410 | `combo_tri_max__bar_ret_0__volume_weighted_price_position__bar_body_rng_0` | `combo_rank_max__volume_weighted_price_position__bar_body_rng_0` |
| 300ETF | single | Cluster 5 | 4 | 0.3410 | `combo_ratio__bar_body_rng_0__volume_weighted_price_position` | `combo_max__first_bar_return__bar_body_rng_0`, `combo_tri_median__rbreaker_sell_setup_proximity_early__bar_ret_0__bar_body_rng_0`, `combo_ratio__first_bar_return__volume_weighted_price_position` |
| 300ETF | single | Cluster 6 | 1 | 0.3410 | `combo_rank_max__volume_weighted_price_position__first_bar_sentiment` | _(none)_ |
| 300ETF | single | Cluster 7 | 1 | 0.3410 | `combo_rank_min__max_up_ret__first_bar_sentiment` | _(none)_ |
| 300ETF | single | Cluster 8 | 1 | 0.3410 | `combo_tri_min__max_up_ret__volume_weighted_price_position__bar_body_rng_0` | _(none)_ |
| 300ETF | single | Cluster 9 | 1 | 0.3410 | `combo_tri_median__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` | _(none)_ |
| 300ETF | single | Cluster 10 | 1 | 0.3410 | `combo_mean__max_up_ret__bar_body_rng_0` | _(none)_ |
| 300ETF | single | Cluster 11 | 7 | 0.3410 | `combo_rank_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio` | `combo_min__rbreaker_sell_setup_proximity_early__max_up_ret`, `combo_mean__rbreaker_sell_setup_proximity_early__max_up_ret`, `combo_mean__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio`, `combo_min__rbreaker_sell_setup_proximity_early__opening_drive_thrust_ratio`, `combo_mean__opening_drive_thrust_ratio__limit_down_proximity_early`, `combo_rank_max__rbreaker_sell_setup_proximity_early__max_up_ret` |
| 300ETF | single | Cluster 12 | 4 | 0.3410 | `combo_ratio__limit_down_proximity_early__volume_concentration` | `combo_rel_diff__rbreaker_sell_setup_proximity_early__first_bar_volume`, `combo_rel_diff__limit_down_proximity_early__volume_concentration`, `combo_clamp_diff__rbreaker_buy_setup_proximity_early__volume_concentration` |
| 300ETF | single | Cluster 13 | 1 | 0.3410 | `combo_sig_product__volume_weighted_price_position__opening_drive_thrust_ratio` | _(none)_ |
| 300ETF | single | Cluster 14 | 3 | 0.3410 | `combo_mean__max_up_ret__volume_weighted_price_position` | `combo_tri_max__max_up_ret__first_bar_return__volume_weighted_price_position`, `combo_rank_max__max_up_ret__volume_weighted_price_position` |
| 300ETF | single | Cluster 15 | 2 | 0.3410 | `combo_min__max_up_ret__opening_drive_thrust_ratio` | `combo_mean__max_up_ret__opening_drive_thrust_ratio` |
| 300ETF | single | Cluster 16 | 1 | 0.3410 | `max_up_ret` | _(none)_ |
| 300ETF | single | Cluster 17 | 1 | 0.3410 | `combo_ratio__opening_drive_thrust_ratio__volume_weighted_price_position` | _(none)_ |
| 300ETF | single | Cluster 18 | 2 | 0.3410 | `combo_rank_max__volume_weighted_price_position__opening_drive_thrust_ratio` | `combo_mean__volume_weighted_price_position__opening_drive_thrust_ratio` |
| 300ETF | single | Cluster 19 | 1 | 0.3410 | `combo_min__max_up_ret__volume_weighted_price_position` | _(none)_ |
| 300ETF | single | Cluster 20 | 3 | 0.3410 | `combo_mean__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | `combo_tri_mean__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0`, `combo_tri_mean__rbreaker_sell_setup_proximity_early__first_bar_return__bar_body_rng_0` |
| 300ETF | single | Cluster 21 | 2 | 0.3410 | `combo_rank_min__rbreaker_sell_setup_proximity_early__bar_body_rng_0` | `combo_tri_min__rbreaker_sell_setup_proximity_early__max_up_ret__bar_body_rng_0` |
| 300ETF | single | Cluster 22 | 2 | 0.3410 | `combo_min__star50_limit_proximity_early__bar_body_rng_0` | `combo_rank_min__bar_body_rng_0__rbreaker_buy_setup_proximity_early` |
| 300ETF | single | Cluster 23 | 3 | 0.3410 | `combo_diff__max_up_ret__early_vwap_acceleration` | `combo_clamp_diff__max_up_ret__early_vwap_acceleration`, `combo_rel_diff__max_up_ret__early_vwap_acceleration` |
| 300ETF | single | Cluster 24 | 2 | 0.3410 | `rbreaker_sell_setup_proximity_early` | `star50_limit_proximity_early` |
