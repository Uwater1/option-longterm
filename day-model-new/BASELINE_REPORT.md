...
| `combo_rank_max__max_up_ret__volume_weighted_price_position` | +1 | +0.0777 | +0.1863 | +0.1849 | 0.0004 | +0.7183 | +0.7760 | 0.744 |
| `combo_mean__max_up_ret__volume_surge_direction` | +1 | +0.0944 | +0.1816 | +0.1804 | 0.0006 | +0.6499 | +0.7284 | 0.788 |
...
| `combo_min__volume_weighted_price_position__volume_surge_direction` | +1 | +0.0839 | +0.1600 | +0.1586 | 0.0026 | +0.4471 | +0.6680 | 0.715 |
...
| `combo_tri_median__opening_drive_thrust_ratio__max_up_ret__smooth_momentum_structure` | +1 | +0.1685 | +0.2940 | +0.2932 | 0.0000 | +0.7752 | +0.7988 | 0.959 |
| `combo_sig_product__max_up_ret__close_vs_open_range` | +1 | +0.1500 | +0.2835 | +0.2832 | 0.0000 | +0.8380 | +0.7607 | 0.622 |
| `combo_rel_diff__max_up_ret__smooth_momentum_structure` | +1 | +0.1953 | +0.2768 | +0.2765 | 0.0000 | +1.0438 | +0.8299 | 0.923 |
| `combo_rel_diff__max_up_ret__late_bar_momentum` | +1 | +0.1889 | +0.2752 | +0.2746 | 0.0000 | +0.9765 | +0.7777 | 0.797 |
| `combo_mean__star50_limit_proximity_early__bar_ret_0` | +1 | +0.1770 | +0.2748 | +0.2744 | 0.0000 | +0.7230 | +0.7507 | 0.905 |
...
| `combo_ratio__max_down_ret__net_volume_flow` | +1 | +0.1323 | +0.2240 | +0.2235 | 0.0002 | +0.8478 | +0.7883 | 0.093 |
| `combo_tri_median__opening_drive_thrust_ratio__star50_limit_proximity_early__body_size_progression` | +1 | +0.1317 | +0.2190 | +0.2185 | 0.0004 | +0.6178 | +0.7437 | 0.918 |
| `combo_ratio__max_down_ret__volatility_expansion_trend_vector` | +1 | +0.1384 | +0.2185 | +0.2177 | 0.0004 | +0.7354 | +0.7525 | 0.099 |
| `combo_sig_product__star50_limit_proximity_early__max_down_ret` | +1 | +0.1432 | +0.2059 | +0.2050 | 0.0006 | +0.5352 | +0.6674 | 0.783 |
| `combo_sig_product__star50_limit_proximity_early__bar_ret_0` | +1 | +0.1436 | +0.2007 | +0.1999 | 0.0006 | +0.3439 | +0.6633 | 0.628 |
| `combo_clamp_diff__opening_drive_thrust_ratio__trend_bar_close_consistency` | +1 | +0.0926 | +0.1951 | +0.1951 | 0.0008 | +0.7041 | +0.7525 | 0.916 |
| `combo_sig_product__opening_drive_thrust_ratio__first_bar_return` | +1 | +0.1518 | +0.1848 | +0.1844 | 0.0012 | +0.4502 | +0.6639 | 1.000 |
| `combo_min__opening_drive_thrust_ratio__double_bottom_bull_flag_early` | +1 | +0.0772 | +0.1732 | +0.1723 | 0.0016 | +0.4734 | +0.6551 | 0.642 |
| `vwap_trend_channel_slope` | +1 | +0.1023 | +0.1640 | +0.1634 | 0.0028 | +0.4395 | +0.6727 | 0.709 |
